...
class WhiteboardCardActionDeleteRename{
    public void run(def params){
        ...
        sleep(1000)
        Click.run(ID:"//DIV[contains(@class,'f-canvas-card')]//DIV[contains(@class,'f-card-title-area')]//*[@class='f-card-title' and .='${params."Whiteboard to Select"}']/../../..//DIV[contains(@class,'fractal-dropdown f-canvas-card-options')]//I")
        if(params."Option"){
