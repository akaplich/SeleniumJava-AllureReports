...
//        SetCheckBox.run(ID:"//*[@id='CB_GATE_FLOATING_SCORECARD']",Check:params."Floating Gate Scorecard")
        ...
        SetCheckBox.run(ID:"//*[@id='CB_SCHEDULER_UPDATES']",Check:params."Site Scheduler v2")
        SetCheckBox.run(ID:"//*[@id='CB_SYNC_PHASE_WIDGET_AND_SCHEDULER']",Check:params."Sync Phase and Scheduler Content (v2 and v3)")
        SetCheckBox.run(ID:"//*[@id='CB_PROJECT_ROOM_SEARCH']",Check:params."Project Room Search in Userhome")
        SetCheckBox.run(ID:"//*[@id='CB_ENABLE_ASYNC_EXPORT_LIST_VIEW']",Check:params."Async Export List View")
        SetCheckBox.run(ID:"//*[@id='CB_DOCTYPE']",Check:params."Enable DOCTYPE")
        SetCheckBox.run(ID:"//*[@id='CB_ENTERPRISE_IDEA_BOARD']",Check:params."Enterprise Ideaboard")
		SetCheckBox.run(ID:"//*[@id='CB_HACK_PURCHASE']",Check:params."Purchase ability for Hackathon")
		SetCheckBox.run(ID:"//*[@id='CB_HACK_DASHBOARD']",Check:params."Hackathon Analytics Dashboard")
        SetCheckBox.run(ID:"//*[@id='CB_APP_PILLAR_UI_UPDATES']",Check:params."App Pillar UI Updates")
        SetCheckBox.run(ID:"//*[@id='CB_HACKATHON_VIRAL_EMAIL_ALERTS']",Check:params."Hackathon Viral Email Alerts")
        SetCheckBox.run(ID:"//*[@id='CB_HIDE_VOTE_COUNTER_UPDATES']",Check:params."Hide Vote Counter Updates")
        SetCheckBox.run(ID:"//*[@id='CB_SCHEDULER_UPDATES_SPRING_25']",Check:params."Scheduler Updates Spring 25")
		SetCheckBox.run(ID:"//*[@id='CB_WB_ECOMMERCE']",Check:params."Whiteboard Ecommerce")
        SetCheckBox.run(ID:"//*[@id='CB_NEWSLETTER_UPDATES']", Check:params."Newsletter Updates")
        SetCheckBox.run(ID:"//*[@id='CB_NEWSLETTER_QUICK_LISTS']", Check:params."Newsletter Quick Lists")
        SetCheckBox.run(ID:"//*[@id='CB_HACKATHON_ONBOARDING_REGISTER_SPLIT']", Check:params."Hackathon Break apart Join Widget from Onboarding")
        
        SetCheckBox.run(ID:"//*[@id='CB_APPS_V3']", Check:params."Activate Apps V3")
        SetCheckBox.run(ID:"//*[@id='CB_V3_ENHANCE']", Check:params."Apps v3 Pre-launch Enhancements")
