...
class SetChallengeBriefQAndA{
    public void run(def params){
        ...
        if(params."Question or Answer"=="Question"){      
            ...
            Click.run(ID:"//*[contains(@id,'comment')]//*[contains(text(),'${params."Question whose answer to be posted"}')]/../../../..//*[contains(@class,'redactor-in redactor-in')]")
            SetText.run(ID:"//*[contains(@id,'comment')]//*[contains(text(),'${params."Question whose answer to be posted"}')]/../../../..//*[contains(@class,'redactor-in redactor-in')]",Text:params."Text")
            sleep(2000)
        }
