...
class GetMailinatorEmail{
    public static def run(def params){
        ...
        //if(params."RequestContentType" == null){ params."RequestContentType" = "text/html"}
        def response
        def emailID
        ...
        for(int i = 1;i <= 10;i++){
            sleep(7000)
            response = HttpClient.MakeRequest(RequestContentType:"text/html",
        ...
        response = HttpClient.MakeRequest(RequestContentType:"text/html",
                                          ContentType:"application/json",
                                          Type:"GET",
                                          URL:"https://api.mailinator.com/api/delete?id=${emailID}&token=${token}").responseData
        sleep(1000)
        response = HttpClient.MakeRequest(RequestContentType:"text/html",
                                          ContentType:"application/json",
                                          Type:"GET",
