...
Click.run(ID:"//*[@id='create-step']", "Handle Stale Element":true)
        ...
        if(params."Select Tool Type"){
            Click.run("ID Type":"By",By:ActionMenuLocators.setToolType)
            def fieldParams = ['Field Value': params."Select Tool Type"]
        ...
        if(params."Select Stage"){
            Click.run("ID Type":"By",By:ActionMenuLocators.setStage)
            def fieldParams = ['Field Value': params."Select Stage"]
        	ReactFormDifferentFieldLocators.run(fieldParams)
        	Click.run("ID Type":"By",By:ReactFormDifferentFieldLocators.dropdownFieldValue)
        }
        
        if(params."Create Stage Stage Name" || params."Create Stage Innovation State"){
            Click.run("ID Type":"By",By:ActionMenuLocators.createNewStage)
            SetText.run("ID Type":"By",By:ActionMenuLocators.setStageName,Text:params."Create Stage Stage Name")
            if(params."Create Stage Innovation State"){
            	Click.run("ID Type":"By",By:ActionMenuLocators.setInnovationState)
            	def fieldParams = ['Field Value': params."Create Stage Innovation State"]
        		ReactFormDifferentFieldLocators.run(fieldParams)
        		Click.run("ID Type":"By",By:ReactFormDifferentFieldLocators.dropdownFieldValue)
        }
//        	SetText.run("ID Type":"By",By:ActionMenuLocators.setStepDescription,Text:params."Step Description")
