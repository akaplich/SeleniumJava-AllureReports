...
class RemoveAdminIdeaTaginPipelineSteps{
    public void run(def params){
        Click.run(ID:"//*[@id='actions_dropdown']")  
        Click.run(ID:"//*[@id='action-remove-admin_label']")
		...
		if(params.Action=="Remove Admin Tags"){Click.run(ID:"//*[@data-test='modal-footer-submit']")}
