...
class AccessIdeainPipelineStepsView{
    public void run(def params){
        ...
        if(params."Idea ID"){set.IDChildren << "[normalize-space()='${params."Idea ID"}']"}
