...
class C130972_WB_Text_AddAndRemoveText extends TestBase {
    private static final Logger logger = LoggerFactory.getLogger(C130972_WB_Text_AddAndRemoveText.class);
