...
class C128776_CommentComponent_EditComment extends TestBase {
    private static final Logger logger = LoggerFactory.getLogger(C128776_CommentComponent_EditComment.class);
