...
//C119208 - Idea Status Changed - Add Comment
class C119208_IdeaStatusChanged_AddComment extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119208_IdeaStatusChanged_AddComment.class);
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Idea Status Changed - Add Comment/.toString(),"Action":/Create/.toString())
