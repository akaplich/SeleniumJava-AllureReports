...
//C129873 - Copy Idea Rule - ' Copy Idea to Pipeline' Triggers New Action Items
class C129873_CopyIdeaRule_CopyIdeatoPipeline_TriggersNewActionItems extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129873_CopyIdeaRule_CopyIdeatoPipeline_TriggersNewActionItems.class);
