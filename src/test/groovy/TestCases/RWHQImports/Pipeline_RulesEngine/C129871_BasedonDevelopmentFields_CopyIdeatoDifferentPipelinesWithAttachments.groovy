...
class C129871_BasedonDevelopmentFields_CopyIdeatoDifferentPipelinesWithAttachments extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129871_BasedonDevelopmentFields_CopyIdeatoDifferentPipelinesWithAttachments.class);
