...
//C129853 - Move Idea Rule Setup - Admin Has No Access to Destination Pipeline
class C129853_MoveIdeaRuleSetup_AdminHasNoAccesstoDestinationPipeline extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129853_MoveIdeaRuleSetup_AdminHasNoAccesstoDestinationPipeline.class);
    ...
    public void testcase(){     
        ...
        new actions.Rules.ConfigureNewRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Pipeline A/.toString(),"Category":/Operations/.toString(),"Status":/Submitted/.toString(),"Action":/Save/.toString())
        //Set Rule window
