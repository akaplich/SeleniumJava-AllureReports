...
//C119479 - Vote Submitted - Change Step
class C119479_VoteSubmitted_ChangeStep extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119479_VoteSubmitted_ChangeStep.class);
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Vote Submitted - Change Step/.toString(),"Action":/Create/.toString())
