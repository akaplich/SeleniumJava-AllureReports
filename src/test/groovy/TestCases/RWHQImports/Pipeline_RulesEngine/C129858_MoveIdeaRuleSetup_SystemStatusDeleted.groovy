...
//C129858 - Move Idea Rule Setup - System Status Deleted
class C129858_MoveIdeaRuleSetup_SystemStatusDeleted extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129858_MoveIdeaRuleSetup_SystemStatusDeleted.class);
    ...
    public void testcase(){     
        ...
        new actions.Rules.ConfigureNewRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Pipeline A/.toString(),"Category":/Marketing & Branding/.toString(),"Status":/Completed/.toString(),"Action":/Save/.toString())
        //Set Rule window
        ...
        new actions.Rules.AccessExistingRule().run("Rule Name":/Rule Move 1/.toString())
        //Set Rule window
