...
//C119204 - Comment Submitted - Change Step
class C119204_CommentSubmitted_ChangeStep extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119204_CommentSubmitted_ChangeStep.class);
