...
//C129678 - Idea Submitted - Add Private Comment
class C129678_IdeaSubmitted_AddPrivateComment extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129678_IdeaSubmitted_AddPrivateComment.class);
