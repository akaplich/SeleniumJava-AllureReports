...
//C119476 - Idea Submitted - Change Step
class C119476_IdeaSubmitted_ChangeStep extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119476_IdeaSubmitted_ChangeStep.class);
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Idea Submitted - Change Step/.toString(),"Action":/Create/.toString())
