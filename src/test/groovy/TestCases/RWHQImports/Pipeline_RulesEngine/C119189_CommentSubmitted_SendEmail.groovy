...
//C119189 - Comment Submitted - Send Email
class C119189_CommentSubmitted_SendEmail extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119189_CommentSubmitted_SendEmail.class);
   ...
   @BeforeAll
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC119189_2/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        //Navigate
        ...
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Send Email/.toString(),"Send Email Recipent Group":/To System Administrator(s)/.toString(),"Send Email Enter Subject":/Test Email/.toString(),"Send Email Text":/Email sent for Comment Submitted/.toString())
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Comment Submitted - Send Email/.toString(),"Action":/Create/.toString())
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC119189_2@mailinator.com/.toString(),"Subject":/Test Email/.toString())
    }
    //Basestate
