...
//C93387 - Comment Submitted Rule
class C93387_CommentSubmittedRule extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C93387_CommentSubmittedRule.class);
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Comment Submitted Change Status/.toString(),"Action":/Create/.toString())
