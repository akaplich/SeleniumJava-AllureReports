...
//C118209 - Vote Submitted - Days Since Last Idea Update Condition - Change Visibility
class C118209_VoteSubmitted_DaysSinceLastIdeaUpdateCondition_ChangeVisibility extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C118209_VoteSubmitted_DaysSinceLastIdeaUpdateCondition_ChangeVisibility.class);
    ...
    public void testcase(){     
        ...
        new actions.Rules.SetNewRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Condition":/Days Since Last Idea Update/.toString(),"Operator value":/Is Not/.toString(),"Condition value":/4/.toString())
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Submit Vote to Change Visibility/.toString(),"Action":/Create/.toString())
