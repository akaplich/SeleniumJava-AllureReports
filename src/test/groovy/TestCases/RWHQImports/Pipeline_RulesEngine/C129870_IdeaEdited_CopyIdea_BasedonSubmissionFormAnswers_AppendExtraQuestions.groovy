...
//C129870 - Idea Edited - Copy Idea - Based on Submission Form Answers, Append Extra Questions
class C129870_IdeaEdited_CopyIdea_BasedonSubmissionFormAnswers_AppendExtraQuestions extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129870_IdeaEdited_CopyIdea_BasedonSubmissionFormAnswers_AppendExtraQuestions.class);
    ...
    public void testcase(){     
        ...
        new actions.Rules.ConfigureNewRuleActionCopyIdeatoPipeline().run("Pipeline":/Pipeline A/.toString(),"Append extra submission questions to description":true,"Action":/Save/.toString())
        //Set Rule window
