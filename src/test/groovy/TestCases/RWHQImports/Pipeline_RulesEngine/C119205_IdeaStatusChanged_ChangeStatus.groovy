...
//C119205 - Idea Status Changed - Change Status
class C119205_IdeaStatusChanged_ChangeStatus extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119205_IdeaStatusChanged_ChangeStatus.class);
    ...
    public void testcase(){
        ...
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Change Status/.toString(),"Action Value":/Pending/.toString())
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Idea Status Changed - Change Status/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Idea Status Changed - Change Status/.toString())
        //Change Rule Status
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/test idea1/.toString(),"Status":/Pending/.toString(),"Linked Submissions":[])
    }
    //Basestate
