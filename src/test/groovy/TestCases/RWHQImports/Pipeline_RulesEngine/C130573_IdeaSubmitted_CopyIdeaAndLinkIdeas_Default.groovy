...
class C130573_IdeaSubmitted_CopyIdeaAndLinkIdeas_Default extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C130573_IdeaSubmitted_CopyIdeaAndLinkIdeas_Default.class);
