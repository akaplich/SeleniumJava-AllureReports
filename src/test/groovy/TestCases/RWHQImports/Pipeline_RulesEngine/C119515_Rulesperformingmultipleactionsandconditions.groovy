...
//C119515 - Rules performing multiple actions and conditions
class C119515_Rulesperformingmultipleactionsandconditions extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119515_Rulesperformingmultipleactionsandconditions.class);
    ...
    public void testcase(){
        ...
        //Set Rule Meet the Following Conditions
        new actions.Rules.SetNewRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/2/.toString(),"Add, Delete or Modify":/Add/.toString(),"Condition":/Status/.toString(),"Operator value":/Is/.toString(),"Condition value":/Non-Adopted/.toString())
        ...
        //Set Rule Perform the Following Actions
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/2/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Change Visibility/.toString(),"Action Value":/Hidden/.toString())
        //Set Rule window
