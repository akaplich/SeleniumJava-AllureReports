...
//C129850 - Move Idea Rule Setup - Admin Has Only One Pipeline
class C129850_MoveIdeaRuleSetup_AdminHasOnlyOnePipeline extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129850_MoveIdeaRuleSetup_AdminHasOnlyOnePipeline.class);
    ...
    public void testcase(){     
        ...
        new actions.WebstormCreation.CreateCustomWebstorm().run("Webstorm Title":/Pipeline A/.toString(),"Description":/desc/.toString(),"Pipeline Administrators":/Evaluator/.toString(),"Administrators Add or Remove":/Add/.toString(),"Action":/Create/.toString())
        //Log Out
