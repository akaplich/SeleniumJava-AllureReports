...
//C119188 - Comment Submitted - Add Comment
class C119188_CommentSubmitted_AddComment extends TestBase {
    private static def variables = [:]  
    private static final Logger logger = LoggerFactory.getLogger(C119188_CommentSubmitted_AddComment.class);
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Comment Submitted - Add Comment/.toString(),"Action":/Create/.toString())
