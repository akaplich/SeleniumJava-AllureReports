...
//C119187 - Comment Submitted - Change Visibility
class C119187_CommentSubmitted_ChangeVisibility extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119187_CommentSubmitted_ChangeVisibility.class);
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Idea Status Changed - Change Visibility/.toString(),"Action":/Create/.toString())
