...
//C119474 - Idea Submitted - Change Visibility
class C119474_IdeaSubmitted_ChangeVisibility extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119474_IdeaSubmitted_ChangeVisibility.class);
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Idea Submitted - Change Visibility/.toString(),"Action":/Create/.toString())
