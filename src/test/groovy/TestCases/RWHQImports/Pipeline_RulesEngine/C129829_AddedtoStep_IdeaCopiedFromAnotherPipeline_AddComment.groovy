...
//C129829 - Added to Step - Idea Copied From Another Pipeline - Add Comment
class C129829_AddedtoStep_IdeaCopiedFromAnotherPipeline_AddComment extends TestBase {
    private static def variables = [:]
    private static def logger = LoggerFactory.getLogger(C129829_AddedtoStep_IdeaCopiedFromAnotherPipeline_AddComment.class)
    ...
    public void testcase(){     
        ...
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Add Public Comment/.toString(),"Commenter":/Pipeline Admin/.toString(),"Comment":/Rules Test/.toString())
        //Set Rule window
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewIdeapage().run("Comment Section":/Comments/.toString(),"Type of Comment":/General Access/.toString(),"Comment":/Rules Test/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
