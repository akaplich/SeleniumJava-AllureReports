...
//C119206 - Idea Status Changed - Change Visibility
class C119206_IdeaStatusChanged_ChangeVisibility
extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119206_IdeaStatusChanged_ChangeVisibility.class);
