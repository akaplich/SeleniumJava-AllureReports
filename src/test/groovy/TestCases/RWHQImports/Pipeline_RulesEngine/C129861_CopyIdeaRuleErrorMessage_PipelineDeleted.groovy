...
//C129861 - Copy Idea Rule Error Message - Pipeline Deleted
class C129861_CopyIdeaRuleErrorMessage_PipelineDeleted extends TestBase {
    private static def variables = [:]      
    private static final Logger logger = LoggerFactory.getLogger(C129861_CopyIdeaRuleErrorMessage_PipelineDeleted.class);
