...
//C118210 - Removed from Step - Days Since Last Comment Condition - Change Status
class C118210_RemovedfromStep_DaysSinceLastCommentCondition_ChangeStatus extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C118210_RemovedfromStep_DaysSinceLastCommentCondition_ChangeStatus.class);
    @BeforeAll
    ...
    public void testcase(){     
        ...
        new actions.Rules.SetNewRuleEventthattriggersthisrule().run("Event":/Removed from Step/.toString(),"Event Value":/Review/.toString())
        //Set Rule Meet the Following Conditions
        new actions.Rules.SetNewRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Condition":/Days Since Last Comment/.toString(),"Operator value":/Is/.toString(),"Condition value":/0/.toString())
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Remove Step and Change Status/.toString(),"Action":/Create/.toString())
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/test idea1/.toString(),"Status":/In Progress/.toString(),"Linked Submissions":[])
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Rules/.toString())
        ...
        new actions.Rules.VerifyRuleinRulesEnginetable().run("Order":/0/.toString(),"Rule Name":/Remove Step and Change Status/.toString(),"Event":/Removed from Step Review/.toString(),"Last Run":/${variables."today"}/.toString(),"Status":/Active/.toString(),"Description":/Days Since Last Comment Is 0; Change Status to In Progress/.toString(),"Number of Matches":/1/.toString())
    }
     //Basestate
