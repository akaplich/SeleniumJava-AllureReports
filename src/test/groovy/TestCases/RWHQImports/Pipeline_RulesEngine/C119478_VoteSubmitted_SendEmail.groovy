...
//C119478 - Vote Submitted - Send Email
class C119478_VoteSubmitted_SendEmail extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119478_VoteSubmitted_SendEmail.class);
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC119478/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        //Navigate
        ...
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Send Email/.toString(),"Send Email Recipent Group":/To Users and Groups/.toString(),"Send Email Enter Subject":/Test Email/.toString(),"Send Email Text":/Email sent for Vote Submitted/.toString(),"Select Recipient":/Autofirst Autolast/.toString())
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Vote Submitted - Send Email/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Vote Submitted - Send Email/.toString())
        //Change Rule Status
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC119478@mailinator.com/.toString(),"Subject":/Test Email/.toString())
    }
    //Basestate
