...
//C119484 - Vote Submitted - Add Comment
class C119484_VoteSubmitted_AddComment extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119484_VoteSubmitted_AddComment.class);
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Vote Submitted - Add Comment/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Vote Submitted - Add Comment/.toString())
        //Change Rule Status
        ...
        new actions.Rules.VerifyRuleinRulesEnginetable().run("Rule Name":/Vote Submitted - Add Comment/.toString(),"Event":/Vote Submitted/.toString(),"Last Run":/${variables."today"}/.toString(),"Status":/Active/.toString(),"Description":/Add Public Comment/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
