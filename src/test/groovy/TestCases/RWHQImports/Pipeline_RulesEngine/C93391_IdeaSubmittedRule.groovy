...
//C93391 - Idea Submitted Rule
class C93391_IdeaSubmittedRule extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C93391_IdeaSubmittedRule.class);
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Change Admin Submitted Idea Status/.toString(),"Action":/Create/.toString())
