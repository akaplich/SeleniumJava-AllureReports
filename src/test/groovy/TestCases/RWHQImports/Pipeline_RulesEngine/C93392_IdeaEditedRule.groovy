...
//C93392 - Idea Edited Rule
class C93392_IdeaEditedRule extends TestBase {
    private static def variables = [:]  
    private static final Logger logger = LoggerFactory.getLogger(C93392_IdeaEditedRule.class);
    ...
    public void testcase(){ 
        ...
        new actions.Rules.SetNewRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Condition":/Days in Current Status/.toString(),"Operator value":/Is Greater Than/.toString(),"Condition value":/1/.toString())
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Edit Idea and Change Visibility/.toString(),"Action":/Create/.toString())
