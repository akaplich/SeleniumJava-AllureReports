...
//C129679 - Added to Step - Add Private Comment
class C129679_AddedtoStep_AddPrivateComment extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129679_AddedtoStep_AddPrivateComment.class);
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Added to Step - Add Private Comment/.toString(),"Action":/Create/.toString())
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/Private/.toString(),"Parent Comment":/testing by adding Private Comment through rules/.toString(),"User":/Pipeline Admin/.toString(),"Placement Number":/1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Rules/.toString())
        ...
        new actions.Rules.VerifyRuleinRulesEnginetable().run("Rule Name":/Added to Step - Add Private Comment/.toString(),"Event":/Added to Step Single Scale/.toString(),"Last Run":/${variables."today"}/.toString(),"Status":/Active/.toString(),"Description":/Category Is New Product; Add Private Comment/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
