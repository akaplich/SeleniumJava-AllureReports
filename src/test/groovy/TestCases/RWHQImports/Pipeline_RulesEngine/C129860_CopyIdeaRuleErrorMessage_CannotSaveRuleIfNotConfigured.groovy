...
//C129860 - Copy Idea Rule Error Message - Cannot Save Rule If Not Configured
class C129860_CopyIdeaRuleErrorMessage_CannotSaveRuleIfNotConfigured extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129860_CopyIdeaRuleErrorMessage_CannotSaveRuleIfNotConfigured.class);
    ...
    public void testcase(){     
        ...
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Copy Idea to Pipeline/.toString())
        //Set Rule window
