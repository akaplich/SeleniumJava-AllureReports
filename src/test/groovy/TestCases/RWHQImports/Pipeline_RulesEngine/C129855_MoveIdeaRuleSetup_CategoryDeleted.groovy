...
//C129855 - Move Idea Rule Setup - Category Deleted
class C129855_MoveIdeaRuleSetup_CategoryDeleted extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129855_MoveIdeaRuleSetup_CategoryDeleted.class);
