...
//C119207 - Idea Status Changed - Change Step
class C119207_IdeaStatusChanged_ChangeStep extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119207_IdeaStatusChanged_ChangeStep.class);
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Idea Status Changed - Change Step/.toString(),"Action":/Create/.toString())
