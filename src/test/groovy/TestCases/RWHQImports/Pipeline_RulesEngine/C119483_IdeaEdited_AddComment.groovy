...
//C119483 - Idea Edited - Add Comment
class C119483_IdeaEdited_AddComment extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C119483_IdeaEdited_AddComment.class);      
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Idea Edited - Add Comment/.toString(),"Action":/Create/.toString())
