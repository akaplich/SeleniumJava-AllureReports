...
//C129864 - Idea Status Changed - Copy Idea - by Pipeline Admin
class C129864_IdeaStatusChanged_CopyIdea_byPipelineAdmin extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129864_IdeaStatusChanged_CopyIdea_byPipelineAdmin.class);
    ...
    public void testcase(){     
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea1 - copy/.toString(),"Number of Matches":/0/.toString())
        //Navigate WebStorm or MTS
