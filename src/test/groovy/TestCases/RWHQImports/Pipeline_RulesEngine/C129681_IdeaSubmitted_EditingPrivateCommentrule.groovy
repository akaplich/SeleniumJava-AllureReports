...
//C129681 - Idea Submitted - Editing Private Comment rule
class C129681_IdeaSubmitted_EditingPrivateCommentrule extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129681_IdeaSubmitted_EditingPrivateCommentrule.class);
    ...
    public void testcase(){     
        ...
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Add Private Comment/.toString(),"Comment":/testing by adding Private Comment through rules/.toString())
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Idea Submitted - Add Private Comment/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Idea Submitted - Add Private Comment/.toString())
        //Change Rule Status
        Action594d63e45cb815bc19ca15e6("Change Status":/Active/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Rules Idea1/.toString(),"Description":/test description/.toString(),"Category":/New Product/.toString(),"Required Short Question":/short ans/.toString(),"Action":/Submit Idea/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Rules Idea1/.toString())
        ...
        new actions.Rules.AccessExistingRule().run("Rule Name":/Idea Submitted - Add Private Comment/.toString())
        //Set Rule Perform the Following Actions
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Comment":/testing by adding Private Comment through rules edited version/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/You will appear as the commenter for future private comments/.toString(),"Should Exist":true)
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Action":/Save/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Rules Idea2/.toString(),"Description":/test description/.toString(),"Category":/New Product/.toString(),"Required Short Question":/short ans/.toString(),"Action":/Submit Idea/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Rules Idea2/.toString())
        //Verify Comment Count in the Header
        new actions.ViewIdeaComment.VerifyCommentCountintheHeader().run("Comment Count":/1/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/Private/.toString(),"Parent Comment":/testing by adding Private Comment through rules edited version/.toString(),"User":/Pipeline Admin/.toString(),"Placement Number":/1/.toString())
        //Navigate WebStorm or MTS
