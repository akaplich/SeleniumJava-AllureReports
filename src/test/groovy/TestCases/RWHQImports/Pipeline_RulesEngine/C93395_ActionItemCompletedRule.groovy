...
//C93395 - Action Item Completed Rule
class C93395_ActionItemCompletedRule extends TestBase {     
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C93395_ActionItemCompletedRule.class);
