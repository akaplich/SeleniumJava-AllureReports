...
//C93393 - Vote Submitted Rule
class C93393_VoteSubmittedRule extends TestBase {
    private static def variables = [:]  
    private static final Logger logger = LoggerFactory.getLogger(C93393_VoteSubmittedRule.class);
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Submit Vote to Change Status/.toString(),"Action":/Create/.toString())
