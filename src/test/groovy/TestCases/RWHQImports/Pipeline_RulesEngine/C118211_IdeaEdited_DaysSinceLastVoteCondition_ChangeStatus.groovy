...
//C118211 - Idea Edited - Days Since Last Vote Condition - Change Status
class C118211_IdeaEdited_DaysSinceLastVoteCondition_ChangeStatus extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C118211_IdeaEdited_DaysSinceLastVoteCondition_ChangeStatus.class);
   ...
   @BeforeAll
    ...
    public void testcase(){     
        ...
        new actions.Rules.SetNewRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Condition":/Days Since Last Vote/.toString(),"Operator value":/Is Less Than/.toString(),"Condition value":/2/.toString())
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Days since Last Vote/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Days since Last Vote/.toString())
        //Change Rule Status
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabTextField().run("Field Name":/Description/.toString(),"Field Value":/test idea1 desc edited/.toString(),"Action":/Save/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString())
        ...
        new actions.Rules.VerifyRuleinRulesEnginetable().run("Order":/0/.toString(),"Rule Name":/Days since Last Vote/.toString(),"Event":/Idea Edited/.toString(),"Last Run":/${variables."today"}/.toString(),"Status":/Active/.toString(),"Description":/Days Since Last Vote Is Less Than 2; Change Status to Completed/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
