...
//C129865 - Comment Submitted - Comment Count - Copy Idea With Comments
class C129865_CommentSubmitted_CommentCount_CopyIdeaWithComments extends TestBase {
    private static def variables = [:]
    private static final Logger logger = LoggerFactory.getLogger(C129865_CommentSubmitted_CommentCount_CopyIdeaWithComments.class);
