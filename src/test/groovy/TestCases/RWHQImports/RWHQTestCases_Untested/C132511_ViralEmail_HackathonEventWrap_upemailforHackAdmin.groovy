...
//C132511 - Viral Email - Hackathon Event Wrap-up email for Hack Admin
class C132511_ViralEmail_HackathonEventWrap_upemailforHackAdmin
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC132511/.toString(),"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        //Navigate
        ...
        //Login
        new actions.general.Login().run("Email":/brightC132511@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        //Navigate
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC132511@mailinator.com/.toString(),"Subject":/You’ve been assigned as a Pipeline Administrator for Hack/.toString(),"From":/noreply@brightidea.com/.toString(),"Email Should Be Received":true)
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC132511@mailinator.com/.toString(),"Subject":/Congrats on a Successful Hackathon!/.toString(),"Email Should Be Received":true)
    }
    //Basestate
