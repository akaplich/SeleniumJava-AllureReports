...
//C132195 - Rules modal error handling - Delete Whiteboard
class C132195_Rulesmodalerrorhandling_DeleteWhiteboard
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/Delete this whiteboard/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Send Idea to Whiteboard/.toString(),"Action Value":/Delete this whiteboard/.toString())
        //Set Rule window
        ...
        new actions.Rules.VerifyRuleinRulesEnginetable().run("Rule Name":/Rule to test error handling/.toString(),"Event":/Idea Submitted/.toString(),"Last Run":/Never/.toString(),"Status":/Active/.toString(),"Description":/Send Idea to Whiteboard/.toString(),"Number of Matches":/1/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Navigate Tab User Homepage or MTS
        new actions.Enterprise.UserHomepage.NavigateTabUserHomepage().run("Tab":/Whiteboards/.toString())
        //Whiteboard Card Action - Delete, Rename
        new actions.Whiteboards.WhiteboardCardActionDeleteRename().run("Whiteboard to Select":/Delete this whiteboard/.toString(),"Option":/Delete/.toString(),"Action":/Submit/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Rules/.toString())
        //Access Existing Rule
        new actions.Rules.AccessExistingRule().run("Rule Name":/Rule to test error handling/.toString())
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Rule name edited/.toString(),"Action":/Save/.toString())
