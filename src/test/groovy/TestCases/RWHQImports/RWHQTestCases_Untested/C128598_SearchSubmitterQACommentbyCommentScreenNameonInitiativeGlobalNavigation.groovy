...
//C128598 - Search Submitter QA Comment by Comment ScreenName on Initiative Global Navigation
class C128598_SearchSubmitterQACommentbyCommentScreenNameonInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Comments/.toString(),"Title":/test comment1/.toString(),"Number of Matches":/1/.toString(),"Click on the result":true)
