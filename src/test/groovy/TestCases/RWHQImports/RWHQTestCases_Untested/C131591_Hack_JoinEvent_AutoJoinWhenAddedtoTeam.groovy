...
//C131591 - Hack > Join Event - Auto Join When Added to Team
class C131591_Hack_JoinEvent_AutoJoinWhenAddedtoTeam
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC131591_team_2/.toString(),"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        //Create Mailinator User
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC131591_2/.toString(),"Finally Login as What User":/brightC131591_2@mailinator.com/.toString())
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/hack project1/.toString(),"Submitter":/Team/.toString(),"Submitter Team User":/Auto/.toString(),"Submitter Team User Add or Remove":/Add/.toString(),"Description":/test/.toString(),"Category":/Theme 2/.toString(),"Action":/Submit Idea/.toString())
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC131591_2@mailinator.com/.toString(),"Subject":/Hack: You've  Joined the Hack Event/.toString(),"From":/noreply@brightidea.com/.toString(),"Email Should Be Received":true)
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC131591_team_2@mailinator.com/.toString(),"Subject":/Hack: You've  Joined the Hack Event/.toString(),"From":/noreply@brightidea.com/.toString(),"Email Should Be Received":true)
    }
    //Basestate
