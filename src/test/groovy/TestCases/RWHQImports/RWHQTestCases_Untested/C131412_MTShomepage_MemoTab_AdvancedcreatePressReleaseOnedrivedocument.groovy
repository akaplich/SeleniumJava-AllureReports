...
//C131412 - MTS homepage > Memo Tab > Advanced create Press Release Onedrive document
class C131412_MTShomepage_MemoTab_AdvancedcreatePressReleaseOnedrivedocument
{
    ...
    public void testcase(){
        ...
        try{
            //Compare Images
            new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/DIV[contains(@class,'f-memo-thumbnail-body')]/.toString(),"Expected Image File":/C131412_expected.png/.toString(),"Actual Image Name":/C131412_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131412_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
