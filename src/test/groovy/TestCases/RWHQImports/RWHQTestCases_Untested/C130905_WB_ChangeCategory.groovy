...
//C130905 - WB - Change Category
class C130905_WB_ChangeCategory
{
    ...
    public void testcase(){
        ...
        //Whiteboard - Set Right Click on Object
        new actions.Whiteboards.SetRightClickonStickyNote().run("Change category":true)
        //Change Category via Right Click Menu in Top Ideas
        new actions.PipelineTopIdeas.TopIdeaChangeCategoryViaRightClickMenu().run("Choose Category":/Operations/.toString(),"Action":/Save/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Category updated successfully./.toString(),"Should Exist":true)
        //Whiteboard - Set Right Click on Object
        new actions.Whiteboards.SetRightClickonStickyNote().run("View idea details":true)
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/Idea1(D113)/.toString(),"Idea Image":true,"Category":/Operations/.toString(),"Submitter Name":/End User/.toString(),"Submitter Image":true)
    }
    //Basestate
