...
//C131980 - Send to PR from VI3 - Send Idea to PR as TeamMember and Not TeamMember
class C131980_SendtoPRfromVI3_SendIdeatoPRasTeamMemberandNotTeamMember
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/Idea1/.toString(),"Description":/desc/.toString(),"Category":/Hackathon Category A/.toString(),"Action":/Submit Idea/.toString())
        //Navigate
        ...
        new actions.ViewIdea30.SetandVerifyProjectRoomInViewIdea3().run("Project Room Title":/Testing project room/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        ...
        new actions.ViewIdea30.SetandVerifyProjectRoomInViewIdea3().run("Project Room Title":/Testing project room/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Set and Verify Project Room In View Idea 3
        new actions.ViewIdea30.SetandVerifyProjectRoomInViewIdea3().run("Project Room Title":/Testing project room2/.toString(),"Number of Matches":/0/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Navigate Tab User Homepage or MTS
        new actions.Enterprise.UserHomepage.NavigateTabUserHomepage().run("Tab":/Project Room/.toString())
        //Verify and Access Project Room Card in Userhome
        new actions.ProjectRoom.VerifyProjectRoomCard().run("Title":/Testing project room/.toString(),"Member count":/3/.toString(),"Total Objects":/2/.toString(),"Total Tasks":/0/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString(),"Access Project Room":true)
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/End User/.toString(),"Idea Name":/Idea1/.toString(),"Category":/Hackathon Category A/.toString())
        //Set and Verify Project Room In View Idea 3
        new actions.ViewIdea30.SetandVerifyProjectRoomInViewIdea3().run("Project Room Title":/Testing project room/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Set and Verify Project Room In View Idea 3
        new actions.ViewIdea30.SetandVerifyProjectRoomInViewIdea3().run("Project Room Title":/Testing project room2/.toString(),"Number of Matches":/0/.toString())
