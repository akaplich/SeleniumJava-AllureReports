...
//C117718 - Highlights - Demote Idea Comment - My Comment Demoted
class C117718_Highlights_DemoteIdeaComment_MyCommentDemoted
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.PromoteDemoteCommentinViewIdeapage().run("Comment":/test comment from End User/.toString(),"Promote or Demote":/Demote/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/bi.enduser1@brightidea.com/.toString(),"Password":/brightidea1/.toString())
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin demoted End User's comment on "test idea3"/.toString(),"Highlights Item Content":/test comment from End User/.toString(),"Number of Matches":/1/.toString(),"Total Number of Items":/2/.toString())
    }
    //Basestate
