...
//C131706 - Add Tasks in Project Room
class C131706_AddTasksinProjectRoom
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/task1/.toString(),"Assignee":/Pipeline Admin/.toString(),"Status":/Complete/.toString(),"Due Date":/11\/24\/2023/.toString(),"Marked Completed":true,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        ...
        new actions.ProjectRoom.VerifyProjectRoomCard().run("Title":/Testing project room/.toString(),"Color of the Project Room Icon":/rgb(52, 152, 219)/.toString(),"Updated":/A task was edited/.toString(),"Updated By":/System Admin/.toString(),"Member count":/3/.toString(),"Total Objects":/1/.toString(),"Total Tasks":/1/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString(),"Access Project Room":true)
        //Navigate to Top Link or Page in Project Room
        new actions.ProjectRoom.NavigateRoomItems().run("Room Item":/Tasks/.toString())
        //Verify Tasks in Project Room
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/task1/.toString(),"Assignee":/Pipeline Admin/.toString(),"Status":/Complete/.toString(),"Due Date":/11\/24\/2023/.toString(),"Marked Completed":true,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        ...
        //Set Add or Edit Tasks In Project Room
        new actions.ProjectRoom.SetTasksInProjectRoom().run("Add or Edit":/Add/.toString(),"New Task Name":/task2/.toString(),"Row Number":/2/.toString(),"Status":/Blocked/.toString(),"Due Date":/${variables."date"}/.toString())
        //Verify Tasks in Project Room
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/task1/.toString(),"Assignee":/Pipeline Admin/.toString(),"Status":/Complete/.toString(),"Due Date":/11\/24\/2023/.toString(),"Marked Completed":true,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Tasks in Project Room
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/task2/.toString(),"Assignee":"","Status":/Blocked/.toString(),"Due Date":/${variables."date"}/.toString(),"Marked Completed":false,"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Navigate Tab User Homepage or MTS
        new actions.Enterprise.UserHomepage.NavigateTabUserHomepage().run("Tab":/Project Room/.toString())
        //Verify and Access Project Room Card in Userhome
        new actions.ProjectRoom.VerifyProjectRoomCard().run("Title":/Testing project room/.toString(),"Color of the Project Room Icon":/rgb(52, 152, 219)/.toString(),"Updated":/A task was edited/.toString(),"Updated By":/End User/.toString(),"Member count":/3/.toString(),"Total Objects":/1/.toString(),"Total Tasks":/2/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString(),"Access Project Room":true)
        //Navigate to Top Link or Page in Project Room
        new actions.ProjectRoom.NavigateRoomItems().run("Room Item":/Tasks/.toString())
        //Verify Tasks in Project Room
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/task1/.toString(),"Assignee":/Pipeline Admin/.toString(),"Status":/Complete/.toString(),"Due Date":/11\/24\/2023/.toString(),"Marked Completed":true,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
