...
//C131156 - Submissions - Application History Export
class C131156_Submissions_ApplicationHistoryExport
{
    ...
    public void testcase(){
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("First Name":/End User/.toString(),"Last Name":/One/.toString(),"Expertise":/QA,SAS,US/.toString(),"Add or Remove Expertise":/Add,Add,Add/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdea30.ApplyOnViewIdea30().run("Message":/Test Message/.toString(),"Action":/Apply/.toString())
        ...
        new actions.general.Navigate().run("Area to Navigate to":/Profile/.toString())
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("First Name":/End User/.toString(),"Last Name":/Two/.toString(),"Expertise":/BP,QA/.toString(),"Add or Remove Expertise":/Add,Add/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString())
        ...
        new actions.ViewIdea30.AcceptDeclineApplicantSendMessageonViewIdea3().run("Applicant's Username":/End User One/.toString(),"Accept or Reject or Send Message":/Accept/.toString(),"Action":/Accept/.toString())
        //Accept/Decline Applicant, Send Message on View Idea 3
        new actions.ViewIdea30.AcceptDeclineApplicantSendMessageonViewIdea3().run("Applicant's Username":/End User Two/.toString(),"Accept or Reject or Send Message":/Reject/.toString(),"Action":/Reject/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Setup/.toString())
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Application_History-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Application Message","Application Date","Application Status","Applicant First Name","Applicant Last Name","Applicant Screen Name","Applicant Email","Applicant Expertise","Applicant Member ID"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
