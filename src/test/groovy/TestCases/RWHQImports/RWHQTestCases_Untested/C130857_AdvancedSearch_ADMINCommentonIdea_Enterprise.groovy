...
//C130857 - Advanced Search - ADMIN Comment on Idea, Enterprise
class C130857_AdvancedSearch_ADMINCommentonIdea_Enterprise
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/test admin comment1/.toString(),"Comment Type":/Update from Admin/.toString())
        //Navigate
        ...
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/test admin comment1/.toString(),"Type":/Comments/.toString(),"Number of Matches":/0/.toString())
        //Verify Quick or Advanced Search Result
