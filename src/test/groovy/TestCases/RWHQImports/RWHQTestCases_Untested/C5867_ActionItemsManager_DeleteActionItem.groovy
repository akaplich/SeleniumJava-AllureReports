...
//C5867 - Action Items Manager - Delete Action Item
class C5867_ActionItemsManager_DeleteActionItem
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Verify in Which List (optional)":/Action Items Manager/.toString(),"Title":/test idea1/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
