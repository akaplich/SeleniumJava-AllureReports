...
class C119079_DuplicateChecker_CheckotherWebStormsunderthesameCommunitytoggleenabledbyEndUser
{
    ...
    public void testcase(){
        ...
        //Verify and Access Similar Ideas using Duplicate Checker in Post Idea
        new actions.PostIdea.VerifyandAccessSimilarIdeasusingDuplicateCheckerinPostIdea().run("Title":/solve test idea2/.toString(),"Description":/solve test idea2 desc/.toString(),"Image":false,"Number of Matches":/0/.toString())
        //Verify and Access Similar Ideas using Duplicate Checker in Post Idea
