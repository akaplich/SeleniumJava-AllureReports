...
//C17873 - Financial Benefits By Submission Table - Search by Category
class C17873_FinancialBenefitsBySubmissionTable_SearchbyCategory
{
    ...
    public void testcase(){
        ...
        new actions.PipelineDashBoard.SearchIdeainSubmissiontableonBusinessImpacttab().run("Search Value":/New Product/.toString())
