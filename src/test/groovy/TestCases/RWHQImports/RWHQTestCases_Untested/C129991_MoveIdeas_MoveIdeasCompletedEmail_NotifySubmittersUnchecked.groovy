...
//C129991 - Move Ideas - Move Ideas Completed Email - Notify Submitters Unchecked
class C129991_MoveIdeas_MoveIdeasCompletedEmail_NotifySubmittersUnchecked
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC1129991_4/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/brightC1129991_4@mailinator.com/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/brightC1129991_4@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Mailinator.VerifyBodyofEmail().run("Email Address":/brightC1129991_4@mailinator.com/.toString(),"Expected Text":/ThemoveideaprocesstoPipelineA(${variables."affiliateURL"}\/PipelineA)completed.Thefollowingideassuccessfullymoved:-testidea3(${variables."affiliateURL"}\/D113)Tomanageyouremailpreferences,visityouruserprofile:${variables."affiliateURL"}\/ct\/c_ent_ct_profile_edit.php/.toString())
    }
    //Basestate
