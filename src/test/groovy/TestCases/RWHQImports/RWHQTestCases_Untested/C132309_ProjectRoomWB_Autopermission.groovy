...
//C132309 - Project Room WB > Auto permission
class C132309_ProjectRoomWB_Autopermission
{
    ...
    public void testcase(){
        ...
        //Whiteboard - Set Share
        new actions.Whiteboards.SetShareWhiteboard().run("Click Share Button":true,"User to Remove":/End User,Moderator/.toString(),"Action":/Close/.toString())
        //Navigate to Top Link or Page in Project Room
        new actions.ProjectRoom.NavigateRoomItems().run("Top Link":/Project Room Settings/.toString())
        //Set Tab in Room Settings in Project Room
        new actions.ProjectRoom.SetTabinRoomSettingsinProjectRoom().run("Tab":/Members/.toString())
        ...
        //Navigate to Top Link or Page in Project Room
        new actions.ProjectRoom.NavigateRoomItems().run("Room Item":/test permission WB/.toString())
        //Whiteboard - Set Share
        new actions.Whiteboards.SetShareWhiteboard().run("Click Share Button":true,"User to Remove":/End User,Moderator,Evaluator/.toString(),"Action":/Close/.toString())
        //Navigate to Top Link or Page in Project Room
        new actions.ProjectRoom.NavigateRoomItems().run("Top Link":/Project Room Settings/.toString())
        //Set Tab in Room Settings in Project Room
        new actions.ProjectRoom.SetTabinRoomSettingsinProjectRoom().run("Tab":/Members/.toString())
        ...
        new actions.ProjectRoom.NavigateRoomItems().run("Room Item":/test permission WB/.toString())
        //Whiteboard - Set Share
        new actions.Whiteboards.SetShareWhiteboard().run("Click Share Button":true,"User to Remove":/End User,Moderator,Evaluator,analyst/.toString(),"Action":/Close/.toString())
    }
    //Basestate
