...
//C129440 - Move Ideas - Attachments, Private Attachments
class C129440_MoveIdeas_Attachments_PrivateAttachments
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforIdeastab().run("Private Attachments on Ideas":true)
        //Navigate WebStorm or MTS
