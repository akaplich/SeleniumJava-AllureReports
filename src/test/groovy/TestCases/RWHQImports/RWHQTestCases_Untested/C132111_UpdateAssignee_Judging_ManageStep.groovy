...
//C132111 - Update Assignee - Judging - Manage Step
class C132111_UpdateAssignee_Judging_ManageStep
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureJudgingStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Judging/.toString(),"Judges":/End User,Evaluator/.toString(),"Judges Add or Remove":/Add,Add/.toString(),"Action":/Activate/.toString())
        ...
        //Verify Assignee In Update Assignee Modal
        new actions.PipelineStepsView.VerifyAssigneeInUpdateAssigneeModal().run("Assignee under Completed or Incomplete Action Items":/Assignees with complete action items/.toString(),"Assignee":/End User/.toString(),"Display Image":/Image/.toString(),"Number of Matches":/1/.toString())
        //Set Update Assignee Modal
        new actions.PipelineStepsView.SetUpdateAssigneeModal().run("Additional Assignee":/End User 2/.toString(),"Additional Assignee Add or Remove":/Add/.toString(),"Action":/Update Assignments/.toString(),"Remove Assignee from incomplete or complete action items":/End User/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Verify Action Items in Progress in Manage Step Page
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Step Name to Manage (optional)":/Judging/.toString(),"Evaluator":/End User/.toString(),"Number of assigned items":/2/.toString(),"Number of remaining items":/0/.toString(),"Number of Matches":/1/.toString())
        //Verify Action Items in Progress in Manage Step Page
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Evaluator":/Evaluator/.toString(),"Number of assigned items":/2/.toString(),"Number of remaining items":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Action Items in Progress in Manage Step Page
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Evaluator":/End User 2/.toString(),"Number of assigned items":/1/.toString(),"Number of remaining items":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
