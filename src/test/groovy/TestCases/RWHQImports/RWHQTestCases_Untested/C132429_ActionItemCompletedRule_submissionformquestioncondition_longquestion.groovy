...
//C132429 - Action Item Completed Rule - submission form question condition - long question
class C132429_ActionItemCompletedRule_submissionformquestioncondition_longquestion
{
    ...
    public void testcase(){
        ...
        new actions.Rules.SetNewRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Condition":/Long Answer Question/.toString(),"Operator value":/Is/.toString(),"Condition value":/answer is long/.toString())
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/rule for long question/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/rule for long question/.toString())
        //Change Rule Status
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/rules idea/.toString(),"Description":/desc/.toString(),"Category":/Operations/.toString(),"Long Answer Question":/answer is long/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Access Action Item in Actions Items React Global Navigation
        new actions.ActionItems.AccessActionIteminActionsItemsReactGlobalNavigation().run("Action Item":/rules idea/.toString())
        ...
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/rules idea/.toString(),"Step Name idea belongs to":/Single Scale/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
