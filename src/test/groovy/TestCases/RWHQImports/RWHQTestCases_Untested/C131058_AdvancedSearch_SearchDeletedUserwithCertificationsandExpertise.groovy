...
//C131058 - Advanced Search - Search Deleted User with Certifications and Expertise
class C131058_AdvancedSearch_SearchDeletedUserwithCertificationsandExpertise
{
    ...
    public void testcase(){
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("Expertise":/java/.toString(),"Add or Remove Expertise":/Add/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.Search.QuickOrAdvanceSearchInGlobalNav().run("Tab (optional)":/Advanced Search/.toString(),"Search Input":/Business Model Canvas/.toString())
        ...
        new actions.general.Navigate().run("Area to Navigate to":/Home/.toString())
        //Quick or Advance Search in Global Nav
        new actions.Search.QuickOrAdvanceSearchInGlobalNav().run("Tab (optional)":/Advanced Search/.toString(),"Search Input":/java/.toString())
        //Verify Quick or Advanced Search Result
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/End User/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
