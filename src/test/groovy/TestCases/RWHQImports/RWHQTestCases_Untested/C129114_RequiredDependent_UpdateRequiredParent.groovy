...
//C129114 - Required Dependent - Update Required Parent
class C129114_RequiredDependent_UpdateRequiredParent
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.VerifyNGAViewIdeaDescriptionTabFieldValue().run("Field Name":/Child3/.toString(),"Field Value":/test Child3/.toString())
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/test Child3/.toString(),"Should Exist":false)
        //Set NGA View Idea Description Tab Dropdown
        new actions.NGAViewIdea.SetNGAViewIdeaDescriptionTabDropdown().run("Field Name":/Child1/.toString(),"Action":/Save/.toString())
        //Verify Error Field in NGA View Idea page
        new actions.NGAViewIdeaFields.VerifyErrorFieldNGAViewIdea().run("Field Name":/Child1/.toString(),"Should Error Exist":true)
        //Set NGA View Idea Description Tab Dropdown
        new actions.NGAViewIdea.SetNGAViewIdeaDescriptionTabDropdown().run("Field Name":/Child1/.toString(),"Field Value":/Child1-3/.toString(),"Action":/Save/.toString())
        //Set NGA View Idea Description Tab Text Field
        new actions.NGAViewIdea.SetNGAViewIdeaDescriptionTabTextField().run("Field Name":/Child2/.toString(),"Field Value":/<EMPTY>/.toString(),"Action":/Save/.toString())
        //Verify Error Field in NGA View Idea page
        new actions.NGAViewIdeaFields.VerifyErrorFieldNGAViewIdea().run("Field Name":/Child2/.toString(),"Should Error Exist":true)
        //Set NGA View Idea Description Tab Text Field
        new actions.NGAViewIdea.SetNGAViewIdeaDescriptionTabTextField().run("Field Name":/Child2/.toString(),"Field Value":/test Child2/.toString(),"Action":/Save/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Test App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Access Pipeline Manage Steps for a Step
        new actions.PipelineStepsView.AccessPipelineManageStepsforaStep().run("Step Name":/Submitted/.toString())
        ...
        new actions.PipelineManageSteps.AccessIdeainPipelineManageCurrentlyinStepPage().run("Idea name":/test idea/.toString())
        //Verify NGA View Idea Description Tab Field Value
        new actions.NGAViewIdea.VerifyNGAViewIdeaDescriptionTabFieldValue().run("Field Name":/Parent1/.toString(),"Field Value":/Parent1-3/.toString())
        //Verify NGA View Idea Description Tab Field Value
        new actions.NGAViewIdea.VerifyNGAViewIdeaDescriptionTabFieldValue().run("Field Name":/Child1/.toString(),"Field Value":/Child1-3/.toString())
        //Verify NGA View Idea Description Tab Field Value
        new actions.NGAViewIdea.VerifyNGAViewIdeaDescriptionTabFieldValue().run("Field Name":/Child2/.toString(),"Field Value":/test Child2/.toString())
    }
    //Basestate
