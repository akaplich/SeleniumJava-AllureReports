...
//C119616 - Pipeline Setup - Scorecard Templates - Missing Answers For Dropdown
class C119616_PipelineSetup_ScorecardTemplates_MissingAnswersForDropdown
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.SetQuestionScorecardTemplate().run("Added Question Order Number":/1/.toString(),"Question Type":/Select Answer (drop down list)/.toString(),"Required to Answer":true,"Question":/Test Question One Answer/.toString(),"Short Name":/Short Name Test/.toString(),"Tooltip":/Test Tooltip One Answer/.toString(),"Action":/Save/.toString())
        //Verify Message
