...
//C131233 - Community Dashboard - By Department - Innovations Submitted by Department - Chart
class C131233_CommunityDashboard_ByDepartment_InnovationsSubmittedbyDepartment_Chart
{
    ...
    public void testcase(){
        ...
        //Verify MouseHover on Chart in Innovation Dashboard Tab
        new actions.PipelineDashBoard.VerifyMouseHoverChartViewInnovationTab().run("What Chart?":/Innovations Submitted by Department/.toString(),"Chart View":/Month to Date/.toString(),"What column to hover over?":/today/.toString(),"Legend to Verify":/Innovation,No Department/.toString(),"Tooltip Text":/today Innovation No Department 1 (33%) 2 (67%)/.toString())
        ...
        //Verify MouseHover on Chart in Innovation Dashboard Tab
        new actions.PipelineDashBoard.VerifyMouseHoverChartViewInnovationTab().run("What Chart?":/Innovations Submitted by Department/.toString(),"Chart View":/Month to Date/.toString(),"What column to hover over?":/today/.toString(),"Legend to Verify":/Innovation/.toString(),"Tooltip Text":/today Innovation 1 (100%)/.toString())
    }
    //Basestate
