...
class C131814_FileUploadonViewIdea2Attachment_Filesizesitelimitoverenterpriselimit
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Idea Title/.toString(),"Description":/Idea Description/.toString(),"Category":/Operations/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Idea Title/.toString())
        //Set Add Attachment in Attachments tab for View Idea page
        new actions.ViewIdea.SetAddAttachmentinAttachmentstabforViewIdeapage().run("Attachment File":/VideoOver2MB.mp4/.toString(),"Wait for Attachment to load":false)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/File is too large. Limit is 2MB./.toString(),"Should Exist":true)
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Set Add Attachment in Attachments tab for View Idea page
        new actions.ViewIdea.SetAddAttachmentinAttachmentstabforViewIdeapage().run("Attachment File":/NonVideoFileOver2MB.pptx/.toString(),"Wait for Attachment to load":false)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/File is too large. Limit is 2MB./.toString(),"Should Exist":true)
        //Refresh
        new actions.selenium.Refresh().run([:])
        ...
        new actions.general.VerifyMessage().run("Message Text":/File is too large. Limit is 2MB./.toString(),"Should Exist":true)
        //Set Add Attachment in Attachments tab for View Idea page
        new actions.ViewIdea.SetAddAttachmentinAttachmentstabforViewIdeapage().run("Attachment File":/NonVideoFileOver1MBAndLessThan2MB.SLDASM/.toString(),"Wait for Attachment to load":true)
        ...
        new actions.selenium.Refresh().run([:])
        //Set Add Attachment in Attachments tab for View Idea page
        new actions.ViewIdea.SetAddAttachmentinAttachmentstabforViewIdeapage().run("Attachment File":/ImageOver1MBAndLessThan2MB.png/.toString(),"Wait for Attachment to load":true)
        //Verify Attachment in Attachments tab for View Idea page
        ...
        new actions.selenium.Refresh().run([:])
        //Set Add Attachment in Attachments tab for View Idea page
        new actions.ViewIdea.SetAddAttachmentinAttachmentstabforViewIdeapage().run("Attachment File":/VideoFileOver1MBAndLessThan2MB.mp4/.toString(),"Wait for Attachment to load":true)
        //Verify Attachment in Attachments tab for View Idea page
