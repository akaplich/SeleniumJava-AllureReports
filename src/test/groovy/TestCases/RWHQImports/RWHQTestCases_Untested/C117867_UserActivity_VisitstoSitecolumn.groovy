...
//C117867 - User Activity - Visits to Site column
class C117867_UserActivity_VisitstoSitecolumn
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/User_activity-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Visits to Site"],"Number of Matches":/1/.toString())
    }
    //Basestate
