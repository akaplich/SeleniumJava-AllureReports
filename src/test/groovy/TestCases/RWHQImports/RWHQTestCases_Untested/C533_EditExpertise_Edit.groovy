...
//C533 - Edit Expertise - Edit
class C533_EditExpertise_Edit
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabDesiredExpertise().run("Expertise Name":/Test Automation/.toString(),"Add or Remove":/Add/.toString(),"Action":/Save/.toString())
