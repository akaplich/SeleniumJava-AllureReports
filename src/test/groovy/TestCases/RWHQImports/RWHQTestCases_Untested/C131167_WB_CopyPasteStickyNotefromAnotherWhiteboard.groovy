...
//C131167 - WB - Copy Paste Sticky Note from Another Whiteboard
class C131167_WB_CopyPasteStickyNotefromAnotherWhiteboard
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.MoveCursorWhiteboard().run("X coordinate1":/-250/.toString(),"Y coordinate1":/0/.toString(),"X coordinate2":/-250/.toString(),"Y coordinate2":/0/.toString())
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/0/.toString(),"Y coordinate":/120/.toString(),"Single Double or Right Click":/Right Click/.toString())
        //Whiteboard - Set Right Click on Object
        new actions.Whiteboards.SetRightClickonStickyNote().run("View idea details":true)
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"Idea Name":/idea1(D113)/.toString())
    }
    //Basestate
