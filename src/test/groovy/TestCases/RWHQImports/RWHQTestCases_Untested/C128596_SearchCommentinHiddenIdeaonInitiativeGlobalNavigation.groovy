...
//C128596 - Search Comment in Hidden Idea on Initiative Global Navigation
class C128596_SearchCommentinHiddenIdeaonInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/Hidden comment automation purpose/.toString())
        //Verify On Global Search Result
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Comments/.toString(),"Title":/Hidden comment automation purpose/.toString(),"Number of Matches":/1/.toString(),"Click on the result":true)
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/Hidden comment automation purpose/.toString())
        //Verify On Global Search Result
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Comments/.toString(),"Title":/Hidden comment automation purpose/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
