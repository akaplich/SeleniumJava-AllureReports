...
//C93346 - Development - Restore Revision
class C93346_Development_RestoreRevision
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureDevelopmentinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Development/.toString(),"Assignment Method":/Individual Assignment/.toString(),"Development Lead":/Idea Submitter/.toString(),"Development Team":/Moderator/.toString(),"Development Team Add or Remove":/Add/.toString(),"Development Field":/Development Multiple Choice Question/.toString(),"Development Field Included or Required":/Included/.toString(),"Action":/Update/.toString())
        ...
        new actions.ActionItems.AccessActionIteminMyActionItemsActionItemsManagertable().run("Access in Which List":/My Action Items/.toString(),"Title":/new idea/.toString())
        //Verify and Access Revision History Development for Idea in Action Items page
        new actions.ActionItems.VerifyRevisionHistoryDevelopmentforIdeainActionItemspage().run("Revision History":/System Admin/.toString(),"Development Multiple Choice Question":/Answer 1/.toString(),"Restore Revision":true)
        //Set Development for Idea in Action Items page
        new actions.ActionItems.SetDevelopmentforIdeainActionItemspage().run("Development Child Checkbox Question":[],"Action":/Mark Complete/.toString())
        //Verify and Access Revision History Development for Idea in Action Items page
        new actions.ActionItems.VerifyRevisionHistoryDevelopmentforIdeainActionItemspage().run("Revision History":/Current Version/.toString(),"Development Multiple Choice Question":/Answer 1/.toString())
        //Verify and Access Revision History Development for Idea in Action Items page
        new actions.ActionItems.VerifyRevisionHistoryDevelopmentforIdeainActionItemspage().run("Revision History":/Moderator/.toString(),"Development Multiple Choice Question":/Answer 3/.toString())
        //Verify and Access Revision History Development for Idea in Action Items page
        new actions.ActionItems.VerifyRevisionHistoryDevelopmentforIdeainActionItemspage().run("Revision History":/System Admin/.toString(),"Development Multiple Choice Question":/Answer 1/.toString())
    }
    //Basestate
