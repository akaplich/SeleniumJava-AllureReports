...
//C195 - Checkbox Question - Select All
class C195_CheckboxQuestion_SelectAll
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Test Idea Checkbox Select All/.toString(),"Description":/Description/.toString(),"Category":/New Product/.toString(),"Checkbox Question Name":/Answer 1,Answer 2,Answer 3/.toString(),"Checkbox Check":/TRUE,TRUE,TRUE/.toString(),"Required Short Question":/Required Short/.toString(),"Action":/Submit Idea/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Test Idea Checkbox Select All/.toString())
        //Verify Custom App Description tab fields in View Idea page
        Action5812921cfa4ee77809f46b4f("Checkbox Question":/Answer 1,Answer 2,Answer 3/.toString())
    }
    //Basestate
