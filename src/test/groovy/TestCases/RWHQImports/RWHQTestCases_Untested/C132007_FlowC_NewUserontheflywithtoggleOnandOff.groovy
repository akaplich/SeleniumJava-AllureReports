...
//C132007 - Flow C - New User on the fly with toggle On and Off
class C132007_FlowC_NewUserontheflywithtoggleOnandOff
{
    ...
    public void testcase(){
        ...
        try{
            ...
            new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Flow Option Title":/I have a team and a project, just need to get started./.toString(),"Name your team Screen Action":/Next/.toString(),"Choose a team image Action":/Next/.toString(),"Find Teammates":/brightC132007User1@mailinator.com/.toString(),"Teammates Add or Remove":/Add/.toString())
        }
        ...
        //Set Flow B and C on Hackathon Onboarding
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Flow Option Title":/I have a team and a project, just need to get started./.toString(),"Project Name":/PR1/.toString(),"Name your team Screen Action":/Next/.toString(),"Choose a team image Action":/Next/.toString(),"Find Teammates":/End User/.toString(),"Teammates Add or Remove":/Add/.toString(),"Build your winning team Screen Action":/Next/.toString(),"Get Started Screen Menu":/Ready to share your teams idea?/.toString(),"Wait for loading to disappear":true)
        //Wait
        new actions.general.Wait().run("Seconds":/4/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/brightC132007User1@mailinator.com/.toString(),"Should Exist":false)
        ...
        new actions.PipelineStepsView.AccessIdeainPipelineStepsView().run("Idea Name":/Check this idea/.toString())
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/Check this idea/.toString(),"Does it have team submission name":true,"Submitter Name":/PR1/.toString(),"Submitter Image":false)
        //Verify Team Submission on View Idea 3
        new actions.ViewIdea30.VerifyTeamSubmissiononViewIdea3().run("Team Members":/System Admin,End User/.toString(),"Team Members Image":/FALSE,FALSE/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/End User/.toString(),"Available to join teams":/Not Available to join teams/.toString(),"Projects":/Check this idea/.toString(),"Number of Matches":/1/.toString())
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/brightC132007User1@mailinator.com/.toString(),"Available to join teams":/Not Available to join teams/.toString(),"Projects":/Check this idea/.toString(),"Number of Matches":/0/.toString())
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/System Admin/.toString(),"Profile Image":false,"Available to join teams":/Not Available to join teams/.toString(),"Projects":/Check this idea/.toString(),"Number of Matches":/1/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetRegistrationorGetStartedForHackathonOnboarding().run("Area Accessing The Menu From":/HTS Left Rail/.toString(),"Onboarding Menu Option":/Get Started/.toString())
        //Set Flow B and C on Hackathon Onboarding
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Flow Option Title":/I have a team and a project, just need to get started./.toString(),"Name your team Screen Action":/Next/.toString(),"Choose a team image Action":/Next/.toString(),"Find Teammates":/brightC132007User2@mailinator.com,Pipeline Admin/.toString(),"Teammates Add or Remove":/Add,Add/.toString(),"Build your winning team Screen Action":/Next/.toString(),"Get Started Screen Menu":/Ready to share your teams idea?/.toString(),"Wait for loading to disappear":true)
        //Wait
        new actions.general.Wait().run("Seconds":/4/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/brightC132007User2@mailinator.com/.toString(),"Should Exist":true)
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Check this idea2/.toString(),"Description":/desc/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."affiliateURL"}\/hack\/boards/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Check this idea2/.toString())
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/Check this idea2/.toString(),"Does it have team submission name":true,"Submitter Name":/Team - End User/.toString(),"Submitter Image":false)
        //Verify Team Submission on View Idea 3
        new actions.ViewIdea30.VerifyTeamSubmissiononViewIdea3().run("Team Members":/End User,Pipeline Admin/.toString(),"Team Members Image":/FALSE,FALSE/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Participants Page/.toString())
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/System Admin/.toString(),"Available to join teams":/Not Available to join teams/.toString(),"Projects":/Check this idea/.toString(),"Number of Matches":/1/.toString())
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/brightC132007User2@mailinator.com/.toString(),"Available to join teams":/Not Available to join teams/.toString(),"Projects":/Check this idea2/.toString(),"Number of Matches":/0/.toString())
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/End User/.toString(),"Participant is the current user":true,"Available to join teams":/Not Available to join teams/.toString(),"Projects":/Check this idea2, Check this idea/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Wait
        new actions.general.Wait().run("Seconds":/15/.toString())
        //Get Evaluations Link in Email Evaluations
        variables."link" = new actions.Mailinator.GetEvaluationsLinkinEmailEvaluations().run("Email Address":/brightC132007User2/.toString())
        //Navigate to URL
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/Check this idea2/.toString(),"Does it have team submission name":true,"Submitter Name":/Team - End User/.toString(),"Submitter Image":false)
        //Verify Team Submission on View Idea 3
        new actions.ViewIdea30.VerifyTeamSubmissiononViewIdea3().run("Team Members":/End User,First Last,Pipeline Admin/.toString(),"Team Members Image":/FALSE,FALSE,FALSE/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Participants Page/.toString())
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/System Admin/.toString(),"Available to join teams":/Not Available to join teams/.toString(),"Projects":/Check this idea/.toString(),"Number of Matches":/1/.toString())
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/First Last/.toString(),"Participant is the current user":true,"Available to join teams":/Not Available to join teams/.toString(),"Projects":/Check this idea2/.toString(),"Number of Matches":/1/.toString())
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/End User/.toString(),"Available to join teams":/Not Available to join teams/.toString(),"Projects":/Check this idea2, Check this idea/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
