...
//C65708 - Idea Boards 30 - Filter Slider Bar - My Submissions - Hidden Idea - Single Submitter
class C65708_IdeaBoards30_FilterSliderBar_MySubmissions_HiddenIdea_SingleSubmitter
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea3/.toString(),"Description":/desc/.toString(),"Category":/Operations/.toString(),"Required Short Question":/required/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
