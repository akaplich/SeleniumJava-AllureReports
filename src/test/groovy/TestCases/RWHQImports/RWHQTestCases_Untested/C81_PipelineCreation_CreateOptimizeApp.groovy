...
//C81 - Pipeline Creation - Create Optimize App
class C81_PipelineCreation_CreateOptimizeApp
{
    ...
    public void testcase(){
        ...
        new actions.Webstorm.VerifyWebstormHome().run("Webstorm Title":/Optimize Challenge title/.toString(),"Webstorm Description":/Optimize Challenge description/.toString())
    }
    //Basestate
