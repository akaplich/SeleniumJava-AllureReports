...
//C131553 - Move Ideas With Custom Code Prefix
class C131553_MoveIdeasWithCustomCodePrefix
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.NewMoveIdeasinPipelineStepspage().run("Move To Pipeline":/Destination/.toString(),"Category":/Marketing & Branding/.toString(),"Status":/Submitted/.toString(),"Action":/Move Idea/.toString())
