...
//PHP8 - C119057 - NGA View Idea Comments - Analyst Reads Private, Admin and Q&A Comments
class PHP8_C119057_NGAViewIdeaComments_AnalystReadsPrivate_AdminandQRedwoodHQTestCaseAComments
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/Admin Comment/.toString(),"Comment Type":/Update from Admin/.toString())
        //Add Comment in View Idea page
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/Private Comment/.toString(),"Comment Type":/Private/.toString())
        //Add Comment in View Idea page
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/Submitter Comment/.toString(),"Comment Type":/Submitter Q&A/.toString())
        //Log Out
        ...
        new actions.NGAViewIdea.VerifyCommentInNGAViewIdeaPage().run("Comment Section":/Comments/.toString(),"User":/System Admin/.toString(),"Comment":/Admin Comment/.toString(),"Comment Type":/Admin/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment In NGA View Idea Page
