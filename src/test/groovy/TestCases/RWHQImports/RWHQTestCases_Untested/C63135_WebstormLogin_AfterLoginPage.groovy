...
//C63135 - Webstorm Login - After Login Page
class C63135_WebstormLogin_AfterLoginPage
{
    ...
    public void testcase(){
        ...
        new actions.SetupSite.SetWebstormSetupSiteComponentsPage().run("After Login Page":/Recent Idea List Page/.toString())
        //Log Out
