...
//C129857 - Idea Submitted - Import Over 100 ideas - Move Ideas
class C129857_IdeaSubmitted_ImportOver100ideas_MoveIdeas
{
    ...
    public void testcase(){
        ...
        new actions.Rules.ConfigureNewRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Custom App/.toString(),"Category":/Strategy/.toString(),"Status":/Completed/.toString(),"Action":/Save/.toString())
        //Set Rule window
        ...
        new actions.PipelineStepsView.ImportIdeasinPipelineStepspage().run("Idea Import File":/TestCaseC129857.xls/.toString(),"Action":/Import Ideas/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/240/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Search Idea in Idea Board page
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Search Value":/test idea115/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea115/.toString(),"Description":/desc115/.toString())
        //Search Idea in Idea Board page
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Clear Search":true)
        //Search Idea in Idea Board page
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Search Value":/test idea120/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea120/.toString(),"Description":/desc120/.toString())
        //Search Idea in Idea Board page
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Clear Search":true)
        //Search Idea in Idea Board page
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Search Value":/test idea5/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea5/.toString())
    }
    //Basestate
