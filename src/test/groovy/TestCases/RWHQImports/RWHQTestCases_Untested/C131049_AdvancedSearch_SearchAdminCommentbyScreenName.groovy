...
//C131049 - Advanced Search - Search Admin Comment by ScreenName
class C131049_AdvancedSearch_SearchAdminCommentbyScreenName
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/test comment1/.toString(),"Comment Type":/Update from Admin/.toString())
        //Navigate
