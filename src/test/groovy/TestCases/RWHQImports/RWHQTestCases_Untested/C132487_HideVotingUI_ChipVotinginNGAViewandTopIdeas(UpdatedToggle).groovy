...
//C132487 - Hide Voting UI > Chip Voting in NGA View and Top Ideas (Updated Toggle)
class C132487_HideVotingUI_ChipVotinginNGAViewandTopIdeas(UpdatedToggle)
{
    ...
    public void testcase(){
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Setup/.toString())
        //Set Webstorm Setup Ideas for Voting tab
        new actions.SetupIdeas.SetWebstormSetupIdeasforNewVotingtab().run("Display Vote Count":false)
        //Navigate WebStorm or MTS
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/*[@id='view-idea-header-container']/.toString(),"Expected Image File":/C132487_NGAViewIdea2_Expected.png/.toString(),"Actual Image Name":/C132487_NGAViewIdea2_Actual.png/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Setup/.toString())
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/*[contains(@class,'f-dropdown-options') and contains (@style,'display: block')]/.toString(),"Expected Image File":/C132487_TopIdeas_Expected.png/.toString(),"Actual Image Name":/C132487_TopIdeas_Actual.png/.toString())
        //Navigate
    ...
    public void afterState(){
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C132487_NGAViewIdea2_Actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C132487_TopIdeas_Actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
