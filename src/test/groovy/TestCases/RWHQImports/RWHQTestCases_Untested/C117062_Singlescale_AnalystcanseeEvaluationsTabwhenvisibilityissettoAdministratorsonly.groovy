...
//C117062 - Singlescale - Analyst can see Evaluations Tab when visibility is set to Administrators only
class C117062_Singlescale_AnalystcanseeEvaluationsTabwhenvisibilityissettoAdministratorsonly
{
    ...
    public void testcase(){
        ...
        try{
            ...
            new actions.ViewIdea.VerifyEvaluationstabRibboninVewIdeapage().run("Overall Score":/7/.toString(),"Total Evaluation":/1/.toString(),"Completed Evaluation":/1/.toString())
        }
        ...
        new actions.PipelineSetup.SetRolesinPipelineSetupPage().run("Navigate to Tab":true,"Analysts":/End User 2/.toString(),"Analysts Add or Remove":/Add/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
