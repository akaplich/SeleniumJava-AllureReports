...
//C64 - Submission Form Multiple Choice Question
class C64_SubmissionFormMultipleChoiceQuestion
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Idea Title/.toString(),"Description":/Idea Description/.toString(),"Category":/New Product/.toString(),"Multiple Choice Question":/Answer 1/.toString(),"Required Short Question":/required short/.toString(),"Action":/Submit Idea/.toString())
        ...
        Action5812921cfa4ee77809f46b4f("Multiple Choice Question":/Answer 1/.toString())
    }
    //Basestate
