...
//C131159 - WB - Sticky Note - No Rounded Corners
class C131159_WB_StickyNote_NoRoundedCorners
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SetRightSideControlsWhiteboard().run("Fill Color":/E870B3/.toString())
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/*[contains(@class,'f-canvas-controls-container')]\/\/*[contains(@id,'f-canvas-corner-radius')]/.toString(),"Should Element Exist":false)
    }
    //Basestate
