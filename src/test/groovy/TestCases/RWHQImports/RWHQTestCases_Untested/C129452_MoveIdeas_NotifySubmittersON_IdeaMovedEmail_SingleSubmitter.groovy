...
//C129452 - Move Ideas - Notify Submitters ON - Idea Moved Email (Single Submitter)
class C129452_MoveIdeas_NotifySubmittersON_IdeaMovedEmail_SingleSubmitter
{
    ...
    public void testcase(){
        ...
        new actions.PipelineCommunications.SetPipelineCommunicationsTab().run("Select Tab":/Emails/.toString(),"Email":/New Idea Submitted/.toString(),"Email Recipient":/Idea Submitter/.toString(),"Email Subject":/A comment has been made on your [SUBMISSION_NAME] brightc65884/.toString(),"Enable this email alert":false,"Action":/Save/.toString())
        //Create Mailinator User
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC129452_7/.toString(),"Finally Login as What User":/brightC129452_7@mailinator.com/.toString())
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC129452_7/.toString(),"Subject":/Pipeline A: Idea was moved/.toString(),"From":/Brightidea/.toString(),"Full From":/Brightidea <noreply@brightidea.com>/.toString(),"Email Should Be Received":true)
    }
    //Basestate
