...
//C119634 - Discard Submission created from My Ideas
class C119634_DiscardSubmissioncreatedfromMyIdeas
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Testing My Idea/.toString(),"Category":/New Product/.toString(),"Required Short Question":/test/.toString(),"Action":/Discard/.toString())
