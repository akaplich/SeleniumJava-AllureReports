...
//C132470 - Action Item Completed Rule - submission form question condition - number question
class C132470_ActionItemCompletedRule_submissionformquestioncondition_numberquestion
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development Number/.toString(),"Additional Question Type":/Number/.toString(),"Development Field":true,"Save Form":true)
        ...
        new actions.PipelineStepsConfigure.ConfigureDevelopmentinNewModalinPipelineStepspage().run("Assignment Method":/Individual Assignment/.toString(),"Development Lead":/Idea Submitter/.toString(),"Development Team":/Evaluator/.toString(),"Development Team Add or Remove":/Add/.toString(),"Development Field":/Development Number/.toString(),"Development Field Included or Required":/Included/.toString(),"Action":/Activate/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Rules.SetNewRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Condition":/Development Number/.toString(),"Operator value":/Is/.toString(),"Condition value":/1116/.toString())
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Rule for num question condition/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Rule for num question condition/.toString())
        //Change Rule Status
        ...
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Title":/num idea/.toString(),"Action":/Submit/.toString())
        //Select Idea in Pipeline Steps page
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/num idea/.toString())
        ...
        new actions.ActionItems.AccessActionIteminActionsItemsGlobalNavigation().run("Action Item":/num idea/.toString())
        //Set Development Action Item Page Fields
        new actions.ActionItems.SetDevelopmentActionItemPageFields().run("Number Question - Title":/Development Number/.toString(),"Number Question - Answer":/1116/.toString(),"Action":/Mark Complete/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/num idea/.toString(),"Step Name idea belongs to":/Selection/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
