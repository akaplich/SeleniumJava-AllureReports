...
//C131365 - Memo - Email Notification - 'You have been assigned a comment' - Comment Expands In Memo
class C131365_Memo_EmailNotification_'Youhavebeenassignedacomment'_CommentExpandsInMemo
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC131365/.toString(),"First Name":/Anna/.toString(),"Last Name":/Test/.toString(),"Screen Name":/Anna Test/.toString(),"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        //Navigate
        ...
        new actions.Memo.ColabEditorSetMemoTitle().run("New Title":/C131365/.toString(),"Action":/Submit/.toString())
        ...
        //Collab Editor - Add Comment
        new actions.Memo.CollabEditorAddComment().run("Comment":/comment for/.toString(),"Parent or Reply":/Parent/.toString(),"Action":/Comment/.toString(),"Tag Usernames":/Anna/.toString(),"Tag Email":/brightc131365@mailinator.com/.toString(),"Assign to Username":/Anna Test/.toString())
        //Collab Editor - Click Go Back Button
        new actions.Memo.ColabEditorClickGoBackButton().run([:])
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/brightc131365@mailinator.com/.toString(),"Password":/brightidea1/.toString(),"Verify if Logged In On Enterprise homepage":false)
        //Get Link From Comment Made on Idea Email
        variables."commentLink" = new actions.Mailinator.GetLinkFromCommentMadeonIdeaEmail().run("Email Address":/brightc131365/.toString(),"Email Subject":/You have been assigned a comment in C131365/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."commentLink"}/.toString())
        //Collab Editor - Verify Memo Comment
        new actions.Memo.CollabEditorVerifyMemoComment().run("Where to verify the comments?":/Comment Popover Next to Document/.toString(),"Comment Count":/2/.toString(),"Commenter Name":/System Admin/.toString(),"Comment to Verify":/comment for Anna Test/.toString(),"Number of Matches":/1/.toString(),"Assigned to":/Anna Test/.toString())
        //Collab Editor - Add Comment
