...
//C47226 - Public Webstorm
class C47226_PublicWebstorm
{
    ...
    public void testcase(){
        ...
        new actions.Widgets.VerifyandAccessWidgetMiniTagCloud().run("Tag Name":/tag1/.toString(),"Number of Matches":/1/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/test idea1/.toString(),"Category":/New Product/.toString(),"Status":/Under Review/.toString(),"Tag":/tag1/.toString(),"Tag Should Exist":/TRUE/.toString(),"Description":/test idea1 desc/.toString(),"Team":[],"Linked Submissions":[])
    }
    //Basestate
