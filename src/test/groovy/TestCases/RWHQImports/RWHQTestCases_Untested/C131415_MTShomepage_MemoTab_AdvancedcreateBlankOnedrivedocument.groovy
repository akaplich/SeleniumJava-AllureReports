...
//C131415 - MTS homepage > Memo Tab > Advanced create Blank Onedrive document
class C131415_MTShomepage_MemoTab_AdvancedcreateBlankOnedrivedocument
{
    ...
    public void testcase(){
        ...
        new actions.MTS.SetAdvancedCreateMemo().run("Select an editor to draft your Memo within":/OneDrive/.toString(),"Action on Select an editor to draft your Memo within slide":/Next/.toString(),"Select visibility for your memo":/Add to Batch/.toString(),"Action on Select visibility for your memo slide":/Done/.toString())
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/DIV[contains(@class,'f-memo-thumbnail-body')]/.toString(),"Expected Image File":/C131415_expected.png/.toString(),"Actual Image Name":/C131415_actual.png/.toString())
        //Verify Memo Card in Userhomepage
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/Memo - Untitled/.toString(),"Memo Icon Type":/Onedrive/.toString(),"User Name":/System Admin/.toString(),"Status":/Incubate 🐣/.toString(),"Thumbnail Image Displayed":true,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131415_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
