...
//C117542 - My Action Items Page - Team Workspace To-do Completed
class C117542_MyActionItemsPage_TeamWorkspaceTo_doCompleted
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Verify in Which List (optional)":/My Action Items/.toString(),"Completed Tab Value":/1/.toString(),"Title":/test idea1/.toString(),"Row number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
