...
//C131427 - MTS homepage > Memo Tab > Shared with me Filter
class C131427_MTShomepage_MemoTab_SharedwithmeFilter
{
    ...
    public void testcase(){
        ...
        new actions.Memo.SetFilterforMemo().run("Tab":/Shared with me/.toString())
        //Verify Memo Card in Userhomepage
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/Private Shared Memo/.toString(),"Memo Icon Type":/Brightidea/.toString(),"User Name":/System Admin/.toString(),"Status":/Private/.toString(),"Thumbnail Image Displayed":true,"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Memo Card in Userhomepage
