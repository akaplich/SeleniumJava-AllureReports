...
//C119607 - Pipeline Setup - Scorecard Templates - Edit Template Title
class C119607_PipelineSetup_ScorecardTemplates_EditTemplateTitle
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.SetTemplatesScorecardTemplates().run("Template Title to Select":/Evaluation - Cost Savings/.toString())
        //Edit Scorecard Template Name
        new actions.PipelineSetup.EditScorecardTemplateName().run("New Name":/Test Name/.toString(),"Action":/Save/.toString())
        ...
        //Set Templates in Scorecard Templates
        new actions.PipelineSetup.SetTemplatesScorecardTemplates().run("Template Title to Select":/Test Name/.toString())
    }
    //Basestate
