...
//C131592 - Hack > Join Event - Leave Event After Submitting Idea
class C131592_Hack_JoinEvent_LeaveEventAfterSubmittingIdea
{
    ...
    public void testcase(){
        ...
        variables."start" = new actions.Utils.ReturnTodaysDateintheRequestedFormat().run("Format":/MM\/dd\/yyyy/.toString())
        //Return Current Time
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC131592_1/.toString(),"Finally Login as What User":/brightC131592_1@mailinator.com/.toString())
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC131592_1@mailinator.com/.toString(),"Subject":/Hack: You've  Joined the Hack Event/.toString(),"From":/noreply@brightidea.com/.toString(),"Email Should Be Received":true)
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Home/.toString())
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/*[contains(@id,'join_event_widget')]\/BUTTON[contains(@class,'join-event-btn') and text()='Join Event']/.toString(),"Should Element Exist":false,"Number of Matches":/0/.toString())
        //Set Registration or Get Started For Hackathon Onboarding
        new actions.WebstormHomepage.HackathonOnboarding.SetRegistrationorGetStartedForHackathonOnboarding().run("Area Accessing The Menu From":/Homepage Header/.toString(),"Onboarding Menu Option":/Menu Dropdown/.toString(),"Onboarding Menu Dropdown Option":/Update or Leave Event/.toString())
        ...
        new actions.Whiteboards.VerifyToastMessageforLinkingandUnlinkingPipeline().run("Message":/You left the event./.toString())
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/DIV[@class='f-modal-body']/.toString(),"Should Element Exist":false,"Number of Matches":/0/.toString())
        //Set Registration or Get Started For Hackathon Onboarding
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Flow Option Title":/I have a team and a project, just need to get started./.toString(),"Register and add expertise Action":/Next/.toString(),"Name your team Screen Action":/Close/.toString())
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC131592_1@mailinator.com/.toString(),"Subject":/Hack: You've  Joined the Hack Event/.toString(),"From":/noreply@brightidea.com/.toString(),"Email Should Be Received":true)
    }
    //Basestate
