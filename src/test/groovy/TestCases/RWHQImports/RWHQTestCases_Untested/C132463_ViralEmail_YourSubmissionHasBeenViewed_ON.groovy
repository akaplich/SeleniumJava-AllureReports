...
//C132463 - Viral Email - Your Submission Has Been Viewed - ON
class C132463_ViralEmail_YourSubmissionHasBeenViewed_ON
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC132463_enduser/.toString(),"First Name":/Autoend/.toString(),"Last Name":/Autouser/.toString(),"Finally Login as What User":/brightC132463_enduser@mailinator.com/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Profile/.toString())
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("Receive event updates via e-mail":true,"Save":true)
        //Create Mailinator User
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC132463_submitter/.toString(),"First Name":/Autosubmitter/.toString(),"Last Name":/Autolast/.toString(),"Finally Login as What User":/brightC132463_submitter@mailinator.com/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Profile/.toString())
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("Receive event updates via e-mail":true,"Save":true)
        ...
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/brightC132463_submitter@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        ...
        new actions.Email.VerifyEmailbyIteratingthroughInboxMailinator().run("Email Address":/brightC132463_submitter@mailinator.com/.toString(),"Subject":/Your submission has been viewed!/.toString(),"Email Should Be Received":true)
        //Verify Email by Iterating through Inbox Mailinator
        new actions.Email.VerifyEmailbyIteratingthroughInboxMailinator().run("Email Address":/brightC132463_enduser@mailinator.com/.toString(),"Subject":/Your submission has been viewed!/.toString(),"Email Should Be Received":true)
    }
    //Basestate
