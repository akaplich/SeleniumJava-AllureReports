...
//C129583 - List View - Demote Reason
class C129583_ListView_DemoteReason
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/test idea1/.toString(),"Vote Count on Voting UI":/0/.toString(),"Number of Matches":/1/.toString())
