...
class C132489_VI3_DisplayVoteCount_isoff_VotecountishiddeninVI3_IdeaBoard3_andMiniIdeaWidget
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Idea Promoted by default/.toString(),"Submitter":/Team/.toString(),"Submitter Team User":/End User,Evaluator/.toString(),"Submitter Team User Add or Remove":/Add,Add/.toString(),"Team Submission Name":/Test123/.toString(),"Description":/Project One Desc/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Idea Promoted by default/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/1/.toString())
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Vote Count":/hidden/.toString(),"Stats Votes":/hidden/.toString())
        ...
        new actions.IdeaBoard.VerifyVotingCommentsIconIdeaCardIdeaBoards30().run("Simple Voting":false)
        //Navigate WebStorm or MTS
        ...
        new actions.general.VerifyElement().run("ID":/\/\/*[@id="mini_idea_list_head_votes"]/.toString(),"Number of Matches":/1/.toString(),"Should Element Exist":false)
    }
    //Basestate
