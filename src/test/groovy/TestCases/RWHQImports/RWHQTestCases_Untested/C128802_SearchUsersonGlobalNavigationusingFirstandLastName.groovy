...
//C128802 - Search Users on Global Navigation using First and Last Name
class C128802_SearchUsersonGlobalNavigationusingFirstandLastName
{
    ...
    public void testcase(){
        ...
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Users/.toString(),"Title":/End User/.toString(),"Number of Matches":/1/.toString(),"Click on the result":true)
        ...
        //Verify On Global Search Result
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Users/.toString(),"Title":/End User/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
