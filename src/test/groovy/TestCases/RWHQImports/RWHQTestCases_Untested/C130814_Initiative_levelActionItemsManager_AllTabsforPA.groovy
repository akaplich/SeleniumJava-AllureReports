...
//C130814 - Initiative-level Action Items Manager - All Tabs for PA
class C130814_Initiative_levelActionItemsManager_AllTabsforPA
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Open Tab Value":/4/.toString(),"Title":/test idea1/.toString(),"Pipeline":/Custom App/.toString(),"Number of Matches":/2/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Open Tab Value":/4/.toString(),"Title":/OpenIdea/.toString(),"Step":/Single Scale/.toString(),"Number of Matches":/0/.toString())
        //Verify Completed table for Action Items page
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Completed Tab Value":/1/.toString(),"Title":/quick add1/.toString(),"Number of Matches":/1/.toString())
        //Verify Completed table for Action Items page
        ...
        new actions.ActionItemsManager.VerifyCanceledtableforActionItemsManager().run("Canceled Tab Value":/1/.toString(),"Title":/test idea2/.toString(),"Step":/Single Scale/.toString(),"Number of Matches":/1/.toString())
        //Verify Canceled table for Action Items Manager
        ...
        new actions.ActionItems.VerifyAlltableforActionItemspage().run("All Tab Value":/6/.toString(),"Title":/test idea1/.toString(),"Status":/Open/.toString(),"Number of Matches":/2/.toString())
        //Verify All table for Action Items page
        new actions.ActionItems.VerifyAlltableforActionItemspage().run("All Tab Value":/6/.toString(),"Title":/test idea2/.toString(),"Number of Matches":/2/.toString())
        //Verify All table for Action Items page
        ...
        //Verify All table for Action Items page
        new actions.ActionItems.VerifyAlltableforActionItemspage().run("All Tab Value":/6/.toString(),"Title":/CompletedIdea/.toString(),"Status":/Completed/.toString(),"Step":/Single Scale/.toString(),"Number of Matches":/0/.toString())
        //Verify All table for Action Items page
        new actions.ActionItems.VerifyAlltableforActionItemspage().run("All Tab Value":/6/.toString(),"Title":/OpenIdea/.toString(),"Status":/Open/.toString(),"Step":/Single Scale/.toString(),"Number of Matches":/0/.toString())
        //Verify All table for Action Items page
        new actions.ActionItems.VerifyAlltableforActionItemspage().run("All Tab Value":/6/.toString(),"Title":/CancelledIdea/.toString(),"Status":/Canceled/.toString(),"Step":/Single Scale/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
