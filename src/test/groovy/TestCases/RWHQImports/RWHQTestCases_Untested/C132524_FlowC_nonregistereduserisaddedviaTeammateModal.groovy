...
//C132524 - Flow C - non registered user is added via Teammate Modal
class C132524_FlowC_nonregistereduserisaddedviaTeammateModal
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Flow Option Title":/I have a team and a project, just need to get started./.toString(),"Expertise":/myexpertise1/.toString(),"Add or Remove Expertise":/Add/.toString(),"I am available to join teams":true,"Register and add expertise Action":/Next/.toString(),"Project Name":/bestteamever/.toString(),"Name your team Screen Action":/Next/.toString(),"Choose a team image Action":/Next/.toString(),"Find Teammates":/End User,Moderator,Pipeline Admin,analyst/.toString(),"Teammates Add or Remove":/Add,Add,Add,Add/.toString(),"Build your winning team Screen Action":/Next/.toString(),"Get Started Screen Menu":/Ready to share your teams idea?/.toString(),"Wait for loading to disappear":true)
        ...
        new actions.PipelineSetup.SetParticipantsinPipelineSetupPage().run("General Access":/End User,Moderator,Pipeline Admin,analyst/.toString(),"General Access Add or Remove":/Remove,Add,Add,Remove/.toString())
    }
    //Basestate
