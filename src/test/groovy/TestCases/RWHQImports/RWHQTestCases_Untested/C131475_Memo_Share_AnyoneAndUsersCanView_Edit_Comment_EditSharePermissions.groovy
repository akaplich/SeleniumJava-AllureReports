...
class C131475_Memo_Share_AnyoneAndUsersCanView_Edit_Comment_EditSharePermissions
{
    ...
    public void testcase(){
        ...
        new actions.Memo.ColabEditorSetMemoTitle().run("New Title":/C131475/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Memo.MemoShareDialogSetParticipants().run("Click Share Button":true,"User(s)":/End User 2/.toString(),"Permission (required)":/can edit/.toString(),"Send Invite":/TRUE/.toString(),"Action":/Close/.toString())
        //Collab Editor/Userhome - Memo Share Dialog -  Set Participants
        ...
        new actions.selenium.NavigateToURL().run("URL":/${variables."currentURL"}/.toString())
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/BUTTON[@id='f-share-dialog-btn' and contains(@class,'disabled')]/.toString(),"Should Element Exist":true,"Number of Matches":/1/.toString())
        try{
            //Collab Editor - Set Text
            new actions.Memo.ColabEditorSetText().run("Text":/no longer able to edit/.toString(),"Key(s)":/Enter/.toString())
        }
        ...
        new actions.selenium.NavigateToURL().run("URL":/${variables."currentURL"}/.toString())
        //Collab Editor - Set Text
        new actions.Memo.ColabEditorSetText().run("Text":/End User 2 can edit/.toString(),"Key(s)":/Enter/.toString())
        //Copy Current URL
        variables."currentURL" = new actions.selenium.CopyCurrentURL().run([:])
        //Collab Editor - Click Go Back Button
        new actions.Memo.ColabEditorClickGoBackButton().run([:])
        ...
        new actions.Memo.CollabEditorVerifyText().run("Contains Text (only verifies text & color!)":/no longer able to edit/.toString(),"Should Text Exist":false)
        //Collab Editor - Verify Text
        new actions.Memo.CollabEditorVerifyText().run("Contains Text (only verifies text & color!)":/End User 2 can edit/.toString(),"Should Text Exist":true)
        //Collab Editor/Userhome - Memo Share Dialog -  Set Participants
        new actions.Memo.MemoShareDialogSetParticipants().run("Click Share Button":true,"User(s)":/End User/.toString(),"Permission (required)":/can comment/.toString(),"Send Invite":/TRUE/.toString(),"Action":/Close/.toString())
        //Copy Current URL
        variables."currentURL" = new actions.selenium.CopyCurrentURL().run([:])
        //Collab Editor - Click Go Back Button
        new actions.Memo.ColabEditorClickGoBackButton().run([:])
        ...
        try{
            ...
            new actions.Memo.MemoShareDialogUpdateRemoveParticipants().run("Click Share Button":true,"User(s)":/End User 2/.toString(),"Option(s)":/remove user/.toString(),"Action":/Done/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Collab Editor/Userhome - Memo Share Dialog -  Set Participants
        ...
        new actions.selenium.NavigateToURL().run("URL":/${variables."currentURL"}/.toString())
        //Collab Editor/Userhome - Memo Share Dialog -  Update/Remove Participants
        new actions.Memo.MemoShareDialogUpdateRemoveParticipants().run("Click Share Button":true,"User(s)":/End User 2/.toString(),"Option(s)":/remove user/.toString(),"Action":/Close/.toString())
        //Collab Editor/Userhome - Memo Share Dialog -  Set Participants
        new actions.Memo.MemoShareDialogSetParticipants().run("Click Share Button":true,"User(s)":/analyst/.toString(),"Permission (required)":/can comment/.toString(),"Send Invite":/TRUE/.toString(),"Action":/Close/.toString())
    }
    //Basestate
