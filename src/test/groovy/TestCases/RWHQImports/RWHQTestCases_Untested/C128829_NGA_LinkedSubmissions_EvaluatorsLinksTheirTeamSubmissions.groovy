...
//C128829 - NGA - Linked Submissions - Evaluators Links Their Team Submissions
class C128829_NGA_LinkedSubmissions_EvaluatorsLinksTheirTeamSubmissions
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.SetLinkedSubmissionsNGAViewIdeaPage().run("Submission Title":/test idea2 - team - system admin Evaluator/.toString(),"Add or Remove":/Add/.toString(),"Action":/Link Submissions/.toString())
