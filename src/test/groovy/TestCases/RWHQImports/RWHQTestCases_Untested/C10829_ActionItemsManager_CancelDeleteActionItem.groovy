...
//C10829 - Action Items Manager - Cancel Delete Action Item
class C10829_ActionItemsManager_CancelDeleteActionItem
{
    ...
    public void testcase(){
        ...
        new actions.ActionItemsManager.SetActionsDropdownintheActionItemsManager().run("Select Ideas":/test idea1/.toString(),"Check":/TRUE/.toString(),"Action":/Delete/.toString(),"Sub Action":/Cancel/.toString())
