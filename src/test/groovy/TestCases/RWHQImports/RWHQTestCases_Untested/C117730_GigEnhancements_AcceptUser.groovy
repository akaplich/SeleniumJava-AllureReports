...
//C117730 - Gig Enhancements - Accept User
class C117730_GigEnhancements_AcceptUser
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.GigEnhancementsApplyApplicants.AcceptApplicantinViewIdea().run("Applicant's Username":/Pipeline Sponsor/.toString(),"Accept or Decline":/Accept/.toString(),"Message (optional)":/test message/.toString(),"Action":/Accept/.toString())
        //Verify Applicants Tab in View Idea
        new actions.ViewIdea.GigEnhancementsApplyApplicants.VerifyApplicantsTabinViewIdea().run("Applicant's Username":/Pipeline Sponsor/.toString(),"Status":/Accepted/.toString())
    }
    //Basestate
