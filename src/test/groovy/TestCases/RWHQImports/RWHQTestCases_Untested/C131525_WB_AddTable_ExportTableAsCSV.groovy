...
//C131525 - WB - Add Table, Export Table As CSV
class C131525_WB_AddTable_ExportTableAsCSV
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131525/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.WhiteboardSetAddTable().run("Rows":/3/.toString(),"Columns":/2/.toString(),"X coordinate":/740/.toString(),"Y coordinate":/350/.toString())
        ...
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/131/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/1/.toString())
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/525/.toString())
        //Click on Whiteboard Canvas
        ...
        new actions.Whiteboards.SetRightClickonStickyNote().run("Export as CSV":true)
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/table*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["131525"],"Number of Matches":/1/.toString(),"Total Number of Rows":/4/.toString())
    }
    //Basestate
