...
//C5865 - Action Items Manager - All tab
class C5865_ActionItemsManager_Alltab
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.VerifyAlltableforActionItemspage().run("Verify in Which List (optional)":/Action Items Manager/.toString(),"All Tab Value":/5/.toString(),"Title":/test idea2/.toString(),"Number of Matches":/1/.toString())
        //Verify All table for Action Items page
