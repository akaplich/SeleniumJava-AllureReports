...
class C131594_HackathonAndExternalHack_EmailtoPipelineAdmin
{
    ...
    public void testcase(){
        ...
        variables."emailURL" = new actions.Mailinator.GetLinkfromInviteParticipantEmail().run("Email Address":/${variables."TCData.User"}/.toString(),"Subject of New Administrator Added Email":/You’ve been assigned as a Pipeline Administrator for Hack Event title/.toString())
        //Navigate to URL
