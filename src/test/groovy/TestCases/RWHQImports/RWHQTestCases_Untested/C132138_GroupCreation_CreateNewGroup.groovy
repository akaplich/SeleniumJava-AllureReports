...
//C132138 - Group Creation - Create New Group
class C132138_GroupCreation_CreateNewGroup
{
    ...
    public void testcase(){
        ...
        //Verify Groups in the List
        new actions.SetupUsers.VerifyGroupsintheList().run("Navigate to Groups Tab":true,"Group Name":/ZTesting Group1/.toString(),"Placement Number":/3/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
