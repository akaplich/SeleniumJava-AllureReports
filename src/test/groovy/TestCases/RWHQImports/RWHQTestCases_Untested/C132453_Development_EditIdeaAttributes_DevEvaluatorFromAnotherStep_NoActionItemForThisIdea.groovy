...
//C132453 - Development - Edit Idea Attributes - Dev Evaluator From Another Step, No Action Item For This Idea
class C132453_Development_EditIdeaAttributes_DevEvaluatorFromAnotherStep_NoActionItemForThisIdea
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.ChangeIdeaStepinPipelineStepspage().run("Step":/DevelopmentEndUser/.toString(),"Action":/Change Step/.toString())
        //Log Out
        ...
        try{
            ...
            new actions.ViewIdea30.SetCoverImageinViewIdea3page().run("Image File":/Image5.jpg/.toString(),"Original Image":/Custom/.toString(),"New Image":true,"Update Cover Image Action":/Update image/.toString())
        }
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/test idea3/.toString(),"Idea Image":true,"Description":/test/.toString(),"Category":/New Product/.toString(),"Status":/Submitted/.toString(),"Submitter Name":/System Admin/.toString(),"Tag":/tag1/.toString(),"Tag Should Exist":/TRUE/.toString())
    }
    //Basestate
