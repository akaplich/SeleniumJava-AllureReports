...
//C130854 - Advanced Search - Private Comment, Enterprise Level
class C130854_AdvancedSearch_PrivateComment_EnterpriseLevel
{
    ...
    public void testcase(){
        ...
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/Private comment automation purpose/.toString(),"Type":/Comments/.toString(),"Number of Total (for Advanced Search)":/2 of 2/.toString(),"Number of Matches":/1/.toString())
        //Log Out
