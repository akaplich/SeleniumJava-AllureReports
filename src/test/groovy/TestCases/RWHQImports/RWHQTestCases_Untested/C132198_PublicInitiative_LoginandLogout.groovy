...
//C132198 - Public Initiative - Login and Logout
class C132198_PublicInitiative_LoginandLogout
{
    ...
    public void testcase(){
        ...
        new actions.SetupSite.SetEnterpriseSetupSiteGlobalNavigationPage().run("Enabled Initiatives - Select All":true)
        //Log Out
        ...
        //Set Login Widget
        new actions.Widgets.SetLoginWidget().run("Email":/bi.adminuser1@brightidea.com/.toString(),"Password":/brightidea1/.toString())
        ...
        new actions.general.Navigate().run("Area to Navigate to":/Enterprise Setup/.toString())
        //Set Enterprise Setup Site Global Navigation Page
        new actions.SetupSite.SetEnterpriseSetupSiteGlobalNavigationPage().run("Enable Global Navigation":false)
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
