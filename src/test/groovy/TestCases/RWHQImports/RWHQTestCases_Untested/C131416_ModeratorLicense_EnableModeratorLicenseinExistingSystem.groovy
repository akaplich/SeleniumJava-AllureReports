...
//C131416 - Moderator License - Enable Moderator License in Existing System
class C131416_ModeratorLicense_EnableModeratorLicenseinExistingSystem
{
    ...
    public void testcase(){
        ...
        new actions.People.AddUserinPeoplepage().run("Email Address":/moderatorBI1@test.com/.toString(),"Action":/Add User/.toString())
        //Add User in People page
        new actions.People.AddUserinPeoplepage().run("Email Address":/moderatorBI2@test.com/.toString(),"Action":/Add User/.toString())
        //Add User in People page
        new actions.People.AddUserinPeoplepage().run("Email Address":/moderatorBox1@test.com/.toString(),"Action":/Add User/.toString())
        //Add User in People page
        new actions.People.AddUserinPeoplepage().run("Email Address":/moderatorBox2@test.com/.toString(),"Action":/Add User/.toString())
        //Navigate
        ...
        new actions.general.VerifyValuesLicenseManager().run("Brightidea Administrator Licenses - Purchased":/5/.toString(),"Idea Box Manager Licenses - Purchased":/5/.toString(),"Brightidea Moderator Licenses - Purchased":/4/.toString())
        //Navigate to URL
        ...
        //Verify Licenses User in People Pillar Licenses tab
        new actions.People.VerifyLicensesUserinPeoplePillarLicensesTab().run("License Type":/Idea Box Manager License Type/.toString(),"Expand License Breakdown":false,"User":/moderatorBox_1@test.com/.toString(),"Roles":/Pipeline Moderator/.toString(),"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Licenses User in People Pillar Licenses tab
        new actions.People.VerifyLicensesUserinPeoplePillarLicensesTab().run("License Type":/Idea Box Manager License Type/.toString(),"Expand License Breakdown":false,"User":/moderatorBox_2@test.com/.toString(),"Roles":/Pipeline Moderator/.toString(),"Placement Number":/3/.toString(),"Number of Matches":/1/.toString())
        //Set Back to Licenses on Licenses Tab
        new actions.People.SetBacktoLicensesonLicensesTab().run([:])
        ...
        //Verify Licenses User in People Pillar Licenses tab
        new actions.People.VerifyLicensesUserinPeoplePillarLicensesTab().run("License Type":/Brightidea Moderator Licenses/.toString(),"Expand License Breakdown":true,"User":/moderatorBI_2@test.com/.toString(),"Roles":/Pipeline Moderator/.toString(),"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Licenses User in People Pillar Licenses tab
        new actions.People.VerifyLicensesUserinPeoplePillarLicensesTab().run("License Type":/Brightidea Moderator Licenses/.toString(),"Expand License Breakdown":false,"User":/moderatorBI_1@test.com/.toString(),"Roles":/Pipeline Moderator/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
