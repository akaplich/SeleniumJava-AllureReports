...
//C65705 - Idea Boards 30 - Filter Slider Bar - My Submissions, Update Submitter
class C65705_IdeaBoards30_FilterSliderBar_MySubmissions_UpdateSubmitter
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.SetSubmitterinViewIdeaPage().run("User":/System Admin,System Admin/.toString(),"Add or Remove or Set Owner":/Add,Set/.toString(),"Action":/Save/.toString())
        //Set Submitter in View Idea Page
        ...
        //Set Submitter in View Idea Page
        new actions.ViewIdea.SetSubmitterinViewIdeaPage().run("User":/End User,End User/.toString(),"Add or Remove or Set Owner":/Add,Set/.toString(),"Action":/Save/.toString())
        //Set Submitter in View Idea Page
        new actions.ViewIdea.SetSubmitterinViewIdeaPage().run("User":/Sri/.toString(),"Add or Remove or Set Owner":/Remove/.toString(),"Action":/Save/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
