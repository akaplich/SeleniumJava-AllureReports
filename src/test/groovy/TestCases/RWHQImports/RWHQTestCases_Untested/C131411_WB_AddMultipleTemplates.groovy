...
//C131411 - WB - Add Multiple Templates
class C131411_WB_AddMultipleTemplates
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131411/.toString(),"Action":/Submit/.toString())
