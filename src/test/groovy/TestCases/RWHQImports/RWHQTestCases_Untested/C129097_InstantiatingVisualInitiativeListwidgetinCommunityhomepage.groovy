...
//C129097 - Instantiating Visual Initiative List widget in Community homepage
class C129097_InstantiatingVisualInitiativeListwidgetinCommunityhomepage
{
    ...
    public void testcase(){
        ...
        new actions.Widgets.SetVisualWebstormListLarge().run("Widget Name":/Visual Initiative List (Large)/.toString(),"WebStorms from List":/Solve App/.toString(),"WebStorm Checkbox Check":/FALSE/.toString())
        //Set Widget
        new actions.Widgets.SetWidget().run("Name of Widget to Modify":/Visual Initiative List (Large)/.toString(),"Remove":true)
        //Set Widget
        ...
        //Verify Visual Initiative List Small Widget
        new actions.Widgets.VerifyVisualInitiativeListSmallWidget().run("Initiative Title":/Evaluators app/.toString(),"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
