...
//C131660 - Apply on VI3 - Cancel Application, Toast Messages, Time Stamp
class C131660_ApplyonVI3_CancelApplication_ToastMessages_TimeStamp
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.VerifyToastMessageforLinkingandUnlinkingPipeline().run("Message":/Application submitted successfully!/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/DIV[contains(@class,'f-gig-application-widget')]\/\/DIV[contains(@class,'f-gig-cancel-wrapper')]\/BUTTON/.toString(),"Expected Image File":/C131660_1_expected2.png/.toString(),"Actual Image Name":/C131660_1_actual.png/.toString(),"Allowed Number of Different Pixels":/10/.toString(),"Temporary Pause Verification; Email Screenshot to":"")
        //Access or Close Idea from View Idea 3 Modal
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Access Idea":/gig offer/.toString())
        //Verify Text in Element
        new actions.selenium.VerifyText().run("ID":/\/\/DIV[contains(@class,'f-gig-application-widget')]\/\/DIV[contains(@class,'f-gig-cancel-wrapper')]\/P/.toString(),"Contains Text":/Applied/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Gig/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/gig offer/.toString())
        //Apply on View Idea 30
        new actions.ViewIdea30.ApplyOnViewIdea30().run("Action":/Apply/.toString())
        //Verify Toast Message for Linking and Unlinking Pipeline
        new actions.Whiteboards.VerifyToastMessageforLinkingandUnlinkingPipeline().run("Message":/Application canceled successfully!/.toString())
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/DIV[contains(@class,'f-gig-vI3-wrapper')]\/BUTTON/.toString(),"Expected Image File":/C131660_2_expected2.png/.toString(),"Actual Image Name":/C131660_2_actual.png/.toString(),"Allowed Number of Different Pixels":/10/.toString(),"Temporary Pause Verification; Email Screenshot to":"")
    }
    //Basestate
    ...
    public void afterState(){
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131660_1_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131660_2_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
