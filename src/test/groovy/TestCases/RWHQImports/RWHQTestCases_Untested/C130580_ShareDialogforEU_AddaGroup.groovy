...
//C130580 - Share Dialog for EU - Add a Group 
class C130580_ShareDialogforEU_AddaGroup
{
    ...
    public void testcase(){
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Import Users from a Spreadsheet/.toString(),"Should Exist":false)
        try{
            //Set Participants in Share Dialog
            new actions.ShareDialog.SetParticipantsinShareDialog().run("Participants":/testgroup/.toString(),"Participants Add or Remove from Input Field":/Add/.toString(),"Send Invite":true)
        }
       catch(all){}catch(Error err){}
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/User(s) added successfully!/.toString(),"Should Exist":false)
        //Set Share Dialog
        ...
        new actions.ShareDialog.VerifyParticipantorGroupinParticipantsTab().run("User or Group":/Group/.toString(),"User or GroupName":/testgroup/.toString(),"Number of Matches":/0/.toString())
        //Verify Participant or Group or Managers in the Share Dialog
