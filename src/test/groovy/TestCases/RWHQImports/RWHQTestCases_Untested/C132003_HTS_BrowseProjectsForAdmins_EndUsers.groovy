...
//C132003 - HTS > Browse Projects For Admins, End Users
class C132003_HTS_BrowseProjectsForAdmins_EndUsers
{
    ...
    public void testcase(){
        ...
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Project - System Admin, End User/.toString(),"Submitter":/Team/.toString(),"Submitter Team User":/End User/.toString(),"Submitter Team User Add or Remove":/Add/.toString(),"Description":/desc/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Home/.toString())
        //Verify and Set MTS tab on homepage
        new actions.MTS.SetMTStabonhomepage().run("Should Tab Exist":false,"Heading":/EXPLORE/.toString(),"Tabs":/Browse Projects/.toString(),"Placement Number of Tab":/2/.toString())
        //Log Out
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Hackathon Team Site/.toString())
        //Verify and Set MTS tab on homepage
        new actions.MTS.SetMTStabonhomepage().run("Should Tab Exist":true,"Heading":/EXPLORE/.toString(),"Tabs":/Browse Projects/.toString(),"Placement Number of Tab":/2/.toString(),"Should User Click on Tab":true)
        //Verify and Access Submission in User Homepage
        new actions.Enterprise.UserHomepage.VerifySubmissioninUserHomepage().run("Total Number of Submissions":/3/.toString(),"Submission Name":/Project - End User/.toString(),"Description":/desc/.toString(),"Status":/Submitted/.toString(),"Number of Matches":/1/.toString())
        //Verify and Access Submission in User Homepage
        new actions.Enterprise.UserHomepage.VerifySubmissioninUserHomepage().run("Total Number of Submissions":/3/.toString(),"Submission Name":/Project - System Admin, End User/.toString(),"Description":/desc/.toString(),"Status":/Submitted/.toString(),"Number of Matches":/1/.toString())
        //Verify and Access Submission in User Homepage
        new actions.Enterprise.UserHomepage.VerifySubmissioninUserHomepage().run("Total Number of Submissions":/3/.toString(),"Submission Name":/Project - System Admin/.toString(),"Description":/desc/.toString(),"Status":/Submitted/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
