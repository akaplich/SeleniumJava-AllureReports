...
//C118732 - Post Idea in Discuss App
class C118732_PostIdeainDiscussApp
{
    ...
    public void testcase(){
        ...
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Discuss forum title/.toString(),"Area to Navigate to":/Post Idea/.toString())
