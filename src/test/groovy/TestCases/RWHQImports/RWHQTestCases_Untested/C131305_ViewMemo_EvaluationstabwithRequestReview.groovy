...
//C131305 - View Memo - Evaluations tab with Request Review
class C131305_ViewMemo_EvaluationstabwithRequestReview
{
    ...
    public void testcase(){
        ...
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Memo Program testing/.toString(),"Area to Navigate to":/Memo Idea Boards/.toString())
        //Access Idea from Pipeline Steps View for End Users
        new actions.IdeaBoard.AccessIdeafromPipelineStepsViewforEndUsers().run("Idea Name":/Memo Review Request Idea1/.toString())
