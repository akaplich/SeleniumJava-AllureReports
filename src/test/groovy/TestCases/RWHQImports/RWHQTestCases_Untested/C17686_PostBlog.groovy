...
class C17686_PostBlog
{
    ...
    public void testcase(){
        ...
        new actions.EnterpriseBlogs.VerifyEnterpriseBlogList().run("Title":/First Blog Post/.toString(),"Topic":/Custom App/.toString(),"Posted By":/System Admin/.toString(),"Tags":/firstblog/.toString(),"Content":/First Blog posted in custom app/.toString(),"Comment Count":/0/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
