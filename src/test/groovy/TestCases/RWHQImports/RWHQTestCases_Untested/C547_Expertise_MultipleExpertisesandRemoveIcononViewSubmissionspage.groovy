...
//C547 - Expertise - Multiple Expertises and Remove Icon on View Submissions page
class C547_Expertise_MultipleExpertisesandRemoveIcononViewSubmissionspage
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabDesiredExpertise().run("Expertise Name":/Expertise9,Expertise10,Expertise8/.toString(),"Add or Remove":/Add,Add,Add/.toString(),"Action":/Save/.toString())
        //Verify Custom App Description tab fields in View Idea page
        Action5812921cfa4ee77809f46b4f("Desired Expertise":/Expertise9,Expertise10,Expertise8/.toString())
        //Set View Idea Description Tab Desired Expertise
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabDesiredExpertise().run("Expertise Name":/Expertise8/.toString(),"Add or Remove":/Remove/.toString(),"Action":/Save/.toString())
        //Verify Custom App Description tab fields in View Idea page
        Action5812921cfa4ee77809f46b4f("Desired Expertise":/Expertise9,Expertise10/.toString())
    }
    //Basestate
