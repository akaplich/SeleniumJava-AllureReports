...
//C131360 - MTS homepage > Pipeline Tab as Admin
class C131360_MTShomepage_PipelineTabasAdmin
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/Memo1/.toString(),"Step Name idea belongs to":/Backlog/.toString(),"Placement Number":/1/.toString())
        //Switch to Browser Window
        new actions.selenium.SwitchWindow().run("Window Name":/Memo Program testing: Team Site/.toString())
        //Verify and Set MTS tab on homepage
        ...
        new actions.selenium.SwitchWindow().run("Tab (start from 0)":/1/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/Memo1/.toString(),"Step Name idea belongs to":/Backlog/.toString(),"Number of Matches":/1/.toString(),"Placement Number":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
