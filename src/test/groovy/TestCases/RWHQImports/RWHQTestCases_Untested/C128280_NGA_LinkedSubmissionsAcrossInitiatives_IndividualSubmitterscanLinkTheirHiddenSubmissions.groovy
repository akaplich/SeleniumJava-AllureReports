...
//C128280 - NGA - Linked Submissions Across Initiatives - Individual Submitters can Link Their Hidden Submissions 
class C128280_NGA_LinkedSubmissionsAcrossInitiatives_IndividualSubmitterscanLinkTheirHiddenSubmissions
{
    ...
    public void testcase(){
        ...
        new actions.WebstormCreation.CreateCustomWebstorm().run("Webstorm Title":/Custom App Test/.toString(),"Description":/about/.toString(),"Submission Name":/Submission/.toString(),"Submission Plural Name":/Submissions/.toString(),"Action":/Create/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Access Idea":/linked idea1/.toString())
        //Set and Verify Toggle Visibility
        new actions.ViewIdea30.SetToggleVisibility().run("Idea Name":/linked idea1/.toString(),"Toggle Visibility":false)
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/evaluator@test.com/.toString(),"Password":/brightidea1/.toString())
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/No Submissions Found/.toString(),"Should Exist":false)
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Wait
        new actions.general.Wait().run("Seconds":/2/.toString())
        //Verify Linked Submission on NGA View Idea
        new actions.NGAViewIdea.VerifyLinkedSubmissionNGAViewIdea().run("Linked Submissions":/linked idea/.toString(),"Should Exist":/TRUE/.toString())
    }
    //Basestate
