...
class C131142_WB_Share_Anyonewithlink..._UpdateViewOnlytoEditPermissionAndBack
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.OpenExistingWhiteboardOnWhiteboardsPage().run("Name of Whiteboard":/TestLink/.toString())
        //Whiteboard - Set Share
        ...
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/UL[@class='f-dropdown-options']\/LI\/DIV[@class='f-menu-item']\/*[contains(.,'Preferences')]/.toString(),"Should Element Exist":false)
        try{
            //Set Whiteboard Title
            new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/Updated Title/.toString(),"Action":/Submit/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Whiteboard Title
        new actions.Whiteboards.VerifyWhiteboardTitle().run("Title":/TestLink/.toString())
    }
    //Basestate
