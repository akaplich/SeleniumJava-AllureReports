...
//C93394 - Removed from Step Rule
class C93394_RemovedfromStepRule
{
    ...
    public void testcase(){
        ...
        new actions.Rules.SetNewRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Condition":/Comment Count/.toString(),"Operator value":/Is Less Than/.toString(),"Condition value":/5/.toString())
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Remove to Change Visibility/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Remove to Change Visibility/.toString())
        //Change Rule Status
