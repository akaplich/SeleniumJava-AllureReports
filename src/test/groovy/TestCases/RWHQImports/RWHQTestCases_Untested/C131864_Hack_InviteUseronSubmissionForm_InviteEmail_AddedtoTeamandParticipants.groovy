...
//C131864 - Hack > Invite User on Submission Form - Invite Email, Added to Team and Participants
class C131864_Hack_InviteUseronSubmissionForm_InviteEmail_AddedtoTeamandParticipants
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/team submission/.toString(),"Submitter":/Team/.toString(),"Submitter Team User":/brightC131864@mailinator.com/.toString(),"Submitter Team User Add or Remove":/Add/.toString(),"Description":/test/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Get Registration Link from Email
        variables."registerURL" = new actions.Mailinator.GetRegistrationLinkfromEmail().run("Email Address":/brightC131864/.toString())
        //Navigate to URL
