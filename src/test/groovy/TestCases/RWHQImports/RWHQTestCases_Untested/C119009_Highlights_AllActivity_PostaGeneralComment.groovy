...
//C119009 - Highlights - All Activity - Post a General Comment
class C119009_Highlights_AllActivity_PostaGeneralComment
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin commented on "test idea1"/.toString(),"Highlights Item Content":/This is comment1/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
