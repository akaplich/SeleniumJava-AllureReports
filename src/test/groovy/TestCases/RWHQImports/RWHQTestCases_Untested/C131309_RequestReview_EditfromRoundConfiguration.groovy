...
//C131309 - Request Review - Edit from Round Configuration
class C131309_RequestReview_EditfromRoundConfiguration
{
    ...
    public void testcase(){
        ...
        //Set Request Review Modal
        new actions.Memo.SetRequestReviewModal().run("Round Configuration":true,"Select Reviewers":/Moderator,Pipeline Admin/.toString(),"Select Reviewers Add or Remove":/Add,Remove/.toString(),"Click on Advanced Settings":true,"Round Name":/Round1 edited/.toString(),"Action":/Update/.toString())
        //Verify Round Information In Review Results modal
        new actions.Memo.VerifyRoundInformationInReviewResultsmodal().run("Progress Bar":/50%/.toString(),"Completed":/1\/2/.toString(),"Due in":true,"Reviewers":/Evaluator,Moderator/.toString(),"Score":/6.3,-/.toString(),"Assigned by":/System Admin/.toString(),"Round name":/Round1 edited/.toString(),"Template":/General Memo Review/.toString())
        //Set Request Review Modal
        new actions.Memo.SetRequestReviewModal().run("Round Configuration":true,"Select Reviewers":/Evaluator/.toString(),"Select Reviewers Add or Remove":/Remove/.toString(),"Action":/Update/.toString())
        //Verify Round Information In Review Results modal
        new actions.Memo.VerifyRoundInformationInReviewResultsmodal().run("Completed":/0\/1/.toString(),"Due in":true,"Reviewers":/Moderator/.toString(),"Score":/-/.toString(),"Assigned by":/System Admin/.toString(),"Round name":/Round1 edited/.toString(),"Template":/General Memo Review/.toString())
    }
    //Basestate
