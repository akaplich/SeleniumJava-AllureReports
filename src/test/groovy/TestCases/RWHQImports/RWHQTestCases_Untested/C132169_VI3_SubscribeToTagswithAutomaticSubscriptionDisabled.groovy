...
//C132169 - VI3 - Subscribe To Tags with Automatic Subscription Disabled
class C132169_VI3_SubscribeToTagswithAutomaticSubscriptionDisabled
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetEnterpriseSetupIdeasIdeaSettingsTab().run("Enable Idea Tags Automatic Subscription":false)
        ...
        //Verify Subscribe To Tags On ViewIdea 30 Page
        new actions.ViewIdea30.VerifySubscribeToTagsOnViewIdea30Page().run("TagName":/tagbyadmin/.toString(),"SubscribeTooltip":/Subscribe/.toString(),"ExpectedSubscribersCount":/0/.toString())
        ...
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/System Admin/.toString(),"Idea Name":/SubscribeToTagsIdea(D113)/.toString(),"Idea Image":true,"Submitter Name":/System Admin/.toString(),"Tag":/newtag1234,tag1/.toString(),"Tag Should Exist":/TRUE,TRUE/.toString())
        //Verify Subscribe To Tags On ViewIdea 30 Page
