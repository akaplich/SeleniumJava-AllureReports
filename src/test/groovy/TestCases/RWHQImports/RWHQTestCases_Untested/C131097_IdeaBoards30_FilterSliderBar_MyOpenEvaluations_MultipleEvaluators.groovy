...
//C131097 - Idea Boards 30 - Filter Slider Bar - My Open Evaluations - Multiple Evaluators
class C131097_IdeaBoards30_FilterSliderBar_MyOpenEvaluations_MultipleEvaluators
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureSingleScaleStepinNewModalinPipelineStepspage().run("Individual Assignment User":/End User,Evaluator/.toString(),"Individual Assignment User Add or Remove":/Add,Add/.toString(),"Action":/Update/.toString())
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/My Open Evaluations/.toString(),"Should Exist":false)
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
