...
//C131048 - Advanced Search - Search General Comment by ScreenName
class C131048_AdvancedSearch_SearchGeneralCommentbyScreenName
{
    ...
    public void testcase(){
        ...
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/test comment/.toString(),"Type":/Comments/.toString(),"Number of Matches":/1/.toString(),"Click on result":true)
        //Verify Comment in View Idea page
        new actions.ViewIdeaComment.VerifyCommentinViewIdeapage().run("Comment Section":/Comments/.toString(),"Type of Comment":/General Access/.toString(),"Comment":/test comment/.toString(),"User":/End User/.toString(),"Number of Matches":/1/.toString())
        //Log Out
