...
//C129748 - New Copy Ideas - Dependent Questions Get Appended to Description
class C129748_NewCopyIdeas_DependentQuestionsGetAppendedtoDescription
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString(),"Status":/Submitted/.toString(),"Username":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString())
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/test idea1/.toString(),"Category":/New Product/.toString(),"Status":/Submitted/.toString(),"Description":/description1 Extra Questions Parent1 Parent1-3 Child1 Child1-3 Child2 long test1/.toString(),"Linked Submissions":[])
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Pipeline B/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea2/.toString(),"Status":/Submitted/.toString(),"Username":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea2/.toString())
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/test idea2/.toString(),"Category":/New Product/.toString(),"Status":/Submitted/.toString(),"Description":/description2 Extra Questions Parent1 Parent1-3 Child1 Child1-2/.toString(),"Linked Submissions":[])
    }
    //Basestate
