...
//C131343 - MTS Homepage > Settings Tab
class C131343_MTSHomepage_SettingsTab
{
    ...
    public void testcase(){
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Team Site Setup: Memo Program testing/.toString(),"Should Exist":true)
        ...
        new actions.SetupSite.SetCommunitySetupSiteInfoTab().run("Vanity URL":/teamsiteedited/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Close All Browsers
        new actions.selenium.CloseBrowser().run([:])
        ...
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("Area to Navigate to":/Memo Team Site/.toString(),"Memo Team Site Link":/teamsiteedited/.toString())
        //Verify and Set MTS tab on homepage
        new actions.MTS.SetMTStabonhomepage().run("Should Tab Exist":false,"Heading":/SETTINGS/.toString(),"Tabs":/Settings/.toString(),"Placement Number of Tab":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
