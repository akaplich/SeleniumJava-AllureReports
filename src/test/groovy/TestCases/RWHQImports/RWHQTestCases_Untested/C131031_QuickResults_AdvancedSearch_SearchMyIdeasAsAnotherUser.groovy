...
//C131031 - Quick Results, Advanced Search - Search My Ideas As Another User
class C131031_QuickResults_AdvancedSearch_SearchMyIdeasAsAnotherUser
{
    ...
    public void testcase(){
        ...
        //Quick or Advance Search in Global Nav
        new actions.Search.QuickOrAdvanceSearchInGlobalNav().run("Tab (optional)":/Quick Results/.toString(),"Search Input":/first my idea/.toString())
        //Verify Quick or Advanced Search Result
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Quick Results/.toString(),"No Search Results":true,"Name of the searched item":/first my idea/.toString())
    }
    //Basestate
