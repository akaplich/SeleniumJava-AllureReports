...
class C39862_SearchBlog
{
    ...
    public void testcase(){
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/blog post/.toString(),"Click View All Results after search":true)
        //Click link on Search Page results section
        new actions.Search.ClicklinkonSearchPageresultssection().run("Search Results Type":/Blog Posts/.toString(),"Link name":/First Blog Post/.toString())
        //Verify Enterprise and Initiative View Blog
        new actions.EnterpriseBlogs.VerifyEnterpriseViewBlog().run("Title":/First Blog Post/.toString(),"Tags":/firstblog/.toString(),"Content":/First Blog posted in custom app/.toString())
    }
    //Basestate
