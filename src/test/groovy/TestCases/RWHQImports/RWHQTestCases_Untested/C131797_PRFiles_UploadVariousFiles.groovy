...
//C131797 - PR Files > Upload Various Files
class C131797_PRFiles_UploadVariousFiles
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.TeamWorkspace.VerifyFilesinTeamWorkspace().run("Attachment Name":/${variables."TCData.Attachment File"}/.toString(),"Attachment Icon":/${variables."TCData.Attachment Icon"}/.toString(),"Number of Matches":/1/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Navigate Tab User Homepage or MTS
        new actions.Enterprise.UserHomepage.NavigateTabUserHomepage().run("Tab":/Project Room/.toString())
