...
//C65759 - Idea Boards 30 - Public Webstorm - Filter - Tags
class C65759_IdeaBoards30_PublicWebstorm_Filter_Tags
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea3/.toString(),"Description":/desc/.toString(),"Tag Name":/Tag1/.toString(),"Tag Add or Remove":/Add/.toString(),"Category":/Operations/.toString(),"Required Short Question":/required/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        ...
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Expand Tags Filter":true,"Status":[],"Stage":[],"Categories":[],"Tags":["tag1"],"Desired Expertise":[])
        ...
        //Filter Idea in Idea Board page
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Status":[],"Stage":[],"Categories":[],"Tags":[],"Desired Expertise":[],"Action":/Reset Filters/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea3/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
