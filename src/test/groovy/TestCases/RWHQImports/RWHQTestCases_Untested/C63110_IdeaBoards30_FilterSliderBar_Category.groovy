...
//C63110 - Idea Boards 30 - Filter Slider Bar - Category
class C63110_IdeaBoards30_FilterSliderBar_Category
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Status":[],"Stage":[],"Categories":["New Product"],"Tags":[],"Desired Expertise":[],"Action":/Apply Filters/.toString())
