...
//C118865 - Idea Import - Hidden Ideas
class C118865_IdeaImport_HiddenIdeas
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.ImportIdeasinPipelineStepspage().run("Idea Import File":/Import_Ideas_C118865.xls/.toString(),"Action":/Import Ideas/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom Initiative for Idea Import Title/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/hidden idea/.toString(),"Step Name idea belongs to":/Submitted/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/hidden improvement/.toString(),"Step Name idea belongs to":/Submitted/.toString())
        //Log Out
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/hidden idea/.toString(),"Description":/desc1/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/hidden improvement/.toString(),"Description":/desc1/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
