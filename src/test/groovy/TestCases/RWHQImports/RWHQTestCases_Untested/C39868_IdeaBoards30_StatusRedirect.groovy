...
//C39868 - Idea Boards 30 - Status Redirect
class C39868_IdeaBoards30_StatusRedirect
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea3/.toString(),"Description":/description/.toString(),"Category":/New Product/.toString(),"Required Short Question":/required short/.toString(),"Action":/Submit Idea/.toString())
        ...
        new actions.ViewIdea.SelectCategoryStatusorTaginViewIdea().run("Category, Status or Tag":/Status/.toString())
