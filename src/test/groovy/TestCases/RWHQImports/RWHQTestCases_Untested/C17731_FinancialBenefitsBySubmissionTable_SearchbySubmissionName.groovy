...
//C17731 - Financial Benefits By Submission Table - Search by Submission Name
class C17731_FinancialBenefitsBySubmissionTable_SearchbySubmissionName
{
    ...
    public void testcase(){
        ...
        new actions.PipelineDashBoard.SearchIdeainSubmissiontableonBusinessImpacttab().run("Search Value":/TEST/.toString())
