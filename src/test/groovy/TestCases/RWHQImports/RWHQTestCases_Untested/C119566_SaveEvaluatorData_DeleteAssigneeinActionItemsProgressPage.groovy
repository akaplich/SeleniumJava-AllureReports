...
//C119566 - Save Evaluator Data - Delete Assignee in Action Items Progress Page
class C119566_SaveEvaluatorData_DeleteAssigneeinActionItemsProgressPage
{
    ...
    public void testcase(){
        ...
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Step Name to Manage (optional)":/Scorecarding/.toString(),"Row Number":/3/.toString(),"Evaluator":/System Admin/.toString(),"Number of assigned items":/2/.toString(),"Number of remaining items":/1/.toString(),"Number of Matches":/1/.toString())
        ...
        //Verify Action Items in Progress in Manage Step Page
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Row Number":/2/.toString(),"Evaluator":/Evaluator/.toString(),"Number of assigned items":/2/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
