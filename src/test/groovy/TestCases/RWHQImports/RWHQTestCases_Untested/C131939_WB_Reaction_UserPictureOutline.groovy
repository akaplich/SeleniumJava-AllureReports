...
//C131939 - WB - Reaction - User Picture Outline
class C131939_WB_Reaction_UserPictureOutline
{
    ...
    public void testcase(){
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/DIV[contains(@class,'f-tab-reactions')]/.toString(),"Expected Image File":/C131939_expected.png/.toString(),"Actual Image Name":/C131939_actual.png/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131939_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
    }
}