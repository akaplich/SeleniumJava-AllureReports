...
//C129755 - New Copy Ideas - Copy Votes - OFF
class C129755_NewCopyIdeas_CopyVotes_OFF
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.NewCopyIdeasinPipelineStepspage().run("Pipeline":/Pipeline A/.toString(),"Copy Votes":/FALSE/.toString(),"Action":/Copy Idea/.toString())
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/test idea2/.toString(),"Points":/0/.toString(),"Votes":/0/.toString(),"Linked Submissions":[])
        //Verify Votes tab in View Idea page
        new actions.ViewIdea.VerifyVotestabinViewIdeapage().run("Types of Vote":/Promotes/.toString(),"User":/Sri/.toString(),"Number of Matches":/0/.toString())
        //Verify Votes tab in View Idea page
