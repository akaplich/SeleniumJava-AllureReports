...
//C129032 - Category Dependent - Edit Category - Analyst
class C129032_CategoryDependent_EditCategory_Analyst
{
    ...
    public void testcase(){
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Select new idea category/.toString(),"Should Exist":false)
    }
    //Basestate
