...
//C129532 - Voting on Card - Voting toggle Off with no votes
class C129532_VotingonCard_VotingtoggleOffwithnovotes
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyVotingUIonIdeaCard().run("Idea Name":/test idea1/.toString(),"Voting UI View":/Displayed/.toString(),"Number of Matches":/0/.toString())
        //Verify Voting/Comments/Favorites Icon on Idea Card in Idea Boards 30
        new actions.IdeaBoard.VerifyVotingCommentsIconIdeaCardIdeaBoards30().run("Chips Voting":false,"Simple Voting":false)
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/new initiative idea1/.toString(),"Status":/Submitted/.toString(),"Username":/System Admin/.toString(),"Votes":/0/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/new initiative idea1/.toString(),"Status":/Submitted/.toString(),"Username":/System Admin/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
