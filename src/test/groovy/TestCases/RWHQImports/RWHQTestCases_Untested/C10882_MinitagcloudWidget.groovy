...
//C10882 - Mini tag cloud Widget
class C10882_MinitagcloudWidget
{
    ...
    public void testcase(){
        ...
        new actions.Widgets.VerifyandAccessWidgetMiniTagCloud().run("Tag Name":/tag1/.toString(),"Click to access":true)
