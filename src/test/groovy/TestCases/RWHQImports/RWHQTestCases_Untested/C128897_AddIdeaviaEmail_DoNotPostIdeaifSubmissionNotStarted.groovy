...
//C128897 - Add Idea via Email - Do Not Post Idea if Submission Not Started
class C128897_AddIdeaviaEmail_DoNotPostIdeaifSubmissionNotStarted
{
    ...
    public void testcase(){
        ...
        new actions.PipelineCommunications.SetPipelineCommunicationsTab().run("Select Tab":/Emails/.toString(),"Email":/New Idea Submitted/.toString(),"Email Recipient":/Idea Submitter/.toString(),"Email Subject":/C128897 Submission Confirmation/.toString(),"Action":/Save/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Discuss forum title/.toString(),"Area to Navigate to":/Setup/.toString())
        ...
        new actions.People.AddUserinPeoplepage().run("Email Address":/annabrightidea1@yahoo.com/.toString(),"First Name":/C128897/.toString(),"Last Name":/Test User/.toString(),"Screen Name":/Email Test User/.toString(),"Action":/Add User/.toString())
        //Wait
        ...
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Discuss forum title/.toString(),"Area to Navigate to":/Idea Board/.toString())
        ...
        new actions.Email.VerifyEmailNotMailinator().run("Sender Host":/imap.mail.yahoo.com/.toString(),"Sender's Email":/annabrightidea1@yahoo.com/.toString(),"Password":/coothhthkgxqqztx/.toString(),"Email Subject to Look For":/C128897 Submission Confirmation/.toString(),"Email Should Exist":false,"Folder":/INBOX/.toString())
    }
    //Basestate
