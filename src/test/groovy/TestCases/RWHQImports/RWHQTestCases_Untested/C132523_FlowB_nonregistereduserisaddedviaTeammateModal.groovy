...
//C132523 - Flow B - non registered user is added via Teammate Modal
class C132523_FlowB_nonregistereduserisaddedviaTeammateModal
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Flow Option Title":/I have a team, but we are not sure what to work on./.toString(),"Team Name":/Hello what is this PR name/.toString(),"Name your team Screen Action":/Next/.toString(),"Choose a team image Action":/Next/.toString(),"Find Teammates":/End User,Moderator,End User 2/.toString(),"Teammates Add or Remove":/Add,Add,Add/.toString(),"Build your winning team Screen Action":/Next/.toString(),"Wait for loading to disappear":true)
        //Wait
        ...
        new actions.PipelineSetup.SetParticipantsinPipelineSetupPage().run("General Access":/End User,End User 2,Moderator/.toString(),"General Access Add or Remove":/Remove,Remove,Add/.toString())
    }
    //Basestate
