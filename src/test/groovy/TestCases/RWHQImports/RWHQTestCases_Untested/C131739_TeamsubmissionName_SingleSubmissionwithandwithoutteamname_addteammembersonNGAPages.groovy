...
//C131739 - Team submission Name - Single Submission with and without team name,add team members on NGA Pages
class C131739_TeamsubmissionName_SingleSubmissionwithandwithoutteamname_addteammembersonNGAPages
{
    ...
    public void testcase(){
        ...
        new actions.PipelineList.VerifyIdeainPipelineListpage().run("Title":/WITH TEAM NAME/.toString(),"Submitter":/System Admin/.toString(),"Submission Team":/End User/.toString(),"Submission Team Name":/team name1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Pipeline List page
        new actions.PipelineList.VerifyIdeainPipelineListpage().run("Title":/WITHOUT TEAM NAME/.toString(),"Submitter":/System Admin/.toString(),"Submission Team":/End User/.toString(),"Submission Team Name":/Team - System Admin/.toString(),"Number of Matches":/1/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Innovations/.toString())
        //Verify Idea in Innovations Pillar
        new actions.NGAInnovationList.VerifyIdeainInnovationsPillar().run("Title":/WITHOUT TEAM NAME/.toString(),"Team Name":/Team - System Admin/.toString(),"Submitter":/System Admin/.toString(),"Number of Matches":/1/.toString())
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC131739/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/brightC131739@mailinator.com/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Innovations/.toString())
        ...
        variables."link" = new actions.Mailinator.GetDownloadLinkfromEmail().run("Email Address":/brightC131739/.toString())
        //Navigate to URL
        ...
        new actions.general.Wait().run("Seconds":/3/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Hack*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["WITHOUT TEAM NAME","Team - System Admin"],"Number of Matches":/1/.toString())
    }
    //Basestate
