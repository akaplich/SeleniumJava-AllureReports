...
//C129806 - Voting Updates - Demote Voting Toggle Off
class C129806_VotingUpdates_DemoteVotingToggleOff
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.VerifyVotestabinViewIdeapage().run("Types of Vote":/Demotes/.toString(),"User":/System Admin/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
