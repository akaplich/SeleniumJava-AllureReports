...
//C128790 - Comment Component - Copy Link from NGA View Idea
class C128790_CommentComponent_CopyLinkfromNGAViewIdea
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.SetCommentEditMenu().run("Comment to Edit":/test comment/.toString(),"Menu Option":/Copy Link/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Comment link copied to clipboard/.toString(),"Should Exist":true)
    }
    //Basestate
