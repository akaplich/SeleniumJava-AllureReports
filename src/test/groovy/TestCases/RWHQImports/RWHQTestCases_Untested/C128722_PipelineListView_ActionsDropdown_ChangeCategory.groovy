...
//C128722 - Pipeline List View - Actions Dropdown - Change Category
class C128722_PipelineListView_ActionsDropdown_ChangeCategory
{
    ...
    public void testcase(){
        ...
        new actions.PipelineList.VerifyIdeainPipelineListpage().run("Title":/test idea1/.toString(),"Category":/Operations/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Pipeline List page
        new actions.PipelineList.VerifyIdeainPipelineListpage().run("Title":/test idea2/.toString(),"Category":/New Product/.toString(),"Number of Matches":/1/.toString())
        //Select Ideas in Pipeline List View
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Category":/Operations/.toString(),"Linked Submissions":[])
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
