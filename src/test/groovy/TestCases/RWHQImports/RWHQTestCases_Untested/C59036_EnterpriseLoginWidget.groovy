...
//C59036 - Enterprise Login Widget
class C59036_EnterpriseLoginWidget
{
    ...
    public void testcase(){
        ...
        new actions.Widgets.VerifyandAccessEnterpriseLoginWidget().run("Logout or Setup":/Setup/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Affiliate Name/.toString(),"Should Exist":true)
        //Go to Community
        new actions.SetupEnterpriseCommunities.GotoCommunity().run("Community Name to go to":/Developers Community/.toString())
        //Verify and Access Enterprise Login Widget
