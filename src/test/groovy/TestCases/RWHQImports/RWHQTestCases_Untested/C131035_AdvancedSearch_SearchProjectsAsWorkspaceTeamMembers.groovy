...
//C131035 - Advanced Search - Search Projects As Workspace Team Members
class C131035_AdvancedSearch_SearchProjectsAsWorkspaceTeamMembers
{
    ...
    public void testcase(){
        ...
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/test idea1/.toString(),"Type":/Projects/.toString(),"Number of Total (for Advanced Search)":/1 of 1/.toString(),"Description (for Advanced Search)":/test idea1 desc/.toString(),"Number of Matches":/1/.toString(),"Click on result":true)
        //Verify Milestones in Team Workspace
        new actions.ViewIdea.TeamWorkspace.VerifyMilestonesinTeamWorkspace().run("Milestone":/This is milestone1/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
