...
//C131687 - WB on VI3 > Whiteboard Access Permissions from VI3
class C131687_WBonVI3_WhiteboardAccessPermissionsfromVI3
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea30.SetWhiteboardOnViewIdea3().run("Add Whiteboard":true,"Whiteboard Title":/Everybody Have Edit Access/.toString(),"Action":/Submit/.toString())
        //Access or Close Idea from View Idea 3 Modal
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Access Idea":/idea with Everybody Have Edit Access/.toString())
        //Set Whiteboard Widget on View Idea 3
        ...
        //Set Whiteboard Widget on View Idea 3
        new actions.ViewIdea30.SetWhiteboardOnViewIdea3().run("Add Whiteboard":true,"Whiteboard Title":/End User Has Edit Access/.toString(),"Action":/Submit/.toString())
        //Access or Close Idea from View Idea 3 Modal
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Access Idea":/idea with End User Has Edit Access/.toString())
        //Set Whiteboard Widget on View Idea 3
        new actions.ViewIdea30.SetWhiteboardOnViewIdea3().run("Menu Option":/Open Whiteboard/.toString())
        //Switch to Browser Window
        ...
        //Set Whiteboard Widget on View Idea 3
        new actions.ViewIdea30.SetWhiteboardOnViewIdea3().run("Add Whiteboard":true,"Whiteboard Title":/End User Has View Access/.toString(),"Action":/Submit/.toString())
        //Access or Close Idea from View Idea 3 Modal
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Access Idea":/idea with End User Has View Access/.toString())
        //Set Whiteboard Widget on View Idea 3
        new actions.ViewIdea30.SetWhiteboardOnViewIdea3().run("Menu Option":/Open Whiteboard/.toString())
        //Switch to Browser Window
        ...
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/idea with End User Has No Access/.toString())
        try{
            //Set Whiteboard Widget on View Idea 3
            new actions.ViewIdea30.SetWhiteboardOnViewIdea3().run("Add Whiteboard":true,"Whiteboard Title":/End User Has No Access/.toString(),"Action":/Submit/.toString())
        }
        ...
        try{
            //Set Whiteboard Widget on View Idea 3
            new actions.ViewIdea30.SetWhiteboardOnViewIdea3().run("Add Whiteboard":true)
        }
       catch(all){}catch(Error err){}
    }
    //Basestate
