...
//C130781 - Top Ideas By Category - Unselect Status, Tags Filter
class C130781_TopIdeasByCategory_UnselectStatus_TagsFilter
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/test idea2/.toString(),"Description":/desc/.toString(),"Tag Name":/c130781,c13078x/.toString(),"Tag Add or Remove":/Add,Add/.toString(),"Category":/Marketing & Branding/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Idea Box BIW/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/test idea3/.toString(),"Description":/desc/.toString(),"Tag Name":/c130781,tokyo/.toString(),"Tag Add or Remove":/Add,Add/.toString(),"Category":/Strategy/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Idea Box BIW/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/test idea5/.toString(),"Description":/desc/.toString(),"Tag Name":/london,tokyo/.toString(),"Tag Add or Remove":/Add,Add/.toString(),"Category":/Strategy/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Idea Box BIW/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/test idea1/.toString(),"Description":/desc/.toString(),"Tag Name":/london/.toString(),"Tag Add or Remove":/Add/.toString(),"Category":/Marketing & Branding/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.PipelineStepsView.AddIdeaTaginPipelineStepspage().run("Tag Name":/c13078x/.toString(),"Tag Add or Remove":/Add/.toString(),"Action":/Add Tags/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.IdeaBoard.SetGlobalIdeaFilterBIW().run("Invoke Filter":true,"Object Type":[],"Status":["Implemented","Not Selected"],"Stage":[],"Step":[],"Category":[],"Owner":[],"Tags":["c130781","c13078x"],"Clear Individual Filters":[],"Action":/Save/.toString(),"Filter Button Should be Active":true)
        ...
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/test idea1/.toString(),"Stack Name Memo belongs to":/Marketing & Branding/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Top Ideas
        ...
        //Set Global Filter in Top Ideas
        new actions.IdeaBoard.SetGlobalIdeaFilterBIW().run("Invoke Filter":true,"Object Type":[],"Status":["Implemented"],"Stage":[],"Step":[],"Category":[],"Owner":[],"Tags":["c13078x"],"Clear Individual Filters":[],"Action":/Save/.toString(),"Filter Button Should be Active":true)
        //Verify Idea in Top Ideas
        ...
        //Set Global Filter in Top Ideas
        new actions.IdeaBoard.SetGlobalIdeaFilterBIW().run("Invoke Filter":true,"Object Type":[],"Status":[],"Stage":[],"Step":[],"Category":[],"Owner":[],"Tags":["london","tokyo","c13078x"],"Clear Individual Filters":[],"Action":/Save/.toString(),"Filter Button Should be Active":true)
        //Verify Idea in Top Ideas
