...
//C45231 - Submissions Status Change History - Remove Report
class C45231_SubmissionsStatusChangeHistory_RemoveReport
{
    ...
    public void testcase(){
        ...
        new actions.SetupExports.VerifyGeneratedReportinSetupExports().run("Report Name Starts with":/Status_history/.toString(),"Number of Matches":/1/.toString())
        ...
        //Verify Generated Report in any Setup Exports
        new actions.SetupExports.VerifyGeneratedReportinSetupExports().run("Report Name Starts with":/Status_history/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
