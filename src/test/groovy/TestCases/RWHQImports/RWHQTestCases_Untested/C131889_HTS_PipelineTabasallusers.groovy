...
//C131889 - HTS - Pipeline Tab as all users
class C131889_HTS_PipelineTabasallusers
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.VerifyStepinPipelineStepspage().run("Step Name":/Initial Submission/.toString(),"Stage Name step belongs to":/Incubate/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Hackathon Team Site/.toString())
        //Verify and Set MTS tab on homepage
        new actions.MTS.SetMTStabonhomepage().run("Should Tab Exist":false,"Heading":/EXPLORE/.toString(),"Tabs":/Pipeline/.toString(),"Placement Number of Tab":/3/.toString())
    }
    //Basestate
