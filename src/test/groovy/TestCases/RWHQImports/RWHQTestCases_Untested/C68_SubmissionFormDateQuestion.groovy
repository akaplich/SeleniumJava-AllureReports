...
//C68 - Submission Form Date Question
class C68_SubmissionFormDateQuestion
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Idea Title/.toString(),"Description":/Idea Description/.toString(),"Category":/New Product/.toString(),"Date Question":/11\/04\/2016/.toString(),"Required Short Question":/required short/.toString(),"Action":/Submit Idea/.toString())
        ...
        Action5812921cfa4ee77809f46b4f("Date Question":/11\/04\/2016/.toString())
    }
    //Basestate
