...
//C119036 - Highlights - All Activity - Post a Comment in launched Status
class C119036_Highlights_AllActivity_PostaCommentinlaunchedStatus
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Prelaunched Idea1/.toString())
        //Add Comment in View and NGA View Idea
        new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("Comment":/This is comment1_testing/.toString(),"Comment Type":/General Access/.toString(),"Post Comment":true)
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/NonBI System Admin commented on "Prelaunched Idea1"/.toString(),"Highlights Item Content":/This is comment1_testing/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/NonBI System Admin commented on "Prelaunched Idea1"/.toString(),"Highlights Item Content":/This is comment1_testing/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
