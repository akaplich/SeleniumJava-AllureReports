...
//C132225 - WB - Timer Icon in Top Toolbar
class C132225_WB_TimerIconinTopToolbar
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/Timer Whiteboard/.toString(),"Action":/Submit/.toString())
        //Verify Timer in Whiteboards
        new actions.Whiteboards.VerifyTimerWhiteboards().run("Timer Should be Present":false)
