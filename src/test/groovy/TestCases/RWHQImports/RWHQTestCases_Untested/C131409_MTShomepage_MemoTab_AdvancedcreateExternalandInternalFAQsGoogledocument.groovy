...
//C131409 - MTS homepage > Memo Tab > Advanced create External and Internal FAQs Google document
class C131409_MTShomepage_MemoTab_AdvancedcreateExternalandInternalFAQsGoogledocument
{
    ...
    public void testcase(){
        ...
        new actions.MTS.SetAdvancedCreateMemo().run("Select an editor to draft your Memo within":/Google Document/.toString(),"Action on Select an editor to draft your Memo within slide":/Next/.toString(),"Select visibility for your memo":/Private Memo/.toString(),"Action on Select visibility for your memo slide":/Done/.toString())
        ...
        try{
            //Compare Images
            new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/DIV[contains(@class,'f-memo-thumbnail-body')]/.toString(),"Expected Image File":/C131409_expected.png/.toString(),"Actual Image Name":/C131409_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Memo Card in Userhomepage
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/Memo - Untitled/.toString(),"Memo Icon Type":/Google/.toString(),"User Name":/End User/.toString(),"Status":/Private/.toString(),"Thumbnail Image Displayed":true,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/https:\/\/docs.google.com\/document\/u\/0\//.toString())
        //Set Delete the 3rd Party documents
        new actions.Utils.DeleteTheGoogleDocument().run("Google document title":/Memo - Untitled/.toString())
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131409_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
