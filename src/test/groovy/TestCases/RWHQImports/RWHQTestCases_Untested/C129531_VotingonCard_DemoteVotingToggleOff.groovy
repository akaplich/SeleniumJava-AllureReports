...
//C129531 - Voting on Card - Demote Voting Toggle Off
class C129531_VotingonCard_DemoteVotingToggleOff
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString(),"Status":/Under Review/.toString(),"Username":/Sri/.toString(),"Votes":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
