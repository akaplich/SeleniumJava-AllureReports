...
//C128675 - Analyst cannot edit but can view admin question in View Idea
class C128675_AnalystcannoteditbutcanviewadminquestioninViewIdea
{
    ...
    public void testcase(){
        ...
        try{
            //Set View Idea Description Tab Dropdown
            new actions.ViewIdeaFields.SetViewIdeaDescriptionTabDropdown().run("Field Name":/Admin Only Dropdown Question/.toString(),"Field Value":/Answer 3/.toString(),"Action":/Save/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Custom App Description tab fields in View Idea page
        Action5812921cfa4ee77809f46b4f("Admin Only Dropdown Question":/Answer 2/.toString())
    }
    //Basestate
