...
//C119579 - Scorecard - Long Answer
class C119579_Scorecard_LongAnswer
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.SetEvaluationScorecardIdeaActionItemspage().run("Long Text - Question":/1 - Long Answer/.toString(),"Long Text - Answer":/test answer/.toString(),"Submit Scorecard":true)
        //Access Action Item in Actions Items React Global Navigation
        ...
        new actions.ActionItems.VerifyScorecardAnswers().run("Long Text - Question":/1 - Long Answer/.toString(),"Long Text - Answer":/test answer/.toString())
    }
    //Basestate
