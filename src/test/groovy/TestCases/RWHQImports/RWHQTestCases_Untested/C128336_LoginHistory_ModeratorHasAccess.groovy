...
//C128336 - Login History - Moderator Has Access
class C128336_LoginHistory_ModeratorHasAccess
{
    ...
    public void testcase(){
        ...
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Login History/.toString(),"Report Name Starts with":/Login_history/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Login_history-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Moderator","moderator@test.com"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
