...
//C53099 - Solve Homepage Redesign - New Homepage with default values
class C53099_SolveHomepageRedesign_NewHomepagewithdefaultvalues
{
    ...
    public void testcase(){
        ...
        //Login
        new actions.general.Login().run("Email":/pipelinesponsor@test.com/.toString(),"Password":/password3/.toString(),"Verify if Logged In On Enterprise homepage":false)
        //Navigate
        ...
        //Verify Challenge Brief Descripton
        new actions.Webstorm.VerifyChallengeBriefDescripton().run("Challenge Brief Description":/Eliminate burrs and other production artifacts in the automobile knuckle. Currently defects are reaching both internal and external customers. Eliminating burrs in the automobile knuckle will increase quality and customer satisfaction, reducing efficiency losses with a total estimated business value of $10 million annually./.toString())
        //Verify Supplemental Panel
        new actions.Webstorm.VerifySupplementalPanel().run("Sponsor Image":true,"Sponsor Name":/Sri/.toString(),"Launch Date":/December 12, 2018/.toString())
    }
    //Basestate
