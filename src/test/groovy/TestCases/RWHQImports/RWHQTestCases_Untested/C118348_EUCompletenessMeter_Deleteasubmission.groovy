...
//C118348 - EU Completeness Meter - Delete a submission
class C118348_EUCompletenessMeter_Deleteasubmission
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyOnboardingPanelMeterItem().run("Completed Total":/3 of 5 completed/.toString(),"Item Name":/Create a submission/.toString(),"Completed":true)
    }
    //Basestate
