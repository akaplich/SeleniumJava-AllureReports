...
//C130820 - Top Ideas By Category - Add Idea To My List
class C130820_TopIdeasByCategory_AddIdeaToMyList
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/test idea1/.toString(),"Description":/desc/.toString(),"Category":/Process Improvement/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.PipelineTopIdeas.VerifyIdeainMyListTopIdeas().run("Idea Title":/test idea1/.toString(),"My List Name":/testList1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
