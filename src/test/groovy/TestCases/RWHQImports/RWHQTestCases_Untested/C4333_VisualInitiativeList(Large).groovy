...
//C4333 - Visual Initiative List (Large)
class C4333_VisualInitiativeList(Large)
{
    ...
    public void testcase(){
        ...
        new actions.Widgets.VerifyWidgetExists().run("Widget Name":/Visual Initiative List (Large)/.toString(),"Number of Matches":/0/.toString())
        //Set Widget Controller
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Discuss forum title/.toString(),"Area to Navigate to":/Home/.toString())
    }
    //Basestate
