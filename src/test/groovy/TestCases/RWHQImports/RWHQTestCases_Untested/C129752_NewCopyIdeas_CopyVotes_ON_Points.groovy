...
//C129752 - New Copy Ideas - Copy Votes - ON - Points
class C129752_NewCopyIdeas_CopyVotes_ON_Points
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforNewVotingtab().run("Type of Voting":/Simple/.toString())
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/test idea2/.toString(),"Points":/2/.toString(),"Votes":/2/.toString(),"Linked Submissions":[])
    }
    //Basestate
