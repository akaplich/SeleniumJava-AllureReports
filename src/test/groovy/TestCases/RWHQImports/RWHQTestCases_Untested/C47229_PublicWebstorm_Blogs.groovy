...
//C47229 - Public Webstorm - Blogs
class C47229_PublicWebstorm_Blogs
{
    ...
    public void testcase(){
        ...
        new actions.SetupSite.SetEnterpriseSetupSiteNavigationPage().run("Add Edit or Delete Navigation Item":/Add/.toString(),"Title":/Blog/.toString(),"Link":/Blog/.toString())
        //Log Out
        ...
        //Click on Element
        new actions.selenium.Click().run("ID":/\/\/*[@id='dynamic_navigation_bar']\/\/*[@class='desktop-nav-core-items']\/\/A[text()='Blog']/.toString(),"ID Type":/XPath/.toString())
