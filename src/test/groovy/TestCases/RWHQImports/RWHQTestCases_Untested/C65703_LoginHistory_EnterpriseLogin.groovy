...
//C65703 - Login History - Enterprise Login
class C65703_LoginHistory_EnterpriseLogin
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Login_history-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Screen Name","Email Address","Login Date","Platform"],"Number of Matches":/1/.toString(),"Total Number of Rows":/1/.toString())
    }
    //Basestate
