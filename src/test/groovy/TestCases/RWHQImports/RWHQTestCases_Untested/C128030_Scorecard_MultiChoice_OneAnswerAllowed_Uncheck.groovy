...
//C128030 - Scorecard - Multi Choice - One Answer Allowed - Uncheck
class C128030_Scorecard_MultiChoice_OneAnswerAllowed_Uncheck
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.SetQuestionScorecardTemplate().run("Added Question Order Number":/1/.toString(),"Question Type":/Multiple Choice (one answer)/.toString(),"Question":/1 - Multiple Choice/.toString(),"Short Name":/Short Name Test/.toString(),"Tooltip":/Test Tooltip One Answer/.toString(),"Answers":/One/.toString(),"Points":/1/.toString(),"Action":/Save/.toString())
        //Add/Edit Question or Save Form on Scorecard Template
        ...
        new actions.ActionItems.SetEvaluationScorecardIdeaActionItemspage().run("Multi Choice One Answer - Question":/1 - Multiple Choice/.toString(),"Multi Choice One - Answer(s)":/One/.toString(),"Submit Scorecard":true)
        //Access Action Item in Actions Items React Global Navigation
        ...
        //Set Evaluation Scorecard for Idea in Action Items page
        new actions.ActionItems.SetEvaluationScorecardIdeaActionItemspage().run("Multi Choice One Answer - Question":/1 - Multiple Choice/.toString(),"Multi Choice One - Answer(s)":/One/.toString(),"Submit Scorecard":false)
        //Set Evaluation Scorecard for Idea in Action Items page
        new actions.ActionItems.SetEvaluationScorecardIdeaActionItemspage().run("Multi Choice One Answer - Question":/1 - Multiple Choice/.toString(),"Multi Choice One - Answer(s)":/One/.toString(),"Submit Scorecard":true)
        //Access Action Item in Actions Items React Global Navigation
        new actions.ActionItems.AccessActionIteminActionsItemsReactGlobalNavigation().run("Action Item":/View All/.toString())
        ...
        new actions.ActionItems.VerifyScorecardAnswers().run("Multi Choice One Answer - Question":/1 - Multiple Choice/.toString())
    }
    //Basestate
