...
//C128581 - Search additional question from another initiative on Initiative Global Navigation
class C128581_SearchadditionalquestionfromanotherinitiativeonInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabTextField().run("Field Name":/Please describe how this solution addresses the problem./.toString(),"Field Value":/automation purpose/.toString(),"Action":/Save/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Submissions/.toString(),"Title":/solve test idea1/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
