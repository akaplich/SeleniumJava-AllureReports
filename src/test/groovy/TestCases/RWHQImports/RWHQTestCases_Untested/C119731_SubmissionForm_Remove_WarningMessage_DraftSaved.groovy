...
//C119731 - Submission Form - Remove - Warning Message - Draft Saved
class C119731_SubmissionForm_Remove_WarningMessage_DraftSaved
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea3/.toString(),"Description":/desc/.toString(),"Category":/New Product/.toString(),"Long Answer Question":/Test test/.toString(),"Action":/Save Draft/.toString())
