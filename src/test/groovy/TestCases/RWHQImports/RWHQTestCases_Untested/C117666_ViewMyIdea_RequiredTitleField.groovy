...
//C117666 - View My Idea - Required Title Field
class C117666_ViewMyIdea_RequiredTitleField
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.SetViewMyIdeaTextField().run("Field Name":/Title/.toString(),"Field Value":/<EMPTY>/.toString())
