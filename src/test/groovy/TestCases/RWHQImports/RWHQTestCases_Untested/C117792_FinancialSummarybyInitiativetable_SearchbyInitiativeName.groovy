...
//C117792 - Financial Summary by Initiative table - Search by Initiative Name
class C117792_FinancialSummarybyInitiativetable_SearchbyInitiativeName
{
    ...
    public void testcase(){
        ...
        new actions.PipelineDashBoard.SearchIdeainSubmissiontableonBusinessImpacttab().run("Search Value":/SOL/.toString())
        //Verify Initiative in the Initiative Table on Enterprise Business Impact tab
        new actions.NGAAnalyticsDashboard.VerifyInitiativeintheInitiativeTableonEnterpriseBusinessImpacttab().run("Total Actual Benefits":/$70,000/.toString(),"Initiative":/Solve App/.toString(),"App Type":/Solve/.toString(),"Status":/Closed/.toString(),"Submissions with Impact":/1/.toString(),"Total Projected Benefits":/$50,000/.toString(),"Total Target Benefits":/$0/.toString(),"Total Projected Costs":/$0/.toString(),"Total Actual Costs":/$0/.toString(),"Row Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Initiative in the Initiative Table on Enterprise Business Impact tab
        new actions.NGAAnalyticsDashboard.VerifyInitiativeintheInitiativeTableonEnterpriseBusinessImpacttab().run("Total Actual Benefits":/$50,000/.toString(),"Initiative":/Custom App/.toString(),"App Type":/Custom/.toString(),"Status":/Active/.toString(),"Submissions with Impact":/1/.toString(),"Total Projected Benefits":/$30,000/.toString(),"Total Target Benefits":/$0/.toString(),"Total Projected Costs":/$0/.toString(),"Total Actual Costs":/$0/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
