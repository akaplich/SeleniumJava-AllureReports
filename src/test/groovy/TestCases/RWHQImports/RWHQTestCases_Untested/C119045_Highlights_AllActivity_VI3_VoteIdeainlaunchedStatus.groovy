...
//C119045 - Highlights - All Activity - VI3 - Vote Idea in launched Status
class C119045_Highlights_AllActivity_VI3_VoteIdeainlaunchedStatus
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/NonBI System Admin has promoted "Prelaunched Idea1" by System Admin/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/NonBI System Admin has promoted "Prelaunched Idea1" by System Admin/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
