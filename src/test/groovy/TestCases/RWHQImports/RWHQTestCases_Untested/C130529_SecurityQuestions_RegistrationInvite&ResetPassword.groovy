...
//C130529 - Security Questions - Registration Invite & Reset Password
class C130529_SecurityQuestions_RegistrationInviteRedwoodHQTestCaseResetPassword
{
    ...
    public void testcase(){
        ...
        //Set Text to Element
        new actions.selenium.SetText().run("ID":/\/\/input[@id='email']/.toString(),"Text":/brightC130529@mailinator.com/.toString())
        //Set Text to Element
        ...
        new actions.People.AddUserinPeoplepage().run("Email Address":/brightC130529@mailinator.com/.toString(),"First Name":/Anna/.toString(),"Last Name":/Kaplich/.toString(),"Action":/Add User/.toString())
        //Get Registration Link from Email
        variables."link" = new actions.Mailinator.GetRegistrationLinkfromEmail().run("Email Address":/brightc130529/.toString())
        //Navigate to URL
        ...
        //Set Text to Element
        new actions.selenium.SetText().run("ID":/\/\/*[@id="emailAddress"]/.toString(),"ID Type":/XPath/.toString(),"Text":/brightc130529@mailinator.com/.toString())
        //Click on Element
        new actions.selenium.Click().run("ID":/\/\/*[@id="send-button"]/.toString(),"ID Type":/XPath/.toString())
        //Get Reset Password Link from Email
        variables."link" = new actions.Mailinator.GetResetPasswordLinkfromEmail().run("Email Address":/brightc130529@mailinator.com/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        ...
        //Login
        new actions.general.Login().run("Webstorm Login":false,"Email":/brightc130529@mailinator.com/.toString(),"Password":/brightidea2/.toString())
