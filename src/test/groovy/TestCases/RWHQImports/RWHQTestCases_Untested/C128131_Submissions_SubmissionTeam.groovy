...
//C128131 - Submissions - Submission Team
class C128131_Submissions_SubmissionTeam
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Submissions-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Submitter email","Submission Team"],"Number of Matches":/1/.toString())
        //Download Generated Report From Enterprise and Community Exports
        new actions.SetupEnterpriseExports.DownloadGeneratedReportEnterpriseExports().run("Section":/Submissions/.toString(),"Report Name Starts with":/Submissions/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Submissions-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["bi.adminuser1@brightidea.com","End User 2"],"Total Number of Rows":/8/.toString())
    }
    //Basestate
