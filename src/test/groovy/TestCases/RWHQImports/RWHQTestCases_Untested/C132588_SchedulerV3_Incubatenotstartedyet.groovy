...
//C132588 - Scheduler V3> Incubate not started yet
class C132588_SchedulerV3_Incubatenotstartedyet
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyVotingUIonIdeaCard().run("Idea Name":/quick add 1/.toString(),"Voting UI View":/Disabled/.toString(),"Number of Matches":/1/.toString())
