...
//C131246 - Move Memo - Administrator Access To two or More initiatives Required
class C131246_MoveMemo_AdministratorAccessTotwoorMoreinitiativesRequired
{
    ...
    public void testcase(){
        ...
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/MemoSource/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        ...
        try{
            ...
            new actions.PipelineStepsView.NewMoveIdeasinPipelineStepspage().run("Move To Pipeline":/MemoDestination/.toString(),"Category":/Process Improvement/.toString(),"Status":/Stopped/.toString(),"Action":/Move Idea/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Administrator access to two or more initiatives is required to move ideas/.toString(),"Should Exist":true)
    }
    //Basestate
