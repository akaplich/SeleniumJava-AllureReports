...
//C65569 - Team Workspace - Risks - Adding Comment Attachment
class C65569_TeamWorkspace_Risks_AddingCommentAttachment
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.TeamWorkspace.SetRiskCommentsinTeamWorkspace().run("Risk to be Commented":/Risk1/.toString(),"Type of Comment":/Comment/.toString(),"Comment":/Parent Risk/.toString(),"Attachment File":/SamplePDF.pdf/.toString(),"Wait for attachment to load":true,"Click on Post Button":true)
        //Set Risk Comments in Team Workspace
        new actions.ViewIdea.TeamWorkspace.SetRiskCommentsinTeamWorkspace().run("Risk to be Commented":/Risk1/.toString(),"Type of Comment":/Reply/.toString(),"Comment":/Parent Risk/.toString(),"Reply Comment":/Reply1/.toString(),"Attachment File":/Sample Text.txt/.toString())
        //Verify Risk Comment in Team Workspace
        new actions.ViewIdea.TeamWorkspace.VerifyRiskCommentinTeamWorkspace().run("Risk to be Commented":/Risk1/.toString(),"Comment":/Parent Risk/.toString(),"User":/System Admin/.toString(),"Attachment File":/SamplePDF.pdf/.toString(),"Total Replies":/1/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Risk Comment Replies in Team Workspace
        new actions.ViewIdea.TeamWorkspace.VerifyRiskCommentRepliesinTeamWorkspace().run("Risk to be Commented":/Risk1/.toString(),"Comment":/Parent Risk/.toString(),"Reply":/Reply1/.toString(),"User":/System Admin/.toString(),"Attachment File":/Sample Text.txt/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
