...
//C131884 - Participants Export - Manual Onboarding
class C131884_ParticipantsExport_ManualOnboarding
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowAforHackathonOnboarding().run("Action on Get Started Screen":/Next/.toString(),"Expertise":/enduserexp1/.toString(),"Add or Remove Expertise":/Add/.toString(),"Register and add expertise Action":/Continue to submission/.toString(),"Action on Time to submit your project":/Cancel/.toString(),"Wait for Post Idea Page to Load":false)
        //Set Flow A for Hackathon Onboarding
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Participants-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Screen Name","Email Address","Webstorm Name","Webstorm ID","Admin Status (Y/N)","Evaluator Status (Y/N)","Expertise","Registered","Joined Event","Join Date","Join Method","Certifications"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Users/.toString(),"Report Name Starts with":/Participants-/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Participants-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["System Admin","bi.adminuser1@brightidea.com","QA,Automation","Manual Opt in"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Users/.toString(),"Report Name Starts with":/Participants-/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Participants-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["End User","bi.enduser1@brightidea.com","N","Y","enduserexp1","Yes","Manual Opt in"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
