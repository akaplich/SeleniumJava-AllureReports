...
//C117793 - Financial Summary by Initiative table - Search by App Type
class C117793_FinancialSummarybyInitiativetable_SearchbyAppType
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.SetInformationinPipelineSetupPage().run("Name":/Buiness Impact Dashboard Initiative/.toString())
        //Navigate WebStorm or MTS
