...
//C131537 - WB - Image - Upload Image over max size
class C131537_WB_Image_UploadImageovermaxsize
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.VerifyToastMessageforLinkingandUnlinkingPipeline().run("Message":/File is too large. Limit is 2 MB./.toString())
    }
    //Basestate
