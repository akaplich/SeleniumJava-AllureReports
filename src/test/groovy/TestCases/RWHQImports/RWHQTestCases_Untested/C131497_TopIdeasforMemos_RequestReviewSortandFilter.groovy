...
//C131497 - Top Ideas for Memos > Request Review Sort and Filter
class C131497_TopIdeasforMemos_RequestReviewSortandFilter
{
    ...
    public void testcase(){
        ...
        new actions.Memo.SetReviewRequestDropdownorButton().run("Click on button":/Complete Review/.toString())
        //Set Request Review Questions
        new actions.Memo.SetRequestReviewQuestions().run("Question Container":/1/.toString(),"Question":/How strong is the core idea for this Memo?/.toString(),"Drag the scrollbar or input the answer":/Input/.toString(),"Answer":/3/.toString())
        //Set Request Review Questions
        new actions.Memo.SetRequestReviewQuestions().run("Question Container":/1/.toString(),"Question":/How complete is the Memo?/.toString(),"Drag the scrollbar or input the answer":/Input/.toString(),"Answer":/4/.toString())
        //Set Request Review Questions
        new actions.Memo.SetRequestReviewQuestions().run("Question Container":/1/.toString(),"Question":/How well is the Memo presented?/.toString(),"Drag the scrollbar or input the answer":/Input/.toString(),"Answer":/5/.toString())
        //Set Request Review Questions
        ...
        new actions.IdeaBoard.SetGlobalIdeaFilterBIW().run("Invoke Filter":true,"Object Type":[],"Status":[],"Stage":[],"Step":[],"Category":[],"Owner":[],"Latest Review Score Min":/2/.toString(),"Latest Review Score Max":/5/.toString(),"Tags":[],"Clear Individual Filters":[],"Action":/Save/.toString())
