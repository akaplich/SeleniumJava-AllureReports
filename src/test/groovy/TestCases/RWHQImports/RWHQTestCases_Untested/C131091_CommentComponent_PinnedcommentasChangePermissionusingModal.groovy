...
//C131091 - Comment Component - Pinned comment as Change Permission using Modal
class C131091_CommentComponent_PinnedcommentasChangePermissionusingModal
{
    ...
    public void testcase(){
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Pinned/.toString(),"Should Exist":false)
        //Set Change Comment Permission Modal
        new actions.ViewIdeaComment.SetChangeCommentPermissionModal().run("Permission":/Private/.toString(),"Action":/Cancel/.toString())
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("View Idea or NGA":/View Idea/.toString(),"Comment section":/Parent Comment/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/test comment/.toString(),"User":/End User/.toString(),"Edited Indicator":false,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
