...
//C131917 - Participants Page - User Pic Outline
class C131917_ParticipantsPage_UserPicOutline
{
    ...
    public void testcase(){
        ...
        new actions.Webstorm.ParticipantsPageSetFilterSearch().run("Search Expertise":"","Available to Join Teams":/Not Available/.toString(),"Certifications":[])
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/DIV[contains(@class,'ideas-view-grid')]\/\/DIV[contains(@class,'f-participant-member')]/.toString(),"Expected Image File":/C131917_expected.png/.toString(),"Actual Image Name":/C131917_actual.png/.toString(),"Do Not Scroll":true)
    }
    //Basestate
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131917_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
    }
}