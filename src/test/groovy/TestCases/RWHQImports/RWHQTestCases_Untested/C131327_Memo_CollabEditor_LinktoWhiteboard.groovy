...
//C131327 - Memo - Collab Editor - Link to Whiteboard
class C131327_Memo_CollabEditor_LinktoWhiteboard
{
    ...
    public void testcase(){
        ...
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Click on Element
        new actions.selenium.Click().run("ID":/\/\/DIV[@role='textbox']\/\/P[@data-slate-node='element']\/\/SPAN[contains(@style,'cursor: pointer')]/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Switch to Browser Window
        new actions.selenium.SwitchWindow().run("Tab (start from 0)":/1/.toString())
        //Verify Whiteboard Title
        new actions.Whiteboards.VerifyWhiteboardTitle().run("Title":/Share me!/.toString())
    }
    //Basestate
