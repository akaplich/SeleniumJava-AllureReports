...
//C69 - Submission Form Number Question
class C69_SubmissionFormNumberQuestion
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Idea Title/.toString(),"Description":/Idea Description/.toString(),"Category":/New Product/.toString(),"Number Question":/9/.toString(),"Required Short Question":/required short/.toString(),"Action":/Submit Idea/.toString())
        ...
        Action5812921cfa4ee77809f46b4f("Number Question":/9/.toString())
    }
    //Basestate
