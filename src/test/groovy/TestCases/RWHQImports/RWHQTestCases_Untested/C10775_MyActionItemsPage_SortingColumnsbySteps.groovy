...
//C10775 - My Action Items Page - Sorting Columns by Steps
class C10775_MyActionItemsPage_SortingColumnsbySteps
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.SortMyActionItemsActionItemsManagertable().run("Column Name":/Step/.toString(),"Sort":/ascending/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Title":/test idea1/.toString(),"Row Number":/1/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Title":/test idea2/.toString(),"Row Number":/2/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Title":/quick add1/.toString(),"Row Number":/3/.toString())
        //Sort My Action Items/Action Items Manager table
        new actions.ActionItems.SortMyActionItemsActionItemsManagertable().run("Column Name":/Step/.toString(),"Sort":/descending/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Title":/quick add1/.toString(),"Row Number":/1/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Title":/test idea2/.toString(),"Row Number":/2/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Title":/test idea1/.toString(),"Row Number":/3/.toString())
    }
    //Basestate
