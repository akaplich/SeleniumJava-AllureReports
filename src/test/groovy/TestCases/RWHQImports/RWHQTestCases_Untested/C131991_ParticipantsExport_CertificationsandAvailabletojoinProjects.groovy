...
//C131991 - Participants Export - Certifications and Available to join Projects
class C131991_ParticipantsExport_CertificationsandAvailabletojoinProjects
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetRegistrationorGetStartedForHackathonOnboarding().run("Area Accessing The Menu From":/Homepage Header/.toString(),"Onboarding Menu Option":/Early Registration/.toString())
        ...
        new actions.SetupIdeas.SetSiteSetupIdeasTeamConfiguration().run("Section":/Team Configuration/.toString(),"User Availability Flag":true)
        //Navigate
        ...
        new actions.PipelineStepsConfigure.ConfigureSingleScaleStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Rate Submissions/.toString(),"Individual Assignment User":/End User/.toString(),"Individual Assignment User Add or Remove":/Add/.toString(),"Action":/Activate/.toString())
        //Log Out
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowAforHackathonOnboarding().run("Action on Get Started Screen":/Next/.toString(),"Expertise":/enduserexp1/.toString(),"Add or Remove Expertise":/Add/.toString(),"I am available to join teams":false,"Register and add expertise Action":/Continue to submission/.toString(),"Action on Time to submit your project":/Cancel/.toString(),"Wait for Post Idea Page to Load":false)
        //Set Flow A for Hackathon Onboarding
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowAforHackathonOnboarding().run("Action on Get Started Screen":/Close/.toString())
        //Refresh
        ...
        new actions.SetupExports.SetWebstormSetupExportsforUsersTab().run("Report Options":/Participants List/.toString(),"Format":/csv/.toString())
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Participants-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Screen Name","Email Address","Webstorm Name","Webstorm ID","Admin Status (Y/N)","Evaluator Status (Y/N)","Expertise","Registered","Joined Event","Join Date","Join Method","Certifications","Available to join projects"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Users/.toString(),"Report Name Starts with":/Participants-/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Participants-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["System Admin","bi.adminuser1@brightidea.com","QA,Automation","Manual Opt in","Yes"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Users/.toString(),"Report Name Starts with":/Participants-/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Participants-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["End User","bi.enduser1@brightidea.com","N","Y","enduserexp1","Yes","Manual Opt in","Business Model Canvas","No"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Users/.toString(),"Report Name Starts with":/Participants-/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Participants-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["End User","bi.enduser1@brightidea.com","N","Y","enduserexp1","Yes","Manual Opt in","Lean Startup","No"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
