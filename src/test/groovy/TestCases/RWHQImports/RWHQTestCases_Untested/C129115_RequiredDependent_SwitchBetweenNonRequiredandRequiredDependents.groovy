...
//C129115 - Required Dependent - Switch Between Non Required and Required Dependents
class C129115_RequiredDependent_SwitchBetweenNonRequiredandRequiredDependents
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.SetNGAViewIdeaDescriptionTabTextField().run("Field Name":/Child1/.toString(),"Action":/Save/.toString())
        ...
        //Set NGA View Idea Description Tab Text Field
        new actions.NGAViewIdea.SetNGAViewIdeaDescriptionTabTextField().run("Field Name":/Child1/.toString(),"Field Value":/test Child1/.toString(),"Action":/Save/.toString())
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Set NGA View Idea Description Tab Radiobutton
        new actions.NGAViewIdeaFields.SetNGAViewIdeaRadioButton().run("Field Name":/Parent1/.toString(),"Field Value":/Parent1-2/.toString(),"Action":/Save/.toString())
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Child1/.toString(),"Should Exist":false)
        //Set NGA View Idea Description Tab Text Field
        new actions.NGAViewIdea.SetNGAViewIdeaDescriptionTabTextField().run("Field Name":/Child2/.toString(),"Action":/Save/.toString())
        //Verify Error Field in NGA View Idea page
        new actions.NGAViewIdeaFields.VerifyErrorFieldNGAViewIdea().run("Field Name":/Child2/.toString(),"Should Error Exist":false)
        //Set NGA View Idea Description Tab Text Field
