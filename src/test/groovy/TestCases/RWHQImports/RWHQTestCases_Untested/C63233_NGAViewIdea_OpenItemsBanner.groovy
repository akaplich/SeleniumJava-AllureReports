...
//C63233 - NGA View Idea - Open Items Banner
class C63233_NGAViewIdea_OpenItemsBanner
{
    ...
    public void testcase(){
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/1 Open Pre Screen Action Items for this Idea/.toString(),"Should Exist":true)
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Home/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        ...
        new actions.PipelineManageSteps.AccessIdeainPipelineManageCurrentlyinStepPage().run("Idea name":/test idea3/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/2 Open Pre Screen Action Items for this Idea/.toString(),"Should Exist":true)
        ...
        new actions.general.VerifyMessage().run("Message Text":/1 Open Pre Screen Action Items for this Idea/.toString(),"Should Exist":true)
        //Access Idea in Pipeline Manage Currently in Step Page
        new actions.PipelineManageSteps.AccessIdeainPipelineManageCurrentlyinStepPage().run("Idea name":/test idea4/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/2 Open Pre Screen Action Items for this Idea/.toString(),"Should Exist":true)
    }
    //Basestate
