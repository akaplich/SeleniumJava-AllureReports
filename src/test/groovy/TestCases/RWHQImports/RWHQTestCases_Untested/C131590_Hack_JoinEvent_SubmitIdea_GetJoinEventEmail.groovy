...
//C131590 - Hack > Join Event - Submit Idea, Get Join Event Email
class C131590_Hack_JoinEvent_SubmitIdea_GetJoinEventEmail
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC131590_15/.toString(),"Webstorm Name":/Hack/.toString(),"Finally Login as What User":/brightC131590_15@mailinator.com/.toString())
        ...
        new actions.Email.VerifyEmailbyIteratingthroughInboxMailinator().run("Email Address":/brightC131590_15@mailinator.com/.toString(),"Subject":/Hack: You've  Joined the Hack Event/.toString(),"From":/noreply@brightidea.com/.toString(),"Email Should Be Received":true)
        //Verify Email by Iterating through Inbox Mailinator
        new actions.Email.VerifyEmailbyIteratingthroughInboxMailinator().run("Email Address":/brightC131590_15@mailinator.com/.toString(),"Subject":/Hack: Project Submission Confirmation/.toString(),"From":/noreply@brightidea.com/.toString(),"Email Should Be Received":true)
    }
    //Basestate
