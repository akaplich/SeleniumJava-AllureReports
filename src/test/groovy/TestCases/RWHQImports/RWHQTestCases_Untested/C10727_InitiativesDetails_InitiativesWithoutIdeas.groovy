...
//C10727 - Initiatives Details - Initiatives Without Ideas
class C10727_InitiativesDetails_InitiativesWithoutIdeas
{
    ...
    public void testcase(){
        ...
        new actions.WebstormCreation.CreateCustomWebstorm().run("Webstorm Title":/Empty Pipeline/.toString(),"Description":/Empty Pipeline/.toString(),"Action":/Create/.toString())
        //Navigate
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Initiative_details-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Empty Pipeline"],"Number of Matches":/0/.toString(),"Total Number of Rows":/7/.toString())
    }
    //Basestate
