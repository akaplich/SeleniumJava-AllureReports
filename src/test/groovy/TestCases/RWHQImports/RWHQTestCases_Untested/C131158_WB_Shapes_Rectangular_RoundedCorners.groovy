...
//C131158 - WB - Shapes - Rectangular - Rounded Corners
class C131158_WB_Shapes_Rectangular_RoundedCorners
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("Rounded Corners Radius":/30/.toString())
    }
    //Basestate
