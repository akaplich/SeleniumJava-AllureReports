...
class C119422_DisableSubmissionCategoriesandcheckNGAviewideapage(actionitemview)_Evaluator
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Title":/test idea1/.toString(),"Number of Matches":/1/.toString())
