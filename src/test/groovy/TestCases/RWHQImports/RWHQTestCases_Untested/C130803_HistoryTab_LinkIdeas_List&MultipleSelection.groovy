...
//C130803 - History Tab - Link Ideas - List & Multiple Selection
class C130803_HistoryTab_LinkIdeas_ListRedwoodHQTestCaseMultipleSelection
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Idea Name":/link idea1/.toString(),"Action":/Submit/.toString())
        //Quick Add an Idea in Pipeline Steps page
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Idea Name":/link idea2/.toString(),"Action":/Submit/.toString())
        //Quick Add an Idea in Pipeline Steps page
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Idea Name":/link idea3/.toString(),"Action":/Submit/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.PipelineList.SelectIdeasPipelineListView().run("Idea Title(s)":/link idea1,link idea2,link idea3/.toString())
        ...
        //Verify History Tab on View Idea
        new actions.ViewIdea.VerifyHistoryTabonViewIdea().run("Event Record to Verify":/Idea linked to link idea1 by System Admin/.toString(),"Number of Matches":/1/.toString(),"Total Number of Records":/3/.toString())
        //Verify History Tab on View Idea
