...
//C132244 - VI3 - Development Questions - Individual Viewing Permissions Per Question
class C132244_VI3_DevelopmentQuestions_IndividualViewingPermissionsPerQuestion
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development Admins Only/.toString(),"Additional Question Type":/Dropdown/.toString(),"Development Field":true,"Viewing Permissions":/admin_only/.toString())
        //Set Webstorm Setup Ideas for Submission Form Tab
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development Admins Evaluators./.toString(),"Additional Question Type":/Dropdown/.toString(),"Development Field":true,"Viewing Permissions":/admin_evals/.toString())
        //Set Webstorm Setup Ideas for Submission Form Tab
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development Admins Evaluators Submitters/.toString(),"Additional Question Type":/Dropdown/.toString(),"Development Field":true,"Viewing Permissions":/admin_evals_submitters/.toString())
        //Set Webstorm Setup Ideas for Submission Form Tab
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development Admins And All Others/.toString(),"Additional Question Type":/Dropdown/.toString(),"Development Field":true,"Viewing Permissions":/admin_evals_all/.toString(),"Save Form":true)
        ...
        new actions.PipelineStepsConfigure.ConfigureDevelopmentinNewModalinPipelineStepspage().run("Assignment Method":/Individual Assignment/.toString(),"Development Lead":/Me/.toString(),"Development Team":/Evaluator/.toString(),"Development Team Add or Remove":/Add/.toString(),"Development Field":/Development Admins Only,Development Admins Evaluators.,Development Admins Evaluators Submitters,Development Admins And All Others/.toString(),"Development Field Included or Required":/Included,Included,Included,Included/.toString(),"Action":/Activate/.toString())
        //Navigate
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Development Idea/.toString(),"Description":/test/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/${variables."TCData.User"}/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdea3Fields.VerifyViewIdea3DescriptionTabFieldValue().run("Field Name":/Development Admins Only/.toString(),"Field Value":/No answer/.toString(),"Should Exist":/${variables."TCData.DevelopmentAdminsOnly"}/.toString())
        //Verify Description Tab Text Field on View Idea 30
        new actions.ViewIdea3Fields.VerifyViewIdea3DescriptionTabFieldValue().run("Field Name":/Development Admins Evaluators./.toString(),"Field Value":/No answer/.toString(),"Should Exist":/${variables."TCData.DevelopmentAdminsEvaluators"}/.toString())
        //Verify Description Tab Text Field on View Idea 30
        new actions.ViewIdea3Fields.VerifyViewIdea3DescriptionTabFieldValue().run("Field Name":/Development Admins Evaluators Submitters/.toString(),"Field Value":/No answer/.toString(),"Should Exist":/${variables."TCData.DevelopmentAdminsEvaluatorsSubmitters"}/.toString())
        //Verify Description Tab Text Field on View Idea 30
        new actions.ViewIdea3Fields.VerifyViewIdea3DescriptionTabFieldValue().run("Field Name":/Development Admins And All Others/.toString(),"Field Value":/No answer/.toString(),"Should Exist":/${variables."TCData.DevelopmentAdminsAndAllOthers"}/.toString())
    }
    //Basestate
