...
//C45252 - Votes - Remove Report
class C45252_Votes_RemoveReport
{
    ...
    public void testcase(){
        ...
        new actions.SetupExports.RemoveReportfromSetupExports().run("Section":/Votes/.toString(),"Report Name Starts with":/Votes/.toString(),"Instance":/1/.toString(),"Action":/Delete Report/.toString())
        //Verify Generated Report in any Setup Exports
        new actions.SetupExports.VerifyGeneratedReportinSetupExports().run("Report Name Starts with":/Votes/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
