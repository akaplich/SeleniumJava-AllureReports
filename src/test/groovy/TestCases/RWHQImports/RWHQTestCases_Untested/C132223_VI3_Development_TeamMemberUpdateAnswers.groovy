...
//C132223 - VI3 - Development - Team Member Update Answers
class C132223_VI3_Development_TeamMemberUpdateAnswers
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightc132223_team/.toString(),"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        //Navigate
        ...
        new actions.PipelineStepsConfigure.ConfigureDevelopmentinNewModalinPipelineStepspage().run("Assignment Method":/Individual Assignment/.toString(),"Development Team":/brightc132223_team@mailinator.com/.toString(),"Development Team Add or Remove":/Add/.toString(),"Selected user":"","Selected Users Add or Remove":"","Development Field":/Development Parent Dropdown Question/.toString(),"Development Field Included or Required":/Included/.toString(),"Action":/Activate/.toString())
        ...
        //Login
        new actions.general.Login().run("Email":/brightc132223_team@mailinator.com/.toString())
        ...
        //Set Development for Idea in Action Items page
        new actions.ActionItems.SetDevelopmentforIdeainActionItemspage().run("Development Parent Dropdown Question":/Answer 3/.toString(),"Development Child Checkbox Question":[],"Action":/Done/.toString(),"Action on Mark Development Form Done":/Mark Done/.toString())
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Verify and Access Revision History Development for Idea in Action Items page
