...
//C131478 - Memo - Share - Move to Batch - Permissions Retained
class C131478_Memo_Share_MovetoBatch_PermissionsRetained
{
    ...
    public void testcase(){
        ...
        //Login
        new actions.general.Login().run("Email":/analyst@test.com/.toString())
        //Navigate
        ...
        new actions.Memo.ColabEditorSetMemoTitle().run("New Title":/C131478/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Memo.CollabEditorSetSubmitToBatch().run("Via Button or Dropdown?":/Button/.toString(),"Select batch":/TestMemo/.toString(),"Action":/Submit/.toString())
        //Copy Current URL
        ...
        //Collab Editor - Set Text
        new actions.Memo.ColabEditorSetText().run("Text":/added by End User 2/.toString(),"Key(s)":/Enter/.toString())
        //Copy Current URL
        variables."currentURL" = new actions.selenium.CopyCurrentURL().run([:])
        //Collab Editor - Click Go Back Button
        new actions.Memo.ColabEditorClickGoBackButton().run([:])
        ...
        try{
            //Collab Editor - Set Text
            new actions.Memo.ColabEditorSetText().run("Text":/should not be here/.toString(),"Key(s)":/Enter/.toString())
        }
        ...
        new actions.Memo.CollabEditorVerifyText().run("Contains Text (only verifies text & color!)":/added by End User 2/.toString(),"Should Text Exist":true)
        //Collab Editor - Verify Text
        new actions.Memo.CollabEditorVerifyText().run("Contains Text (only verifies text & color!)":/should not be here/.toString(),"Should Text Exist":false)
    }
    //Basestate
