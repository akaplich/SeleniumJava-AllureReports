...
//C128673 - Moderator can edit and view admin Question in NGA View Idea
class C128673_ModeratorcaneditandviewadminQuestioninNGAViewIdea
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.SetNGAViewIdeaDescriptionTabDropdown().run("Field Name":/Admin Only Dropdown Question/.toString(),"Field Value":/Answer 2/.toString(),"Action":/Save/.toString())
