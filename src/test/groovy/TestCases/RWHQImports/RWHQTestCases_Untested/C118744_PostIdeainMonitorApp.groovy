...
//C118744 - Post Idea in Monitor App
class C118744_PostIdeainMonitorApp
{
    ...
    public void testcase(){
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Monitor Forum title/.toString(),"Area to Navigate to":/Post Idea/.toString())
