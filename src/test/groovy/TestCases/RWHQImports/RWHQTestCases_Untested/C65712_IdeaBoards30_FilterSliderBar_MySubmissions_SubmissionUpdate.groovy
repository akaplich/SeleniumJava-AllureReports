...
//C65712 - Idea Boards 30 - Filter Slider Bar - My Submissions - Submission Update
class C65712_IdeaBoards30_FilterSliderBar_MySubmissions_SubmissionUpdate
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea3/.toString(),"Instance":/1/.toString())
        //Set View Idea Description Tab Text Field
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabTextField().run("Field Name":/Description/.toString(),"Field Value":/test idea3 update desc/.toString(),"Action":/Save/.toString())
        //Navigate WebStorm or MTS
