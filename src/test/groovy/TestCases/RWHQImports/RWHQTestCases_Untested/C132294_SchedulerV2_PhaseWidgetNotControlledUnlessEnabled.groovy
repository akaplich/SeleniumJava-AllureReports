...
//C132294 - Scheduler V2 - Phase Widget Not Controlled Unless Enabled
class C132294_SchedulerV2_PhaseWidgetNotControlledUnlessEnabled
{
    ...
    public void testcase(){
        ...
        //Set Phase Widget
        new actions.Widgets.SetPhaseWidget().run("Phase":/Final Phase/.toString(),"Action on Phase":/Add/.toString(),"Description of Phase":/test/.toString(),"Action on Adding or Editing Phase":/Save Phase/.toString())
        //Set Widget Controller
        new actions.Widgets.SetWidgetController().run("Widget Edit Mode":/Disable/.toString())
        //Verify Phases in the Phase Widget
        new actions.Widgets.VerifyPhasesinthePhaseWidget().run("Phase":/Final Phase/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
