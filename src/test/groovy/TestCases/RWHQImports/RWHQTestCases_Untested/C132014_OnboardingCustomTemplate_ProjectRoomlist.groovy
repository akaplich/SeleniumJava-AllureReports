...
//C132014 - Onboarding Custom Template - Project Room list
class C132014_OnboardingCustomTemplate_ProjectRoomlist
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.ProjectRoomCreateProjectRoom().run([:])
        //Set and Verify Project Room Title
        new actions.ProjectRoom.SetProjectRoomTitle().run("Title":/Testing2/.toString(),"Action":/Submit/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Navigate Tab User Homepage or MTS
        new actions.Enterprise.UserHomepage.NavigateTabUserHomepage().run("Tab":/Project Room/.toString())
        ...
        new actions.ProjectRoom.ProjectRoomCreateProjectRoom().run([:])
        //Set and Verify Project Room Title
        new actions.ProjectRoom.SetProjectRoomTitle().run("Title":/Testing3/.toString(),"Action":/Submit/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Enterprise Setup/.toString())
        //Set Enterprise Setup Site User Homepage 
        new actions.SetupSite.SetEnterpriseSetupSiteUserHomepage().run("User Homepage options":/User Homepage/.toString(),"Activities":true,"My Ideas":true,"Submissions":true)
        ...
        new actions.PipelineSetup.SetProjectRoomTemplates().run("Tab":/Participant Template/.toString(),"Template Name":/Testing2/.toString(),"Action":/Select Project Room/.toString())
        //Log Out
        ...
        try{
            //Set Project Room Templates for Stage Gate or Onboarding
            new actions.PipelineSetup.SetProjectRoomTemplates().run("Tab":/Participant Template/.toString(),"Template Name":/Testing3/.toString(),"Action":/Select Project Room/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Set Project Room Templates for Stage Gate or Onboarding
            new actions.PipelineSetup.SetProjectRoomTemplates().run("Action":/Cancel/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Project Room Templates in Pipeline Setup
        new actions.PipelineSetup.VerifyProjectRoomTemplatesinPipelineSetup().run("Template Title":/Testing2/.toString(),"Created By":/System Admin/.toString(),"Number of Matches":/1/.toString(),"Access the Template":true)
        //Wait
