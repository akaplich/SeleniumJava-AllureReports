...
class C129986_AddIdeaviaEmail_DoNotPostIdeaifInitiativeClosed
{
    ...
    public void testcase(){
        ...
        new actions.PipelineCommunications.SetPipelineCommunicationsTab().run("Select Tab":/Emails/.toString(),"Email":/New Idea Submitted/.toString(),"Email Recipient":/Idea Submitter/.toString(),"Email Subject":/C129986 Submission Confirmation/.toString(),"Action":/Save/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.People.AddUserinPeoplepage().run("Email Address":/annabrightidea1@yahoo.com/.toString(),"First Name":/C129986/.toString(),"Last Name":/Test User/.toString(),"Screen Name":/Email Test User/.toString(),"Action":/Add User/.toString())
        //Wait
        ...
        new actions.Email.VerifyEmailNotMailinator().run("Sender Host":/imap.mail.yahoo.com/.toString(),"Sender's Email":/annabrightidea1@yahoo.com/.toString(),"Password":/coothhthkgxqqztx/.toString(),"Email Subject to Look For":/C129986 Submission Confirmation/.toString(),"Email Should Exist":false,"Folder":/INBOX/.toString())
    }
    //Basestate
