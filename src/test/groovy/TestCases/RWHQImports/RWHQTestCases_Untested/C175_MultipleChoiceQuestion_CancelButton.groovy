...
//C175 - Multiple Choice Question - Cancel Button
class C175_MultipleChoiceQuestion_CancelButton
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabRadiobutton().run("Field Name":/Multiple Choice Question/.toString(),"Field Value":/Answer 2/.toString(),"Action":/Cancel/.toString())
