...
//C130122 - Standard Licensing - Add Pipeline Administrator Email
class C130122_StandardLicensing_AddPipelineAdministratorEmail
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC130122ExistingPA_test3/.toString(),"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        //Navigate
        ...
        new actions.PipelineSetup.SetRolesinPipelineSetupPage().run("Type of Licensing Model":/Standard Licensing Model/.toString(),"Navigate to Tab":true,"Admin Field Name":/Pipeline Administrators/.toString(),"Administrators":/brightC130122ExistingPA_test3@mailinator.com/.toString(),"Administrators Add or Remove":/Add/.toString(),"Click Save":false)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Assigning Users to Licensed Roles/.toString(),"Should Exist":false)
        //Verify Message
        ...
        variables."link" = new actions.Mailinator.GetLinkfromTeamWorkspaceEmail().run("Email Address":/brightC130122ExistingPA_test3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Login
        new actions.general.Login().run("Webstorm Login":true,"Email":/brightC130122ExistingPA_test3@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom Pipeline/.toString(),"Area to Navigate to":/Pipeline Setup/.toString())
        //Set Roles in Pipeline Setup Page
        new actions.PipelineSetup.SetRolesinPipelineSetupPage().run("Type of Licensing Model":/Standard Licensing Model/.toString(),"Navigate to Tab":true,"Admin Field Name":/Pipeline Administrators/.toString(),"Administrators":/brightC130122NewPA_test3@mailinator.com/.toString(),"Administrators Add or Remove":/Add/.toString(),"Click Save":false)
        //Verify Message
        ...
        variables."link" = new actions.Mailinator.GetLinkfromInviteParticipantEmail().run("Inbox Email Count":/2/.toString(),"Email Address":/brightC130122NewPA_test3/.toString(),"Subject of New Administrator Added Email":/been assigned as a Pipeline Administrator/.toString())
        //Navigate to URL
        ...
        new actions.People.VerifyLicensesUserinPeoplePillarLicensesTab().run("License Type":/Brightidea Administrator License Type/.toString(),"Expand License Breakdown":true,"User":/FirstName LastName/.toString(),"Roles":/Pipeline Administrator/.toString(),"Number of Matches":/1/.toString())
        //Verify Licenses User in People Pillar Licenses tab
        new actions.People.VerifyLicensesUserinPeoplePillarLicensesTab().run("License Type":/Brightidea Administrator License Type/.toString(),"Expand License Breakdown":false,"User":/Autofirst Autolast/.toString(),"Roles":/Pipeline Administrator/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
