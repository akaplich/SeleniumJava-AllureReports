...
//C131903 - HTS - Participants Page with single Participant
class C131903_HTS_ParticipantsPagewithsingleParticipant
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.HackSetParticipantsCardonParticipantsPage().run("Username":/System Admin/.toString(),"Leave Event":true)
        //Set Join/Leave Event Modal - Hack App
