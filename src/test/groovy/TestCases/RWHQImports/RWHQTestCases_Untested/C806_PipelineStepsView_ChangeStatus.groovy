...
//C806 - Pipeline Steps View - Change Status
class C806_PipelineStepsView_ChangeStatus
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Status":/On Hold/.toString(),"Team":[],"Linked Submissions":[])
    }
    //Basestate
