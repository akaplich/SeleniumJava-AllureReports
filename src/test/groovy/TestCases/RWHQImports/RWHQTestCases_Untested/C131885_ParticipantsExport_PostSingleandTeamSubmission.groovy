...
//C131885 - Participants Export - Post Single and Team Submission
class C131885_ParticipantsExport_PostSingleandTeamSubmission
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/single submission1/.toString(),"Description":/desc/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/team submission1/.toString(),"Submitter":/Team/.toString(),"Submitter Team User":/End User 2/.toString(),"Submitter Team User Add or Remove":/Add/.toString(),"Description":/desc/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.SetupExports.SetWebstormSetupExportsforUsersTab().run("Report Options":/Participants List/.toString(),"Format":/xlsx/.toString())
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Participants-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Screen Name","Email Address","Webstorm Name","Webstorm ID","Admin Status (Y/N)","Evaluator Status (Y/N)","Expertise","Submission","Submission Team Name","Submission Team","Registered","Joined Event","Join Date","Join Method","Certifications"],"Number of Matches":/1/.toString(),"Total Number of Rows":/4/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Users/.toString(),"Report Name Starts with":/Participants-/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Participants-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["System Admin","bi.adminuser1@brightidea.com","Hack","Y","N","D111","Submission"],"Number of Matches":/1/.toString(),"Total Number of Rows":/4/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Users/.toString(),"Report Name Starts with":/Participants-/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Participants-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["End User","bi.enduser1@brightidea.com","Hack","D112","Team - End User","End User,End User 2","Submission"],"Number of Matches":/1/.toString(),"Total Number of Rows":/4/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Users/.toString(),"Report Name Starts with":/Participants-/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Participants-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["End User 2","bi.enduser2@brightidea.com","Hack","D112","Team - End User","End User,End User 2","Added to submission team"],"Number of Matches":/1/.toString(),"Total Number of Rows":/4/.toString())
    }
    //Basestate
