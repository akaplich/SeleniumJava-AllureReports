...
//C117555 - Idea Boards 30 - Administrator and Evaluator permission to Development Questions
class C117555_IdeaBoards30_AdministratorandEvaluatorpermissiontoDevelopmentQuestions
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development Question with Multiple Choice1/.toString(),"Additional Question Type":/Multiple Choice/.toString(),"Additional Question Answers":/Yes,No,Answer 3/.toString(),"Additional Question Answers Actions":/Add,Add,Remove/.toString(),"Development Field":true,"Viewing Permissions":/admin_evals/.toString(),"Save Form":true)
        //Navigate Webstorm via Admin Dropdown Only
        new actions.general.NavigateWebstormviaAdminBarOnly().run("Area to Navigate to":/Site Setup/.toString())
        //Set Webstorm Setup Ideas for Submission Form Tab
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development Question with Checkbox1/.toString(),"Additional Question Type":/Checkbox/.toString(),"Additional Question Answers":/Option1,Option2,Option3/.toString(),"Additional Question Answers Actions":/Add,Add,Add/.toString(),"Development Field":true,"Viewing Permissions":/admin_evals/.toString(),"Save Form":true)
        //Navigate Webstorm via Admin Dropdown Only
        new actions.general.NavigateWebstormviaAdminBarOnly().run("Area to Navigate to":/Site Setup/.toString())
        //Set Webstorm Setup Ideas for Submission Form Tab
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development Question with Dropdown1/.toString(),"Additional Question Type":/Dropdown/.toString(),"Additional Question Answers":/Dropdown Option1,Dropdown Option2,Dropdown Option3/.toString(),"Additional Question Answers Actions":/Add,Add,Add/.toString(),"Development Field":true,"Viewing Permissions":/admin_evals/.toString(),"Save Form":true)
        //Navigate Webstorm via Admin Dropdown Only
        new actions.general.NavigateWebstormviaAdminBarOnly().run("Area to Navigate to":/Site Setup/.toString())
        try{
