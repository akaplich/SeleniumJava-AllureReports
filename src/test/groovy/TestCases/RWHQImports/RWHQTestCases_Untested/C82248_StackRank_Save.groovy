...
//C82248 - Stack Rank - Save
class C82248_StackRank_Save
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.SetStackRankforIdeainActionItemspage().run("Idea":/stackrank idea2/.toString(),"New Order":/1/.toString(),"Action":/Save/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Action Items/.toString())
        //Verify Completed table for Action Items page
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Title":/Stack Rank/.toString(),"Number of Matches":/0/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/My Action Items/.toString(),"Title":/Stack Rank/.toString(),"Number of Matches":/1/.toString())
        ...
        //Verify Stack Rank for Idea in Action Items Page
        new actions.ActionItems.VerifyStackRankforIdeainActionItemsPage().run("Idea":/stackrank idea1/.toString(),"Rank":/2/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
