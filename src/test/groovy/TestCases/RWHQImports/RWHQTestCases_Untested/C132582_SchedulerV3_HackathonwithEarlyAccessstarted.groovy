...
//C132582 - Scheduler V3> Hackathon with Early Access started
class C132582_SchedulerV3_HackathonwithEarlyAccessstarted
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyActivityinUserHomepage().run("Active or Closed":/Active/.toString(),"Activity Name":/Hack/.toString(),"Phase Starts":/Incubate starts in:/.toString(),"Phase Starts Countdown":/1 days, 23 hours/.toString(),"Number of Matches":/1/.toString())
        //Navigate
        ...
        new actions.WebstormHomepage.VerifyDaystoLaunch().run("Days":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
