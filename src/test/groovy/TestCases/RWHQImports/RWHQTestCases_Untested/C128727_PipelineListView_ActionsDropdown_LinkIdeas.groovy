...
//C128727 - Pipeline List View - Actions Dropdown - Link Ideas
class C128727_PipelineListView_ActionsDropdown_LinkIdeas
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.VerifyLinkedSubmissiononViewIdea().run("Linked Submissions":/test idea2/.toString(),"Should Exist":/TRUE/.toString(),"Name of the Linked Submission to Navigate to":/test idea2/.toString())
        //Verify Linked Submission on View Idea
