...
//C132285 - Action Item Completed Rule - switch from old to new rules modal
class C132285_ActionItemCompletedRule_switchfromoldtonewrulesmodal
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development Question/.toString(),"Additional Question Type":/Short Answer/.toString(),"Development Field":true,"Save Form":true)
        ...
        new actions.PipelineStepsView.EditStepinPipelineStepspage().run("Step to Edit":/Initial Screen/.toString(),"Step Name":/Development/.toString(),"Tool Type":/Development/.toString(),"Action":/Save/.toString())
        //Configure Development Step in Pipeline Steps page
        new actions.PipelineStepsConfigure.ConfigureDevelopmentinNewModalinPipelineStepspage().run("Development Team":/System Admin/.toString(),"Development Team Add or Remove":/Add/.toString(),"Development Field":/Development Question/.toString(),"Development Field Included or Required":/Included/.toString(),"Action":/Activate/.toString())
        ...
        new actions.ActionItems.SetDevelopmentforIdeainActionItemspage().run("Development Short Answer Question":/Confirm/.toString(),"Development Child Checkbox Question":[],"Action":/Save/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Test App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Rules.SetRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Condition":/Development Question/.toString(),"Operator value":/Is/.toString(),"Condition value":/Confirm/.toString())
        //OLD RULE Set Rule Perform the Following Actions
        new actions.Rules.SetRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Perform Following Action":/Change Step/.toString(),"Action Value":/Completed/.toString())
        //OLD RULE Set Rule window
        new actions.Rules.SetRulewindow().run("Rule Name":/Complete AI Rule/.toString(),"Action":/Create/.toString())
        ...
        new actions.Rules.AccessExistingRule().run("Rule Name":/Complete AI Rule/.toString())
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Action":/Save/.toString())
        //Verify Rule in Rules Engine table
        new actions.Rules.VerifyRuleinRulesEnginetable().run("Rule Name":/Complete AI Rule/.toString(),"Event":/Action Item Completed/.toString(),"Last Run":/Never/.toString(),"Status":/Inactive/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
