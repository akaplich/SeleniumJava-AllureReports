...
//C119076 - Duplicate Checker - Enabled
class C119076_DuplicateChecker_Enabled
{
    ...
    public void testcase(){
        ...
        //Verify and Access Similar Ideas using Duplicate Checker in Post Idea
        new actions.PostIdea.VerifyandAccessSimilarIdeasusingDuplicateCheckerinPostIdea().run("Title":/test idea2/.toString(),"Access the Idea":true)
        try{
