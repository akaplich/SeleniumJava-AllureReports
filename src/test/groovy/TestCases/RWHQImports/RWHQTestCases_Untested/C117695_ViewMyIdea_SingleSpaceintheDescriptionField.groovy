...
//C117695 - View My Idea - Single Space in the Description Field
class C117695_ViewMyIdea_SingleSpaceintheDescriptionField
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.SetViewMyIdeaTextField().run("Field Name":/Description/.toString(),"Field Value":/ /.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Access My Idea on View My Idea
        new actions.Enterprise.UserHomepage.AccessMyIdeaonViewMyIdea().run("Access View My Idea modal":/Brightidea must be next big thing/.toString())
