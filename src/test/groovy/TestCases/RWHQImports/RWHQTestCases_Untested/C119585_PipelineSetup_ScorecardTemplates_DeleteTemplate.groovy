...
//C119585 - Pipeline Setup - Scorecard Templates - Delete Template
class C119585_PipelineSetup_ScorecardTemplates_DeleteTemplate
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.SetActionSelectedScorecardTemplate().run("Action":/Delete Template/.toString(),"Delete Template Action":/Delete/.toString())
        try{
            //Set Templates in Scorecard Templates
            new actions.PipelineSetup.SetTemplatesScorecardTemplates().run("Template Title to Select":/General Evaluation Scorecard/.toString())
        }
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/General Evaluation Scorecard/.toString(),"Should Exist":false)
    }
    //Basestate
