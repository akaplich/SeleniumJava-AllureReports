...
//C119142 - Highlights - All Activity - Post a Private Comment
class C119142_Highlights_AllActivity_PostaPrivateComment
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/This is comment2/.toString(),"Comment Type":/Private/.toString())
        //Log Out
