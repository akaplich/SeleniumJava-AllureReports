...
//C59002 - Mini tag cloud Wiget - Delete Idea
class C59002_MinitagcloudWiget_DeleteIdea
{
    ...
    public void testcase(){
        ...
        new actions.Widgets.VerifyandAccessWidgetMiniTagCloud().run("Tag Name":/tag1/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
