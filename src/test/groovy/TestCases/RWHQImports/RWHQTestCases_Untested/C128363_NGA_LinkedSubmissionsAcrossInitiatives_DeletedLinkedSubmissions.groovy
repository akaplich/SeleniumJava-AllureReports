...
//C128363 - NGA - Linked Submissions Across Initiatives - Deleted Linked Submissions 
class C128363_NGA_LinkedSubmissionsAcrossInitiatives_DeletedLinkedSubmissions
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/linked idea2/.toString())
        ...
        new actions.NGAViewIdea.VerifyLinkedSubmissionNGAViewIdea().run("Linked Submissions":/linked idea2/.toString(),"Should Exist":/FALSE/.toString())
        //Verify Message
