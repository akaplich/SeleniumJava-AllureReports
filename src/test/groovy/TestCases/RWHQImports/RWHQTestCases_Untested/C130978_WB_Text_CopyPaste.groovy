...
//C130978 - WB - Text - Copy Paste
class C130978_WB_Text_CopyPaste
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/C130978/.toString())
        //Send Key(s) To Whiteboard
        ...
        new actions.general.Wait().run("Seconds":/1/.toString())
        //Verify Element
        new actions.general.VerifyElement().run("ID":/(\/\/UL[@class='f-canvas-element-list']\/LI\/DIV\/SPAN[starts-with(.,'C130978')])[2]\/..\/..\/..\/..\/..\/../.toString(),"Should Element Exist":true,"Number of Matches":/1/.toString())
    }
    //Basestate
