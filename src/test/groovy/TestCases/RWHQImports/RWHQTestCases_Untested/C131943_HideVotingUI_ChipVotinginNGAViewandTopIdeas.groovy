...
//C131943 - Hide Voting UI > Chip Voting in NGA View and Top Ideas
class C131943_HideVotingUI_ChipVotinginNGAViewandTopIdeas
{
    ...
    public void testcase(){
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/*[@id='view-idea-header-container']/.toString(),"Expected Image File":/C131943_NGAViewIdea2_ExpectedImage1.png/.toString(),"Actual Image Name":/C131943_NGAViewIdea2_ActualImage.png/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Setup/.toString())
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/*[contains(@class,'f-dropdown-options') and contains (@style,'display: block')]/.toString(),"Expected Image File":/C131943_TopIdeas_ExpectedImage1.png/.toString(),"Actual Image Name":/C131943_TopIdeas_ActualImage.png/.toString())
        //Navigate
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/*[contains(@class,'f-idea-page-content')]/.toString(),"Expected Image File":/C131943_NGAViewIdea3_ExpectedImage3.png/.toString(),"Actual Image Name":/C131943_NGAViewIdea3_ActualImage.png/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131943_NGAViewIdea2_ActualImage.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131943_TopIdeas_ActualImage.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131943_NGAViewIdea3_ActualImage.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
