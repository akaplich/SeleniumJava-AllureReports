...
//C10794 - Voting History - New Vote
class C10794_VotingHistory_NewVote
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Votes_history-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["D107","test idea2","System Admin","Demoted","-1"],"Number of Matches":/1/.toString(),"Total Number of Rows":/9/.toString())
    }
    //Basestate
