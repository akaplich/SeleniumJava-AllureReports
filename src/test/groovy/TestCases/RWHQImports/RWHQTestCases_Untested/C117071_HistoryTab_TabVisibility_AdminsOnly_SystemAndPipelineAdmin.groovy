...
class C117071_HistoryTab_TabVisibility_AdminsOnly_SystemAndPipelineAdmin
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.VerifyHistoryTabonViewIdea().run("Event Record to Verify":/Idea submitted by System Admin/.toString(),"Number of Matches":/1/.toString(),"Placement Number":/1/.toString())
        //Navigate WebStorm or MTS
        ...
        try{
            //Verify History Tab on View Idea
            new actions.ViewIdea.VerifyHistoryTabonViewIdea().run("Event Record to Verify":/Idea submitted by Pipeline Admin/.toString(),"Number of Matches":/1/.toString(),"Placement Number":/1/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Message
