...
class C129624_MoveIdeas_ExpertiseAndTags
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforIdeastab().run("Enable Expertise on Ideas":true)
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString())
        //Set View Idea Description Tab Desired Expertise
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabDesiredExpertise().run("Expertise Name":/Expertise1/.toString(),"Add or Remove":/Add/.toString(),"Action":/Save/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea3/.toString(),"Description":/Desc/.toString(),"Expertise":/Expertise3/.toString(),"Expertise Add or Remove":/Add/.toString(),"Tag Name":/tag3/.toString(),"Tag Add or Remove":/Add/.toString(),"Category":/Operations/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea4/.toString(),"Description":/Desc/.toString(),"Expertise":/Expertise4,Expertise5/.toString(),"Expertise Add or Remove":/Add,Add/.toString(),"Tag Name":/Tag4/.toString(),"Tag Add or Remove":/Add/.toString(),"Category":/Operations/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Navigate Webstorm via Admin Dropdown Only
        ...
        new actions.PipelineList.SelectIdeasPipelineListView().run("Idea Title(s)":/test idea3,test idea4/.toString())
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Tag":/tag3/.toString(),"Tag Should Exist":/TRUE/.toString(),"Linked Submissions":[])
        //Verify View Idea Description Tab Field Value
        new actions.ViewIdeaFields.VerifyViewIdeaDescriptionTabFieldValue().run("Field Name":/Expertise Required/.toString(),"Field Value":/Expertise3/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Pipeline A/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea4/.toString())
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Tag":/tag4/.toString(),"Tag Should Exist":/TRUE/.toString(),"Linked Submissions":[])
        //Verify View Idea Description Tab Field Value
        new actions.ViewIdeaFields.VerifyViewIdeaDescriptionTabFieldValue().run("Field Name":/Expertise Required/.toString(),"Field Value":/Expertise4,Expertise5/.toString())
    }
    //Basestate
