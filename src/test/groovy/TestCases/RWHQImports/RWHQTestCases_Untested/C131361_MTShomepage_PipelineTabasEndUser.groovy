...
class C131361_MTShomepage_PipelineTabasEndUser
{
    ...
    public void testcase(){
        ...
        //Set Quick Add Memo or Idea
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Memo or Idea":/Memo/.toString(),"Title":/Memo2/.toString(),"Category":/Process Improvement/.toString(),"Status":/In-flight 🔥/.toString(),"Action":/Submit/.toString())
        //Set Quick Add Memo or Idea
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Memo or Idea":/Idea/.toString(),"Title":/Idea1/.toString(),"Category":/Process Improvement/.toString(),"Status":/Stopped ⛔️/.toString(),"Action":/Submit/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Memo Record/.toString(),"View As":/End User/.toString(),"Idea Name":/Memo1(D111)/.toString(),"Category":/Process Improvement/.toString(),"Status":/Green Light ✅/.toString(),"Owner":/System Admin/.toString())
