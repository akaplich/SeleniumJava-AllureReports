...
//C131768 - WB - Add Link on Text character(s) via Right Panel
class C131768_WB_AddLinkonTextcharacter(s)viaRightPanel
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131768/.toString(),"Action":/Submit/.toString())
