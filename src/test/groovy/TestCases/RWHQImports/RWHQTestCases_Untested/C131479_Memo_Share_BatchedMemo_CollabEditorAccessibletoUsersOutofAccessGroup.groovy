...
//C131479 - Memo - Share - Batched Memo - Collab Editor Accessible to Users Out of Access Group
class C131479_Memo_Share_BatchedMemo_CollabEditorAccessibletoUsersOutofAccessGroup
{
    ...
    public void testcase(){
        ...
        new actions.Memo.ColabEditorSetMemoTitle().run("New Title":/C131479/.toString(),"Action":/Submit/.toString())
