...
//C130106 - Standard Licensing - Add System Sponsor
class C130106_StandardLicensing_AddSystemSponsor
{
    ...
    public void testcase(){
        //Basestate
        Action58123c20fa4ee77809f468f6("Licensing Model":/Standard Licensing Model/.toString(),"Unlimited Brightidea Administrator License Type":/0/.toString(),"Brightidea Administrator License Type Purchased Count":/4/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Enterprise Setup/.toString())
        //Verify Info Message for Standard Licensing
        new actions.SetupUsers.VerifyInfoMessageonPeoplePillarandAdministratorTab().run("Area":/System Setup/.toString(),"Info Message":/Assigning a user to either the Affiliate Sponsor or System Administrator role requires granting the user a Brightidea Administrator License (4 Available). Any other license will be removed from the user; role assignments will not be affected.Get more licenses/.toString(),"Info Message Exists":true)
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/End User/.toString(),"Should Exist":true)
        //Verify Info Message for Standard Licensing
        ...
        //Verify Licenses User in People Pillar Licenses tab
        new actions.People.VerifyLicensesUserinPeoplePillarLicensesTab().run("License Type":/Brightidea Administrator License Type/.toString(),"Expand License Breakdown":true,"User":/End User/.toString(),"Roles":/System Sponsor/.toString(),"Number of Matches":/0/.toString())
        //Verify Licenses User in People Pillar Licenses tab
