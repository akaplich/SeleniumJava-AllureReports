...
//C39820 - Subscribe user to a submission
class C39820_Subscribeusertoasubmission
{
    ...
    public void testcase(){
        ...
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Venture title/.toString(),"Area to Navigate to":/Setup/.toString())
        //Set Webstorm Setup Ideas for Ideas tab
        new actions.SetupIdeas.SetWebstormSetupIdeasforIdeastab().run("Enable admin ability to subscribe other users":true)
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Venture title/.toString(),"Area to Navigate to":/Idea Board/.toString())
        ...
        new actions.ViewIdea.SetToggleVisibilityinViewIdeapage().run("Change Visibility":/Visible/.toString(),"Action":/Change Visibility/.toString())
        //Set Subscriber in View Idea Page
        new actions.ViewIdea.SetSubscriberinViewIdeaPage().run("Subscriber":/End User 2/.toString())
        //Log Out
        ...
        new actions.MyActivity.VerifySubscriptionsinMyActivitypage().run("Value Type to Verify":/Ideas/.toString(),"Idea/Webstorm Name":/Idea1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
