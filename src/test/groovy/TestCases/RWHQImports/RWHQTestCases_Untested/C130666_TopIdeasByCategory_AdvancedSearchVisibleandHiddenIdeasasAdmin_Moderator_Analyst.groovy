...
class C130666_TopIdeasByCategory_AdvancedSearchVisibleandHiddenIdeasasAdmin_Moderator_Analyst
{
    ...
    public void testcase(){
        ...
        new actions.PipelineTopIdeas.SearchIdeaInTopIdeas().run("Search Value":/technology/.toString(),"Search with 'Enter'?":true)
        ...
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Techno Update Visible1/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Top Ideas
