...
//C132043 - Flow B - Disable Team Name
class C132043_FlowB_DisableTeamName
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Flow Option Title":/I have a team, but we are not sure what to work on./.toString(),"Expertise":/Expertise1,Expertise2/.toString(),"Add or Remove Expertise":/Add,Add/.toString(),"I am available to join teams":true,"Register and add expertise Action":/Next/.toString(),"Team Name":/test team1/.toString(),"Name your team Screen Action":/Next/.toString(),"Choose a team image Action":/Next/.toString(),"Find Teammates":/End User,Moderator/.toString(),"Teammates Add or Remove":/Add,Add/.toString(),"Wait for loading to disappear":false)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Find Teammates/.toString(),"Should Exist":true)
        //Set Flow B and C on Hackathon Onboarding
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Build your winning team Screen Action":/Next/.toString(),"Wait for loading to disappear":true)
        //Wait
        ...
        new actions.ProjectRoom.VerifyProjectRoomCard().run("Title":/test team1 - Project Room/.toString(),"Updated By":/System Admin/.toString(),"Member count":/3/.toString(),"Total Objects":/9/.toString(),"Total Tasks":/5/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString(),"Access Project Room":true)
    }
    //Basestate
