...
//C130824 - Top Ideas By Category - Add Idea Tags
class C130824_TopIdeasByCategory_AddIdeaTags
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.AddIdeaTaginPipelineStepspage().run("Tag Name":/testtag1,testtag2,testtag3/.toString(),"Tag Add or Remove":/Add,Add,Add/.toString(),"Action":/Add Tags/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/test idea1/.toString(),"Tag":/testtag1,testtag2,testtag3/.toString(),"Tag Should Exist":/TRUE,TRUE,TRUE/.toString())
    }
    //Basestate
