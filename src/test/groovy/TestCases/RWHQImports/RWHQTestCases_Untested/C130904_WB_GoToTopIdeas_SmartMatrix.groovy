...
//C130904 - WB - Go To Top Ideas (Smart Matrix)
class C130904_WB_GoToTopIdeas_SmartMatrix
{
    ...
    public void testcase(){
        ...
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Idea2/.toString(),"Stack Name Memo belongs to":/Quick Add/.toString(),"Idea Code":/D114/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Idea1/.toString(),"Stack Name Memo belongs to":/Quick Add/.toString(),"Idea Code":/D113/.toString(),"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/quick add1/.toString(),"Stack Name Memo belongs to":/Quick Add/.toString(),"Placement Number":/3/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/test idea1/.toString(),"Stack Name Memo belongs to":/New Product/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/test idea2/.toString(),"Stack Name Memo belongs to":/Operations/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Step Result in Top Ideas
        new actions.PipelineTopIdeas.VerifyStepResultInTopIdeas().run("Idea Title":/Idea2/.toString(),"Idea Code":/114/.toString(),"Score":/12.3/.toString(),"Number of Matches":/1/.toString())
        //Verify Step Result in Top Ideas
        ...
        //Verify Step Result in Top Ideas
        new actions.PipelineTopIdeas.VerifyStepResultInTopIdeas().run("Idea Title":/quick add1/.toString(),"Score":/-/.toString(),"Number of Matches":/1/.toString())
        //Verify Step Result in Top Ideas
        new actions.PipelineTopIdeas.VerifyStepResultInTopIdeas().run("Idea Title":/test idea1/.toString(),"Score":/-/.toString(),"Number of Matches":/1/.toString())
        //Verify Step Result in Top Ideas
        new actions.PipelineTopIdeas.VerifyStepResultInTopIdeas().run("Idea Title":/test idea2/.toString(),"Score":/-/.toString(),"Number of Matches":/1/.toString())
        ...
        new actions.Whiteboards.VerifyWhiteboardTitle().run("Title":/Whiteboard with smart matrix/.toString())
    }
    //Basestate
