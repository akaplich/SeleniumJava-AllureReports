...
//C128213 - Comment Component - Tagged Users
class C128213_CommentComponent_TaggedUsers
{
    ...
    public void testcase(){
        ...
        try{
            ...
            new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("View Idea or NGA":/NGA/.toString(),"Comment":/for testing /.toString(),"Comment Type":/General Access/.toString())
        }
        ...
        new actions.ViewIdeaComment.VerifyTaggedUsersInCommentsinViewandNGAViewIdea().run("Comment":/for testing/.toString(),"Tagged User":/End User/.toString(),"Number of Matches":/1/.toString(),"Access User from Comment":true)
