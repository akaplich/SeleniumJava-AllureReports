...
//C128608 - Duplicate Initiative Updates - Add Access Group
class C128608_DuplicateInitiativeUpdates_AddAccessGroup
{
    ...
    public void testcase(){
        ...
        //Login
        new actions.general.Login().run("Webstorm Login":true,"Email":/nonbisysadmin@test.com/.toString(),"Password":/brightidea1/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.PipelineSetup.SetParticipantsinPipelineSetupPage().run("General Access":/System Admin Group,ALL/.toString(),"General Access Add or Remove":/Remove,Add/.toString())
    }
    //Basestate
