...
//C128281 - NGA - Linked Submissions Across Initiatives - Team Submitters Can Link Their Hidden Idea 
class C128281_NGA_LinkedSubmissionsAcrossInitiatives_TeamSubmittersCanLinkTheirHiddenIdea
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea2 - team - system admin Evaluator/.toString())
        ...
        try{
            ...
            new actions.NGAViewIdea.SetLinkedSubmissionsNGAViewIdeaPage().run("Submission Title":/test idea2 - team/.toString(),"Add or Remove":/Add/.toString(),"Action":/Link Submissions/.toString())
        }
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/No Linked Submissions/.toString(),"Should Exist":false)
        //Verify Linked Submission on NGA View Idea
        new actions.NGAViewIdea.VerifyLinkedSubmissionNGAViewIdea().run("Linked Submissions":/test idea2 - team - system admin Evaluator/.toString(),"Should Exist":/TRUE/.toString())
    }
    //Basestate
