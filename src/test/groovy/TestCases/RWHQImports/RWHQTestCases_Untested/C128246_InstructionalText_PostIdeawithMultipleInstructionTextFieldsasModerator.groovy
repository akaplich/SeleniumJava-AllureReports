...
//C128246 - Instructional Text - Post Idea with Multiple Instruction Text Fields as Moderator
class C128246_InstructionalText_PostIdeawithMultipleInstructionTextFieldsasModerator
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/New Text Field/.toString(),"Additional Question Type":/Instruction Text Block/.toString())
        //Edit Additional Questions in Submission Form tab
        new actions.SetupIdeas.EditAdditionalQuestionsinSubmissionFormtab().run("Question":/New Text Field/.toString(),"Edit or Hide or Remove":/Edit/.toString(),"Action on Edit, Hide or Remove":/Submit/.toString(),"Body":/Instructional Text for New Text Field C128246/.toString(),"Save Form":true)
        //Set Webstorm Setup Ideas for Submission Form Tab
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/New Multiple Choice/.toString(),"Additional Question Type":/Multiple Choice/.toString())
        //Edit Additional Questions in Submission Form tab
        new actions.SetupIdeas.EditAdditionalQuestionsinSubmissionFormtab().run("Question":/New Multiple Choice/.toString(),"Edit or Hide or Remove":/Edit/.toString(),"Action on Edit, Hide or Remove":/Submit/.toString(),"Body":/Instructional Text for New Multiple Choice C128246/.toString(),"Save Form":true)
        //Log Out
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Instructional Text for New Multiple Choice C128246/.toString(),"Should Exist":true)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Instructional Text for New Text Field C128246/.toString(),"Should Exist":true)
        ...
        new actions.ViewIdeaFields.VerifyViewIdeaDescriptionTabFieldMultiValue().run("Field Name":/New Multiple Choice/.toString(),"Field Value":/Answer 2/.toString())
        //Verify Message
