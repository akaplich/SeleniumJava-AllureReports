...
//C129562 - List View - Deleted Comment Count
class C129562_ListView_DeletedCommentCount
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("Comment":/test parent comment/.toString(),"Post Comment":true)
        //Reply to Comment in View and NGA View Idea
        new actions.ViewIdeaComment.ReplytoCommentinViewandNGAViewIdea().run("Parent Comment":/test parent comment/.toString(),"Comment Reply":/test child comment/.toString(),"Post Reply":true)
        //Set Comment Edit Menu
        new actions.ViewIdeaComment.SetCommentEditMenu().run("Comment to Edit":/test parent comment/.toString(),"Menu Option":/Delete.../.toString(),"Delete Action":/Delete/.toString())
        //Set Comment Edit Menu
