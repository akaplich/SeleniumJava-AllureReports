...
class C532_Date_Invaliddatewithyearenteredas2digitonViewSubmissionspage
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabTextField().run("Field Name":/Date Question/.toString(),"Field Value":/01\/24\/17/.toString(),"Action":/Save/.toString())
