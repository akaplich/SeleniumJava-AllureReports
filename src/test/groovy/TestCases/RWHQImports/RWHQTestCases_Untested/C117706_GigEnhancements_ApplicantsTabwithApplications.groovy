...
//C117706 - Gig Enhancements - Applicants Tab with Applications
class C117706_GigEnhancements_ApplicantsTabwithApplications
{
    ...
    public void testcase(){
        ...
        new actions.general.Navigate().run("Area to Navigate to":/Profile/.toString())
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("Expertise":/Expertise100,Expertise110,Expertise150,Expertise170,Expertise250,Expertise275,Expertise300,Expertise310,Expertise330/.toString(),"Add or Remove Expertise":/Add,Add,Add,Add,Add,Add,Add,Add,Add/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Gig Marketplace Test/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString())
        ...
        new actions.ViewIdea.GigEnhancementsApplyApplicants.VerifyApplicantsTabinViewIdea().run("Number of Applicants":/4/.toString())
    }
    //Basestate
