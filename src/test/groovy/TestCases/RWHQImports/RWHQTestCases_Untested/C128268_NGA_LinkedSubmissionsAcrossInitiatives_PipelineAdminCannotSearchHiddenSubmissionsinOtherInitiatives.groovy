...
//C128268 - NGA - Linked Submissions Across Initiatives - Pipeline Admin Cannot Search Hidden Submissions in Other Initiatives
class C128268_NGA_LinkedSubmissionsAcrossInitiatives_PipelineAdminCannotSearchHiddenSubmissionsinOtherInitiatives
{
    ...
    public void testcase(){
        ...
        new actions.WebstormCreation.CreateCustomWebstorm().run("Webstorm Title":/Custom App Test/.toString(),"Description":/desc/.toString(),"General Access":/ALL,End User/.toString(),"General Access Add or Remove":/Remove,Add/.toString(),"Moderators":/Moderator/.toString(),"Moderators Add or Remove":/Add/.toString(),"Action":/Create/.toString())
        //Log Out
        ...
        try{
            ...
            new actions.NGAViewIdea.SetLinkedSubmissionsNGAViewIdeaPage().run("Submission Title":/linked/.toString(),"Add or Remove":/Add/.toString())
        }
