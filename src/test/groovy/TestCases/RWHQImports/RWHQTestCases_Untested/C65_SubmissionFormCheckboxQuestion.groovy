...
//C65 - Submission Form Checkbox Question
class C65_SubmissionFormCheckboxQuestion
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Idea Title/.toString(),"Description":/Idea Description/.toString(),"Category":/New Product/.toString(),"Checkbox Question Name":/Answer 1,Answer 2,Answer 1/.toString(),"Checkbox Check":/TRUE,TRUE,FALSE/.toString(),"Required Short Question":/required short/.toString(),"Action":/Submit Idea/.toString())
        ...
        Action5812921cfa4ee77809f46b4f("Checkbox Question":/Answer 2/.toString())
    }
    //Basestate
