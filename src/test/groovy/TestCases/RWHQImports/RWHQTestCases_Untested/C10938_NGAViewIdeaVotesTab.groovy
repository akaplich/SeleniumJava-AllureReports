...
//C10938 - NGA View Idea Votes Tab
class C10938_NGAViewIdeaVotesTab
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.VerifyVotestabinNGAViewIdeapage().run("Types of Vote":/Promotes/.toString(),"User":/Sri/.toString(),"Number of Matches":/1/.toString())
        //Verify Votes tab in NGA View Idea page
        new actions.NGAViewIdea.VerifyVotestabinNGAViewIdeapage().run("Types of Vote":/Promotes/.toString(),"User":/System Admin/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
