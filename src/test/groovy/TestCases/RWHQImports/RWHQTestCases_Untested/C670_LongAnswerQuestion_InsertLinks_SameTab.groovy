...
//C670 - Long Answer Question - Insert Links - Same Tab
class C670_LongAnswerQuestion_InsertLinks_SameTab
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Test Idea Insert Links/.toString(),"Description":/Dscription/.toString(),"Category":/New Product/.toString(),"Long Answer Question":/ test/.toString())
        //Set Post Idea Link for Text Field
        new actions.SetIdeaFields.SetPostIdeaLinkforTextField().run("Field Name":/Long Answer Question/.toString(),"Link, Unlink or Edit":/Link/.toString(),"Text":/Display in the same tab/.toString(),"URL":/www.google.com/.toString(),"Open link in new tab":false,"Link Action":/Insert/.toString())
        //Set Custom and Other App Post Idea
        ...
        Action5812921cfa4ee77809f46b4f("Long AnswerQuestion":/Display in the same tab test/.toString())
        //Click on Element and Verify Element exists in other Tab
        new actions.general.ClickonElementandVerifyElementexistsinotherTab().run("XPATH of an element to click on":/\/\/A[contains(text(),'Display in the same tab')]/.toString(),"XPATH of element to verify":/\/\/textarea[@name='q']/.toString(),"Tab (optional)":/0/.toString())
    }
    //Basestate
