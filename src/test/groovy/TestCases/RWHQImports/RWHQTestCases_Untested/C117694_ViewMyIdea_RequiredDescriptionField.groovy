...
//C117694 - View My Idea - Required Description Field
class C117694_ViewMyIdea_RequiredDescriptionField
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.SetViewMyIdeaTextField().run("Field Name":/Description/.toString(),"Field Value":/<EMPTY>/.toString())
