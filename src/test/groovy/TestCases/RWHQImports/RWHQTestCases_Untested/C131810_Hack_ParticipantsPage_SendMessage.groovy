...
//C131810 - Hack > Participants Page - Send Message
class C131810_Hack_ParticipantsPage_SendMessage
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.HackSetParticipantsCardonParticipantsPage().run("Username":/End User/.toString(),"Actions":/Send message/.toString())
        //Set Message in Message Pop Up On Idea Boards
        new actions.general.SetMessageInMessagePopUpOnIdeaBoards().run("Subject":/C131810/.toString(),"Message Body":/This is a message from Sys Admin/.toString(),"Action":/Submit/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/bi.enduser1@brightidea.com/.toString(),"Password":/brightidea1/.toString())
        //Access Messages in Messages Global Navigation
        new actions.Messages.AccessMessagesinMessagesGlobalNavigation().run("Sender":/System Admin/.toString(),"Message":/This is a message from Sys Admin/.toString())
        //Set Actions on View Private Message
        new actions.Messages.SetActionsonViewPrivateMessage().run("Reply Message":/This is reply from End User/.toString())
    }
    //Basestate
