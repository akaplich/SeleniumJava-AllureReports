...
//C128678 - Save Evaluator Data - AIs after removing Assignee from Judging Step
class C128678_SaveEvaluatorData_AIsafterremovingAssigneefromJudgingStep
{
    ...
    public void testcase(){
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Configure Judging Step in Pipeline Steps page
        new actions.PipelineStepsConfigure.ConfigureJudgingStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Judging/.toString(),"Judges":/System Admin,Evaluator/.toString(),"Judges Add or Remove":/Add,Remove/.toString(),"Action":/Update/.toString())
