...
//C129804 - Voting Updates - Remove Voting
class C129804_VotingUpdates_RemoveVoting
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/test idea1/.toString(),"Linked Submissions":[],"Vote Count on Voting UI":/1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        ...
        new actions.ViewIdea.SetnewVotinginViewIdeaPage().run("Promote or Demote":/Demote/.toString())
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/test idea2/.toString(),"Linked Submissions":[],"Vote Count on Voting UI":/1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        ...
        new actions.ViewIdea.SetnewVotinginViewIdeaPage().run("Promote or Demote":/Promote/.toString())
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/quick add1/.toString(),"Linked Submissions":[],"Vote Count on Voting UI":/2/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/quick add1/.toString())
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/quick add1/.toString(),"Points":/2/.toString(),"Votes":/2/.toString(),"Linked Submissions":[],"Vote Count on Voting UI":/2/.toString())
    }
    //Basestate
