...
//C132030 - Project Room > Left Rail - Favorites - Different Users
class C132030_ProjectRoom_LeftRail_Favorites_DifferentUsers
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SendToProjectRoom().run("From the Actions Menu":false,"Existing or New":/Create Project Room/.toString(),"Title":/C132030/.toString(),"Action":/Submit/.toString())
        ...
        new actions.ProjectRoom.VerifyProjectRoomCard().run("Title":/C132030/.toString(),"Access Project Room":true)
        ...
        new actions.ProjectRoom.VerifyRoomPageInFavoritesTabInProjectRoom().run("Room Page":/test idea1/.toString(),"Number of Matches":/0/.toString())
        //Verify Room Page In Favorites Tab In Project Room
        ...
        //Set Edit Menu for Room Pages in Project Room
        new actions.ProjectRoom.SetEditMenuforRoomPagesinProjectRoom().run("Room Page":/Business Impact/.toString(),"Menu Options":/Add to My Favorites/.toString(),"Placement Number Of Folder or Page":/4/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.ProjectRoom.VerifyProjectRoomCard().run("Title":/C132030/.toString(),"Access Project Room":true)
        //Verify Room Page In Favorites Tab In Project Room
        new actions.ProjectRoom.VerifyRoomPageInFavoritesTabInProjectRoom().run("Room Page":/test idea1/.toString(),"Number of Matches":/1/.toString())
        //Verify Room Page In Favorites Tab In Project Room
        new actions.ProjectRoom.VerifyRoomPageInFavoritesTabInProjectRoom().run("Room Page":/Tasks/.toString(),"Number of Matches":/1/.toString())
        //Verify Room Page In Favorites Tab In Project Room
