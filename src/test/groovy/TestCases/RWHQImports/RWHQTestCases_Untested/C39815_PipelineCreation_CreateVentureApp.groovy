...
//C39815 - Pipeline Creation - Create Venture App
class C39815_PipelineCreation_CreateVentureApp
{
    ...
    public void testcase(){
        ...
        new actions.Webstorm.VerifyWebstormHome().run("Webstorm Title":/Venture title/.toString())
    }
    //Basestate
