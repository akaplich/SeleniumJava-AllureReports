...
//C65734 - Idea Boards 30 - Search - Email
class C65734_IdeaBoards30_Search_Email
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Search Value":/bi.enduser1@brightidea.com/.toString())
        ...
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/New Idea1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
