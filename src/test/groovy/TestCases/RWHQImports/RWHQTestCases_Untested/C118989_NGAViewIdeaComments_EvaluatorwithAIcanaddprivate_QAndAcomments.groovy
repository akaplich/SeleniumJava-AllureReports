...
class C118989_NGAViewIdeaComments_EvaluatorwithAIcanaddprivate_QAndAcomments
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.AddCommentinNGAViewIdeapage().run("Comment":/Private comment/.toString(),"Attachment Add or Remove":/Add/.toString(),"Comment Type":/Private/.toString())
        //Add Comment in NGA View Idea page
        new actions.NGAViewIdea.AddCommentinNGAViewIdeapage().run("Comment":/General comment/.toString(),"Attachment Add or Remove":/Add/.toString(),"Comment Type":/General Access/.toString())
        //Add Comment in NGA View Idea page
        new actions.NGAViewIdea.AddCommentinNGAViewIdeapage().run("Comment":/Submitter comment/.toString(),"Attachment Add or Remove":/Add/.toString(),"Comment Type":/Submitter Q&A/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.NGAViewIdea.VerifyCommentInNGAViewIdeaPage().run("Comment Section":/Comments/.toString(),"User":/Evaluator/.toString(),"Comment":/General comment/.toString(),"Comment Type":/Public/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment In NGA View Idea Page
        new actions.NGAViewIdea.VerifyCommentInNGAViewIdeaPage().run("Comment Section":/Comments/.toString(),"User":/Evaluator/.toString(),"Comment":/Private comment/.toString(),"Comment Type":/Private/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment In NGA View Idea Page
        new actions.NGAViewIdea.VerifyCommentInNGAViewIdeaPage().run("Comment Section":/Comments/.toString(),"User":/Evaluator/.toString(),"Comment":/Submitter comment/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
