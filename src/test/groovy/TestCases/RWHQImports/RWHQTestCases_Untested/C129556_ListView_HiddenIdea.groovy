...
//C129556 - List View - Hidden Idea
class C129556_ListView_HiddenIdea
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Hidden Idea1/.toString(),"Submitter":/Team/.toString(),"Submitter Team User":/Pipeline Sponsor/.toString(),"Submitter Team User Add or Remove":/Add/.toString(),"Description":/Hidden Idea1 desc/.toString(),"Category":/Operations/.toString(),"Required Short Question":/test/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/Hidden Idea1/.toString())
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/Hidden Idea1/.toString(),"Status":/Submitted/.toString(),"Description":/Hidden Idea1 desc/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/bi.enduser1@brightidea.com/.toString(),"Password":/brightidea1/.toString())
        ...
        new actions.IdeaBoard.NavigatetoIdeaBoardsView().run("View":/List/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/Hidden Idea1/.toString(),"Status":/Submitted/.toString(),"Description":/Hidden Idea1 desc/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
