...
//C131602 - Removed from Stage - Edit the Stage name
class C131602_RemovedfromStage_EdittheStagename
{
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Removed from Stage - Change Status/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Removed from Stage - Change Status/.toString())
        //Change Rule Status
        Action594d63e45cb815bc19ca15e6("Change Status":/Active/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Edit Stage in Pipeline Steps page
        new actions.PipelineStepsView.EditStageinPipelineStepspage().run("Stage to Edit":/Selection/.toString(),"Stage Name":/Selection xyz/.toString(),"Action":/Save/.toString())
        //Refresh
        ...
        new actions.Rules.VerifyRuleinRulesEnginetable().run("Order":/0/.toString(),"Rule Name":/Removed from Stage - Change Status/.toString(),"Event":/Removed from Stage Selection xyz/.toString(),"Last Run":/${variables."today"}/.toString(),"Status":/Active/.toString(),"Description":/Category Is Operations; Change Status to On Hold/.toString(),"Number of Matches":/1/.toString())
        //Access Existing Rule
        new actions.Rules.AccessExistingRule().run("Rule Name":/Removed from Stage - Change Status/.toString())
        //Verify Element Attribute
        new actions.selenium.VerifyAttribute().run("ID":/\/\/*[contains(@class,'fractal-combobox f-trigger-step-dropdown')]\/\/*[contains(@id,"f-event-trigger-dropdown")]/.toString(),"ID Type":/XPath/.toString(),"Value":/Selection xyz/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/Quick Idea for Rules Engine/.toString(),"Status":/On Hold/.toString(),"Linked Submissions":[])
    }
    //Basestate
