...
//C128561 - Search Hidden Idea Description on Initiative Global Navigation
class C128561_SearchHiddenIdeaDescriptiononInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabTextField().run("Field Name":/Description/.toString(),"Field Value":/automation purpose/.toString(),"Action":/Save/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Submissions/.toString(),"Title":/quick add1/.toString(),"Description":/automation purpose/.toString(),"Number of Matches":/1/.toString(),"Click on the result":true)
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/quick add1/.toString(),"Description":/automation purpose/.toString(),"Linked Submissions":[])
        //Log Out
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/automation purpose/.toString())
        //Verify On Global Search Result
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Submissions/.toString(),"Title":/quick add1/.toString(),"Description":/automation purpose/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
