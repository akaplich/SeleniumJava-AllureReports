...
//C129728 - New Copy Ideas - Sub Form - Append Extra Questions - ON
class C129728_NewCopyIdeas_SubForm_AppendExtraQuestions_ON
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.NewCopyIdeasinPipelineStepspage().run("Pipeline":/Pipeline B/.toString(),"Append Additional Info to description":/FALSE/.toString(),"Copy Comments":/FALSE/.toString(),"Copy Attachments":/FALSE/.toString(),"Copy Votes":/FALSE/.toString(),"Action":/Copy Idea/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/test idea3/.toString(),"Creator username":/System Admin/.toString(),"Category":/New Product/.toString(),"Status":/Submitted/.toString(),"Description":/desc Extra Questions Checkbox Question A Answer 1 Date Question A 01\/01\/2020/.toString(),"Linked Submissions":[])
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Pipeline B/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
