...
//C212 - Long Answer Question - Input Links Directly
class C212_LongAnswerQuestion_InputLinksDirectly
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Test Idea Input Links Directly/.toString(),"Description":/Description/.toString(),"Category":/New Product/.toString(),"Long Answer Question":/${variables."TCData.Input hyperlink"}/.toString(),"Required Short Question":/Required Short/.toString(),"Action":/Submit Idea/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Test Idea Input Links Directly/.toString())
        //Verify Custom App Description tab fields in View Idea page
        Action5812921cfa4ee77809f46b4f("Long AnswerQuestion":/${variables."TCData.Verify Hyperlink"}/.toString())
        //Click on Element and Verify Element exists in other Tab
        new actions.general.ClickonElementandVerifyElementexistsinotherTab().run("XPATH of an element to click on":/\/\/A[contains(text(),'google.com')]/.toString(),"XPATH of element to verify":/\/\/*[@name='q']/.toString(),"Tab (optional)":/1/.toString())
    }
    //Basestate
