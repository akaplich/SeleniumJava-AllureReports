...
//C132224 - Action Item Completed Rule - submission form question condition  - short question
class C132224_ActionItemCompletedRule_submissionformquestioncondition_shortquestion
{
    ...
    public void testcase(){
        ...
        new actions.Rules.SetNewRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Condition":/Required Short Question/.toString(),"Operator value":/Is/.toString(),"Condition value":/short/.toString())
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/rule for short question/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/rule for short question/.toString())
        //Change Rule Status
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/rules idea/.toString(),"Description":/desc/.toString(),"Category":/Operations/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
