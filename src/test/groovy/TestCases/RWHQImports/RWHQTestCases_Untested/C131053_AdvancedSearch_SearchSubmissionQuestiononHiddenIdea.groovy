...
//C131053 - Advanced Search - Search Submission Question on Hidden Idea
class C131053_AdvancedSearch_SearchSubmissionQuestiononHiddenIdea
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabTextField().run("Field Name":/Required Short Question/.toString(),"Field Value":/Automation/.toString(),"Action":/Save/.toString())
        //Navigate
        ...
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/quick add1/.toString(),"Type":/Submissions/.toString(),"Number of Matches":/1/.toString(),"Click on result":true)
        ...
        new actions.Search.QuickOrAdvanceSearchInGlobalNav().run("Tab (optional)":/Advanced Search/.toString(),"Search Input":/Automation/.toString())
        //Verify Quick or Advanced Search Result
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/quick add1/.toString(),"Type":/Submissions/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
