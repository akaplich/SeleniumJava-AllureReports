...
//C131565 - Scout AI - Import All Compaines
class C131565_ScoutAI_ImportAllCompaines
{
    ...
    public void testcase(){
        ...
        try{
            //Verify AI Toast Message
            new actions.PipelineStepsView.VerifyToastMessage().run("Toast Message":/Companies imported successfully!/.toString())
        }
       catch(all){println all}catch(Error err){println err}
        //Navigate WebStorm or MTS
        ...
        //Access or Close Idea from View Idea 3 Modal
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Access Idea":/${variables."title1"}/.toString())
        //Verify Idea on View Idea 30
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Scout Process Test/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Return the element from Company and Description Array for Scout App
        variables."title2" = new actions.Utils.ReturntheelementfromanArray().run("List":/${variables."titleList"}/.toString(),"Element Location Number":/2/.toString())
        //Return the element from Company and Description Array for Scout App
        variables."description2" = new actions.Utils.ReturntheelementfromanArray().run("List":/${variables."descriptionList"}/.toString(),"Element Location Number":/2/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/${variables."title2"}/.toString())
        //Access or Close Idea from View Idea 3 Modal
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Access Idea":/${variables."title2"}/.toString())
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Description":/${variables."description2"} Generated via Brightidea AI Assist./.toString())
    }
    //Basestate
