...
//C10737 - Initiative Details - Remove Report
class C10737_InitiativeDetails_RemoveReport
{
    ...
    public void testcase(){
        ...
        new actions.SetupEnterpriseExports.SetEnterpriseExportsforInitiativestab().run("Report Options":/Details/.toString(),"Format":/csv/.toString())
        ...
        new actions.SetupExports.VerifyGeneratedReportinSetupExports().run("Report Name Starts with":/Initiative_details/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
