...
//C129024 - Category Dependent - Switch Between Required and Non-required
class C129024_CategoryDependent_SwitchBetweenRequiredandNon_required
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Dependent Required Strategy/.toString(),"Additional Question Type":/Checkbox/.toString())
        //Set Webstorm Setup Ideas for Submission Form Tab
        ...
        new actions.SetupIdeas.EditAdditionalQuestionsinSubmissionFormtab().run("Question":/Dependent Required Strategy/.toString(),"Edit or Hide or Remove":/Edit/.toString(),"Set Dependent Answer":true,"Set Dependent Answer Dropdown":/Category: Strategy/.toString(),"Required":true)
        //Edit Additional Questions in Submission Form tab
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionCheckbox().run("Field Name":/Dependent Required Strategy/.toString(),"Action":/Save/.toString())
        //Verify Error Field in View Idea page
        new actions.ViewIdeaFields.VerifyErrorRequiredFieldViewIdeaPage().run("Field Name":/Dependent Required Strategy/.toString(),"Should Error Exist":true)
        //Set Category for View Idea page
        new actions.ViewIdea.SetCategoryForViewIdeaPage().run("Field Value":/Operations/.toString(),"Action":/Change Category/.toString())
        //Set View Idea Description Tab Text Field
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabTextField().run("Field Name":/Dependent Operations/.toString(),"Field Value":/test Dependent Operations/.toString(),"Action":/Save/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Dependent Required Strategy/.toString(),"Should Exist":false)
        //Verify View Idea Description Tab Field Value
        new actions.ViewIdeaFields.VerifyViewIdeaDescriptionTabFieldValue().run("Field Name":/Dependent Operations/.toString(),"Field Value":/test Dependent Operations/.toString())
    }
    //Basestate
