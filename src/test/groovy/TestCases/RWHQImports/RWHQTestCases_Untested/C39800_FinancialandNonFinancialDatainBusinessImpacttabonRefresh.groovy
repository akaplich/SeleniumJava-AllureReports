...
//C39800 - Financial and NonFinancial Data in Business Impact tab on Refresh
class C39800_FinancialandNonFinancialDatainBusinessImpacttabonRefresh
{
    ...
    public void testcase(){
        ...
        try{
            ...
            new actions.ViewIdea.VerifyVotestabinViewIdeapage().run([:])
        }
