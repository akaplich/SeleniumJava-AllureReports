...
//C128789 - Comment Component - Comment Edit menu for Public user
class C128789_CommentComponent_CommentEditmenuforPublicuser
{
    ...
    public void testcase(){
        ...
        try{
            ...
            new actions.ViewIdeaComment.SetCommentEditMenu().run("Comment to Edit":/test comment/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Copy Link/.toString(),"Should Exist":false)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Delete/.toString(),"Should Exist":false)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Hide/.toString(),"Should Exist":false)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Edit/.toString(),"Should Exist":false)
    }
    //Basestate
