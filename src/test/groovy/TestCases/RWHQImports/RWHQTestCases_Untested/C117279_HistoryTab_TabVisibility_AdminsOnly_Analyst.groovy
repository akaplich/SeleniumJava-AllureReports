...
//C117279 - History Tab - Tab Visibility - Admins Only - Analyst
class C117279_HistoryTab_TabVisibility_AdminsOnly_Analyst
{
    ...
    public void testcase(){
        ...
        try{
            //Verify History Tab on View Idea
            new actions.ViewIdea.VerifyHistoryTabonViewIdea().run("Event Record to Verify":/Idea submitted by Moderator/.toString(),"Number of Matches":/1/.toString(),"Placement Number":/1/.toString(),"Total Number of Records":/1/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Message
