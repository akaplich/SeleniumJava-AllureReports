...
//C131953 - WB - Send Ideas - Stack - Add Smart Matrix
class C131953_WB_SendIdeas_Stack_AddSmartMatrix
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SendIdeaToWhiteboardFromPipelineSteps().run("Existing Whiteboard or New Whiteboard":/New Whiteboard/.toString(),"Whiteboard Title":/C131953/.toString(),"Format":/Stack/.toString(),"Sort by":/Status/.toString(),"Add Smart Matrix":true,"Smart Matrix Name":/Matrix for C131953/.toString(),"X Axis Labels":/Value/.toString(),"Y Axis Labels":/Effort/.toString(),"Action":/Send/.toString())
        //Verify Toast Message in Pipeline Steps/List
        new actions.PipelineStepsView.VerifyToastMessageInPipelineStepsList().run("Message":/The selected ideas were sent successfully to the whiteboard: C131953/.toString(),"Click on the link":true)
        ...
        new actions.Whiteboards.MoveCursorWhiteboard().run("X coordinate1":/-200/.toString(),"Y coordinate1":/-200/.toString(),"X coordinate2":/0/.toString(),"Y coordinate2":/-250/.toString())
