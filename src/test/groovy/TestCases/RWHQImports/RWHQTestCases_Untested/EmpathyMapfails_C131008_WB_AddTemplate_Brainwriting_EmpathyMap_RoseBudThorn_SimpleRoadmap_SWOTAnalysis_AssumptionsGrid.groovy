...
class EmpathyMapfails_C131008_WB_AddTemplate_Brainwriting_EmpathyMap_RoseBudThorn_SimpleRoadmap_SWOTAnalysis_AssumptionsGrid
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SetAddTemplateWhiteboardPage().run("Template Title":/${variables."TCData.Template"}/.toString(),"Action":/Add Template/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Verify Element
        new actions.general.VerifyElement().run("ID":/${variables."TCData.Text"}/.toString(),"Should Element Exist":true,"Number of Matches":/1/.toString())
    }
    //Basestate
