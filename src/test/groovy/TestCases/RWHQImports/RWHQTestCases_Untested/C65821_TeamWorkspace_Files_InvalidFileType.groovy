...
//C65821 - Team Workspace - Files - Invalid File Type
class C65821_TeamWorkspace_Files_InvalidFileType
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.TeamWorkspace.SetFilesinTeamWorkspace().run("Verify in Which Tab (optional)":/Files/.toString(),"Attachment File":/example1.exe/.toString(),"Wait for attachment":false)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/File type not allowed./.toString(),"Should Exist":true)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Something isn't right here. Please try again. If this issue persists, please contact your administrator./.toString(),"Should Exist":false)
