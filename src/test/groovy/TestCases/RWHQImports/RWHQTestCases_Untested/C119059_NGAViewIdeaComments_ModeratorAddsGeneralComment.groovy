...
//C119059  - NGA View Idea Comments - Moderator Adds General Comment
class C119059_NGAViewIdeaComments_ModeratorAddsGeneralComment
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.VerifyCommentInNGAViewIdeaPage().run("Comment Section":/Comments/.toString(),"User":/Moderator/.toString(),"Comment":/General Comment/.toString(),"Comment Type":/Public/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment In NGA View Idea Page
        new actions.NGAViewIdea.VerifyCommentInNGAViewIdeaPage().run("Comment Section":/Comments/.toString(),"User":/Moderator/.toString(),"Comment":/General Comment/.toString(),"Comment Type":/Private/.toString(),"Number of Matches":/0/.toString())
        //Verify Comment In NGA View Idea Page
        new actions.NGAViewIdea.VerifyCommentInNGAViewIdeaPage().run("Comment Section":/Comments/.toString(),"User":/Moderator/.toString(),"Comment":/General Comment/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
