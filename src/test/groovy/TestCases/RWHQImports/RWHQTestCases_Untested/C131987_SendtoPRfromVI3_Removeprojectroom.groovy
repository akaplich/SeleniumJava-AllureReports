...
//C131987 - Send to PR from VI3 - Remove project room
class C131987_SendtoPRfromVI3_Removeprojectroom
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/End User/.toString(),"Idea Name":/Idea1/.toString(),"Category":/Theme 1/.toString())
        ...
        //Set and Verify Project Room In View Idea 3
        new actions.ViewIdea30.SetandVerifyProjectRoomInViewIdea3().run("Project Room Title":/Testing project room/.toString(),"Project Room Icon Color":/rgb(52, 152, 219)/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString(),"Remove Project Room":true,"Remove Project Room Action":/Cancel/.toString())
        //Set and Verify Project Room In View Idea 3
        new actions.ViewIdea30.SetandVerifyProjectRoomInViewIdea3().run("Project Room Title":/Testing project room/.toString(),"Project Room Icon Color":/rgb(52, 152, 219)/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString(),"Remove Project Room":true,"Remove Project Room Action":/Remove/.toString())
        //Set and Verify Project Room In View Idea 3
        ...
        new actions.ProjectRoom.VerifyProjectRoomCard().run("Title":/Testing project room/.toString(),"Total Objects":/9/.toString(),"Access Project Room":true)
        //Verify Folder Or Room Page In Project Room in Root Folder
