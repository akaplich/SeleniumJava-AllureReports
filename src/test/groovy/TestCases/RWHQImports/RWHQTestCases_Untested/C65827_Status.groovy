...
class C65827_Status
{
    ...
    public void testcase(){
        ...
        new actions.Widgets.SetWidgetController().run("Widget Edit Mode":/Enable/.toString(),"Add Widget from Selection":/Status/.toString())
        //Access Widget Status Link 
        new actions.Widgets.AccessWidgetStatusLink().run("Status":/Under Review/.toString())
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Home/.toString())
        //Access Widget Status Link 
        new actions.Widgets.AccessWidgetStatusLink().run("Status":/On Hold/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/quick add1/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Idea Board page
