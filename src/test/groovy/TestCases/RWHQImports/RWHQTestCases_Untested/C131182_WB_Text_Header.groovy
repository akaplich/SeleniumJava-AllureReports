...
//C131182 - WB - Text - Header
class C131182_WB_Text_Header
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/C131182/.toString())
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/Escape/.toString())
        //Verify Right Side Controls in Whiteboard 
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("L or W":/680/.toString(),"H":/80/.toString(),"Text Font":/Lato/.toString(),"Font Size":/64/.toString(),"Font Color":/444647/.toString())
    }
    //Basestate
