...
//C130566 - Merge Ideas - Merge Into Existing Parent
class C130566_MergeIdeas_MergeIntoExistingParent
{
    ...
    public void testcase(){
        ...
        //Select Multiple Ideas in Pipeline Steps
        new actions.PipelineStepsView.SelectMultipleIdeasinPipelineSteps().run("Idea Names":["parent test idea3","test idea2"])
        //Set Merge Ideas in Pipeline Steps & List
