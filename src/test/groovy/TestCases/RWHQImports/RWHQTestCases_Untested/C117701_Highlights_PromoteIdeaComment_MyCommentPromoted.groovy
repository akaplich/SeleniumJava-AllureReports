...
//C117701 - Highlights - Promote Idea Comment - My Comment Promoted
class C117701_Highlights_PromoteIdeaComment_MyCommentPromoted
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/test comment from End User/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.ViewIdeaComment.PromoteDemoteCommentinViewIdeapage().run("Comment":/test comment from End User/.toString(),"Promote or Demote":/Promote/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/bi.enduser1@brightidea.com/.toString(),"Password":/brightidea1/.toString())
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin promoted End User's comment on "test idea3"/.toString(),"Highlights Item Content":/test comment from End User/.toString(),"Number of Matches":/1/.toString(),"Total Number of Items":/2/.toString())
    }
    //Basestate
