...
//C130885 - Remove User From Shared
class C130885_RemoveUserFromShared
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.OpenExistingWhiteboardOnWhiteboardsPage().run("Tab":/My Whiteboards/.toString(),"Name of Whiteboard":/Shared Canvas/.toString())
        //Whiteboard - Set Share
