...
//C131306 - Request Review - Delete round
class C131306_RequestReview_Deleteround
{
    ...
    public void testcase(){
        ...
        //Set Request Review Modal
        new actions.Memo.SetRequestReviewModal().run("Round Configuration":true,"Action":/Delete Round/.toString(),"Delete Action":/Delete/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Memo Review Round deleted successfully./.toString(),"Should Exist":true)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/No Results/.toString(),"Should Exist":true)
        //Verify Review Results
        new actions.Memo.VerifyReviewResults().run("Round Name":/Round1/.toString(),"Score":/6.3/.toString(),"Score Color":/orange/.toString(),"Progress Bar width completed":/50/.toString(),"Complete":/1 of 2 Complete/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
