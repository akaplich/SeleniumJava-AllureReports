...
//C132420 - Gate Export - Action Items and Gate Approval Response Detail (Flag) 
class C132420_GateExport_ActionItemsandGateApprovalResponseDetail(Flag)
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC132420/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/brightC132420@mailinator.com/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Accelerate title/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Export Step in Pipeline Steps page
        new actions.PipelineStepsView.ExportStepinPipelineStepsPage().run("Step to Export":/gate for testing/.toString(),"Action Items":true,"Submissions":false,"Action":/Export/.toString())
        //Get Download Link from Email
        variables."link" = new actions.Mailinator.GetDownloadLinkfromEmail().run("Email Address":/brightC132420/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Accelerate_title-gate_for_testing_Action_Items*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Code","Title","Pipeline","Step Name","Tool Type","Evaluator","Evaluator Email","Assigner","Assigner Email","Date Assigned","Due Date","Status","Status Updated Date"],"Number of Matches":/1/.toString(),"Total Number of Rows":/7/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Accelerate_title-gate_for_testing_Action_Items*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["idea2","Completed"],"Number of Matches":/1/.toString(),"Total Number of Rows":/7/.toString())
        //Export Step in Pipeline Steps page
        new actions.PipelineStepsView.ExportStepinPipelineStepsPage().run("Step to Export":/gate for testing/.toString(),"Action Items":false,"Submissions":false,"User Score Detail":false,"Response Detail (Count)":false,"Response Detail (Percentage)":false,"Response Detail (Text)":false,"Response Detail (Flag)":true,"Action":/Export/.toString())
        //Get Download Link from Email
        variables."link" = new actions.Mailinator.GetDownloadLinkfromEmail().run("Email Address":/brightC132420/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        ...
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Gate_Approval_details_flag*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Code","Title","Submitter Email","Category","Scorecard Template","Scorecard Score","Scorecard Question","Scorecard Answer","Evaluator","End User","Pipeline Admin"],"Number of Matches":/1/.toString(),"Total Number of Rows":/81/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Gate_Approval_details_flag*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["idea2","The risks are well-defined and surmountable.","Agree","1"],"Number of Matches":/1/.toString(),"Total Number of Rows":/81/.toString())
    }
    //Basestate
