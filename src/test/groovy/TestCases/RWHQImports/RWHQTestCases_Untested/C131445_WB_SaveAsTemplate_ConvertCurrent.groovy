...
//C131445 - WB - Save As Template - Convert Current
class C131445_WB_SaveAsTemplate_ConvertCurrent
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131444/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.WhiteboardSetSaveAsTemplate().run("Template Name":/test template C131444/.toString(),"Save a copy of the whiteboard as a template":false,"Action":/Save Template/.toString())
        //Wait
