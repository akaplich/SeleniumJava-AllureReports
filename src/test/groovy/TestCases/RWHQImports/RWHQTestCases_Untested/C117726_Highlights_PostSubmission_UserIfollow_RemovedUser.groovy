...
//C117726 - Highlights - Post Submission - User I follow, Removed User
class C117726_Highlights_PostSubmission_UserIfollow_RemovedUser
{
    ...
    public void testcase(){
        ...
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/End User submitted "End User Idea1"/.toString(),"Highlights Item Content":/Custom App/.toString(),"Number of Matches":/0/.toString(),"Total Number of Items":/0/.toString())
    }
    //Basestate
