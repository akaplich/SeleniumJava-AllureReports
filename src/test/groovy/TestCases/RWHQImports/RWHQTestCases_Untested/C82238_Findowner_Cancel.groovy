...
//C82238 - Find owner - Cancel
class C82238_Findowner_Cancel
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.SetFindOwnerforanIdeainActionItemspage().run("Do you own the decision to implement this idea":/Yes/.toString(),"Do you plan to implement this idea":/Yes - I am considering implementing this idea./.toString(),"Action":/Cancel/.toString())
        ...
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/Find Owner Idea1/.toString(),"Step Name idea belongs to":/Implementation/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
