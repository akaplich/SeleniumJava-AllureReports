...
//C128571 - Business Impact Updates - Innovation List Export Updates
class C128571_BusinessImpactUpdates_InnovationListExportUpdates
{
    ...
    public void testcase(){
        ...
        new actions.People.AddUserinPeoplepage().run("Email Address":/brightc128571@mailinator.com/.toString(),"First Name":/Autouserfirst/.toString(),"Last Name":/Autouserlast/.toString(),"Screen Name":/Autouserscreen/.toString(),"Administrator":true,"Action":/Add User/.toString())
        //Get Registration Link from Email
        variables."link" = new actions.Mailinator.GetRegistrationLinkfromEmail().run("Email Address":/brightC128571/.toString())
        //Navigate to URL
        ...
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/brightc128571@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        //Navigate
        ...
        variables."link" = new actions.Mailinator.GetDownloadLinkfromEmail().run("Email Address":/brightc128571/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Innovations-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["test idea1","test idea1 desc","D102","Custom App","Collection","Review","New Product","Under Review","Idea"],"Number of Matches":/1/.toString(),"Total Number of Rows":/7/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Innovations-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["112325","-144","153081","-130","1"],"Number of Matches":/1/.toString(),"Total Number of Rows":/7/.toString())
    }
    //Basestate
