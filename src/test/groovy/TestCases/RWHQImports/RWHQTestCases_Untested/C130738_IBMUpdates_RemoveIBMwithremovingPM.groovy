...
//C130738 - IBM Updates - Remove IBM with removing PM
class C130738_IBMUpdates_RemoveIBMwithremovingPM
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.SetRolesinPipelineSetupPage().run("Type of Licensing Model":/Standard Licensing Model/.toString(),"Navigate to Tab":true,"Idea Box Managers":/Pipeline Admin/.toString(),"Idea Box Managers Add or Remove":/Remove/.toString(),"Click Save":true)
