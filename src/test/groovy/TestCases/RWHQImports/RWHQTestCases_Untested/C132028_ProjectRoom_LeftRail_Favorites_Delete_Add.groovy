...
//C132028 - Project Room > Left Rail - Favorites - Delete, Add
class C132028_ProjectRoom_LeftRail_Favorites_Delete_Add
{
    ...
    public void testcase(){
        ...
        new actions.general.Wait().run("Seconds":/10/.toString())
        //Set Edit Menu for Room Pages in Project Room
        new actions.ProjectRoom.SetEditMenuforRoomPagesinProjectRoom().run("Room Page":/Files/.toString(),"Menu Options":/Add to My Favorites/.toString(),"Placement Number Of Folder or Page":/3/.toString())
        //Set Room Page in the Project Room
        new actions.ProjectRoom.SetRoomPageintheProjectRoom().run("Type of Room Page":/Tasks/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/10/.toString())
        //Set Edit Menu for Room Pages in Project Room
        new actions.ProjectRoom.SetEditMenuforRoomPagesinProjectRoom().run("Room Page":/Tasks/.toString(),"Menu Options":/Add to My Favorites/.toString(),"Placement Number Of Folder or Page":/4/.toString())
        ...
        //Verify Room Page In Favorites Tab In Project Room
        new actions.ProjectRoom.VerifyRoomPageInFavoritesTabInProjectRoom().run("Placement Number of Page":/2/.toString(),"Room Page":/Files/.toString(),"Number of Matches":/1/.toString())
        //Verify Room Page In Favorites Tab In Project Room
        ...
        //Set Edit Menu for Room Pages in Project Room
        new actions.ProjectRoom.SetEditMenuforRoomPagesinProjectRoom().run("Room Page":/Business Impact/.toString(),"Menu Options":/Remove from My Favorites/.toString(),"Placement Number Of Folder or Page":/3/.toString())
        //Set Edit Menu for Room Pages in Project Room
        new actions.ProjectRoom.SetEditMenuforRoomPagesinProjectRoom().run("Room Page":/Files/.toString(),"Menu Options":/Remove from My Favorites/.toString(),"Placement Number Of Folder or Page":/2/.toString())
        //Wait
        ...
        //Verify Room Page In Favorites Tab In Project Room
        new actions.ProjectRoom.VerifyRoomPageInFavoritesTabInProjectRoom().run("Placement Number of Page":/1/.toString(),"Room Page":/Files/.toString(),"Number of Matches":/0/.toString())
        //Verify Room Page In Favorites Tab In Project Room
        new actions.ProjectRoom.VerifyRoomPageInFavoritesTabInProjectRoom().run("Placement Number of Page":/1/.toString(),"Room Page":/Tasks/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
