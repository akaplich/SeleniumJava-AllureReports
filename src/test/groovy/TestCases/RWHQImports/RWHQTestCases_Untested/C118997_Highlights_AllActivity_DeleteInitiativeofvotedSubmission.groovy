...
//C118997 - Highlights - All Activity - Delete Initiative of voted Submission
class C118997_Highlights_AllActivity_DeleteInitiativeofvotedSubmission
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/NonBI System Admin has demoted "test idea1" by Sri/.toString(),"Number of Matches":/0/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin has promoted "test idea1" by Sri/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
