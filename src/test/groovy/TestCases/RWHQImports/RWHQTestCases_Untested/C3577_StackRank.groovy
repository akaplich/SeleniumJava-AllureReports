...
class C3577_StackRank
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.SetStackRankforIdeainActionItemspage().run("Idea":/stackrank idea2/.toString(),"New Order":/1/.toString(),"Action":/Complete/.toString())
        //Navigate
        ...
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Open Tab Value":/3/.toString(),"Title":/Stack Rank/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
