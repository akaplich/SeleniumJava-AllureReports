...
//C131542 - View Idea 3.0 - Invalid and Max image upload
class C131542_ViewIdea30_InvalidandMaximageupload
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.SetUploadyourOwnBackground().run("Choose File":/SampleExcel.xlsx/.toString())
        //Verify Message
