...
//C117753 - Highlights - Submission I Follow Gets Voted On
class C117753_Highlights_SubmissionIFollowGetsVotedOn
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/End User has promoted "test idea1" by Sri/.toString(),"Highlights Item Content":/Custom App/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
