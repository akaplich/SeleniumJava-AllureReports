...
//C129322 - Hide Private Comments - view comments as PA evaluator with option disabled on View Idea with new commenting
class C129322_HidePrivateComments_viewcommentsasPAevaluatorwithoptiondisabledonViewIdeawithnewcommenting
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureDevelopmentinNewModalinPipelineStepspage().run("Assignment Method":/Category Assignment/.toString(),"Development Lead Category":/New Product,Operations,Marketing & Branding,Strategy,Quick Add\/New Categories/.toString(),"Development Lead":/Select a user,Select a user,Select a user,Select a user,Select a user/.toString(),"Selected user":/Pipeline Admin,Pipeline Admin,Pipeline Admin,Pipeline Admin,Pipeline Admin/.toString(),"Selected Users Add or Remove":/Add,Add,Add,Add,Add/.toString(),"Development Field":/Development Multiple Choice Question/.toString(),"Development Field Included or Required":/Included/.toString(),"Allow action item assignees to view Private Comments":false,"Action":/Activate/.toString())
