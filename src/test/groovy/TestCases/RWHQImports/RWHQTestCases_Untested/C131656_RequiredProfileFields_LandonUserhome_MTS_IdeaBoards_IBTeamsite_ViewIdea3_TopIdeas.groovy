...
class C131656_RequiredProfileFields_LandonUserhome_MTS_IdeaBoards_IBTeamsite_ViewIdea3_TopIdeas
{
    ...
    public void testcase(){
        ...
        new actions.SetupUsers.SetEnterpriseSetupProfileFieldspage().run("Select Profile Field Type":/Custom/.toString(),"Section or Field to Edit/Remove":/Custom/.toString(),"Edit or Remove":/Edit/.toString(),"New Field Title":/Required Custom Field/.toString(),"Profile Field Type":/Custom/.toString(),"Required":true,"Action":/Save/.toString())
        //Set Enterprise Setup Profile Fields page
        new actions.SetupUsers.SetEnterpriseSetupProfileFieldspage().run("Section or Field to Edit/Remove":/First Name/.toString(),"Edit or Remove":/Edit/.toString(),"Required":true,"Action":/Save/.toString(),"Click Save":true)
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."affiliateURL"}\/userhome/.toString())
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("First Name":/Harry/.toString(),"Custom Field":/testing1/.toString())
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("First Name":/Ron/.toString(),"Custom Field":/testing2/.toString())
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("First Name":/Neville/.toString(),"Custom Field":/testing3/.toString())
        //Verify and Set MTS tab on homepage
        new actions.MTS.SetMTStabonhomepage().run("Should Tab Exist":true,"Heading":/EXPLORE/.toString(),"Tabs":/Backlog/.toString(),"Placement Number of Tab":/2/.toString(),"Should User Click on Tab":true)
        //Verify Idea in Top Ideas
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("First Name":/Seamus/.toString(),"Custom Field":/testing4/.toString())
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("First Name":/Dean/.toString(),"Custom Field":/testing5/.toString())
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("First Name":/Cedric/.toString(),"Custom Field":/testing6/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Idea1/.toString(),"Stack Name Memo belongs to":/Quick Add/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
