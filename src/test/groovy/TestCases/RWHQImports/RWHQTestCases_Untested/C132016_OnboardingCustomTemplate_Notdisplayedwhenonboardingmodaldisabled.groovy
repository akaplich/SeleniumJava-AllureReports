...
//C132016 - Onboarding Custom Template - Not displayed when onboarding modal disabled
class C132016_OnboardingCustomTemplate_Notdisplayedwhenonboardingmodaldisabled
{
    ...
    public void testcase(){
        ...
        new actions.SetupSite.SetWebstormSetupSiteGeneralSettingsPage().run("Onboarding for Hackathon":false)
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Onboarding Template/.toString(),"Should Exist":false)
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Apps/.toString())
        //Apply Filter on Apps Pillar 2.0
        ...
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Accelerate/.toString(),"Area to Navigate to":/Pipeline Setup/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Onboarding Template/.toString(),"Should Exist":false)
    }
    //Basestate
