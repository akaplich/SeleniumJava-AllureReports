...
//C132205 - Rules modal error handling - Delete Category
class C132205_Rulesmodalerrorhandling_DeleteCategory
{
    ...
    public void testcase(){
        ...
        new actions.WebstormCreation.CreateCustomWebstorm().run("Webstorm Title":/Pipeline test/.toString(),"Description":/desc/.toString(),"Action":/Create/.toString())
        ...
        new actions.Rules.ConfigureNewRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Pipeline test/.toString(),"Category":/Strategy/.toString(),"Status":/Submitted/.toString(),"Action":/Save/.toString())
        //Set Rule window
        ...
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Pipeline test/.toString(),"Area to Navigate to":/Setup/.toString())
