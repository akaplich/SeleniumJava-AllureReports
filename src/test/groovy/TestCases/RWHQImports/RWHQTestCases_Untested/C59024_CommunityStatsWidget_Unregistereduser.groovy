...
//C59024 - Community Stats Widget - Unregistered user
class C59024_CommunityStatsWidget_Unregistereduser
{
    ...
    public void testcase(){
        ...
        new actions.Widgets.VerifyWidgetCommunityStats().run("submissions":/2/.toString(),"comment":/1/.toString(),"votes":/2/.toString(),"users":/1/.toString())
    }
    //Basestate
