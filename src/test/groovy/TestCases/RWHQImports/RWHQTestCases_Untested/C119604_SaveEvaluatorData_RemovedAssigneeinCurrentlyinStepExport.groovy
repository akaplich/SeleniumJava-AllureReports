...
//C119604 - Save Evaluator Data - Removed Assignee in Currently in Step Export
class C119604_SaveEvaluatorData_RemovedAssigneeinCurrentlyinStepExport
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC119604_8/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        ...
        new actions.selenium.Browser().run("URL":/${variables."affiliateURL"}/.toString(),"Browser Type":/Chrome/.toString())
        //Login
        new actions.general.Login().run("Email":/brightC119604_8@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Configure Scorecard Step in Pipeline Steps page
        ...
        //Set Export in Actions Dropdown In Currently and History in Step
        new actions.PipelineManageSteps.SetExportinActionsDropdownInCurrentlyinStep().run("Scorecard User Score Detail":/TRUE/.toString(),"Action":/Export/.toString())
        //Get Download Link from Email
        variables."link" = new actions.Mailinator.GetDownloadLinkfromEmail().run("Email Address":/brightC119604_8/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Scorecard_user_detail*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Code","Title","Scorecard Template","Scorecard Score","Evaluator (Removed)","End User","System Admin"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Scorecard_user_detail*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["D114","Quick add Idea2","General Evaluation Scorecard","65.22"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
