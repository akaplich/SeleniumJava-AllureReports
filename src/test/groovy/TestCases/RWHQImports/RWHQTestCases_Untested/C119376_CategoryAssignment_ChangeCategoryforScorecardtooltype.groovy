...
//C119376 - Category Assignment - Change Category for Scorecard tooltype
class C119376_CategoryAssignment_ChangeCategoryforScorecardtooltype
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureScorecardStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Scorecarding/.toString(),"Assignment Method":/Category Assignment/.toString(),"Category":/New Product,Operations,Marketing & Branding,Strategy,Quick Add\/New Categories/.toString(),"Category Assignment User":/End User,System Admin,End User,System Admin,End User/.toString(),"Category Assignment User Add or Remove":/Add,Add,Add,Add,Add/.toString(),"Action":/Update/.toString())
        ...
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Completed Tab Value":/1/.toString(),"Title":/new idea/.toString(),"Score":/69.57/.toString(),"Number of Matches":/1/.toString())
