...
//C93376 - Duplicate Initiative - Duplicate Rules
class C93376_DuplicateInitiative_DuplicateRules
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/rules engine test title/.toString(),"Description":/Description/.toString(),"Category":/New Product/.toString(),"Required Short Question":/short question/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Copy Custom App Pipeline/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/rules engine test title/.toString(),"Step Name idea belongs to":/Single Scale/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
