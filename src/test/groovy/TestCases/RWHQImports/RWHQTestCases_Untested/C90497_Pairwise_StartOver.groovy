...
//C90497 - Pairwise - Start Over
class C90497_Pairwise_StartOver
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigurePairwiseinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Pairwise/.toString(),"Evaluators":/System Admin/.toString(),"Evaluators Add or Remove":/Add/.toString(),"Automatic Ratings":true,"Action":/Update/.toString())
        ...
        new actions.ActionItems.SetPairwiseforIdeainActionItemspage().run("Select Idea Name or Neither":/pairwise idea2/.toString())
        //Set Pairwise for Idea in Action Items page
        new actions.ActionItems.SetPairwiseforIdeainActionItemspage().run("Select Idea Name or Neither":/Neither/.toString(),"Action":/Start Over/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Action Items/.toString())
        //Verify Completed table for Action Items page
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Title":/Pairwise/.toString(),"Number of Matches":/0/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Title":/Pairwise/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/bi.adminuser1@brightidea.com/.toString(),"Password":/brightidea1/.toString())
        //Access Action Item in Actions Items Global Navigation
        new actions.ActionItems.AccessActionIteminActionsItemsGlobalNavigation().run("Action Item":/Pairwise/.toString())
        //Set Pairwise for Idea in Action Items page
        new actions.ActionItems.SetPairwiseforIdeainActionItemspage().run("Select Idea Name or Neither":/pairwise idea1/.toString())
        //Set Pairwise for Idea in Action Items page
        new actions.ActionItems.SetPairwiseforIdeainActionItemspage().run("Select Idea Name or Neither":/Neither/.toString(),"Action":/Complete/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Action Items/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/My Action Items/.toString(),"Title":/Pairwise/.toString(),"Number of Matches":/0/.toString())
        //Verify Completed table for Action Items page
        ...
        new actions.ActionItems.VerifySelectedIdeaforthePairwise().run("Pairing":/Pairing 1,Pairing 2,Pairing 3/.toString(),"Selected Idea":/pairwise idea1,Neither,pairwise idea1/.toString())
    }
    //Basestate
