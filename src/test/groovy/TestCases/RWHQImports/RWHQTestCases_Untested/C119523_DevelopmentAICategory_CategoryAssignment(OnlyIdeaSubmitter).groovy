...
//C119523 - Development AI Category - Category Assignment (Only Idea Submitter)
class C119523_DevelopmentAICategory_CategoryAssignment(OnlyIdeaSubmitter)
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Development idea1/.toString(),"Description":/desc/.toString(),"Category":/Operations/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Completed Tab Value":/1/.toString(),"Title":/Development idea1/.toString(),"Number of Matches":/1/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Open Tab Value":/0/.toString(),"Title":/Development idea1/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
