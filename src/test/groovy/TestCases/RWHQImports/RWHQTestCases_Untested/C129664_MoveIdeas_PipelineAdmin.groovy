...
//C129664 - Move Ideas - Pipeline Admin
class C129664_MoveIdeas_PipelineAdmin
{
    ...
    public void testcase(){
        ...
        new actions.SetupUsers.SetWebstormSetupUsersAdministratorspage().run("WebStorm Administrators":/Pipeline Admin/.toString(),"WebStorm Administrators Add or Remove":/Remove/.toString())
        //Navigate WebStorm or MTS
        ...
        //Set Webstorm Setup Users Administrators page
        new actions.SetupUsers.SetWebstormSetupUsersAdministratorspage().run("WebStorm Administrators":/Pipeline Admin/.toString(),"WebStorm Administrators Add or Remove":/Add/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/pipelineadmin@test.com/.toString(),"Password":/brightidea1/.toString())
