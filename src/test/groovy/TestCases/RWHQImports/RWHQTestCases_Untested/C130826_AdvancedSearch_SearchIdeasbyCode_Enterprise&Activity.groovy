...
//C130826 - Advanced Search - Search Ideas by Code, Enterprise & Activity
class C130826_AdvancedSearch_SearchIdeasbyCode_EnterpriseAndActivity
{
    ...
    public void testcase(){
        ...
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/test idea1/.toString(),"Type":/Submissions/.toString(),"Number of Total (for Advanced Search)":/1 of 1/.toString(),"Description (for Advanced Search)":/test idea1 desc/.toString(),"Number of Matches":/1/.toString(),"Click on result":true)
        ...
        //Quick or Advance Search in Global Nav
        new actions.Search.QuickOrAdvanceSearchInGlobalNav().run("Tab (optional)":/Advanced Search/.toString(),"Search Input":/D105/.toString())
        //Verify Quick or Advanced Search Result
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/quick add1/.toString(),"Type":/Submissions/.toString(),"Number of Total (for Advanced Search)":/1 of 1/.toString(),"Description (for Advanced Search)":/(posted via Quick Add)/.toString(),"Number of Matches":/1/.toString())
        //Navigate
