...
//C131069 - WB - Search with Shared Collaborator name
class C131069_WB_SearchwithSharedCollaboratorname
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SetSearchWhiteboardOnUserhomepage().run("Search Field":/analyst/.toString())
        ...
        //Set Search whiteboard on Userhomepage
        new actions.Whiteboards.SetSearchWhiteboardOnUserhomepage().run("Search Field":/John Doe/.toString(),"Clear Field":true)
        //Verify Whiteboard Card in Userhomepage
        new actions.Whiteboards.VerifyWhiteboard().run("Whiteboard Name":/Random/.toString(),"Last Edited Displayed":true,"Number of Matches":/0/.toString())
        //Set Search whiteboard on Userhomepage
        new actions.Whiteboards.SetSearchWhiteboardOnUserhomepage().run("Clear Field":true)
        //Verify Whiteboard Card in Userhomepage
        new actions.Whiteboards.VerifyWhiteboard().run("Whiteboard Name":/Random/.toString(),"Last Edited Displayed":true,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        //Set Search whiteboard on Userhomepage
        new actions.Whiteboards.SetSearchWhiteboardOnUserhomepage().run("Search Field":/John/.toString())
        //Verify Whiteboard Card in Userhomepage
        new actions.Whiteboards.VerifyWhiteboard().run("Whiteboard Name":/Random/.toString(),"Last Edited Displayed":true,"Number of Matches":/0/.toString())
    }
    //Basestate
