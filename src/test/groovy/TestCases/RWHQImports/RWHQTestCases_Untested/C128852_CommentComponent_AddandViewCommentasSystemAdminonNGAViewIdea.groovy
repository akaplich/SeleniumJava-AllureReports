...
class C128852_CommentComponent_AddandViewCommentasSystemAdminonNGAViewIdea
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Number of add Comment Panel Expanded":/0/.toString(),"Comment section":/Parent Comment/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/test general comment/.toString(),"User":/System Admin/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment in View and NGA View Idea
        ...
        //Add Comment in View and NGA View Idea
        new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("Comment":/test private comment/.toString(),"Post Comment":true)
        //Reply to Comment in View and NGA View Idea
