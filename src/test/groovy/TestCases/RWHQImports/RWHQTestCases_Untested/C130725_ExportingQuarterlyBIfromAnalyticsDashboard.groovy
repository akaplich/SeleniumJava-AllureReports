...
//C130725 - Exporting Quarterly BI from Analytics Dashboard
class C130725_ExportingQuarterlyBIfromAnalyticsDashboard
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC130725/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/brightC130725@mailinator.com/.toString())
        //Navigate
        ...
        variables."link" = new actions.Mailinator.GetDownloadLinkfromEmail().run("Email Address":/brightC130725/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/3/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/auto*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Initiative Name","Link to Initiative","App Type","Initiative Status","Total Submissions with Business Impact","Total Submissions","First Impact Recorded","Last Impact Recorded","Total Projected Benefit ($)","Total Projected Cost ($)","Total Actual Benefit ($)","Total Actual Cost ($)","Total Target Benefit ($)","Total Non-financial Benefit"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/3/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/auto*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["1","2021","2022","49000","39000","48000","41644"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/3/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/auto*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["3","2021","6000","100","7000","14000"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
