...
//C128184 - Team Workspace - Member to Add BI without Option
class C128184_TeamWorkspace_MembertoAddBIwithoutOption
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.TeamWorkspace.AccessTeamWorkspace().run([:])
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Add Impact/.toString(),"Should Exist":false)
    }
    //Basestate
