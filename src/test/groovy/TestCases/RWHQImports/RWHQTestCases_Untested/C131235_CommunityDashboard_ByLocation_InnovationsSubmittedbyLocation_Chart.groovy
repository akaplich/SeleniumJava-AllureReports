...
//C131235 - Community Dashboard - By Location - Innovations Submitted by Location - Chart
class C131235_CommunityDashboard_ByLocation_InnovationsSubmittedbyLocation_Chart
{
    ...
    public void testcase(){
        ...
        new actions.NGAAnalyticsDashboard.NavigateToAnalyticsDashboardandTab().run("Tab":/By Location/.toString())
        //Verify MouseHover on Chart in Innovation Dashboard Tab
        new actions.PipelineDashBoard.VerifyMouseHoverChartViewInnovationTab().run("What Chart?":/Innovations Submitted by Location/.toString(),"Chart View":/Month to Date/.toString(),"What column to hover over?":/today/.toString(),"Legend to Verify":/United StatesNo Location/.toString(),"Tooltip Text":/today United States No Location 1 (33%) 2 (67%)/.toString())
        //Navigate Community Admin Bar Dropdown
        new actions.general.NavigateCommunityAdminBar().run("Area to Navigate to":/Dashboard/.toString())
        //Refresh
        ...
        new actions.NGAAnalyticsDashboard.NavigateToAnalyticsDashboardandTab().run("Dashboard":/Innovations Dashboard/.toString(),"Tab":/By Location/.toString())
        //Verify MouseHover on Chart in Innovation Dashboard Tab
        new actions.PipelineDashBoard.VerifyMouseHoverChartViewInnovationTab().run("What Chart?":/Innovations Submitted by Location/.toString(),"Chart View":/Month to Date/.toString(),"What column to hover over?":/today/.toString(),"Legend to Verify":/United States/.toString(),"Tooltip Text":/today United States 2 (100%)/.toString())
    }
    //Basestate
