...
//C10777 - Sort Score Column
class C10777_SortScoreColumn
{
    ...
    public void testcase(){
        ...
        //Set General Evaluation Scorecard for Idea in Action Items page
        new actions.ActionItems.SetGeneralEvaluationScorecardforIdeainActionItemspage().run("What is the strategic impact":/High/.toString(),"What is the likely timeframe to implement":/1-3 months/.toString(),"What is the estimated level of enterprise":/High/.toString(),"What resource level would need to be dedicated":/less than 1/.toString(),"What is the revenue potential of the idea":/$1M to $5M/.toString())
        //Navigate
        ...
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Verify in Which List (optional)":/My Action Items/.toString(),"Completed Tab Value":/2/.toString(),"Title":/scorecard idea1/.toString(),"Number of Matches":/1/.toString())
        //Access Action Item in My Action Items/Action Items Manager table
        new actions.ActionItems.AccessActionIteminMyActionItemsActionItemsManagertable().run("Access in Which List":/My Action Items/.toString(),"Title":/scorecard idea1/.toString())
        //Sort My Action Items/Action Items Manager table
        new actions.ActionItems.SortMyActionItemsActionItemsManagertable().run("Sort Which List":/My Action Items/.toString(),"Column Name":/Score/.toString(),"Sort":/ascending/.toString())
        //Verify Completed table for Action Items page
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Title":/scorecard idea2/.toString(),"Score":/82.61/.toString(),"Row number":/2/.toString())
        //Verify Completed table for Action Items page
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Title":/scorecard idea1/.toString(),"Score":/69.57/.toString(),"Row number":/1/.toString())
        //Sort My Action Items/Action Items Manager table
        new actions.ActionItems.SortMyActionItemsActionItemsManagertable().run("Column Name":/Score/.toString(),"Sort":/descending/.toString())
        //Verify Completed table for Action Items page
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Title":/scorecard idea2/.toString(),"Score":/82.61/.toString(),"Row number":/1/.toString())
        //Verify Completed table for Action Items page
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Title":/scorecard idea1/.toString(),"Score":/69.57/.toString(),"Row number":/2/.toString())
    }
    //Basestate
