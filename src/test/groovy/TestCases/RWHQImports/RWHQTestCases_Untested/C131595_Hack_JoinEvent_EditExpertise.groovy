...
//C131595 - Hack > Join Event - Edit Expertise
class C131595_Hack_JoinEvent_EditExpertise
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.SetJoinEventHackApp().run("Expertise":/DevOps,Cybersecurity/.toString(),"Add or Remove Expertise":/Add,Add/.toString(),"Action on Register and add expertise Screen":/Confirm/.toString())
        ...
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/System Admin/.toString(),"Participant is the current user":true,"Expertise":/Cybersecurity,DevOps/.toString(),"Number of Matches":/1/.toString())
        //Navigate Webstorm via Admin Dropdown Only
        ...
        //Set Join/Leave Event Modal - Hack App
        new actions.WebstormHomepage.SetJoinEventHackApp().run("Expertise":/DevOps,Cybersecurity,Cloud Computing,Database Management/.toString(),"Add or Remove Expertise":/Remove,Remove,Add,Add/.toString(),"Action on Update or Leave Event":/Update/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Participants Page/.toString())
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/System Admin/.toString(),"Participant is the current user":true,"Expertise":/Cloud Computing,Database Management/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
