...
//C131718 - Delete Project Room
class C131718_DeleteProjectRoom
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.SetRoomSettingsInProjectRoom().run("Action":/Delete Room/.toString(),"Delete Project Room Action":/Cancel/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Room deleted successfully./.toString(),"Should Exist":false)
        //Set Room Settings In Project Room
        ...
        new actions.ProjectRoom.VerifyProjectRoomCard().run("Title":/Testing project room1/.toString(),"Number of Matches":/0/.toString())
        //Verify and Access Project Room Card in Userhome
        new actions.ProjectRoom.VerifyProjectRoomCard().run("Title":/Testing project room2/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString(),"Access Project Room":true)
        //Navigate to Top Link or Page in Project Room
        new actions.ProjectRoom.NavigateRoomItems().run("Top Link":/Project Room Settings/.toString())
        //Set Tab in Room Settings in Project Room
        new actions.ProjectRoom.SetTabinRoomSettingsinProjectRoom().run("Tab":/Settings/.toString())
