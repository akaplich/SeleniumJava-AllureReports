...
//C65648 - Team Workspace In-App Notification when milestone is completed
class C65648_TeamWorkspaceIn_AppNotificationwhenmilestoneiscompleted
{
    ...
    public void testcase(){
        ...
        //Set Milestones in Team Workspace
        new actions.ViewIdea.TeamWorkspace.SetMilestonesinTeamWorkspace().run("Tab (optional)":/Milestones/.toString(),"Add or Edit":/Edit/.toString(),"Mark Complete or Mark Incomplete":/Mark Complete/.toString(),"Row Number":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/bi.adminuser1@brightidea.com/.toString(),"Password":/brightidea1/.toString())
        //Verify Notifications
        new actions.Notifications.VerifyNotifications().run("Notification message":/End User completed the Milestone This is my new milestone1/.toString(),"Idea Name":/Team WorkspaceIdea1/.toString(),"Number of Matches":/1/.toString())
        //Access Notification from Global Navigation
        new actions.Notifications.AccessNotificationfromGlobalNavigation().run("Notification Message":/End User completed the Milestone This is my new milestone1/.toString())
        //Verify Milestones in Team Workspace
