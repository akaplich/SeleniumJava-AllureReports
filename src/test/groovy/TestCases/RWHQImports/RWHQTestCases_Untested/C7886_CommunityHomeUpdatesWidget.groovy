...
//C7886 - Community Home Updates Widget
class C7886_CommunityHomeUpdatesWidget
{
    ...
    public void testcase(){
        ...
        new actions.Widgets.VerifyWidgetUpdates().run("Update Text Contains":/Custom App/.toString())
        //Verify Widget Updates
        new actions.Widgets.VerifyWidgetUpdates().run("Update Text Contains":/Solve App/.toString(),"Number of Matches":/0/.toString())
        //Verify Widget Updates
        new actions.Widgets.VerifyWidgetUpdates().run("Update Text Contains":/Evaluators app/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
