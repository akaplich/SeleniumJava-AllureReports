...
//C132441 - Update Assignee - Set Time for Action Item
class C132441_UpdateAssignee_SetTimeforActionItem
{
    ...
    public void testcase(){
        ...
        variables."dueTime" = new actions.Utils.AddSubtractFromTime().run("Time":/Now/.toString(),"Add or Subtract":/Subtract/.toString(),"Number":/2/.toString(),"Units":/Hours/.toString(),"Format":/h:mm a/.toString())
        //Navigate
        ...
        new actions.PipelineStepsView.SetUpdateAssigneeModal().run("Open Modal":true,"Additional Assignee":/System Admin/.toString(),"Additional Assignee Add or Remove":/Add/.toString(),"Due Date":/${variables."today"}/.toString(),"Due Time":/${variables."dueTime"}/.toString(),"Confirm Time Zone":/(UTC) Coordinated Universal Time/.toString())
        //Access Action Item in Actions Items React Global Navigation
        new actions.ActionItems.AccessActionIteminActionsItemsReactGlobalNavigation().run("Action Item":/test idea1/.toString(),"Due Date":/Due 3 hours ago/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
