...
//C119725 - Submission Form - Edit - Warning Message - Edit Idea, Add Data
class C119725_SubmissionForm_Edit_WarningMessage_EditIdea_AddData
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea3Fields.SetViewIdea3DescriptionTabTextField().run("Field Name":/Long Answer Question/.toString(),"Field Value":/Test test/.toString(),"Action":/Save/.toString())
        ...
        try{
            ...
            new actions.SetupIdeas.EditAdditionalQuestionsinSubmissionFormtab().run("Question":/Long Answer Question/.toString(),"Edit or Hide or Remove":/Edit/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Editing or removing existing additional submission fields may cause data to be lost from existing submissions/.toString(),"Should Exist":true)
    }
    //Basestate
