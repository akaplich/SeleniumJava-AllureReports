...
//C131195 - Delete Message from Another User
class C131195_DeleteMessagefromAnotherUser
{
    ...
    public void testcase(){
        ...
        new actions.Messages.VerifyPrivateMessagesonViewPrivateMessage().run("Subject":/First Personal Message/.toString(),"Sender":/System Admin/.toString(),"Message":/This is the First Personal Message to End User from System Admin/.toString(),"Number of Matches":/1/.toString())
        //Set Actions on View Private Message
        new actions.Messages.SetActionsonViewPrivateMessage().run("Delete":true)
        //Access Messages in Messages Global Navigation
        new actions.Messages.AccessMessagesinMessagesGlobalNavigation().run("See All Messages":true)
        //Verify Private Messages on View Private Message
        new actions.Messages.VerifyPrivateMessagesonViewPrivateMessage().run("Sender":/System Admin/.toString(),"Message":/This is the First Personal Message to End User from System Admin/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
