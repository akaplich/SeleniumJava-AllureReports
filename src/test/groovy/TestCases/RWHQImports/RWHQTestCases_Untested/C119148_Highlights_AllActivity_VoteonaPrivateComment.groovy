...
//C119148 - Highlights - All Activity - Vote on a Private Comment
class C119148_Highlights_AllActivity_VoteonaPrivateComment
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/Vote on this comment3/.toString(),"Comment Type":/Private/.toString())
        //Add Comment in View Idea page
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/Vote on this comment4/.toString(),"Comment Type":/Private/.toString())
        //Log Out
