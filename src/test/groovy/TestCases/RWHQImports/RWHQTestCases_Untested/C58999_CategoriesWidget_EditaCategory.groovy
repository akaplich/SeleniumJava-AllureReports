...
// C58999 - Categories Widget - Edit a Category 
class C58999_CategoriesWidget_EditaCategory
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupCategoryIdeasTab().run("Action":/Modify/.toString(),"Original Category Name":/Operations/.toString(),"New Category Name":/Edited_Operations/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Widgets.VerifyandAccessWidgetCategories().run("Category Name":/Edited_Operations/.toString(),"Number of Matches":/1/.toString(),"Click to access":true)
