...
//C131648 - Hack > Participants Page - Join Event
class C131648_Hack_ParticipantsPage_JoinEvent
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC131648test5/.toString(),"Finally Login as What User":/brightC131648test5@mailinator.com/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/Autofirst Autolast/.toString(),"Participant is the current user":true,"Available to join teams":/Not Available to join teams/.toString(),"Expertise":/Cybersecurity,DevOps/.toString(),"Number of Matches":/1/.toString())
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC131648test5@mailinator.com/.toString(),"Subject":/Hack: You've  Joined the Hack Event/.toString(),"From":/noreply@brightidea.com/.toString(),"Email Should Be Received":true)
    }
    //Basestate
