...
//C132042 - VI3 - Select Template
class C132042_VI3_SelectTemplate
{
    ...
    public void testcase(){
        ...
        //Set Template Selection
        new actions.ViewIdea30.SetTemplateSelection().run("Template":/Large Header (Large Image)/.toString(),"Action":/Change Template/.toString())
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Large Header/.toString(),"Idea Name":/Hack Project/.toString())
    }
    //Basestate
