...
class C131404_WB_ShapesAndText_DuplicatedObjectsSaveOrder
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131404/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.WhiteboardSetTextBox().run("X coordinate":/110/.toString(),"Y coordinate":/110/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/1/.toString())
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/C131404/.toString())
        //Click on Whiteboard Tool
        new actions.Whiteboards.ClickOnWhiteboardTool().run("Tool Type":/Shapes/.toString())
        //Set Shapes Tool in Whiteboard
        ...
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/0/.toString(),"Y coordinate":/-110/.toString(),"Single Double or Right Click":/Single Click/.toString())
        //Wait
        ...
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/Control + D/.toString())
        //Set Marker or Move Tool in Whiteboard
        new actions.Whiteboards.SetMarkerToolToWhiteboard().run("X coordinate1":/0/.toString(),"Y coordinate1":/-120/.toString(),"X coordinate2":/300/.toString(),"Y coordinate2":/0/.toString(),"X coordinate3":/100/.toString(),"Y coordinate3":/0/.toString())
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/200/.toString(),"Y coordinate":/0/.toString(),"Single Double or Right Click":/Single Click/.toString())
        //Compare Images
        new actions.selenium.CompareImages().run("Expected Image File":/C131404_Expected3282025.png/.toString(),"Actual Image Name":/C131404_actual.png/.toString(),"Crop Screenshot Start at X":/100/.toString(),"Crop Screenshot Start at Y":/0/.toString(),"Crop Screenshot Width":/720/.toString(),"Crop Screenshot Height":/500/.toString(),"Allowed Number of Different Pixels":/300/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Name":/C131404_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
