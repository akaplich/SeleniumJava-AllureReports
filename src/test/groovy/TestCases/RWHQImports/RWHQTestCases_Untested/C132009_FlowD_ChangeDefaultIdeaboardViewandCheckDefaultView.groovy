...
//C132009 - Flow D - Change Default Idea board View and Check Default View
class C132009_FlowD_ChangeDefaultIdeaboardViewandCheckDefaultView
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/Project One Title/.toString(),"Vote Count on Voting UI":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
