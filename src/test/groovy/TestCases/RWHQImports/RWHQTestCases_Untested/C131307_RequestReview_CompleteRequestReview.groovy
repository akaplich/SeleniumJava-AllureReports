...
//C131307 - Request Review - Complete Request Review
class C131307_RequestReview_CompleteRequestReview
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.AccessActionIteminActionsItemsReactGlobalNavigation().run("Action Item":/Memo Review Request Idea1/.toString())
        ...
        //Navigate Tab in My Reviews
        new actions.Memo.NavigateTabinMyReviews().run("Tab":/Open/.toString())
    }
    //Basestate
