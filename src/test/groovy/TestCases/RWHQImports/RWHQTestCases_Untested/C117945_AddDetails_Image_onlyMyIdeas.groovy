...
//C117945 - Add Details: Image-only My Ideas
class C117945_AddDetails_Image_onlyMyIdeas
{
    ...
    public void testcase(){
        ...
        try{
            //Capture My Idea
            new actions.Enterprise.UserHomepage.CaptureMyIdea().run("Capture My Idea from":/Global Nav/.toString(),"Attachments":/Image4.jpg/.toString(),"Attachment Add or Remove":/Add/.toString(),"Action":/Add Details/.toString())
        }
