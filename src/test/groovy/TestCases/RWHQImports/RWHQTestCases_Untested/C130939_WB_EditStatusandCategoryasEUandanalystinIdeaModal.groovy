...
//C130939 - WB - Edit Status and Category as EU and analyst in Idea Modal
class C130939_WB_EditStatusandCategoryasEUandanalystinIdeaModal
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SetShareWhiteboard().run("Click Share Button":true,"User(s)":/bi.enduser1@brightidea.com,analyst/.toString(),"User Add or Remove":/Add,Add/.toString(),"Send Invite":true,"Action":/Close/.toString())
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/End User/.toString(),"Idea Name":/Idea1(D113)/.toString(),"Idea Image":true,"Category":/Quick Add/.toString(),"Status":/Submitted/.toString(),"Submitter Name":/System Admin/.toString())
        ...
        new actions.Whiteboards.OpenExistingWhiteboardOnWhiteboardsPage().run("Tab":/Shared with Me/.toString(),"Name of Whiteboard":/Change Category and Status/.toString())
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/-20/.toString(),"Y coordinate":/-45/.toString(),"Single Double or Right Click":/Right Click/.toString())
        //Whiteboard - Set Right Click on Object
        new actions.Whiteboards.SetRightClickonStickyNote().run("Right Click on Sticky Note":false,"View idea details":true)
        try{
            //Set View Idea 3 Dropdown Text Field
