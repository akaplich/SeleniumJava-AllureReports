...
class C39855_EditBlog
{
    ...
    public void testcase(){
        ...
        //Verify Enterprise and Initiative View Blog
        new actions.EnterpriseBlogs.VerifyEnterpriseViewBlog().run("Title":/First Blog Post Edited/.toString(),"Tags":/firstblog/.toString(),"Content":/First Blog posted in custom app/.toString())
    }
    //Basestate
