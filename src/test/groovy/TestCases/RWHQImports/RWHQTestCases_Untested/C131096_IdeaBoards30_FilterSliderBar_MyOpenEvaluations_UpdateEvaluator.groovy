...
//C131096 - Idea Boards 30 - Filter Slider Bar - My Open Evaluations, Update Evaluator
class C131096_IdeaBoards30_FilterSliderBar_MyOpenEvaluations_UpdateEvaluator
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Status":[],"Stage":[],"Categories":[],"Tags":[],"Admin Tags":[],"Desired Expertise":[],"My Open Evaluations":true)
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea - end user1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea - end user2/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
