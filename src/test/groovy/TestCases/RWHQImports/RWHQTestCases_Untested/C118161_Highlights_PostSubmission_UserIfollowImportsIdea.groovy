...
//C118161 - Highlights - Post Submission - User I follow Imports Idea
class C118161_Highlights_PostSubmission_UserIfollowImportsIdea
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/System Admin Idea1/.toString(),"Description":/desc for System Admin Idea1/.toString(),"Category":/New Product/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        ...
        new actions.IdeaBoard.SetUserFlyoverinIdeaBoardpage30().run("Idea Name":/System Admin Idea1/.toString(),"Username":/System Admin/.toString(),"Action":/Follow/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin submitted "Emerging Market Development"/.toString(),"Highlights Item Content":/Custom App - Operations/.toString())
    }
    //Basestate
