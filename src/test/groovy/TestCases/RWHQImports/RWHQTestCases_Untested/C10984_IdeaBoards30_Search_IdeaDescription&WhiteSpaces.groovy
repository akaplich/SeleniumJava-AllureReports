...
class C10984_IdeaBoards30_Search_IdeaDescriptionRedwoodHQTestCaseWhiteSpaces
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Search Value":/desc/.toString())
        ...
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Clear Search":true)
        //Search Idea in Idea Board page
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Search Value":/test idea1 desc/.toString(),"Clear Search":false)
        //Verify Idea in Idea Board page TEMP
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/quick add1/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Idea Board page TEMP
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString(),"Number of Matches":/1/.toString())
