...
class C118693_Highlights_PostCommentwithUserTag_UserIfollow
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyClickableLinkinHighlight().run("Highlights Item Header":/End User commented on "test idea1"/.toString(),"Clickable Link Text in Content to Verify":/End User 2/.toString(),"Number of Matches":/1/.toString(),"Click on it?":true)
        //Verify Message
