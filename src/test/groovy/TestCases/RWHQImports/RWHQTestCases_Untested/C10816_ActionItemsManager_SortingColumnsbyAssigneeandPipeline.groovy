...
//C10816 - Action Items Manager - Sorting Columns by Assignee and Pipeline
class C10816_ActionItemsManager_SortingColumnsbyAssigneeandPipeline
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureJudgingStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Judging/.toString(),"Judges":/System Admin,Moderator/.toString(),"Judges Add or Remove":/Add,Add/.toString(),"Action":/Activate/.toString())
        ...
        new actions.ActionItems.SortMyActionItemsActionItemsManagertable().run("Sort Which List":/Action Items Manager/.toString(),"Column Name":/Assignee/.toString(),"Sort":/ascending/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/Action Items Manager/.toString(),"Title":/judging idea1/.toString(),"Row Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/Action Items Manager/.toString(),"Title":/solve test idea2/.toString(),"Row Number":/6/.toString(),"Number of Matches":/1/.toString())
        //Sort My Action Items/Action Items Manager table
        new actions.ActionItems.SortMyActionItemsActionItemsManagertable().run("Sort Which List":/Action Items Manager/.toString(),"Column Name":/Pipeline/.toString(),"Sort":/ascending/.toString())
        //Verify Open table for Action Items page
