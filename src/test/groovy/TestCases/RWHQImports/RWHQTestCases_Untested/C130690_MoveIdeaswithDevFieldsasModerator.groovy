...
//C130690 - Move Ideas with Dev Fields as Moderator
class C130690_MoveIdeaswithDevFieldsasModerator
{
    ...
    public void testcase(){
        ...
        new actions.WebstormCreation.CreateCustomWebstorm().run("Webstorm Title":/Source Pipeline/.toString(),"Description":/desc/.toString(),"Pipeline Administrators":/Moderator/.toString(),"Administrators Add or Remove":/Add/.toString(),"Action":/Create/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Apps/.toString())
        //Create Custom Webstorm
        new actions.WebstormCreation.CreateCustomWebstorm().run("Webstorm Title":/Destination Pipeline/.toString(),"Description":/desc/.toString(),"Moderators":/Moderator/.toString(),"Moderators Add or Remove":/Add/.toString(),"Action":/Create/.toString())
        ...
        new actions.ActionItems.SetDevelopmentActionItemPageFields().run("Number Question - Title":/Same Development Question/.toString(),"Number Question - Answer":/125/.toString(),"Multiple Choice - Title":/Different Development Question/.toString(),"Multiple Choice - Answer":/Answer 1/.toString(),"Action":/Mark Complete/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/Move this idea1/.toString())
        //Set New Move Ideas in Pipeline Steps page
        new actions.PipelineStepsView.NewMoveIdeasinPipelineStepspage().run("Move To Pipeline":/Destination Pipeline/.toString(),"Category":/Operations/.toString(),"Status":/Submitted/.toString(),"Missing Development Question Field":/1/.toString(),"Action":/Move Idea/.toString())
        //Navigate WebStorm or MTS
