...
//C118333 - EU Completeness Meter - Upload a photo
class C118333_EUCompletenessMeter_Uploadaphoto
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyOnboardingPanelMeterItem().run("Completed Total":/2 of 6 completed/.toString(),"Item Name":/Upload a profile photo/.toString(),"Completed":true)
    }
    //Basestate
