...
//C119147 - Highlights - All Activity - Post a Hidden Comment
class C119147_Highlights_AllActivity_PostaHiddenComment
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.HideCommentinViewIdeapage().run("Comment to Hide":/This is comment2/.toString(),"Hide":true)
        //Log Out
        ...
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin commented on "test idea1"/.toString(),"Highlights Item Content":/This is comment2/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
