...
//C131721 - Email Notification for added team members (Toggled Off)
class C131721_EmailNotificationforaddedteammembers_ToggledOff
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightaddC131721_1/.toString(),"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        //Navigate
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightaddC131721_1/.toString(),"Subject":/You have been invited to collaborate on/.toString(),"Email Should Be Received":false)
    }
    //Basestate
