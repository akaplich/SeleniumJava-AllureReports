...
class C45242_Notification
{
    ...
    public void testcase(){
        ...
        new actions.Notifications.VerifyNotifications().run("Notification message":/Moderator voted on your Idea New Idea1./.toString(),"Number of Matches":/1/.toString())
        //Access Notification from Global Navigation
        new actions.Notifications.AccessNotificationfromGlobalNavigation().run("Notification Message":/Moderator voted on your Idea New Idea1./.toString())
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/New Idea1/.toString(),"Linked Submissions":[])
        //Navigate
