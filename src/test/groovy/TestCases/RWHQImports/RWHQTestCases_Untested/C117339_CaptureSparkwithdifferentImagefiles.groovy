...
//C117339 - Capture Spark with different Image files
class C117339_CaptureSparkwithdifferentImagefiles
{
    ...
    public void testcase(){
        ...
        //Capture My Idea
        new actions.Enterprise.UserHomepage.CaptureMyIdea().run("Capture My Idea from":/Global Nav/.toString(),"Description":/We propose the use of synchronously moving micro-optics (lenslet arrays) for image pickup and display in three-dimensional integral imaging to overcome the upper resolution limit imposed/.toString(),"Attachments":/Image4.jpg,SamplePNG.png,Pocketcube.gif/.toString(),"Attachment Add or Remove":/Add,Add,Add/.toString(),"Action":/Save/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Verify Idea in My Ideas List
        new actions.Enterprise.UserHomepage.VerifyIdeainMyIdeasList().run("Thumbnail":/Image/.toString(),"Title":/We propose the use of synchronously moving micro-optics (lenslet arrays) for image pickup and displa/.toString(),"Row Number":/1/.toString(),"Number of Matches":/1/.toString())
        ...
        //Verify Attachments in View My Idea in User Homepage
        new actions.Enterprise.UserHomepage.VerifyAttachmentsinViewMyIdeainUserHomepage().run("Attachment File":/Pocketcube.gif/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
