...
class C131487_TopIdeasforMemos_CardDisplay(Code_Status_Stage_Step)
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Memo or Idea":/Idea/.toString(),"Title":/Idea in Drafting step/.toString(),"Category":/Process Improvement/.toString(),"Status":/Paused ⏸/.toString(),"Action":/Submit/.toString())
        //Set Quick Add Memo or Idea
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Memo or Idea":/Memo/.toString(),"Title":/Memo in Backlog stage/.toString(),"Category":/Organizational Improvement/.toString(),"Status":/Stopped ⛔️/.toString(),"Action":/Submit/.toString())
        //Set Quick Add Memo or Idea
        ...
        new actions.TopIdeas.SetTopIdeasGearMenu().run("Click on gear icon":true,"Option":/Code/.toString()," Click on Option":true)
        //Set and Verify Top Ideas Gear Menu
        new actions.TopIdeas.SetTopIdeasGearMenu().run("Option":/Status/.toString()," Click on Option":true)
        //Set and Verify Top Ideas Gear Menu
        new actions.TopIdeas.SetTopIdeasGearMenu().run("Option":/Step/.toString()," Click on Option":true)
        //Set and Verify Top Ideas Gear Menu
        new actions.TopIdeas.SetTopIdeasGearMenu().run("Option":/Stage/.toString()," Click on Option":true)
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Memo in Backlog stage/.toString(),"Stack Name Memo belongs to":/Organizational Improvement/.toString(),"Image":/Memo/.toString(),"Status":/Stopped ⛔️/.toString(),"Activity Indicator Displayed":true,"Activity Indicator":/green/.toString(),"Last Activity":/by System Admin/.toString(),"Last Activity Displayed":true,"Progress Bar":/0/.toString(),"Stage":/Backlog/.toString(),"Step":/Backlog/.toString(),"Open Action Items Count":/0/.toString(),"Idea Code":/D112/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Memo in Backlog stage/.toString(),"Stack Name Memo belongs to":/Organizational Improvement/.toString(),"Image":/Memo/.toString(),"Activity Indicator Displayed":true,"Activity Indicator":/green/.toString(),"Last Activity":/by System Admin/.toString(),"Last Activity Displayed":true,"Open Action Items Count":/0/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Memo in Review step/.toString(),"Stack Name Memo belongs to":/Process Improvement/.toString(),"Image":/Memo/.toString(),"Activity Indicator Displayed":true,"Activity Indicator":/green/.toString(),"Last Activity":/by System Admin/.toString(),"Last Activity Displayed":true,"Open Action Items Count":/0/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Memo in Review step/.toString(),"Stack Name Memo belongs to":/Process Improvement/.toString(),"Image":/Memo/.toString(),"Status":/In-flight 🔥/.toString(),"Activity Indicator Displayed":true,"Activity Indicator":/green/.toString(),"Last Activity":/by System Admin/.toString(),"Last Activity Displayed":true,"Progress Bar":/1/.toString(),"Stage":/Active Development/.toString(),"Step":/Review/.toString(),"Open Action Items Count":/0/.toString(),"Idea Code":/D113/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Idea in Drafting step/.toString(),"Stack Name Memo belongs to":/Process Improvement/.toString(),"Image":/Idea/.toString(),"Status":/Paused ⏸/.toString(),"Stage":/Active Development/.toString(),"Step":/Drafting/.toString(),"Open Action Items Count":/0/.toString(),"Idea Code":/D111/.toString(),"Placement Number":/2/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Idea in Drafting step/.toString(),"Stack Name Memo belongs to":/Process Improvement/.toString(),"Image":/Idea/.toString(),"Open Action Items Count":/0/.toString(),"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
