...
//C130785 - Homepage Header 2 - Invalid file type for background
class C130785_HomepageHeader2_Invalidfiletypeforbackground
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.SetUploadyourOwnBackground().run("Choose File":/plaintext.txt/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/File type not permitted. Please use a valid image file: .png, .gif, .jpg, .jpeg./.toString(),"Should Exist":true)
        try{
            //Set Upload your Own Background
