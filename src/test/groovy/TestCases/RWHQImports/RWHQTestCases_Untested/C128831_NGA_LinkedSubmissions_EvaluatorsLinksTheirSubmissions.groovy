...
//C128831 - NGA - Linked Submissions - Evaluators Links Their Submissions
class C128831_NGA_LinkedSubmissions_EvaluatorsLinksTheirSubmissions
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.SetLinkedSubmissionsNGAViewIdeaPage().run("Submission Title":/test idea3/.toString(),"Add or Remove":/Add/.toString(),"Action":/Link Submissions/.toString())
        ...
        new actions.NGAViewIdea.VerifyLinkedSubmissionNGAViewIdea().run("Linked Submissions":/test idea3/.toString(),"Should Exist":/TRUE/.toString(),"Name of the Linked Submission to Navigate to":/test idea3/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/desc for test idea3/.toString(),"Should Exist":true)
    }
    //Basestate
