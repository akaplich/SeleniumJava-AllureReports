...
//C45270 - Find owner - Forward to Colleague
class C45270_Findowner_ForwardtoColleague
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Verify in Which List (optional)":/My Action Items/.toString(),"Title":/Find Owner Idea1/.toString(),"Answer":/Not Owner - Forwarded/.toString(),"Number of Matches":/1/.toString())
