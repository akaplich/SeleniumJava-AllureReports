...
//C129773 - Move Ideas - Match Category - Select Multiple ideas with Different Categories
class C129773_MoveIdeas_MatchCategory_SelectMultipleideaswithDifferentCategories
{
    ...
    public void testcase(){
        ...
        try{
            ...
            new actions.PipelineStepsView.NewMoveIdeasinPipelineStepspage().run("Move To Pipeline":/Pipeline A/.toString(),"Status":/Under Review/.toString(),"Action":/Move Idea/.toString())
        }
