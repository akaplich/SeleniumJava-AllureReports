...
//C119363 - Highlights - All Activity - Comment on Hidden Submission
class C119363_Highlights_AllActivity_CommentonHiddenSubmission
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Title":/Posting Idea3 as Admin/.toString(),"Action":/Submit/.toString())
        //Select Idea in Pipeline Steps page
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/Posting Idea3 as Admin/.toString())
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Posting Idea3 as Admin/.toString())
        //Add Comment in View Idea page
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/This is comment6/.toString(),"Comment Type":/General Access/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/NonBI System Admin commented on "Posting Idea3 as Admin"./.toString(),"Highlights Item Content":/This is comment6/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/NonBI System Admin commented on "Posting Idea3 as Admin"./.toString(),"Highlights Item Content":/This is comment6/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
