...
//C130960 - VI3 - Find Owner as IS and team submission member
class C130960_VI3_FindOwnerasISandteamsubmissionmember
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea30.SetSubmitterinViewIdea3UsingDropdown().run("Field":/Owner/.toString(),"Search User Text":/System Admin/.toString(),"User":/System Admin/.toString())
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/team submission/.toString())
        //Set Submitter or Owner in View Idea 3 Using Dropdown
        new actions.ViewIdea30.SetSubmitterinViewIdea3UsingDropdown().run("Field":/Owner/.toString(),"Search User Text":/Pipeline Admin/.toString(),"User":/Pipeline Admin/.toString())
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/team submission(D113)/.toString(),"Idea Image":false,"Category":/Marketing & Branding/.toString(),"Submitter Name":/Team End User/.toString(),"Owner":/Pipeline Admin/.toString())
        //Set Submitter or Owner in View Idea 3 Using Dropdown
        new actions.ViewIdea30.SetSubmitterinViewIdea3UsingDropdown().run("Field":/Owner/.toString(),"Clear owner":true)
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/team submission(D113)/.toString(),"Idea Image":false,"Category":/Marketing & Branding/.toString(),"Submitter Name":/Team End User/.toString(),"Owner":/Unassigned/.toString())
        //Access or Close Idea from View Idea 3 Modal
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Close Idea Modal":true)
        //Log Out
        new actions.general.LogOut().run([:])
