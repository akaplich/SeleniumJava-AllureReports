...
//C542 - Expertise - Cancel button
class C542_Expertise_Cancelbutton
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabDesiredExpertise().run("Expertise Name":/Expertise6/.toString(),"Add or Remove":/Add/.toString(),"Action":/Cancel/.toString())
        //Verify Custom App Description tab fields in View Idea page
        Action5812921cfa4ee77809f46b4f("Desired Expertise":/<EMPTY>/.toString())
    }
    //Basestate
