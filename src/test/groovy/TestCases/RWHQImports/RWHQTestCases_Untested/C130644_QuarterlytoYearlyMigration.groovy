...
//C130644 - Quarterly to Yearly Migration
class C130644_QuarterlytoYearlyMigration
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforIdeastab().run("Business impact timeframe":/Yearly/.toString(),"Action for Business impact timeframe modal":/Continue/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom Initiative title/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/quarterly idea1/.toString())
        ...
        new actions.ViewIdea.BusinessImpact.VerifyProjectedandActualCostsinBusinessImpacttabforViewIdeapage().run("Year":/2021;2022/.toString(),"Current Year":/2021/.toString(),"Costs Title":/New Cost;New Cost/.toString(),"Row Number":/1;1/.toString(),"Projected Cost":/35,000;4,000/.toString(),"Actual Cost":/16,000;25,644/.toString())
        //Verify Projected and Actual Benefits in Business Impact tab for View Idea page
        new actions.ViewIdea.BusinessImpact.VerifyProjectedandActualBenefitsinBusinessImpacttabforViewIdeapage().run("Year":/2021;2022/.toString(),"Current Year":/2021/.toString(),"Benefit Type":/Cost Savings;Cost Savings/.toString(),"Row Number of the Benefit":/1;1/.toString(),"Projected Benefit":/24,000;25,000/.toString(),"Actual Benefit":/24,000;24,000/.toString())
        //Verify Total Cost and Benefits in Business Impact tab
        new actions.ViewIdea.BusinessImpact.VerifyTotalCostandBenefitsinBusinessImpacttab().run("Year":/2021;2022/.toString(),"Current Year":/2021/.toString(),"Total Projected Benefit":/24,000;25,000/.toString(),"Total Actual Benefit":/24,000;24,000/.toString(),"Projected Net Benefit":/-11,000;21,000/.toString(),"Actual Net Benefit":/8,000;-1,644/.toString())
        //Access Team Workspace
        new actions.ViewIdea.TeamWorkspace.AccessTeamWorkspace().run([:])
        //Set Business Impact Tab
