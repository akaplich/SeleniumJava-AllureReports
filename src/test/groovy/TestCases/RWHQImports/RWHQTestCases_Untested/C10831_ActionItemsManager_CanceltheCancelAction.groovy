...
//C10831 - Action Items Manager - Cancel the Cancel Action
class C10831_ActionItemsManager_CanceltheCancelAction
{
    ...
    public void testcase(){
        ...
        new actions.ActionItemsManager.SetActionsDropdownintheActionItemsManager().run("Select Ideas":/review idea/.toString(),"Check":/TRUE/.toString(),"Action":/Cancel/.toString(),"Sub Action":/Cancel/.toString())
        ...
        new actions.ActionItemsManager.VerifyCanceledtableforActionItemsManager().run("Canceled Tab Value":/0/.toString(),"Title":/review idea/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
