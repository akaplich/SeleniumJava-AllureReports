...
//C117473 - Step Result - Scorecard - Complete Multiple Action Items
class C117473_StepResult_Scorecard_CompleteMultipleActionItems
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureScorecardStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Scorecarding/.toString(),"Assignment Method":/Individual Assignment/.toString(),"Individual Assignment User":/System Admin,End User/.toString(),"Individual Assignment User Add or Remove":/Add,Add/.toString(),"Action":/Update/.toString())
        ...
        new actions.PipelineStepsView.VerifyStepResultsinStepsViewpage().run("Step Name":/Scorecarding/.toString(),"Idea Code":/D102/.toString(),"Score":/66.1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
