...
//C130986 - WB - Change Submitter
class C130986_WB_ChangeSubmitter
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/Change Submitter/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.OpenExistingWhiteboardOnWhiteboardsPage().run("Tab":/Shared with Me/.toString(),"Name of Whiteboard":/Change Submitter/.toString())
        ...
        new actions.ViewIdea30.SetSubmitterinViewIdea3UsingDropdown().run("Field":/Submitter/.toString(),"Search User Text":/bi.enduser1@brightidea.com/.toString(),"User":/End User/.toString())
        //Verify Toast Message for Linking and Unlinking Pipeline
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/idea1(D113)/.toString(),"Idea Image":true,"Category":/Quick Add/.toString(),"Status":/Submitted/.toString(),"Submitter Name":/End User/.toString(),"Submitter Image":true)
    }
    //Basestate
