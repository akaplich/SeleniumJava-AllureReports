...
//C131104 - WB - Add Line - (Hotkey L)
class C131104_WB_AddLine_(HotkeyL)
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131104/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/l/.toString())
        //Wait
        ...
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("L or W":/390/.toString(),"Fill Color":/444647/.toString(),"Fill Color Opacity":/100%/.toString(),"Line Width":/2/.toString())
    }
    //Basestate
