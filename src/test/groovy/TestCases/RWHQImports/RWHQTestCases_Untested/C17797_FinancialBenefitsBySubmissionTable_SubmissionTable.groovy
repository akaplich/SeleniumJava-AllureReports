...
//C17797 - Financial Benefits By Submission Table - Submission Table
class C17797_FinancialBenefitsBySubmissionTable_SubmissionTable
{
    ...
    public void testcase(){
        ...
        //Verify Submission in the Submission Table on Business Impact tab
        new actions.PipelineDashBoard.VerifySubmissionintheSubmissionTableonBusinessImpacttab().run("Idea":/quick add1/.toString(),"Category":/Quick Add/.toString(),"Stage":/Collection/.toString(),"Total Projected Benefits":/$1.1MM/.toString(),"Total Actual Benefits":/$959.3K/.toString(),"Total Projected Costs":/$1.1MM/.toString(),"Total Actual Costs":/$950K/.toString(),"Row Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Submission in the Submission Table on Business Impact tab
