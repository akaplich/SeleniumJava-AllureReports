...
//C130739 - IBM Updates - Re-adding existing IBM
class C130739_IBMUpdates_Re_addingexistingIBM
{
    ...
    public void testcase(){
        ...
        //Login
        new actions.general.Login().run("Email":/communityadmin@test.com/.toString())
        ...
        try{
            ...
            new actions.PipelineSetup.SetRolesinPipelineSetupPage().run("Type of Licensing Model":/Standard Licensing Model/.toString(),"Navigate to Tab":true,"Idea Box Managers":/Pipeline Admin/.toString(),"Idea Box Managers Add or Remove":/Add/.toString(),"Click Save":false)
        }
