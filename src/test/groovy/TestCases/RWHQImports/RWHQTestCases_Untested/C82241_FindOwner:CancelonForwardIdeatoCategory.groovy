...
class C82241_FindOwner:CancelonForwardIdeatoCategory
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/Find Owner Idea1/.toString(),"Category":/Quick Add/.toString(),"Linked Submissions":[])
        //Log Out
        ...
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/My Action Items/.toString(),"Title":/Find Owner Idea1/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
