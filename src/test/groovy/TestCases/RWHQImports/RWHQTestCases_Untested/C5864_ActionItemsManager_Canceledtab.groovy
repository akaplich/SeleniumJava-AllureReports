...
//C5864 - Action Items Manager - Canceled tab
class C5864_ActionItemsManager_Canceledtab
{
    ...
    public void testcase(){
        ...
        new actions.ActionItemsManager.VerifyCanceledtableforActionItemsManager().run("Canceled Tab Value":/1/.toString(),"Title":/review idea/.toString(),"Row Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
