...
//C131052 - Advanced Search - Search Hidden Idea by Status
class C131052_AdvancedSearch_SearchHiddenIdeabyStatus
{
    ...
    public void testcase(){
        ...
        new actions.Search.QuickOrAdvanceSearchInGlobalNav().run("Tab (optional)":/Advanced Search/.toString(),"Search Input":/Submitted/.toString())
