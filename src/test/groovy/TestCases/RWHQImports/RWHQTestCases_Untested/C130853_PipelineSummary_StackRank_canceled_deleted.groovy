...
//C130853 - Pipeline Summary - Stack Rank (canceled, deleted)
class C130853_PipelineSummary_StackRank_canceled_deleted
{
    ...
    public void testcase(){
        ...
        //Configure Stack Rank Step in Pipeline Steps page
        new actions.PipelineStepsConfigure.ConfigureStackRankinNewModalinPipelineStepspage().run("Evaluators":/System Admin/.toString(),"Evaluators Add or Remove":/Add/.toString(),"Action":/Activate/.toString())
        ...
        new actions.ActionItemsManager.SetActionsDropdownintheActionItemsManager().run("Select Ideas":/Stack Rank/.toString(),"Assignee":/System Admin/.toString(),"Check":/TRUE/.toString(),"Action":/Delete/.toString(),"Sub Action":/Delete Action Item/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Action Items Manager/.toString())
        //Set Actions Dropdown in the Action Items Manager
        new actions.ActionItemsManager.SetActionsDropdownintheActionItemsManager().run("Select Ideas":/Stack Rank/.toString(),"Check":/TRUE/.toString(),"Action":/Cancel/.toString(),"Sub Action":/Cancel Action Item/.toString())
        //Navigate WebStorm or MTS
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Pipeline_Summary-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["quick add3","Collection","Stack Rank2","0","N/A"],"Number of Matches":/1/.toString(),"Total Number of Rows":/5/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Pipeline_Summary/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Pipeline_Summary-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["quick add4","Collection","Stack Rank2","0","N/A"],"Number of Matches":/1/.toString(),"Total Number of Rows":/5/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Pipeline_Summary/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Pipeline_Summary-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["quick add2","Collection","Stack Rank1","0","Canceled"],"Number of Matches":/1/.toString(),"Total Number of Rows":/5/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Pipeline_Summary/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Pipeline_Summary-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["quick add1","Collection","Stack Rank1","0","Canceled"],"Number of Matches":/1/.toString(),"Total Number of Rows":/5/.toString())
    }
    //Basestate
