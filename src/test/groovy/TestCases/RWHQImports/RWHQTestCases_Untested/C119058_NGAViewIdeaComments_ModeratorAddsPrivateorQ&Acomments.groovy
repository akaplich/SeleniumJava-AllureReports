...
//C119058 - NGA View Idea Comments - Moderator Adds Private or Q&A comments
class C119058_NGAViewIdeaComments_ModeratorAddsPrivateorQRedwoodHQTestCaseAcomments
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.VerifyCommentInNGAViewIdeaPage().run("Comment Section":/Comments/.toString(),"User":/Moderator/.toString(),"Comment":/Private comment/.toString(),"Comment Type":/Private/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment In NGA View Idea Page
        new actions.NGAViewIdea.VerifyCommentInNGAViewIdeaPage().run("Comment Section":/Comments/.toString(),"User":/Moderator/.toString(),"Comment":/Submitter comment/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
