...
//C117061 - Singlescale - Evaluator can see Evaluations Tab when visibility is set to Administrators and select roles
class C117061_Singlescale_EvaluatorcanseeEvaluationsTabwhenvisibilityissettoAdministratorsandselectroles
{
    ...
    public void testcase(){
        ...
        new actions.SetupUsers.SetWebstormSetupUsersAdministratorspage().run("WebStorm Administrators":/End User 2/.toString(),"WebStorm Administrators Add or Remove":/Add/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
