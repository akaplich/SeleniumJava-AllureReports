...
//C131502 - Memo - Share - Can Comment - File Menu Access
class C131502_Memo_Share_CanComment_FileMenuAccess
{
    ...
    public void testcase(){
        ...
        new actions.Memo.ColabEditorSetMemoTitle().run("New Title":/C131483 - Everyone Can Comment, EU2 Can Edit/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Memo.MemoShareDialogSetParticipants().run("Click Share Button":true,"User(s)":/End User 2/.toString(),"Permission (required)":/can edit/.toString(),"Send Invite":/TRUE/.toString(),"Anyone With Link":/can comment/.toString(),"Action":/Close/.toString())
        //Copy Current URL
        ...
        try{
            //Collab Editor, Whiteboard - Set File Menu
            new actions.Memo.ColabEditorSetTopBarDropdown().run("Click on the Bar?":true,"Main Option":/Submit to Batch/.toString())
        }
       catch(all){}catch(Error err){}
        try{
        ...
        new actions.MTS.SetMemoTemplateTile().run("Template":/Blank Document/.toString())
        //Collab Editor - Set Memo Title
        new actions.Memo.ColabEditorSetMemoTitle().run("New Title":/C131483 - Everyone With Link Can View, EU2 Can Comment/.toString(),"Action":/Submit/.toString())
        //Collab Editor - Set Text
        new actions.Memo.ColabEditorSetText().run("Text":/Testing Permissions/.toString(),"Key(s)":/Enter/.toString())
        //Collab Editor/Userhome - Memo Share Dialog -  Set Participants
        new actions.Memo.MemoShareDialogSetParticipants().run("Click Share Button":true,"User(s)":/End User 2/.toString(),"Permission (required)":/can comment/.toString(),"Send Invite":/TRUE/.toString(),"Anyone With Link":/can view/.toString(),"Action":/Close/.toString())
        //Copy Current URL
        variables."currentURL" = new actions.selenium.CopyCurrentURL().run([:])
        //Collab Editor - Click Go Back Button
        new actions.Memo.ColabEditorClickGoBackButton().run([:])
        ...
        new actions.Memo.CollabEditorVerifyDocumentTitle().run("Expected Status":/PRIVATE/.toString())
    }
    //Basestate
