...
//C117903 - Create Submission - Deleted Submission
class C117903_CreateSubmission_DeletedSubmission
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/Brightidea is a next big thing/.toString())
