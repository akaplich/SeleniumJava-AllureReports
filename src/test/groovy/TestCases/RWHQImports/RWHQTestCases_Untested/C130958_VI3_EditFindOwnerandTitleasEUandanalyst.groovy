...
//C130958 - VI3 - Edit Find Owner and Title as EU and analyst
class C130958_VI3_EditFindOwnerandTitleasEUandanalyst
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea30.SetSubmitterinViewIdea3UsingDropdown().run("Field":/Owner/.toString(),"Search User Text":/John Doe/.toString(),"User":/bi.adminuser1@brightidea.com/.toString())
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/End User/.toString(),"Idea Name":/test idea1(D102)/.toString(),"Idea Image":true,"Category":/New Product/.toString(),"Status":/Under Review/.toString(),"Submitter Name":/Sri/.toString(),"Submitter Image":true,"Owner":/John Doe/.toString())
        try{
            //Set Submitter or Owner in View Idea 3 Using Dropdown
