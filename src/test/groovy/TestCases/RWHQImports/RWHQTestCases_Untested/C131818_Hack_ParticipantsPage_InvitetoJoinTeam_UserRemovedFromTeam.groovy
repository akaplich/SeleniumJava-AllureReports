...
class C131818_Hack_ParticipantsPage_InvitetoJoinTeam_UserRemovedFromTeam
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/team submission with end user/.toString())
