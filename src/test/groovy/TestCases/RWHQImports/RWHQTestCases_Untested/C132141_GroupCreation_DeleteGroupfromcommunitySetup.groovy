...
//C132141 - Group Creation - Delete Group from community Setup
class C132141_GroupCreation_DeleteGroupfromcommunitySetup
{
    ...
    public void testcase(){
        ...
        new actions.SetupUsers.VerifyGroupsintheList().run("Navigate to Groups Tab":true,"Group Name":/ZTesting Group1/.toString(),"Number of Matches":/1/.toString())
        //Set Create Edit or Delete Group
        new actions.SetupUsers.SetCreateEditorDeleteGroup().run("Create Edit or Delete":/Delete/.toString(),"Group Name to Edit or Delete":/ZTesting Group1/.toString(),"Delete Action":/Delete/.toString())
        //Verify Toast Message for Linking and Unlinking Pipeline
        new actions.Whiteboards.VerifyToastMessageforLinkingandUnlinkingPipeline().run("Message":/This group has been deleted./.toString())
        //Verify Groups in the List
