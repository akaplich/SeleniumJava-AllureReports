...
//C119518 - Userhome Activities Tab - Delete Pipeline
class C119518_UserhomeActivitiesTab_DeletePipeline
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSidebar.DeletePipelineorFolderinPipelineSidebar().run("Pipeline or Folder Name":/Discuss App Test/.toString())
        ...
        new actions.Enterprise.UserHomepage.VerifyActivityinUserHomepage().run("Total Number of Activities on the page":/1/.toString(),"Activity Name":/Discuss App Test/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
