...
//C63253 - Team Workspace In-App Notification A Risk has been added
class C63253_TeamWorkspaceIn_AppNotificationARiskhasbeenadded
{
    ...
    public void testcase(){
        ...
        new actions.Notifications.VerifyNotifications().run("Notification message":/System Admin added a new Risk to /.toString(),"Idea Name":/test idea1/.toString(),"Number of Matches":/1/.toString())
        //Access Notification from Global Navigation
        new actions.Notifications.AccessNotificationfromGlobalNavigation().run("Notification Message":/System Admin added a new Risk to test idea1/.toString())
        //Verify Risks in Team Workspace
