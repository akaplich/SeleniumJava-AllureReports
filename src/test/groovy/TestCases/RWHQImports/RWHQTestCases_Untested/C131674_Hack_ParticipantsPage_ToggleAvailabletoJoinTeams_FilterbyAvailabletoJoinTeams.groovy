...
//C131674 - Hack > Participants Page - Toggle Available to Join Teams, Filter by Available to Join Teams
class C131674_Hack_ParticipantsPage_ToggleAvailabletoJoinTeams_FilterbyAvailabletoJoinTeams
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowAforHackathonOnboarding().run("Action on Get Started Screen":/Next/.toString(),"Expertise":/JavaScript,MySQL/.toString(),"Add or Remove Expertise":/Add,Add/.toString(),"Register and add expertise Action":/Continue to submission/.toString(),"Action on Time to submit your project":/Cancel/.toString(),"Wait for Post Idea Page to Load":false)
        //Set Flow A for Hackathon Onboarding
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetRegistrationorGetStartedForHackathonOnboarding().run("Area Accessing The Menu From":/Homepage Header/.toString(),"Onboarding Menu Option":/Registration/.toString())
        //Set Flow A for Hackathon Onboarding
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowAforHackathonOnboarding().run("Action on Get Started Screen":/Next/.toString(),"Expertise":/QA,Automation/.toString(),"Add or Remove Expertise":/Add,Add/.toString(),"I am available to join teams":true,"Register and add expertise Action":/Continue to submission/.toString(),"Action on Time to submit your project":/Cancel/.toString(),"Wait for Post Idea Page to Load":false)
        //Set Flow A for Hackathon Onboarding
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowAforHackathonOnboarding().run("Action on Get Started Screen":/Close/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Webstorm.ParticipantsPageSetFilterSearch().run("Search Expertise":"","Available to Join Teams":/Available/.toString(),"Certifications":[])
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/End User/.toString(),"Available to join teams":/Available to join teams/.toString(),"Expertise":/Automation,QA/.toString(),"Number of Matches":/1/.toString())
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/System Admin/.toString(),"Number of Matches":/0/.toString())
        //Participants Page - Set Filter or Search
        new actions.Webstorm.ParticipantsPageSetFilterSearch().run("Clear All Filters":true,"Search Expertise":"","Available to Join Teams":/Not Available/.toString(),"Certifications":[])
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/System Admin/.toString(),"Available to join teams":/Not Available to join teams/.toString(),"Expertise":/JavaScript,MySQL/.toString(),"Number of Matches":/1/.toString())
        //Participants Page - Verify Participant
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/End User/.toString(),"Participant is the current user":true,"Number of Matches":/1/.toString())
    }
    //Basestate
