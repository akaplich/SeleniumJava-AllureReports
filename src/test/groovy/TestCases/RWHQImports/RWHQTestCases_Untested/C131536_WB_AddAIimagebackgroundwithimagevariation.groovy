...
//C131536 - WB - Add AI image background with image variation
class C131536_WB_AddAIimagebackgroundwithimagevariation
{
    ...
    public void testcase(){
        ...
        //Set Generate AI Image
        new actions.WebstormHomepage.SetGenerateAIImage().run("AI Image Number to Click":/4/.toString(),"Action":/Add Image/.toString())
        //Wait
