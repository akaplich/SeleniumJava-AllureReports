...
class C131789_WB_TopIdeas_SendToWB_Stacks_AssignCardtoSubmitter
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131789/.toString(),"Action":/Submit/.toString())
        //Navigate
        ...
        new actions.Whiteboards.SendIdeaToWhiteboardFromPipelineSteps().run("Send to Whiteboard or Smart Matrix":/Send to Whiteboard/.toString(),"Existing Whiteboard or New Whiteboard":/New Whiteboard/.toString(),"Whiteboard Title":/C131789/.toString(),"Format":/Stack/.toString(),"Sort by":/Category/.toString(),"Assign card to Submitter":true,"Action":/Send/.toString())
        //Verify Toast Message in Tasks In Project Room
        new actions.ProjectRoom.VerifyToastMessageinTasksInProjectRoom().run("Message":/The selected ideas were sent successfully to the whiteboard: C131789/.toString(),"Click on the link":true)
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Expected Image File":/C131789_Expected3282025.png/.toString(),"Actual Image Name":/C131789_actual.png/.toString(),"Crop Screenshot Start at X":/410/.toString(),"Crop Screenshot Start at Y":/450/.toString(),"Crop Screenshot Width":/500/.toString(),"Crop Screenshot Height":/215/.toString(),"Allowed Number of Different Pixels":/100/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Name":/C131789_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
