...
//C10937 - NGA View Idea Details Tab
class C10937_NGAViewIdeaDetailsTab
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.VerifyDetailstabforNGAViewIdeapage().run("Points":/1/.toString(),"Votes":/1/.toString(),"Unique Views":/2/.toString(),"Total Views":/2/.toString(),"Comments":/1/.toString(),"Favorited":/0/.toString())
    }
    //Basestate
