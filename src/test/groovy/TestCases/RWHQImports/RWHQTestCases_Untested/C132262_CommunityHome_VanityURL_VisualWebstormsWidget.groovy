...
//C132262  - Community Home - Vanity URL - Visual Webstorms Widget
class C132262_CommunityHome_VanityURL_VisualWebstormsWidget
{
    ...
    public void testcase(){
        ...
        new actions.SetupSite.SetCommunitySetupSiteInfoTab().run("Vanity URL":/C132262Vanity/.toString(),"Verify Vanity URL Status":/Available/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."affiliateURL"}\/community\/C132262Vanity/.toString())
