...
//C128152 - Submissions Status Change History - Linked Submissions
class C128152_SubmissionsStatusChangeHistory_LinkedSubmissions
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Status_history-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Code","Title","Submission Team","Status","Date Idea Entered status","Date Idea Left status","Days in status","Previous Status","Status Change Reason","User Name","User Email","Member ID","Linked Submissions"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Status_history/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Status_history-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["D114","test idea4","Submitted","test idea3 (D113)"],"Number of Matches":/2/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Status_history/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Status_history-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["D114","test idea4","Under Review","test idea3 (D113)"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
