...
//C63188 - Deleting Milestones
class C63188_DeletingMilestones
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.TeamWorkspace.VerifyCountontheTabofTeamWorkspace().run("Tab Name":/Milestones/.toString(),"Count":/2/.toString())
        ...
        //Verify Milestones in Team Workspace
        new actions.ViewIdea.TeamWorkspace.VerifyMilestonesinTeamWorkspace().run("Milestone":/This is my new milestone2/.toString(),"Complete":/FALSE/.toString(),"Placement Number":/1/.toString())
        //Verify Milestones in Team Workspace
        new actions.ViewIdea.TeamWorkspace.VerifyMilestonesinTeamWorkspace().run("Milestone":/This is my new milestone1/.toString(),"Number of Matches":/0/.toString())
        //Verify Count on the Tab of Team Workspace
        new actions.ViewIdea.TeamWorkspace.VerifyCountontheTabofTeamWorkspace().run("Tab Name":/Milestones/.toString(),"Count":/1/.toString())
    }
    //Basestate
