...
//C130929 - WB - Email notification for new user
class C130929_WB_Emailnotificationfornewuser
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SetShareWhiteboard().run("Click Share Button":true,"User(s)":/brightC130929_3@mailinator.com/.toString(),"User Add or Remove":/Add/.toString(),"Send Invite":true,"Action":/Close/.toString())
        ...
        variables."link" = new actions.Mailinator.GetLinkfromInviteParticipantEmail().run("Inbox Email Count":/1/.toString(),"Email Address":/brightC130929_3/.toString(),"Subject of New Administrator Added Email":/You have been invited to collaborate on a Whiteboard/.toString())
        //Navigate to URL
