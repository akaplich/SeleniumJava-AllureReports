...
//C132221 - Upgrade Moderator license to IBM when no Moderator license available
class C132221_UpgradeModeratorlicensetoIBMwhennoModeratorlicenseavailable
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.VerifyGrantBrightideaAdministratorLicense().run("Info Message":/Evaluator will be assigned a Idea Box Manager license, as there are no available Moderator licenses.The Idea Box Manager license will allow Evaluator to be assigned to licensed roles throughout the product./.toString(),"Action":/OK/.toString())
        ...
        //Verify Info Message for Standard Licensing
        new actions.SetupUsers.VerifyInfoMessageonPeoplePillarandAdministratorTab().run("Info Message":/Assigning Users to Licensed RolesAssigning a user to either the Idea Box Manager, Pipeline Manager or Pipeline Moderator role for this pipeline requires granting the user one of the following licenses:Idea Box Manager license (0 Available)Brightidea Administrator license (1 Available)Brightidea Moderator license (0 Available)Get more licensesUsers will receive an email notification about their role assignment. /.toString(),"Info Message Exists":true)
        ...
        //Verify License Type of User in Fields
        new actions.PipelineSetup.VerifyLicenseTypeofUserinFields().run("Field":/Pipeline Moderators/.toString(),"User":/Evaluator/.toString(),"License Type":/Ideabox Manager/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
