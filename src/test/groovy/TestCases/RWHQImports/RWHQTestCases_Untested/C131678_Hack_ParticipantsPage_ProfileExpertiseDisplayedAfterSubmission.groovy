...
//C131678 - Hack > Participants Page - Profile Expertise Displayed After Submission
class C131678_Hack_ParticipantsPage_ProfileExpertiseDisplayedAfterSubmission
{
    ...
    public void testcase(){
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("Expertise":/DevOps,Database,Automation/.toString(),"Add or Remove Expertise":/Add,Add,Add/.toString())
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/hack project1/.toString(),"Submitter":/Yourself/.toString(),"Submitter Team User Add or Remove":/Add/.toString(),"Description":/test/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.WebstormHomepage.HackVerifyPariticipant().run("Username":/End User/.toString(),"Participant is the current user":true,"Available to join teams":/Not Available to join teams/.toString(),"Expertise":/Automation,Database,DevOps/.toString(),"Projects":/hack project1/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.WebstormHomepage.SetJoinEventHackApp().run("Expertise":/Automation,Testing/.toString(),"Add or Remove Expertise":/Remove,Add/.toString(),"Action on Update or Leave Event":/Update/.toString())
    }
    //Basestate
