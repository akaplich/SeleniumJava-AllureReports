...
//C130831 - Advanced Search - Search Hidden Question
class C130831_AdvancedSearch_SearchHiddenQuestion
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.EditAdditionalQuestionsinSubmissionFormtab().run("Question":/Required Short Question/.toString(),"Edit or Hide or Remove":/Hide/.toString(),"Save Form":true)
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Apps/.toString())
        //Quick or Advance Search in Global Nav
        new actions.Search.QuickOrAdvanceSearchInGlobalNav().run("Tab (optional)":/Advanced Search/.toString(),"Search Input":/required short/.toString())
        //Verify Quick or Advanced Search Result
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"No Search Results":true,"Name of the searched item":/required short/.toString())
        //Log Out
