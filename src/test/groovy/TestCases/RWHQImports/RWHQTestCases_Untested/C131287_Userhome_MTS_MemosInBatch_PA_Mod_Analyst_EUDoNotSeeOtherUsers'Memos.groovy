...
class C131287_Userhome_MTS_MemosInBatch_PA_Mod_Analyst_EUDoNotSeeOtherUsers'Memos
{
    ...
    public void testcase(){
        ...
        new actions.general.Navigate().run("Area to Navigate to":/Apps/.toString())
        //Create Memo Webstorm
        new actions.WebstormCreation.CreateMemoWebstorm().run("Sponsor Name":/Pipeline Sponsor/.toString(),"Sponsor Add or Remove":/Add/.toString(),"Webstorm Title":/MemoRestricted/.toString(),"Description":/Test Description/.toString(),"Vanity URL":/MemoRestricted/.toString(),"Action on Design Tab":/Continue/.toString(),"Type of Licensing Model":/Standard Licensing Model/.toString(),"General Access":/End User 2,End User/.toString(),"General Access Add or Remove":/Add,Add/.toString(),"Action":/Create/.toString())
        ...
        //Login
        new actions.general.Login().run("Email":/bi.enduser1@brightidea.com/.toString(),"Verify if Logged In On Enterprise homepage":false)
        //Navigate
        ...
        new actions.Memo.CollabEditorSetSubmitToBatch().run("Via Button or Dropdown?":/Button/.toString(),"Select batch":/MemoRestricted/.toString(),"Action":/Submit/.toString())
        //Collab Editor - Click Go Back Button
        new actions.Memo.ColabEditorClickGoBackButton().run([:])
        //Set Memo Template Tile
        new actions.MTS.SetMemoTemplateTile().run("Template":/Blank Document/.toString())
        //Collab Editor - Set Memo Title
        new actions.Memo.ColabEditorSetMemoTitle().run("New Title":/All Memo/.toString(),"Action":/Submit/.toString())
        //Collab Editor/Userhome/MTS - Set Submit to Batch
        ...
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/bi.enduser2@brightidea.com/.toString(),"Verify if Logged In On Enterprise homepage":false)
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Navigate Tab User Homepage or MTS
        new actions.Enterprise.UserHomepage.NavigateTabUserHomepage().run("Tab":/Memos/.toString())
        ...
        new actions.MTS.SetMemoTemplateTile().run("Template":/Blank Document/.toString())
        //Collab Editor - Set Memo Title
        new actions.Memo.ColabEditorSetMemoTitle().run("New Title":/End User2 - Memo/.toString(),"Action":/Submit/.toString())
        //Collab Editor/Userhome/MTS - Set Submit to Batch
        new actions.Memo.CollabEditorSetSubmitToBatch().run("Via Button or Dropdown?":/Button/.toString(),"Select batch":/MemoRestricted/.toString(),"Action":/Submit/.toString())
        //Collab Editor - Click Go Back Button
        new actions.Memo.ColabEditorClickGoBackButton().run([:])
        ...
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/End User - Memo/.toString(),"User Name":/End User/.toString(),"Status":/Incubate/.toString(),"Number of Matches":/0/.toString())
        //Verify Memo Card in Userhomepage
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/End User2 - Memo/.toString(),"User Name":/End User 2/.toString(),"Status":/Incubate/.toString(),"Number of Matches":/1/.toString())
        //Verify Memo Card in Userhomepage
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/All - Memo/.toString(),"User Name":/End User/.toString(),"Status":/Incubate/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/${variables."TCData.User"}/.toString(),"Password":/brightidea1/.toString(),"Verify if Logged In On Enterprise homepage":false)
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Navigate Tab User Homepage or MTS
        new actions.Enterprise.UserHomepage.NavigateTabUserHomepage().run("Tab":/Memos/.toString())
        ...
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/End User - Memo/.toString(),"User Name":/End User/.toString(),"Status":/Incubate/.toString(),"Number of Matches":/0/.toString())
        //Verify Memo Card in Userhomepage
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/End User 2 - Memo/.toString(),"User Name":/End User 2/.toString(),"Status":/Incubate/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
