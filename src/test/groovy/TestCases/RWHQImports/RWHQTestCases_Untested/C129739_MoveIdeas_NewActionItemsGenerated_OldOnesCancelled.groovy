...
//C129739 - Move Ideas - New Action Items Generated, Old Ones Cancelled
class C129739_MoveIdeas_NewActionItemsGenerated_OldOnesCancelled
{
    ...
    public void testcase(){
        ...
        //Set New Move Ideas in Pipeline Steps page
        new actions.PipelineStepsView.NewMoveIdeasinPipelineStepspage().run("Move To Pipeline":/Pipeline C/.toString(),"Category":/New Product/.toString(),"Status":/Submitted/.toString(),"Action":/Move Idea/.toString())
        //Navigate
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/No action items completed/.toString(),"Should Exist":true)
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
