...
//C131013 - WB - Delete Shared Collaborator
class C131013_WB_DeleteSharedCollaborator
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SetShareWhiteboard().run("Click Share Button":true,"User(s)":/pipelineadmin@test.com/.toString(),"User Add or Remove":/Add/.toString(),"Send Invite":true,"Action":/Close/.toString())
        //Copy Current URL
