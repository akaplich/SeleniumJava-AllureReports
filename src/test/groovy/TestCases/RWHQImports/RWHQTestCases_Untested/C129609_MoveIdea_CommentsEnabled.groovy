...
//C129609 - Move Idea - Comments Enabled
class C129609_MoveIdea_CommentsEnabled
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasCommentsTab().run("Action":/Save Changes/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Pipeline A/.toString(),"Area to Navigate to":/Setup/.toString())
        ...
        new actions.PipelineStepsView.NewMoveIdeasinPipelineStepspage().run("Move To Pipeline":/Custom App/.toString(),"Category":/New Product/.toString(),"Status":/Pending/.toString(),"Action":/Move Idea/.toString())
        //Navigate WebStorm or MTS
