...
class C131224_VI3_LinkedIdeas_EndUsersCannotSeeHiddenLinkedIdeas
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea30.VerifyLinkedSubmissionsVI3().run("Linked Idea(s)":/(D105) quick add1/.toString(),"Linked Idea(s) Status":/Submitted/.toString(),"Should Exist":/FALSE/.toString())
    }
    //Basestate
