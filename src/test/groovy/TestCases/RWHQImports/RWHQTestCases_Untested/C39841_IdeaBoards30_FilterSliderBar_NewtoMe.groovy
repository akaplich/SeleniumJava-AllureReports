...
//C39841 - Idea Boards 30 - Filter Slider Bar - New to Me
class C39841_IdeaBoards30_FilterSliderBar_NewtoMe
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Status":[],"Stage":[],"Categories":[],"Tags":[],"Admin Tags":[],"Desired Expertise":[],"New To Me":true)
