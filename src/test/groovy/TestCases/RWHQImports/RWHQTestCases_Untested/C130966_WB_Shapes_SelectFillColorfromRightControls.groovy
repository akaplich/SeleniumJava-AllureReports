...
//C130966 - WB - Shapes - Select Fill Color from Right Controls
class C130966_WB_Shapes_SelectFillColorfromRightControls
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("Fill Color":/E74C3C/.toString())
        //Verify Smart Matrix & Other Elements Exists On Whiteboard
        new actions.Whiteboards.VerifySmartMatrixExists().run("Element (skip if verifying text)":/Rectangle 2/.toString(),"Should Exist":true)
    }
    //Basestate
