...
//C128119 - Idea Board 30 - Back Button Respects Sort by Title
class C128119_IdeaBoard30_BackButtonRespectsSortbyTitle
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/adhoc idea1/.toString(),"Description":/desc/.toString(),"Category":/Operations/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Title/.toString(),"Idea Name":/adhoc idea1/.toString())
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/adhoc idea1/.toString(),"Linked Submissions":[])
        //Click Previous/Next Button on View Idea
