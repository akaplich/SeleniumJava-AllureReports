...
//C129954 - List View - Pinned Comment with attachment
class C129954_ListView_PinnedCommentwithattachment
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("Comment":/test pinned comment/.toString(),"Comment Type":/Pinned/.toString(),"Attachment File":/Image4.jpg,SamplePNG.png/.toString(),"Attachment Add or Remove":/Add,Add/.toString(),"Post Comment":true)
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        ...
        new actions.IdeaBoard.VerifyPinnedCommentinIdeaBoardsListView().run("Idea":/test idea2/.toString(),"Comment":/test pinned comment/.toString(),"Comment Submitter":/System Admin/.toString(),"Comment Submitter Image":false,"Comment Date Displayed":true,"Edited Indicator":false,"Attachments":/Image4.jpg,SamplePNG.png/.toString(),"Number of Matches":/1/.toString())
        //Verify Image or File in the Viewer
        new actions.IdeaBoard.VerifyImageorFileintheViewerintheListView().run("Idea":/test idea2/.toString(),"Comment":/test pinned comment/.toString(),"Image or File":/Image4.jpg/.toString(),"Number of Matches":/1/.toString())
        //Verify Image or File in the Viewer
        new actions.IdeaBoard.VerifyImageorFileintheViewerintheListView().run("Idea":/test idea2/.toString(),"Comment":/test pinned comment/.toString(),"Image or File":/SamplePNG.png/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
