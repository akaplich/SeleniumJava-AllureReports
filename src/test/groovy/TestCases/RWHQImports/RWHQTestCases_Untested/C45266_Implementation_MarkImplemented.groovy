...
//C45266 - Implementation - Mark Implemented
class C45266_Implementation_MarkImplemented
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Verify in Which List (optional)":/My Action Items/.toString(),"Title":/Find Owner Idea1/.toString(),"Answer":/Implemented/.toString(),"Number of Matches":/1/.toString())
        ...
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/Find Owner Idea1/.toString(),"Step Name idea belongs to":/Record Outcomes/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
