...
//C128730 - Pipeline List View - Actions Dropdown - Delete Ideas
class C128730_PipelineListView_ActionsDropdown_DeleteIdeas
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SetDeleteIdea().run("I understand that deleting these Ideas will also delete all related comments, votes, and action items.":true,"Action":/Delete Ideas/.toString())
