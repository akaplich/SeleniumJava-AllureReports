...
//C129561 - List View - Hidden Comment Count
class C129561_ListView_HiddenCommentCount
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.SetCommentEditMenu().run("Comment to Edit":/test general comment/.toString(),"Menu Option":/Hide/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
