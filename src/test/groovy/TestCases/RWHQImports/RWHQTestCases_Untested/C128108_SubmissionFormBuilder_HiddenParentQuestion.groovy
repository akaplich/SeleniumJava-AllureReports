...
//C128108 - Submission Form Builder - Hidden Parent Question
class C128108_SubmissionFormBuilder_HiddenParentQuestion
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetPostIdeaFields().run("Idea Title Question - Title":/Title/.toString(),"Idea Title Question - Value":/test idea3/.toString(),"Description Question - Title":/Description/.toString(),"Description Question - Value":/desc/.toString(),"Category Question - Title":/Category/.toString(),"Category Question - Value":/New Product/.toString(),"Multiple Choice - Title":/Parent Question/.toString(),"Multiple Choice - Value":/Answer 1/.toString())
        //Set Post Idea Fields
        new actions.PostIdea.SetPostIdeaFields().run("Short Answer - Title":/Child Question/.toString(),"Short Answer - Value":/test text here/.toString(),"Action":/Submit Idea/.toString())
        //Navigate Webstorm via Admin Dropdown Only
        new actions.general.NavigateWebstormviaAdminBarOnly().run("Area to Navigate to":/Site Setup/.toString())
        //Edit Additional Questions in Submission Form tab
        new actions.SetupIdeas.EditAdditionalQuestionsinSubmissionFormtab().run("Question":/Parent Question/.toString(),"Edit or Hide or Remove":/Hide/.toString(),"Action on Edit, Hide or Remove":/Submit/.toString(),"Save Form":true)
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Test App/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Parent Question/.toString(),"Should Exist":false)
        //Verify Message
