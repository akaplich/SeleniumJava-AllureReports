...
//C118996 - Highlights - All Activity - Delete User who submitted voted Idea
class C118996_Highlights_AllActivity_DeleteUserwhosubmittedvotedIdea
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin has demoted "test idea2" by Sri/.toString(),"Number of Matches":/0/.toString())
        //Verify Highlights Item on User Homepage
