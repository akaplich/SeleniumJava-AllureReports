...
//C129317 - Userhome - Featured Activities Updated
class C129317_Userhome_FeaturedActivitiesUpdated
{
    ...
    public void testcase(){
        ...
        new actions.SetupSite.SetEnterpriseSetupSiteUserHomepage().run("User Homepage options":/User Homepage/.toString(),"Highlights":true,"Featured Activity":true,"Featured Activity Title(s)":/Solve App,My Activity - Test/.toString(),"Featured Activity Title(s) Add or Remove":/Add,Add/.toString(),"Activities":true,"My Ideas":true,"Submissions":true,"Projects":true,"Helpful Links":true,"User Metrics My Ideas":true,"User Metrics Submissions":true,"User Metrics Activities":true,"User Metrics Submission Views":true,"User Metrics Collaborators":true,"User Metrics Projects":true,"User Metrics Business Impact":true)
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Enterprise Setup/.toString())
        //Set Enterprise Setup Site User Homepage 
        new actions.SetupSite.SetEnterpriseSetupSiteUserHomepage().run("Featured Activity Title(s)":/Solve App,My Activity - Test,Custom App,Evaluators app/.toString(),"Featured Activity Title(s) Add or Remove":/Remove,Remove,Add,Add/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
