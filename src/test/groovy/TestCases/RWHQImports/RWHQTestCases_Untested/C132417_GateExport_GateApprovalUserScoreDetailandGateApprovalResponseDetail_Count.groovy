...
//C132417 - Gate Export - Gate Approval User Score Detail and Gate Approval Response Detail (Count)
class C132417_GateExport_GateApprovalUserScoreDetailandGateApprovalResponseDetail_Count
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC132417/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/brightC132417@mailinator.com/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Accelerate title/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Export Step in Pipeline Steps page
        new actions.PipelineStepsView.ExportStepinPipelineStepsPage().run("Step to Export":/gate for testing/.toString(),"Action Items":false,"Submissions":false,"User Score Detail":true,"Response Detail (Count)":false,"Response Detail (Percentage)":false,"Response Detail (Text)":false,"Response Detail (Flag)":false,"Action":/Export/.toString())
        //Get Download Link from Email
        variables."link" = new actions.Mailinator.GetDownloadLinkfromEmail().run("Email Address":/brightC132417/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Gate_Approval_user_detail*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Code","Title","Submitter Email","Category","Scorecard Template","Scorecard Score","Evaluator","End User","Pipeline Admin"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Gate_Approval_user_detail*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["idea2","75"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Export Step in Pipeline Steps page
        new actions.PipelineStepsView.ExportStepinPipelineStepsPage().run("Step to Export":/gate for testing/.toString(),"Action Items":false,"Submissions":false,"User Score Detail":false,"Response Detail (Count)":true,"Response Detail (Percentage)":false,"Response Detail (Text)":false,"Response Detail (Flag)":false,"Action":/Export/.toString())
        //Get Download Link from Email
        variables."link" = new actions.Mailinator.GetDownloadLinkfromEmail().run("Email Address":/brightC132417/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        ...
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Gate_Approval_details_count-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["The proposal is aligned with our strategy and objectives."],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Gate_Approval_details_count-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["idea2","75","1"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
