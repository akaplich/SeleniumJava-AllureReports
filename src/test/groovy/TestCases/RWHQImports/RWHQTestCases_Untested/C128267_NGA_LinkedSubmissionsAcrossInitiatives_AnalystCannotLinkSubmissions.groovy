...
//C128267 - NGA - Linked Submissions Across Initiatives - Analyst Cannot Link Submissions
class C128267_NGA_LinkedSubmissionsAcrossInitiatives_AnalystCannotLinkSubmissions
{
    ...
    public void testcase(){
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Search Submissions/.toString(),"Should Exist":false)
        try{
            //Set Linked Submissions on NGA View Idea Page
