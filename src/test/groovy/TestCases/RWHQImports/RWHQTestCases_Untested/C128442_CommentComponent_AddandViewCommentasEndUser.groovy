...
//C128442 - Comment Component - Add and View Comment as End User
class C128442_CommentComponent_AddandViewCommentasEndUser
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/test general comment/.toString(),"User":/End User/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Reply/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/test general comment/.toString(),"Reply Comment":/test reply to general comment/.toString(),"User":/End User/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        try{
            //Add Comment in View and NGA View Idea
            new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("Comment":/test submitter QA comment/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Post Comment":true)
        }
