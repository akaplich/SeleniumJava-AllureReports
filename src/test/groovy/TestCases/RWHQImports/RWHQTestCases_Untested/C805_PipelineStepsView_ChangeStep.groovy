...
//C805 - Pipeline Steps View - Change Step
class C805_PipelineStepsView_ChangeStep
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/test idea1/.toString(),"Step Name idea belongs to":/Single Scale/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
