...
//C128875 - Comment Component - Add and View Submitter QA Comment as Analyst in NGA View Idea
class C128875_CommentComponent_AddandViewSubmitterQACommentasAnalystinNGAViewIdea
{
    ...
    public void testcase(){
        ...
        try{
            //Add Comment in View and NGA View Idea
            new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("View Idea or NGA":/NGA/.toString(),"Comment":/test analyst submitter QA comment/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Post Comment":true)
        }
       catch(all){}catch(Error err){}
        try{
            //Reply to Comment in View and NGA View Idea
            new actions.ViewIdeaComment.ReplytoCommentinViewandNGAViewIdea().run("Parent Comment":/test submitter QA comment/.toString(),"Comment Reply":/test reply to analyst submitter QA comment/.toString(),"Post Reply":true)
        }
       catch(all){}catch(Error err){}
        //Verify Comment Count in the Header
        new actions.ViewIdeaComment.VerifyCommentCountintheHeader().run("Comment Count":/3/.toString())
        ...
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Parent Comment":/test analyst submitter QA comment/.toString(),"User":/analyst/.toString(),"Number of Matches":/0/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Reply/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Parent Comment":/test submitter QA comment/.toString(),"Reply Comment":/test reply to analyst submitter QA comment/.toString(),"User":/analyst/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
