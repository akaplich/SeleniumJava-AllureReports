...
//C130733 - Quarterly BI export from the Community Setup
class C130733_QuarterlyBIexportfromtheCommunitySetup
{
    ...
    public void testcase(){
        ...
        //Update Community
        new actions.SetupEnterpriseCommunities.UpdateCommunity().run("Apps":/Custom Initiative title/.toString(),"Checkbox Check":/TRUE/.toString())
        //Go to Community
        ...
        new actions.SetupExports.DownloadGeneratedReport().run("Report Name Starts with":/Developers Community-Outcomes Details/.toString(),"Instance":/1/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/10/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/*Details-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["2021 Projected Benefit ($)","2021 Projected Cost ($)","2021 Actual Benefit ($)","2021 Actual Cost ($)","2022 Projected Benefit ($)","2022 Projected Cost ($)","2022 Actual Benefit ($)","2022 Actual Cost ($)"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Report Name Starts with":/Developers Community-Outcomes Details/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/*Details-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Benefit","Cost Savings","24000","0"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Report Name Starts with":/Developers Community-Outcomes Details/.toString(),"Instance":/1/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/10/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/*Details-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["24000","0","25000"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Report Name Starts with":/Developers Community-Outcomes Details/.toString(),"Instance":/1/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/10/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/*Details-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Cost","New Cost","0","-35000"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Report Name Starts with":/Developers Community-Outcomes Details/.toString(),"Instance":/1/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/10/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/*Details-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["-16000","0","-4000"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
