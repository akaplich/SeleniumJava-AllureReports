...
//C132070 - Task Sort and Filter - Dragging and adding tasks in filtered list
class C132070_TaskSortandFilter_Draggingandaddingtasksinfilteredlist
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.SetFilterforProjectRoomTasks().run("Invoke Filter":true,"Assignee":["End User","Pipeline Admin"],"Status":[],"Due Date":[])
        try{
            //Drag and Drop Tasks in Project Room
            new actions.ProjectRoom.DragandDropTasksinProjectRoom().run("Task":/1TASK/.toString(),"New Row Number":/1/.toString())
        }
        ...
        //Verify Tasks in Project Room
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/ZTask/.toString(),"Assignee":/System Admin/.toString(),"Status":/In Progress/.toString(),"Due Date":/11\/24\/2024/.toString(),"Marked Completed":false,"Number of Matches":/0/.toString())
        //Set Add or Edit Tasks In Project Room
        new actions.ProjectRoom.SetTasksInProjectRoom().run("Add or Edit":/Add/.toString(),"New Task Name":/lasttask/.toString(),"Row Number":/3/.toString(),"Assignee":/System Admin/.toString(),"Status":/Paused/.toString(),"Due Date":/06-07-2024/.toString())
        //Set Project Room Tasks Sort
        new actions.ProjectRoom.SetProjectRoomTasksSort().run("Column To Sort":/Assignee/.toString())
        //Verify Tasks in Project Room
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/lasttask/.toString(),"Assignee":/System Admin/.toString(),"Status":/Paused/.toString(),"Due Date":/06\/07\/2024/.toString(),"Marked Completed":false,"Number of Matches":/0/.toString())
        //Verify Tasks in Project Room
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/1TASK/.toString(),"Assignee":/End User/.toString(),"Status":/Paused/.toString(),"Due Date":/06\/07\/2024/.toString(),"Marked Completed":false,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Tasks in Project Room
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/1task/.toString(),"Assignee":/Pipeline Admin/.toString(),"Status":/Blocked/.toString(),"Due Date":/Select Date.../.toString(),"Marked Completed":false,"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
