...
//C59029 - Login Widget - System Admin
class C59029_LoginWidget_SystemAdmin
{
    ...
    public void testcase(){
        ...
        new actions.SetupSite.SetWebstormSetupSiteInfoPage().run("Webstorm Description":/New Edited Description/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Home/.toString())
        //Verify and Access Enterprise Login Widget
