...
//C39843 - Pipeline Creation - Create Consult App
class C39843_PipelineCreation_CreateConsultApp
{
    ...
    public void testcase(){
        ...
        new actions.Webstorm.VerifyWebstormHome().run("Webstorm Title":/Consult title/.toString())
    }
    //Basestate
