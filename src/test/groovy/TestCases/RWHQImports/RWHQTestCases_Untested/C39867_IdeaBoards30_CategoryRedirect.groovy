...
//C39867 - Idea Boards 30 - Category Redirect
class C39867_IdeaBoards30_CategoryRedirect
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Category":/New Product/.toString(),"Title":/test idea3/.toString(),"Description":/description/.toString(),"Tag Add or Remove":/Add/.toString(),"Required Short Question":/required short/.toString(),"Action":/Submit Idea/.toString())
