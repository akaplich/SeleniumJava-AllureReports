...
//C129802 - Move Ideas - Matched Category in History Tab
class C129802_MoveIdeas_MatchedCategoryinHistoryTab
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.NewMoveIdeasinPipelineStepspage().run("Move To Pipeline":/Pipeline A/.toString(),"Action":/Move Idea/.toString())
        ...
        new actions.ViewIdea.VerifyHistoryTabonViewIdea().run("Event Record to Verify":/Category changed from 'Marketing & Branding' to 'Marketing & Branding' by System Admin/.toString(),"Number of Matches":/0/.toString())
        //Verify History Tab on View Idea
        new actions.ViewIdea.VerifyHistoryTabonViewIdea().run("Event Record to Verify":/Status changed from 'Submitted' to 'Submitted' by System Admin/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
