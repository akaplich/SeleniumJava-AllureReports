...
//C128849 - Development - Number - Update, Invalid Input
class C128849_Development_Number_Update_InvalidInput
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.SetDevelopmentActionItemPageFields().run("Number Question - Title":/Development Number/.toString(),"Number Question - Answer":/123.45/.toString(),"Action":/Save/.toString())
        //Access Action Item in Actions Items React Global Navigation
        new actions.ActionItems.AccessActionIteminActionsItemsReactGlobalNavigation().run("Action Item":/new idea/.toString())
        //Set Development Action Item Page Fields
        new actions.ActionItems.SetDevelopmentActionItemPageFields().run("Number Question - Title":/Development Number/.toString(),"Number Question - Answer":/test678test/.toString(),"Action":/Save/.toString())
        //Access Action Item in Actions Items React Global Navigation
        new actions.ActionItems.AccessActionIteminActionsItemsReactGlobalNavigation().run("Action Item":/new idea/.toString())
        //Verify Development Card Answers
        new actions.ActionItems.VerifyDevelopmentCardAnswers().run("Number Question - Title":/Development Number/.toString(),"Number Question - Answer":/678/.toString())
    }
    //Basestate
