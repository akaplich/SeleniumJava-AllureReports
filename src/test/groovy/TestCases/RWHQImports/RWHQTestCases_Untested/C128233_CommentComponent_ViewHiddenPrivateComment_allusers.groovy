...
//C128233 - Comment Component - View Hidden Private Comment (all users)
class C128233_CommentComponent_ViewHiddenPrivateComment_allusers
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("View Idea or NGA":/View Idea/.toString(),"Comment":/test private hidden comment/.toString(),"Comment Type":/Private/.toString(),"Post Comment":true)
        //Reply to Comment in View and NGA View Idea
        new actions.ViewIdeaComment.ReplytoCommentinViewandNGAViewIdea().run("Parent Comment":/test private hidden comment/.toString(),"Comment Reply":/test reply to private hidden comment/.toString(),"Post Reply":true)
        //Set Comment Edit Menu
        new actions.ViewIdeaComment.SetCommentEditMenu().run("Comment to Edit":/test private hidden comment/.toString(),"Menu Option":/Hide/.toString())
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("View Idea or NGA":/View Idea/.toString(),"Comment section":/Parent Comment/.toString(),"Comment Type":/Hidden/.toString(),"Parent Comment":/test private hidden comment/.toString(),"User":/System Admin/.toString(),"User Image":false,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("View Idea or NGA":/View Idea/.toString(),"Comment section":/Reply/.toString(),"Comment Type":/Hidden/.toString(),"Parent Comment":/test private hidden comment/.toString(),"Reply Comment":/test reply to private hidden comment/.toString(),"User":/System Admin/.toString(),"User Image":false,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        ...
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("View Idea or NGA":/View Idea/.toString(),"Comment section":/Parent Comment/.toString(),"Comment Type":/Hidden/.toString(),"Parent Comment":/test private hidden comment/.toString(),"User":/System Admin/.toString(),"User Image":false,"Number of Matches":/0/.toString())
        //Verify Comment in View and NGA View Idea
