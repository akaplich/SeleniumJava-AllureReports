...
//C130632 - Merge Ideas - Analyst Can See Hidden Children 
class C130632_MergeIdeas_AnalystCanSeeHiddenChildren
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SetMergeIdeasInPipelineStepsList().run("Verify Order of Ideas:":[],"Select Parent":/hidden parent/.toString(),"Action":/Merge Ideas/.toString())
        //Select Ideas in Pipeline List View
        ...
        new actions.ViewIdea.VerifyMergedSubmissionOnViewIdea().run("Merged Submissions":/visible child,hidden child/.toString(),"Should Exist":/TRUE,TRUE/.toString())
    }
    //Basestate
