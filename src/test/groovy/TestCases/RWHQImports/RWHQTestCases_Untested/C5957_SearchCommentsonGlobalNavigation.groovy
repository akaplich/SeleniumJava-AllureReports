...
//C5957 - Search Comments on Global Navigation
class C5957_SearchCommentsonGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/Yet another Comment/.toString(),"Click View All Results after search":true)
        //Click link on Search Page results section
        new actions.Search.ClicklinkonSearchPageresultssection().run("Search Results Type":/Comments/.toString(),"Link name":/Yet another Comment/.toString())
