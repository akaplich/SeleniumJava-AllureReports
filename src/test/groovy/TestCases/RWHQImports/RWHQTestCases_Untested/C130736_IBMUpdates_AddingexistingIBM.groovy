...
//C130736 - IBM Updates - Adding existing IBM
class C130736_IBMUpdates_AddingexistingIBM
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightexistinguserC130736_test3/.toString(),"Finally Login as What User":/communityadmin@test.com/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.PipelineSetup.SetRolesinPipelineSetupPage().run("Type of Licensing Model":/Standard Licensing Model/.toString(),"Navigate to Tab":true,"Idea Box Managers":/brightexistinguserC130736_test3@mailinator.com/.toString(),"Idea Box Managers Add or Remove":/Add/.toString(),"Click Save":false)
        //Verify Message
        ...
        variables."link" = new actions.Mailinator.GetLinkfromInviteParticipantEmail().run("Inbox Email Count":/1/.toString(),"Email Address":/brightexistinguserC130736_test3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Login
        new actions.general.Login().run("Email":/brightexistinguserC130736_test3@mailinator.com/.toString(),"Password":/brightidea1/.toString())
