...
//C63182 - [Team Workspace] - Edit Financial and NonFinancial Data in Business Impact tab
class C63182_[TeamWorkspace]_EditFinancialandNonFinancialDatainBusinessImpacttab
{
    ...
    public void testcase(){
        ...
        //Set Non Financial Benefit in Business Impact tab
        new actions.ViewIdea.BusinessImpact.SetNonFinancialBenefitinBusinessImpacttab().run("Add or Edit":/Edit/.toString(),"Benefit Title":/Product Launch/.toString(),"Benefit Type":/Customer Satisfaction/.toString(),"Description":/Changed Description/.toString(),"Row Number":/1/.toString())
        //Set Business Impact Tab
        new actions.ViewIdea.BusinessImpact.SetBusinessImpactForViewIdeaPage().run("Action":/Save Version/.toString())
        ...
        new actions.ViewIdea.BusinessImpact.VerifyNonFinancialBenefitsinBusinessImpacttabforViewIdeapage().run("Benefit Title":/Product Launch/.toString(),"Benefit Type":/Customer Satisfaction/.toString(),"Description":/Changed Description/.toString(),"Row Number":/1/.toString())
    }
    //Basestate
