...
//C117932 - Userhome Submissions Tab - Verify Draft Data
class C117932_UserhomeSubmissionsTab_VerifyDraftData
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Custom App test idea draft/.toString(),"Description":/Description of Idea draft for Custom App/.toString(),"Category":/New Product/.toString(),"Required Short Question":/required short answer/.toString(),"Action":/Save Draft/.toString())
        //Navigate
