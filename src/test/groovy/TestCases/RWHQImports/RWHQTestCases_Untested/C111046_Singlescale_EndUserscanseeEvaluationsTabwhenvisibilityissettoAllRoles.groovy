...
//C111046 - Singlescale - End Users can see Evaluations Tab when visibility is set to All Roles
class C111046_Singlescale_EndUserscanseeEvaluationsTabwhenvisibilityissettoAllRoles
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.VerifyEvaluationstabRibboninVewIdeapage().run("Overall Score":/5 Overall Score/.toString(),"Total Evaluation":/50 Percentile of 1 Submission/.toString(),"Completed Evaluation":/1 \/ 1 Evaluations Completed/.toString())
    }
    //Basestate
