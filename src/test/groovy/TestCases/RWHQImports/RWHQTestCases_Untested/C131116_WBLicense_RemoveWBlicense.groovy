...
//C131116 - WB License - Remove WB license
class C131116_WBLicense_RemoveWBlicense
{
    ...
    public void testcase(){
        ...
        new actions.general.Navigate().run("Area to Navigate to":/People/.toString())
        //Verify Licenses Metrics in People Pillar
        new actions.People.VerifyLicensesMetricsinPeoplePillar().run("License Type":/Whiteboard License Type/.toString(),"Metric Text":/In Use/.toString(),"Metric Value":/2/.toString(),"Number of Matches":/1/.toString())
        //Set Whiteboard License User
        new actions.People.SetWhiteboardLicenseUser().run("Expand License Breakdown":true,"Remove User":/analyst/.toString(),"Remove Licensed User Action":/Remove/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/User removed successfully!/.toString(),"Should Exist":true)
        //Verify Whiteboard Licenses in Use
        new actions.People.VerifyWhiteboardLicensesinUse().run("Expand License Breakdown":false,"Licenses in Use":/analyst/.toString(),"Number of Whiteboards":/3/.toString()," Last Login":/Todays date/.toString(),"Number of Matches":/0/.toString())
        //Verify Whiteboard Licenses in Use
        ...
        new actions.Whiteboards.VerifyWhiteboard().run("Whiteboard Name":/Whiteboard1/.toString(),"Number of Matches":/1/.toString())
        //Verify Whiteboard Card in Userhomepage
        new actions.Whiteboards.VerifyWhiteboard().run("Whiteboard Name":/Whiteboard2/.toString(),"Number of Matches":/1/.toString())
        //Verify Whiteboard Card in Userhomepage
        new actions.Whiteboards.VerifyWhiteboard().run("Whiteboard Name":/Whiteboard3/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
