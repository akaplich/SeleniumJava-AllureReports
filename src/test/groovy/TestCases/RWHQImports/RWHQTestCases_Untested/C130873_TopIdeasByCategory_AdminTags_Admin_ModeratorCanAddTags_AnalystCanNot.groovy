...
//C130873 - Top Ideas By Category - Admin Tags - Admin, Moderator Can Add Tags, Analyst Can Not
class C130873_TopIdeasByCategory_AdminTags_Admin_ModeratorCanAddTags_AnalystCanNot
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.AddAdminIdeaTaginPipelineStepspage().run("Tag Name":/testtag1/.toString(),"Tag Add or Remove":/Add/.toString(),"Action":/Add Admin Tags/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.PipelineTopIdeas.SetRightClickMenuInTopIdeas().run("Select Option":/Add admin tags.../.toString())
        //Add Admin Idea Tag in Pipeline Steps page
        new actions.PipelineStepsView.AddAdminIdeaTaginPipelineStepspage().run("Tag Name":/testtag2,testtag3/.toString(),"Tag Add or Remove":/Add,Add/.toString(),"Action":/Add Admin Tags/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        try{
            //Add Admin Idea Tag in Pipeline Steps page
            new actions.PipelineStepsView.AddAdminIdeaTaginPipelineStepspage().run("Tag Name":/testtag4/.toString(),"Tag Add or Remove":/Add/.toString(),"Action":/Add Admin Tags/.toString())
        }
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/End User/.toString(),"Idea Name":/test idea1/.toString(),"Admin Tag":/testtag1,testtag2,testtag3,testtag4/.toString(),"Admin Tag Should Exist":/TRUE,TRUE,TRUE,FALSE/.toString())
    }
    //Basestate
