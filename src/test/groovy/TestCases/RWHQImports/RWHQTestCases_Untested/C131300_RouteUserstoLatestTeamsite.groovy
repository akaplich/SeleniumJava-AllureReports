...
//C131300 - Route Users to Latest Team site
class C131300_RouteUserstoLatestTeamsite
{
    ...
    public void testcase(){
        ...
        new actions.selenium.NavigateToURL().run("URL":/${variables."affiliateURL"}\/app\/apps/.toString())
        //Create Memo Webstorm
        new actions.WebstormCreation.CreateMemoWebstorm().run("Sponsor Name":/Pipeline Sponsor/.toString(),"Sponsor Add or Remove":/Add/.toString(),"Webstorm Title":/Memo Program testing2/.toString(),"Description":/desc/.toString(),"Vanity URL":/teamsite2/.toString(),"General Access":/End User/.toString(),"General Access Add or Remove":/Add/.toString(),"Action":/Create/.toString())
        //Log Out
        ...
        //Verify Page Title
        new actions.selenium.VerifyPageTitle().run("Title":/Memo Program testing2: Team Site/.toString())
        //Navigate to URL
        ...
        new actions.general.Login().run("Email":/bi.enduser1@brightidea.com/.toString(),"Password":/brightidea1/.toString(),"Verify if Logged In On Enterprise homepage":false)
        //Verify Page Title
        new actions.selenium.VerifyPageTitle().run("Title":/Memo Program testing1: Team Site/.toString())
    }
    //Basestate
