...
//C65660 - Community Stats Widget - Chips voting
class C65660_CommunityStatsWidget_Chipsvoting
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.SetChipsinViewIdeapage().run("Add or Edit Chips":/Add Chips/.toString(),"Chip count to be added":/6/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Widgets.VerifyWidgetCommunityStats().run("submissions":/3/.toString(),"comment":/1/.toString(),"votes":/6/.toString())
    }
    //Basestate
