...
//C131484 - Memo - Share - Can Comment Permission - Memo Export Available
class C131484_Memo_Share_CanCommentPermission_MemoExportAvailable
{
    ...
    public void testcase(){
        ...
        new actions.Memo.ColabEditorSetMemoTitle().run("New Title":/C131484Everyone/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Memo.MemoShareDialogSetParticipants().run("Click Share Button":true,"Anyone With Link":/can comment/.toString(),"Action":/Close/.toString())
        //Copy Current URL
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/C131484Everyone*.pdf/.toString(),"File Location":/Downloads/.toString(),"Row Values":[])
        //Copy Current URL
        variables."currentURL" = new actions.selenium.CopyCurrentURL().run([:])
        //Collab Editor - Click Go Back Button
        new actions.Memo.ColabEditorClickGoBackButton().run([:])
        ...
        new actions.selenium.NavigateToURL().run("URL":/${variables."currentURL"}/.toString())
        //Collab Editor - Set Memo Title
        new actions.Memo.ColabEditorSetMemoTitle().run("New Title":/C131484IndUser/.toString(),"Action":/Submit/.toString())
        //Collab Editor/Userhome - Memo Share Dialog -  Set Participants
        new actions.Memo.MemoShareDialogSetParticipants().run("Click Share Button":true,"User(s)":/End User/.toString(),"Permission (required)":/can comment/.toString(),"Send Invite":/TRUE/.toString(),"Anyone With Link":/can view/.toString(),"Action":/Close/.toString())
        //Copy Current URL
        variables."currentURL" = new actions.selenium.CopyCurrentURL().run([:])
        //Collab Editor - Click Go Back Button
        new actions.Memo.ColabEditorClickGoBackButton().run([:])
        ...
        new actions.Memo.CollabEditorSetToolBarOptions().run("Export":true)
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/C131484IndUser*.pdf/.toString(),"File Location":/Downloads/.toString(),"Row Values":[])
    }
    //Basestate
