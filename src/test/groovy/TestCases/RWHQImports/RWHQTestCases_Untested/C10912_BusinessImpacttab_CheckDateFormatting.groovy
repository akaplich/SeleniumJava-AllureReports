...
//C10912 - Business Impact tab - Check Date Formatting
class C10912_BusinessImpacttab_CheckDateFormatting
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.BusinessImpact.SetDateandNotesforFinancialSummaryinBusinessImpacttab().run("Date":/05-09-18/.toString())
        ...
        new actions.ViewIdea.BusinessImpact.VerifyDateandNotesforFinancialSummaryinBusinessImpactTab().run("Date":/05-09-18/.toString())
    }
    //Basestate
