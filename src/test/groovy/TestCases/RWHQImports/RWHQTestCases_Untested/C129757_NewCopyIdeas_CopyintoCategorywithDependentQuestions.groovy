...
//C129757 - New Copy Ideas - Copy into Category with Dependent Questions
class C129757_NewCopyIdeas_CopyintoCategorywithDependentQuestions
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaFields.VerifyViewIdeaDescriptionTabFieldMultiValue().run("Field Name":/Dependent New Product/.toString(),"Field Value":/<EMPTY>/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Pipeline B/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
