...
//C128586 - Search blog title on Initiative Global Navigation
class C128586_SearchblogtitleonInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Blog Posts/.toString(),"Title":/First Blog Post/.toString(),"Number of Matches":/1/.toString(),"Click on the result":true)
