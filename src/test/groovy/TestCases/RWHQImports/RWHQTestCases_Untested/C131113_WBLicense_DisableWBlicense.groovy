...
//C131113 - WB License - Disable WB license
class C131113_WBLicense_DisableWBlicense
{
    ...
    public void testcase(){
        //Basestate
        Action58123c20fa4ee77809f468f6("Licensing Model":/Standard Licensing Model/.toString(),"Brightidea Administrator License Type Purchased Count":/3/.toString(),"Idea Box Manager License Type Purchased Count":/1/.toString())
        ...
        //Set License Manager
        new actions.general.SetLicenseManager().run("System":/${variables."affiliateURL"}/.toString(),"Enable IT System Admin role overlay":true,"Require min one user assigned as IT System Admin":false,"Enable Whiteboard License":false,"Unlicensed Board limit count":/1/.toString())
        //Navigate to URL
        ...
        new actions.People.VerifyLicensesMetricsinPeoplePillar().run("License Type":/Idea Box Manager License Type/.toString(),"Metric Text":/Purchased/.toString(),"Metric Value":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Whiteboard Licenses/.toString(),"Should Exist":false)
        //Log Out
        ...
        new actions.Whiteboards.CreateWhiteboardFromUserhome().run("Create New or Choose Template":/New Blank Whiteboard/.toString())
        //Set Whiteboard Title
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/PA Whiteboard1/.toString(),"Action":/Submit/.toString())
        //Go Back From Whiteboard
        new actions.Whiteboards.GoBackFromWhiteboard().run([:])
        //Create Whiteboard or Edit Template
