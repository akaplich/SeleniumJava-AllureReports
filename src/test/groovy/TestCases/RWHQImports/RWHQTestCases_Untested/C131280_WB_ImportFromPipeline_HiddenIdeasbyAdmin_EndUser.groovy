...
//C131280 - WB - Import From Pipeline - Hidden Ideas by Admin, End User
class C131280_WB_ImportFromPipeline_HiddenIdeasbyAdmin_EndUser
{
    ...
    public void testcase(){
        ...
        //Click on Element
        new actions.selenium.Click().run("ID":/\/\/BUTTON[@id='user_homepage_save_button']/.toString(),"Type of Click":/Javascript/.toString())
        //Navigate
        ...
        new actions.Whiteboards.ImportIdeasFromPipelineToWhiteboard().run("Choose pipeline":/Custom App/.toString(),"Choose idea(s) to import":/quick add1/.toString(),"Action":/Submit/.toString())
        //Copy Current URL
        variables."currentURL" = new actions.selenium.CopyCurrentURL().run([:])
        //Whiteboard - Set Share
        new actions.Whiteboards.SetShareWhiteboard().run("Click Share Button":true,"User(s)":/End User 2/.toString(),"User Add or Remove":/Add/.toString(),"Send Invite":true,"Action":/Close/.toString())
