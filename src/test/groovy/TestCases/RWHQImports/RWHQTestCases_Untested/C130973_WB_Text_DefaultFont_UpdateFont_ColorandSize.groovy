...
//C130973 - WB - Text - Default Font, Update Font, Color and Size
class C130973_WB_Text_DefaultFont_UpdateFont_ColorandSize
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("Text Font":/Lato/.toString())
