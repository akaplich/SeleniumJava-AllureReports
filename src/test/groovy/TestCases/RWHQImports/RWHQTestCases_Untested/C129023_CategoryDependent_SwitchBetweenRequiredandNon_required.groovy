...
//C129023 - Category Dependent - Switch Between Required and Non-required
class C129023_CategoryDependent_SwitchBetweenRequiredandNon_required
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.VerifyErrorFieldinPostIdeapage().run("Field Name":/Dependent Required Strategy/.toString(),"Should Error Exist":true)
        //Set Post Idea Fields
        new actions.PostIdea.SetPostIdeaFields().run("Category Question - Title":/Category/.toString(),"Category Question - Value":/Operations/.toString(),"Action":/Submit Idea/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea3/.toString(),"Number of Matches":/1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Test App/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Post Idea Fields
        new actions.PostIdea.SetPostIdeaFields().run("Idea Title Question - Title":/Title/.toString(),"Idea Title Question - Value":/test idea4/.toString(),"Description Question - Title":/Description/.toString(),"Description Question - Value":/desc/.toString(),"Category Question - Title":/Category/.toString(),"Category Question - Value":/Operations/.toString(),"Short Answer - Title":/Dependent Operations/.toString(),"Short Answer - Value":/test dependent operations/.toString())
        //Set Post Idea Fields
        new actions.PostIdea.SetPostIdeaFields().run("Category Question - Title":/Category/.toString(),"Category Question - Value":/Strategy/.toString(),"Action":/Submit Idea/.toString())
        //Verify Error Field in Post Idea page
        new actions.PostIdea.VerifyErrorFieldinPostIdeapage().run("Field Name":/Dependent Required Strategy/.toString(),"Should Error Exist":true)
    }
    //Basestate
