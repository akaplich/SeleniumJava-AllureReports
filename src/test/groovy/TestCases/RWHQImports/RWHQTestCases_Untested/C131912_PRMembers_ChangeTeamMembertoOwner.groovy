...
//C131912 - PR Members > Change Team Member to Owner
class C131912_PRMembers_ChangeTeamMembertoOwner
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.SetMembersinProjectRoom().run("Member":/System Admin,Pipeline Admin/.toString(),"Member Add or Remove":/Add,Add/.toString())
        ...
        //Verify Project Room Member in Members Tab
        new actions.ProjectRoom.VerifyProjectRoomMemberinMembersTab().run("Member Name":/End User/.toString(),"Member Display Picture":false,"Type of Member":/team member/.toString(),"Number of Matches":/1/.toString())
        //Verify Project Room Member in Members Tab
        ...
        try{
            //Edit or Remove Team Member in Project Room
            new actions.ProjectRoom.EditorRemoveTeamMemberinProjectRoom().run("Member(s)":/Pipeline Admin/.toString(),"Option(s)":/owner/.toString())
        }
