...
//C117689 - View My Idea - Single Space in the Title Field
class C117689_ViewMyIdea_SingleSpaceintheTitleField
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.SetViewMyIdeaTextField().run("Field Name":/Title/.toString(),"Field Value":/ /.toString())
