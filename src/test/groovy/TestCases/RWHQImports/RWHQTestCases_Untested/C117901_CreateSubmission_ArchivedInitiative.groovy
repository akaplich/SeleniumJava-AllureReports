...
//C117901 - Create Submission - Archived Initiative
class C117901_CreateSubmission_ArchivedInitiative
{
    ...
    public void testcase(){
        ...
        new actions.SetupEnterpriseWebStorms.ManageWebstormsfromEnterpriseSetuppage().run("Webstorms":/Custom App/.toString(),"Webstorm Status":/Archived/.toString())
        ...
        try{
            ...
            new actions.PostIdea.SetCustomAppPostIdea().run("Category":/New Product/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        }
       catch(all){}catch(Error err){}
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
