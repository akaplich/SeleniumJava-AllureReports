...
//C130691 - Copy Ideas with Dev Fields as Moderator
class C130691_CopyIdeaswithDevFieldsasModerator
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.NewCopyIdeasinPipelineStepspage().run("Pipeline":/Destination Pipeline/.toString(),"Missing Development Question Field":/1/.toString(),"Action":/Copy Idea/.toString())
        //Navigate WebStorm or MTS
