...
class C131387_WB_Stacks_BringCardsInRedwoodHQTestCaseOut_CardsRetainSettings
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131387/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.SetRightSideControlsWhiteboard().run("Fill Color":/B7EE5C/.toString(),"Fill Color Opacity":/50/.toString())
        //Refresh
        ...
        new actions.Whiteboards.SetMarkerToolToWhiteboard().run("X coordinate1":/0/.toString(),"Y coordinate1":/0/.toString(),"X coordinate2":/800/.toString(),"Y coordinate2":/0/.toString(),"X coordinate3":/0/.toString(),"Y coordinate3":/0/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/1/.toString())
        //Verify Right Side Controls in Whiteboard 
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("Fill Color":/B7EE5C/.toString(),"Fill Color Opacity":/50/.toString())
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/0/.toString(),"Y coordinate":/-50/.toString(),"Single Double or Right Click":/Single Click/.toString())
        ...
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/0/.toString(),"Y coordinate":/50/.toString(),"Single Double or Right Click":/Single Click/.toString())
        //Set Marker or Move Tool in Whiteboard
        new actions.Whiteboards.SetMarkerToolToWhiteboard().run("X coordinate1":/0/.toString(),"Y coordinate1":/0/.toString(),"X coordinate2":/-400/.toString(),"Y coordinate2":/0/.toString(),"X coordinate3":/0/.toString(),"Y coordinate3":/0/.toString())
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/0/.toString(),"Y coordinate":/-50/.toString(),"Single Double or Right Click":/Single Click/.toString())
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/0/.toString(),"Y coordinate":/50/.toString(),"Single Double or Right Click":/Single Click/.toString())
