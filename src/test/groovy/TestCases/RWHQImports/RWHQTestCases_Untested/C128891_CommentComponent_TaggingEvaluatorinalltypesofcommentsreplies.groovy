...
//C128891 - Comment Component - Tagging Evaluator in all types of comments replies
class C128891_CommentComponent_TaggingEvaluatorinalltypesofcommentsreplies
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.TagorUntagUserInCommentInViewAndNGAViewIdea().run("Comment Section":/Reply/.toString(),"SearchText":/Automation/.toString(),"Username":/Joe Doe/.toString(),"Email":/evaluator@test.com/.toString(),"Add or Remove":/Add/.toString())
        //Reply to Comment in View and NGA View Idea
        ...
        //Set Tag or Untag user in Comment in View and NGA View Idea
        new actions.ViewIdeaComment.TagorUntagUserInCommentInViewAndNGAViewIdea().run("Comment Section":/Reply/.toString(),"SearchText":/Joe/.toString(),"Username":/Joe Doe/.toString(),"Email":/evaluator@test.com/.toString(),"Add or Remove":/Add/.toString())
        //Reply to Comment in View and NGA View Idea
        ...
        //Set Tag or Untag user in Comment in View and NGA View Idea
        new actions.ViewIdeaComment.TagorUntagUserInCommentInViewAndNGAViewIdea().run("Comment Section":/Reply/.toString(),"SearchText":/Doe/.toString(),"Username":/Joe Doe/.toString(),"Email":/evaluator@test.com/.toString(),"Add or Remove":/Add/.toString())
        //Reply to Comment in View and NGA View Idea
