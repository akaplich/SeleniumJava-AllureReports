...
//C131968 - Project Room > Memo > OnedriveDoc
class C131968_ProjectRoom_Memo_OnedriveDoc
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.VerifyFolderOrRoomPageInProjectRoom().run("Placement Number of Child Page or Folder":/2/.toString(),"Child Page or Folder":/Automation One drive doc1.docx/.toString(),"Room Icon":/Memo/.toString(),"Memo Type for Room Icon":/OneDrive/.toString(),"Number of Matches":/1/.toString())
        //Navigate to Top Link or Page in Project Room
        new actions.ProjectRoom.NavigateRoomItems().run("Room Item":/Automation One drive doc1.docx/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Switch to Browser Window
        new actions.selenium.SwitchWindow().run("Tab (start from 0)":/1/.toString())
        ...
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Verify Page Title
        new actions.selenium.VerifyPageTitle().run("Title":/Automation One drive doc1.docx/.toString())
    }
    //Basestate
