...
//C128560 - Search Hidden Idea Status on Initiative Global Navigation
class C128560_SearchHiddenIdeaStatusonInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/Submitted/.toString())
