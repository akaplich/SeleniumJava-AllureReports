...
//C130936 - VI3 - Edit Status and Category as Evaluator
class C130936_VI3_EditStatusandCategoryasEvaluator
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureSingleScaleStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Single Scale/.toString(),"Individual Assignment User":/Evaluator/.toString(),"Individual Assignment User Add or Remove":/Add/.toString(),"Idea Editing":false,"Action":/Update/.toString())
        ...
        new actions.PipelineStepsConfigure.ConfigureScorecardStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Scorecarding/.toString(),"Individual Assignment User":/Pipeline Sponsor/.toString(),"Individual Assignment User Add or Remove":/Add/.toString(),"Allow Assignees to Edit Idea Attributes":true,"Action":/Update/.toString())
        //Select Idea in Pipeline Steps page
        ...
        try{
            //Set View Idea 3 Dropdown Text Field
            new actions.ViewIdea3Fields.SetViewIdea3DropdownTextField().run("Column":/Right/.toString(),"Field Name":/Status/.toString(),"Field Value":/Submitted/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/End User/.toString(),"Idea Name":/test idea1(D102)/.toString(),"Idea Image":true,"Category":/New Product/.toString(),"Status":/Under Review/.toString(),"Submitter Name":/Sri/.toString(),"Submitter Image":true)
        ...
        //Set View Idea 3 Dropdown Text Field
        new actions.ViewIdea3Fields.SetViewIdea3DropdownTextField().run("Column":/Right/.toString(),"Field Name":/Category/.toString(),"Field Value":/New Product/.toString())
        //Set View Idea 3 Dropdown Text Field
        ...
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/test idea2(D107)/.toString(),"Idea Image":true,"Category":/New Product/.toString(),"Status":/Pending/.toString(),"Submitter Name":/Sri/.toString(),"Submitter Image":true)
    }
    //Basestate
