...
//C129152 - Comment Component - Comment Component - Adding a Comment in Hidden Idea as Evaluator
class C129152_CommentComponent_CommentComponent_AddingaCommentinHiddenIdeaasEvaluator
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("View Idea or NGA":/NGA/.toString(),"Comment":/comment as evaluator/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Post Comment":true)
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Parent Comment":/comment as evaluator/.toString(),"User":/Evaluator/.toString(),"Placement Number":/1/.toString(),"Number of Matches":"")
    }
    //Basestate
