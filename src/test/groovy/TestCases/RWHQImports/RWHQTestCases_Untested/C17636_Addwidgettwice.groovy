...
//C17636 - Add widget twice
class C17636_Addwidgettwice
{
    ...
    public void testcase(){
        ...
        //Set Widget
        new actions.Widgets.SetWidget().run("Name of Widget to Modify":/Enterprise Updates/.toString(),"New Title name":/Update Activity/.toString())
        try{
            //Set Widget Controller
        ...
        //Verify Widget Exists
        new actions.Widgets.VerifyWidgetExists().run("Widget Name":/Update Activity/.toString(),"Number of Matches":/1/.toString())
        //Verify Widget Exists
