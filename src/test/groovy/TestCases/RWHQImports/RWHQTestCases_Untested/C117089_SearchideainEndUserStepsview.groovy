...
//C117089 - Search idea in End User Steps view
class C117089_SearchideainEndUserStepsview
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Search":/test idea1/.toString(),"Status":[],"Stage":[],"Categories":[],"Tags":[],"Admin Tags":[],"Desired Expertise":[])
