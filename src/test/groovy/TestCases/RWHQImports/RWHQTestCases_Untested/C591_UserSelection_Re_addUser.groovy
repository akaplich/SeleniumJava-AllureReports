...
//C591 - User Selection - Re-add User
class C591_UserSelection_Re_addUser
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/User Selection Remove/.toString(),"Description":/Description/.toString(),"Category":/New Product/.toString(),"User Selection Question Name":/End User 2/.toString(),"User Selection Question Add or Remove":/Add/.toString(),"Required Short Question":/Required Short/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("User Selection Question Name":/End User 2/.toString(),"User Selection Question Add or Remove":/Remove/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("User Selection Question Name":/End User 2/.toString(),"User Selection Question Add or Remove":/Add/.toString(),"Action":/Submit Idea/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/User Selection Remove/.toString())
        //Verify Custom App Description tab fields in View Idea page
        Action5812921cfa4ee77809f46b4f("User Selection Question":/End User 2/.toString())
    }
    //Basestate
