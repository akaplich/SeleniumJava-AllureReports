...
//C130165 - Standard Licensing - IT Manager
class C130165_StandardLicensing_ITManager
{
    ...
    public void testcase(){
        ...
        new actions.People.SetITManagerinPeoplePillar().run("User":/Pipeline Admin/.toString(),"Expand License Breakdown":true,"IT Manager":true)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/IT System Admin setting has been updated/.toString(),"Should Exist":true)
        //Log Out
