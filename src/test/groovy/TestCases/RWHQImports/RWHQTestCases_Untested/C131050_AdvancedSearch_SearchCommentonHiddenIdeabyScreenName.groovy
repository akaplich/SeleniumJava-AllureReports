...
//C131050 - Advanced Search - Search Comment on Hidden Idea by ScreenName
class C131050_AdvancedSearch_SearchCommentonHiddenIdeabyScreenName
{
    ...
    public void testcase(){
        ...
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/Hidden comment automation purpose/.toString(),"Type":/Comments/.toString(),"Number of Matches":/1/.toString(),"Click on result":true)
        ...
        new actions.Search.QuickOrAdvanceSearchInGlobalNav().run("Tab (optional)":/Advanced Search/.toString(),"Search Input":/System Admin/.toString())
        //Verify Quick or Advanced Search Result
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/Hidden comment automation purpose/.toString(),"Type":/Comments/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
