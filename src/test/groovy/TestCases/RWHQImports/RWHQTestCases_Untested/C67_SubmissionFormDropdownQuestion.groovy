...
//C67 - Submission Form Dropdown Question
class C67_SubmissionFormDropdownQuestion
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Idea Title/.toString(),"Description":/Idea Description/.toString(),"Category":/New Product/.toString(),"Dropdown Question":/Answer 3/.toString(),"Required Short Question":/required short/.toString(),"Action":/Submit Idea/.toString())
        ...
        Action5812921cfa4ee77809f46b4f("Dropdown Question":/Answer 3/.toString())
    }
    //Basestate
