...
//C132572 - Scheduler V1 > Winners Widget should not be displayed
class C132572_SchedulerV1_WinnersWidgetshouldnotbedisplayed
{
    ...
    public void testcase(){
        ...
        new actions.SetupBI.SetSiteSetupforBIBetatab().run("Hackathon Scheduler v3":false)
        //Navigate WebStorm or MTS
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Winner/.toString(),"Should Exist":false)
    }
    //Basestate
