...
//C128276 - Search Hidden Idea code on Initiative Global Navigation
class C128276_SearchHiddenIdeacodeonInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/D105/.toString())
