...
//C131924 - Delete Tasks Page in Project Room
class C131924_DeleteTasksPageinProjectRoom
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.SetEditMenuforRoomPagesinProjectRoom().run("Room Page":/Tasks/.toString(),"Menu Options":/Delete/.toString(),"Placement Number Of Folder or Page":/1/.toString())
        ...
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/task1/.toString(),"Assignee":"","Status":/Blocked/.toString(),"Number of Matches":/0/.toString())
        //Verify Tasks in Project Room
        ...
        new actions.ProjectRoom.VerifyProjectRoomCard().run("Title":/Testing project room/.toString(),"Color of the Project Room Icon":/rgb(52, 152, 219)/.toString(),"Updated":/A task was edited/.toString(),"Updated By":/End User/.toString(),"Member count":/2/.toString(),"Total Objects":/1/.toString(),"Total Tasks":/1/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString(),"Access Project Room":true)
        //Navigate to Top Link or Page in Project Room
        new actions.ProjectRoom.NavigateRoomItems().run("Room Item":/Tasks/.toString())
        //Verify Tasks in Project Room
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/task1/.toString(),"Assignee":"","Status":/Blocked/.toString(),"Marked Completed":false,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Set Edit Menu for Room Pages in Project Room
        new actions.ProjectRoom.SetEditMenuforRoomPagesinProjectRoom().run("Room Page":/Tasks/.toString(),"Menu Options":/Delete/.toString(),"Placement Number Of Folder or Page":/1/.toString())
        //Set Remove Page on Project room
        new actions.ProjectRoom.SetRemovePageonProjectRoom().run("Action":/Delete/.toString())
        ...
        new actions.ProjectRoom.SetRoomPageintheProjectRoom().run("Type of Room Page":/Tasks/.toString())
        //Verify Tasks in Project Room
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/task1/.toString(),"Assignee":"","Status":/Blocked/.toString(),"Marked Completed":false,"Number of Matches":/0/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Navigate Tab User Homepage or MTS
        new actions.Enterprise.UserHomepage.NavigateTabUserHomepage().run("Tab":/Project Room/.toString())
        //Verify and Access Project Room Card in Userhome
        new actions.ProjectRoom.VerifyProjectRoomCard().run("Title":/Testing project room/.toString(),"Color of the Project Room Icon":/rgb(52, 152, 219)/.toString(),"Updated":/An object was added/.toString(),"Updated By":/End User 2/.toString(),"Member count":/2/.toString(),"Total Objects":/1/.toString(),"Total Tasks":/0/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
