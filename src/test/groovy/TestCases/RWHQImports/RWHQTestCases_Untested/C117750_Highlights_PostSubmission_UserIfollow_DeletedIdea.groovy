...
//C117750 - Highlights - Post Submission - User I follow, Deleted Idea
class C117750_Highlights_PostSubmission_UserIfollow_DeletedIdea
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/End User submitted "End User Idea1"/.toString(),"Highlights Item Content":/Custom App/.toString(),"Number of Matches":/1/.toString(),"Total Number of Items":/2/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Select Idea in Pipeline Steps page
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/End User Idea1/.toString())
        ...
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/End User submitted "End User Idea1"/.toString(),"Highlights Item Content":/Custom App/.toString(),"Number of Matches":/0/.toString(),"Total Number of Items":/1/.toString())
    }
    //Basestate
