...
//C131829 - WB - Text - Highlighted Bullets Indent
class C131829_WB_Text_HighlightedBulletsIndent
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131829/.toString(),"Action":/Submit/.toString())
        //Whiteboard - Set Zoom
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Expected Image File":/C131829_Expected3282025.png/.toString(),"Actual Image Name":/C131829_actual.png/.toString(),"Crop Screenshot Start at X":/100/.toString(),"Crop Screenshot Start at Y":/100/.toString(),"Crop Screenshot Width":/400/.toString(),"Crop Screenshot Height":/400/.toString(),"Allowed Number of Different Pixels":/10/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131829_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
    }
}