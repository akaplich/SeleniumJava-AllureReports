...
//C119562 - Save Evaluator Data - Removed Assignee in Action Item Progress Page
class C119562_SaveEvaluatorData_RemovedAssigneeinActionItemProgressPage
{
    ...
    public void testcase(){
        ...
        //Verify Action Items in Progress in Manage Step Page
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Row Number":/1/.toString(),"Evaluator":/End User/.toString(),"Number of assigned items":/2/.toString(),"Number of remaining items":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Action Items in Progress in Manage Step Page
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Row Number":/3/.toString(),"Evaluator":/Evaluator/.toString(),"Number of assigned items":/2/.toString(),"Number of remaining items":/0/.toString(),"Number of Matches":/1/.toString())
        //Verify Action Items Hover in Progress in Manage Step Page
        new actions.PipelineManageSteps.VerifyActionItemsHoverinProgressinManageStepPage().run("Evaluator to Hover":/Evaluator/.toString(),"Evaluator Name in the Hover":/Evaluator (Removed)/.toString(),"User Image":false,"Number of Assigned Action Items":/2/.toString(),"Number of Completed Action Items":/1/.toString(),"Number of Cancelled Action Items":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
