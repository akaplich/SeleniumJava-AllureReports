...
//C129749 - New Copy Ideas - Keep Same Visibility Setting
class C129749_NewCopyIdeas_KeepSameVisibilitySetting
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Idea Name":/steps - visible/.toString(),"Action":/Submit/.toString())
        //Quick Add an Idea in Pipeline Steps page
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Idea Name":/list - visible/.toString(),"Action":/Submit/.toString())
