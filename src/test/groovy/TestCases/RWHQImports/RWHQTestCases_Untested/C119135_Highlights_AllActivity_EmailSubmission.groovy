...
//C119135 - Highlights - All Activity - Email Submission
class C119135_Highlights_AllActivity_EmailSubmission
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/Gmail User submitted "Email Idea1"/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
