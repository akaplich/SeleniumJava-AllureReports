...
//C117795 - Financial Summary by Initiative table - Verify values in table
class C117795_FinancialSummarybyInitiativetable_Verifyvaluesintable
{
    ...
    public void testcase(){
        ...
        new actions.NGAAnalyticsDashboard.VerifyInitiativeintheInitiativeTableonEnterpriseBusinessImpacttab().run("Initiative":/Custom App/.toString(),"Initiative Image":/Default Image/.toString(),"App Type":/Custom/.toString(),"Status":/Active/.toString(),"Submissions with Impact":/1/.toString(),"Total Projected Benefits":/$30,000/.toString(),"Total Actual Benefits":/$50,000/.toString(),"Total Target Benefits":/$0/.toString(),"Total Projected Costs":/$0/.toString(),"Total Actual Costs":/$0/.toString(),"Row Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Initiative in the Initiative Table on Enterprise Business Impact tab
        new actions.NGAAnalyticsDashboard.VerifyInitiativeintheInitiativeTableonEnterpriseBusinessImpacttab().run("Initiative":/Solve App/.toString(),"Initiative Image":/Default Image/.toString(),"App Type":/Solve/.toString(),"Status":/Closed/.toString(),"Submissions with Impact":/1/.toString(),"Total Projected Benefits":/$50,000/.toString(),"Total Actual Benefits":/$70,000/.toString(),"Total Target Benefits":/$0/.toString(),"Total Projected Costs":/$0/.toString(),"Total Actual Costs":/$0/.toString(),"Row Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
