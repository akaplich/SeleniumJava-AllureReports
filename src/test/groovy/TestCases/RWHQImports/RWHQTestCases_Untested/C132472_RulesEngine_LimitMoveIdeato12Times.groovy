...
//C132472 - Rules Engine - Limit Move Idea to 12 Times
class C132472_RulesEngine_LimitMoveIdeato12Times
{
    ...
    public void testcase(){
        ...
        new actions.Rules.ConfigureNewRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Pipeline A/.toString(),"Category":/Strategy/.toString(),"Status":/Under Review/.toString(),"Action":/Save/.toString())
        //Set Rule Perform the Following Actions
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/2/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Add Public Comment/.toString(),"Commenter":/System Admin/.toString(),"Comment":/Idea moved/.toString())
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/2 Rule move idea/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/2 Rule move idea/.toString())
        //Change Rule Status
        Action594d63e45cb815bc19ca15e6("Change Status":/Active/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Pipeline A/.toString(),"Area to Navigate to":/Rules/.toString())
        //Access Add/Create Rule popup
        new actions.Rules.SetAddCreateRule().run([:])
        //Set Rule Event that triggers this rule
        new actions.Rules.SetNewRuleEventthattriggersthisrule().run("Event":/Added to Step/.toString(),"Event Value":/Submitted/.toString())
        //Set Rule Perform the Following Actions
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Move Idea to Pipeline/.toString(),"Configure Action (Move or Copy to Pipeline Only)":true)
        //Configure Rule Action Move Idea to Pipeline
        new actions.Rules.ConfigureNewRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Custom App/.toString(),"Category":/Strategy/.toString(),"Status":/Under Review/.toString(),"Action":/Save/.toString())
        //Set Rule Perform the Following Actions
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/2/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Add Public Comment/.toString(),"Commenter":/System Admin/.toString(),"Comment":/Idea moved/.toString())
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/1 Rule move idea/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/1 Rule move idea/.toString())
        //Change Rule Status
        Action594d63e45cb815bc19ca15e6("Change Status":/Active/.toString())
        //Wait
        ...
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Title":/test idea3/.toString(),"Action":/Submit/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/Idea moved/.toString(),"User":/System Admin/.toString(),"Expected Emoji Reaction Count":/1/.toString(),"Number of Matches":/12/.toString())
    }
    //Basestate
