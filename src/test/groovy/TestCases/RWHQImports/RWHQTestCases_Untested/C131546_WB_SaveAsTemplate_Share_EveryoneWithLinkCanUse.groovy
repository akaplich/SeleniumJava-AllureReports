...
//C131546 - WB - Save As Template - Share - Everyone With Link Can Use
class C131546_WB_SaveAsTemplate_Share_EveryoneWithLinkCanUse
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131546Template/.toString(),"Action":/Submit/.toString())
        ...
        //Create Whiteboard or Edit Template
        new actions.Whiteboards.CreateWhiteboardFromUserhome().run("Edit Custom Template":/C131546Template/.toString())
        ...
        //Create Whiteboard or Edit Template
        new actions.Whiteboards.CreateWhiteboardFromUserhome().run("Create New or Choose Template":/C131546Template/.toString())
