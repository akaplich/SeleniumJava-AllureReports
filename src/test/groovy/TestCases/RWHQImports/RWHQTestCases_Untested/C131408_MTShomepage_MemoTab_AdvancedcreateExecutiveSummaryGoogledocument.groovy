...
class C131408_MTShomepage_MemoTab_AdvancedcreateExecutiveSummaryGoogledocument
{
    ...
    public void testcase(){
        ...
        try{
            //Compare Images
            new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/DIV[contains(@class,'f-memo-thumbnail-body')]/.toString(),"Expected Image File":/C131408_expected.png/.toString(),"Actual Image Name":/C131408_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131408_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
