...
//C128615 - Development - Multi Choice - One Answer Allowed
class C128615_Development_MultiChoice_OneAnswerAllowed
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.SetDevelopmentActionItemPageFields().run("Multiple Choice - Title":/Development Multi Choice - A/.toString(),"Multiple Choice - Answer":/Answer 1/.toString())
        //Set Development Action Item Page Fields
