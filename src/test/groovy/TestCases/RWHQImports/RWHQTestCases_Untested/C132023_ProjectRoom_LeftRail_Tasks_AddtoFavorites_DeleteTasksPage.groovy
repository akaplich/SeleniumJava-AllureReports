...
//C132023 - Project Room > Left Rail - Tasks - Add to Favorites, Delete Tasks Page
class C132023_ProjectRoom_LeftRail_Tasks_AddtoFavorites_DeleteTasksPage
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.VerifyRoomPageInFavoritesTabInProjectRoom().run("Placement Number of Page":/1/.toString(),"Room Page":/Tasks/.toString(),"Number of Matches":/0/.toString())
        //Verify Folder Or Room Page In Project Room in Root Folder
        new actions.ProjectRoom.VerifyFolderOrRoomPageInProjectRoom().run("Placement Number of Child Page or Folder":/1/.toString(),"Parent Folder Name":/Tasks/.toString(),"Child Page or Folder":"","Number of Matches":/0/.toString())
    }
    //Basestate
