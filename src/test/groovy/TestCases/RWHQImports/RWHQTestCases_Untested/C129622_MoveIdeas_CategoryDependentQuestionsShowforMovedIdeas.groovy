...
//C129622 - Move Ideas - Category Dependent Questions Show for Moved Ideas
class C129622_MoveIdeas_CategoryDependentQuestionsShowforMovedIdeas
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Dependent Strategy/.toString(),"Additional Question Type":/Dropdown/.toString())
        ...
        new actions.PipelineStepsView.NewMoveIdeasinPipelineStepspage().run("Move To Pipeline":/Pipeline A/.toString(),"Category":/Strategy/.toString(),"Status":/Submitted/.toString(),"Action":/Move Idea/.toString())
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabDropdown().run("Field Name":/Dependent Strategy/.toString(),"Field Value":/Answer 1/.toString(),"Action":/Save/.toString())
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Verify View Idea Description Tab Field Multi Value
        new actions.ViewIdeaFields.VerifyViewIdeaDescriptionTabFieldMultiValue().run("Field Name":/Dependent Strategy/.toString(),"Field Value":/Answer 1/.toString())
    }
    //Basestate
