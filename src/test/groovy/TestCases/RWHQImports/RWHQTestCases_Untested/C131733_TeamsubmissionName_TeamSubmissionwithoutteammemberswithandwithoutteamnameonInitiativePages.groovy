...
//C131733 - Team submission Name - Team Submission with out team members with and without team name on Initiative Pages
class C131733_TeamsubmissionName_TeamSubmissionwithoutteammemberswithandwithoutteamnameonInitiativePages
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"View Type":/Gallery/.toString(),"Idea Name":/WITH TEAM NAME/.toString(),"Username":/team name1/.toString(),"Description":/Idea Description/.toString(),"Number of Matches":/1/.toString(),"Placement Number":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"View Type":/Gallery/.toString(),"Idea Name":/WITHOUT TEAM NAME/.toString(),"Username":/End User/.toString(),"Description":/Idea Description/.toString(),"Number of Matches":/1/.toString(),"Placement Number":/2/.toString())
        //Set Tab/View on Idea Board
        new actions.IdeaBoard.NavigatetoIdeaBoardsView().run("View":/List/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"View Type":/List/.toString(),"Idea Name":/WITH TEAM NAME/.toString(),"Username":/team name1/.toString(),"Description":/Idea Description/.toString(),"Number of Matches":/1/.toString(),"Placement Number":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"View Type":/List/.toString(),"Idea Name":/WITHOUT TEAM NAME/.toString(),"Username":/End User/.toString(),"Description":/Idea Description/.toString(),"Number of Matches":/1/.toString(),"Placement Number":/2/.toString())
        //Set Tab/View on Idea Board
        ...
        new actions.IdeaBoard.VerifythesubmissionhoveronPipelineStepsViewforEndUsers().run("Idea Title":/WITHOUT TEAM NAME/.toString(),"Does it contain team name":false,"Idea Submitter":/End User/.toString(),"Submitted":/${variables."date"}/.toString(),"Idea Status":/Submitted/.toString(),"Idea Category":/Theme 1/.toString(),"Idea Description":/Idea Description/.toString(),"Favorite":false,"Number of Matches":/1/.toString())
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Set Tab/View on Idea Board
        new actions.IdeaBoard.NavigatetoIdeaBoardsView().run("View":/Steps/.toString())
        //Verify Submission Rollover in Pipeline Steps View for End Users
        new actions.IdeaBoard.VerifythesubmissionhoveronPipelineStepsViewforEndUsers().run("Idea Title":/WITH TEAM NAME/.toString(),"Does it contain team name":true,"Idea Submitter":/team name1/.toString(),"Submitted":/${variables."date"}/.toString(),"Idea Description":/Idea Description/.toString(),"Favorite":false,"Number of Matches":/1/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/WITH TEAM NAME/.toString(),"Does it have team submission name":true,"Submitted":/${variables."date"}/.toString(),"Submitter Name":/team name1/.toString())
        //Access or Close Idea from View Idea 3 Modal
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Close Idea Modal":true)
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/WITHOUT TEAM NAME/.toString())
        ...
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/WITHOUT TEAM NAME/.toString(),"Submitted":/${variables."date"}/.toString(),"Submitter Name":/End User/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack Event title/.toString(),"Area to Navigate to":/Setup/.toString())
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Projects-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["WITH TEAM NAME","team name1"],"Number of Matches":/1/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Projects/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Projects-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["WITHOUT TEAM NAME","End User"],"Number of Matches":/1/.toString())
    }
    //Basestate
