...
//C119575 - Scorecard - Multi Choice - More Than One Allowed
class C119575_Scorecard_MultiChoice_MoreThanOneAllowed
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.SetEvaluationScorecardIdeaActionItemspage().run("Multi Choice Multi Answer - Question":/1 - Multiple Choice/.toString(),"Multi Choice Multi - Answer(s)":/One/.toString(),"Submit Scorecard":false)
        //Set Evaluation Scorecard for Idea in Action Items page
        new actions.ActionItems.SetEvaluationScorecardIdeaActionItemspage().run("Multi Choice Multi Answer - Question":/2 - Multiple Choice/.toString(),"Multi Choice Multi - Answer(s)":/Three,Four/.toString(),"Submit Scorecard":false)
        //Set Evaluation Scorecard for Idea in Action Items page
        new actions.ActionItems.SetEvaluationScorecardIdeaActionItemspage().run("Multi Choice Multi Answer - Question":/3 - Multiple Choice/.toString(),"Multi Choice Multi - Answer(s)":/Six,Seven,Eight,Nine,Ten/.toString(),"Submit Scorecard":true)
        //Access Action Item in Actions Items React Global Navigation
        ...
        new actions.ActionItems.VerifyScorecardAnswers().run("Multi Choice Multi Answer - Question":/1 - Multiple Choice/.toString(),"Multi Choice Multi - Answer(s)":/One/.toString())
        //Verify Scorecard Answers
        new actions.ActionItems.VerifyScorecardAnswers().run("Multi Choice Multi Answer - Question":/2 - Multiple Choice/.toString(),"Multi Choice Multi - Answer(s)":/Three,Four/.toString())
        //Verify Scorecard Answers
        new actions.ActionItems.VerifyScorecardAnswers().run("Multi Choice Multi Answer - Question":/3 - Multiple Choice/.toString(),"Multi Choice Multi - Answer(s)":/Six,Seven,Eight,Nine,Ten/.toString())
    }
    //Basestate
