...
//C131882 - Flow A - Register and Submit Idea
class C131882_FlowA_RegisterandSubmitIdea
{
    ...
    public void testcase(){
        ...
        new actions.MTS.SetMTStabonhomepage().run("Should Tab Exist":true,"Heading":/EXPLORE/.toString(),"Tabs":/Top Projects/.toString(),"Placement Number of Tab":/2/.toString(),"Should User Click on Tab":true)
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Project One Title/.toString(),"Stack Name Memo belongs to":/Theme 3/.toString(),"Status":/Submitted/.toString(),"Stage":/Incubate/.toString(),"Step":/Initial Submission/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Hackathon Team Site/.toString())
        //Set Registration or Get Started For Hackathon Onboarding
        ...
        //Set Flow A for Hackathon Onboarding
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowAforHackathonOnboarding().run("Action on Get Started Screen":/Next/.toString(),"Action on Time to submit your project":/Cancel/.toString(),"Wait for Post Idea Page to Load":false)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Choose an option to begin participating in the hackathon./.toString(),"Should Exist":true)
    }
    //Basestate
