...
//C132044 - Flow C - Disable Team Name
class C132044_FlowC_DisableTeamName
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Flow Option Title":/I have a team and a project, just need to get started./.toString(),"Expertise":/myexpertise1/.toString(),"Add or Remove Expertise":/Add/.toString(),"I am available to join teams":true,"Register and add expertise Action":/Next/.toString(),"Project Name":/team name1/.toString(),"Name your team Screen Action":/Next/.toString(),"Choose a team image Action":/Next/.toString(),"Find Teammates":/End User,Moderator/.toString(),"Teammates Add or Remove":/Add,Add/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Find Teammates/.toString(),"Should Exist":true)
        //Set Flow B and C on Hackathon Onboarding
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Build your winning team Screen Action":/Next/.toString(),"Get Started Screen Menu":/Ready to share your teams idea?/.toString(),"Wait for loading to disappear":true)
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"View Type":/Gallery/.toString(),"Idea Name":/Check this idea/.toString(),"Username":/Team - System Admin/.toString(),"Description":/desc/.toString(),"Number of Matches":/1/.toString(),"Placement Number":/1/.toString())
    }
    //Basestate
