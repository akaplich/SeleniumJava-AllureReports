...
//C119581 - Scorecard - Short Answer
class C119581_Scorecard_ShortAnswer
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.SetEvaluationScorecardIdeaActionItemspage().run("Short Text - Question":/1 - Short Answer/.toString(),"Short Text - Answer":/test answer/.toString(),"Submit Scorecard":true)
        //Access Action Item in Actions Items React Global Navigation
        ...
        new actions.ActionItems.VerifyScorecardAnswers().run("Short Text - Question":/1 - Short Answer/.toString(),"Short Text - Answer":/test answer/.toString())
    }
    //Basestate
