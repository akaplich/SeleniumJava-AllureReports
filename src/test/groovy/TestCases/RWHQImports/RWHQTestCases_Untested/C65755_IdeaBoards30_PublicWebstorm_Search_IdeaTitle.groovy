...
//C65755 - Idea Boards 30 - Public Webstorm - Search - Idea Title
class C65755_IdeaBoards30_PublicWebstorm_Search_IdeaTitle
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Search":/idea2/.toString(),"Status":[],"Stage":[],"Categories":[],"Tags":[],"Desired Expertise":[],"Action":/Apply Filters/.toString())
