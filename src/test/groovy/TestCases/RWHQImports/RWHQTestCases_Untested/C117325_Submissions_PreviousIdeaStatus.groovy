...
//C117325 - Submissions - Previous Idea Status
class C117325_Submissions_PreviousIdeaStatus
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Ideas-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["D102","test idea1","Non-Adopted","On Hold"],"Number of Matches":/1/.toString(),"Total Number of Rows":/4/.toString())
    }
    //Basestate
