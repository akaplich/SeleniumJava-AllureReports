...
//C63241 - NGA View Idea - Interact with Submitter
class C63241_NGAViewIdea_InteractwithSubmitter
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.SetUserFlyoverNGAViewIdea().run("Submitter Username":/Sri/.toString(),"Action":/Message/.toString())
        ...
        //Set User Flyover in NGA View Idea
        new actions.NGAViewIdea.SetUserFlyoverNGAViewIdea().run("Submitter Username":/Sri/.toString(),"Action":/Follow/.toString())
        //Navigate
        ...
        new actions.MyActivity.VerifyPeopleIamFollowinginmyActivitypage().run("People":/Sri/.toString())
        //Navigate
        ...
        new actions.PipelineManageSteps.AccessIdeainPipelineManageCurrentlyinStepPage().run("Idea name":/test idea1/.toString())
        //Set User Flyover in NGA View Idea
        new actions.NGAViewIdea.SetUserFlyoverNGAViewIdea().run("Submitter Username":/Sri/.toString(),"Action":/Profile/.toString())
