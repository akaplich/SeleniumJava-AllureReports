...
//C119000 - Highlights - All Activity - Post a Submission and Delete Submission
class C119000_Highlights_AllActivity_PostaSubmissionandDeleteSubmission
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/Sri submitted "test idea2"/.toString(),"Number of Matches":/0/.toString())
        //Wait
