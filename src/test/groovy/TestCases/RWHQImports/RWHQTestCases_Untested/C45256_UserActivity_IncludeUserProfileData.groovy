...
//C45256 - User Activity - Include User Profile Data
class C45256_UserActivity_IncludeUserProfileData
{
    ...
    public void testcase(){
        ...
        new actions.SetupExports.SetWebstormSetupExportsforUsersTab().run("Report Options":/User Activity/.toString(),"Include User Profile Data":true,"Format":/csv/.toString())
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/User_activity-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Screen Name for End User","bi.enduser1@brightidea.com","FNEnd","LNUser","IPM","Innovation"],"Number of Matches":/1/.toString(),"Total Number of Rows":/4/.toString())
    }
    //Basestate
