...
//C131767 - WB - Add Invalid Link to Text Box via Right Panel
class C131767_WB_AddInvalidLinktoTextBoxviaRightPanel
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131767/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/C131767/.toString())
        //Send Key(s) To Whiteboard
