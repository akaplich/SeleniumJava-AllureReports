...
class C117405_LinkedSubmissionsAcrossInitiatives_SubmittersCanNotSearchHiddenRedwoodHQTestCaseRestricted
{
    ...
    public void testcase(){
        ...
        try{
            ...
            new actions.ViewIdea.SetLinkedSubmissionsonViewIdeaPage().run("Submission Title":/quick add1/.toString(),"Add or Remove":/Add/.toString(),"Action":/Save Changes/.toString())
        }
       catch(all){}catch(Error err){}
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App Restricted/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea3/.toString())
        //Verify Linked Submission on View Idea
        new actions.ViewIdea.VerifyLinkedSubmissiononViewIdea().run("Linked Submissions":/quick add1/.toString(),"Should Exist":/FALSE/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        try{
            //Set Linked Submissions on View Idea Page
            new actions.ViewIdea.SetLinkedSubmissionsonViewIdeaPage().run("Submission Title":/test idea3/.toString(),"Add or Remove":/Add/.toString())
        }
       catch(all){}catch(Error err){}
        //Navigate WebStorm or MTS
