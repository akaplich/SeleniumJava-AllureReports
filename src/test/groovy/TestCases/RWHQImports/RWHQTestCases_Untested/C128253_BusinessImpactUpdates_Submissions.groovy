...
//C128253 - Business Impact Updates - Submissions
class C128253_BusinessImpactUpdates_Submissions
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Ideas-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Code","Category","Submitted","Submitter","Submitter email","Submission Team","Title","Description","Status","Stage","Step","Score"],"Number of Matches":/1/.toString(),"Total Number of Rows":/4/.toString())
        //Download Generated Report From Enterprise and Community Exports
        new actions.SetupEnterpriseExports.DownloadGeneratedReportEnterpriseExports().run("Section":/Submissions/.toString(),"Report Name Starts with":/Ideas/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Ideas-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Projected Benefit ($)","Projected Cost ($)","Actual Benefit ($)","Actual Cost ($)","Non-Financial Benefit"],"Number of Matches":/1/.toString(),"Total Number of Rows":/4/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Setup/.toString())
        //Download Generated Report From Enterprise and Community Exports
        new actions.SetupEnterpriseExports.DownloadGeneratedReportEnterpriseExports().run("Section":/Submissions/.toString(),"Report Name Starts with":/Ideas/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Ideas-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["112325","-144","153081","-130","1"],"Number of Matches":/1/.toString(),"Total Number of Rows":/4/.toString())
    }
    //Basestate
