...
//C192 - Long Answer Question - Invalid Image File Type
class C192_LongAnswerQuestion_InvalidImageFileType
{
    ...
    public void testcase(){
        ...
        new actions.SetIdeaFields.SetPostIdeaInsertImageforTextField().run("Field Name":/Long Answer Question/.toString(),"Image File":/SampleDoc.docx/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Invalid Image/.toString(),"Description":/Description/.toString(),"Category":/New Product/.toString(),"Required Short Question":/Required Short/.toString(),"Action":/Submit Idea/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Invalid Image/.toString())
