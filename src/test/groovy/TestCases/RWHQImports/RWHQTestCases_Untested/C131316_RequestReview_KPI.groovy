...
//C131316 - Request Review - KPI
class C131316_RequestReview_KPI
{
    ...
    public void testcase(){
        ...
        //Set Review Request Dropdown or Button
        new actions.Memo.SetReviewRequestDropdownorButton().run("Dropdown Options":/Request Review/.toString())
        //Set Request Review Modal
        new actions.Memo.SetRequestReviewModal().run("Select Reviewers":/Pipeline Admin/.toString(),"Select Reviewers Add or Remove":/Add/.toString(),"Click on Advanced Settings":true,"Round Name":/Round2/.toString(),"Action":/Assign Review/.toString())
        ...
        new actions.Memo.VerifyReviewResults().run("Round Name":/Round1/.toString(),"Score":/6.3/.toString(),"Score Color":/orange/.toString(),"Progress Bar width completed":/100/.toString(),"Complete":/1 of 1 Complete/.toString(),"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Review Results
        new actions.Memo.VerifyReviewResults().run("Round Name":/Round2/.toString(),"Score":/-/.toString(),"Progress Bar width completed":/0/.toString(),"Complete":/0 of 1 Complete/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString(),"View Results":true)
        //Verify Review KPI in the review modal
        new actions.Memo.VerifyReviewKPIinthereviewmodal().run("Title":/Score/.toString(),"Value":-,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Review KPI in the review modal
        new actions.Memo.VerifyReviewKPIinthereviewmodal().run("Title":/Completed/.toString(),"Value":0 / 1,"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Review KPI in the review modal
        new actions.Memo.VerifyReviewKPIinthereviewmodal().run("Title":/Until Due/.toString(),"Value":true,"Placement Number":/3/.toString(),"Number of Matches":/1/.toString())
        //Verify Review KPI in the review modal
        new actions.Memo.VerifyReviewKPIinthereviewmodal().run("Title":/from last Round/.toString(),"Value":-100%,"Placement Number":/4/.toString(),"Number of Matches":/1/.toString())
        //Set Review Results Modal Header buttons
        new actions.Memo.SetReviewResultsModalHeaderbuttons().run("Action":/Previous Round/.toString())
        //Verify Review KPI in the review modal
        new actions.Memo.VerifyReviewKPIinthereviewmodal().run("Title":/Score/.toString(),"Value":6.3,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Review KPI in the review modal
        new actions.Memo.VerifyReviewKPIinthereviewmodal().run("Title":/Completed/.toString(),"Value":1 / 1,"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Review KPI in the review modal
        new actions.Memo.VerifyReviewKPIinthereviewmodal().run("Title":/Until Due/.toString(),"Value":true,"Placement Number":/3/.toString(),"Number of Matches":/1/.toString())
        //Verify Review KPI in the review modal
        new actions.Memo.VerifyReviewKPIinthereviewmodal().run("Title":/from last Round/.toString(),"Value":-,"Placement Number":/4/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
