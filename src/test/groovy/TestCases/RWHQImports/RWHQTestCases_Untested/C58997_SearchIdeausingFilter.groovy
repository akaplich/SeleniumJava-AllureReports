...
//C58997 - Search Idea using Filter
class C58997_SearchIdeausingFilter
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.BusinessImpact.SetDateandNotesforFinancialSummaryinBusinessImpacttab().run("Date":/12\/12\/2019/.toString())
        //Set Costs in Business Impact tab
        new actions.ViewIdea.BusinessImpact.SetCostsinBusinessImpacttab().run("Add or Edit Costs":/Add/.toString(),"Year":/2019/.toString(),"Current Year":/2019/.toString(),"Cost Title":/Cost quick add1/.toString(),"Projected Cost":/1076040/.toString(),"Actual Cost":/950000/.toString(),"Row Number":/1/.toString())
        //Set Benefits in Business Impact tab
        new actions.ViewIdea.BusinessImpact.SetBenefitsinBusinessImpacttab().run("Add or Edit Benefits":/Add/.toString(),"Year":/2019/.toString(),"Current Year":/2019/.toString(),"Benefit Type":/Cost Avoidance/.toString(),"Projected Benefit":/1076800/.toString(),"Actual Benefit":/959300/.toString(),"Row Number of the Benefit":/1/.toString())
        //Set Business Impact Tab
        new actions.ViewIdea.BusinessImpact.SetBusinessImpactForViewIdeaPage().run("Action":/Save Version/.toString())
        //Navigate WebStorm or MTS
        ...
        //Filter Idea on the Business Impact tab in Pipeline Dashboard
        new actions.PipelineDashBoard.FilterIdeainSubmissionTableonBusinessImpacttab().run("Category":["New Product","Operations"],"Status":["Submitted","Under Review"])
        ...
        //Verify Submission in the Submission Table on Business Impact tab
        new actions.PipelineDashBoard.VerifySubmissionintheSubmissionTableonBusinessImpacttab().run("Idea":/quick add1/.toString(),"Category":/Quick Add/.toString(),"Stage":/Collection/.toString(),"Total Projected Benefits":/$1.1MM/.toString(),"Total Actual Benefits":/$959.3K/.toString(),"Total Projected Costs":/$1.1MM/.toString(),"Total Actual Costs":/$950K/.toString(),"Number of Matches":/0/.toString())
        //Verify Submission in the Submission Table on Business Impact tab
        ...
        new actions.PipelineDashBoard.SearchIdeainSubmissiontableonBusinessImpacttab().run("Search Value":/test idea1/.toString())
        //Verify Submission in the Submission Table on Business Impact tab
        new actions.PipelineDashBoard.VerifySubmissionintheSubmissionTableonBusinessImpacttab().run("Idea":/test idea1/.toString(),"Category":/New Product/.toString(),"Stage":/Collection/.toString(),"Total Projected Benefits":/$10,000/.toString(),"Total Actual Benefits":/$9,500/.toString(),"Total Projected Costs":/$84,271/.toString(),"Total Actual Costs":/$43,244/.toString(),"Row Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Submission in the Submission Table on Business Impact tab
        new actions.PipelineDashBoard.VerifySubmissionintheSubmissionTableonBusinessImpacttab().run("Idea":/test idea2/.toString(),"Category":/Operations/.toString(),"Stage":/Collection/.toString(),"Total Projected Benefits":/$1.1MM/.toString(),"Total Actual Benefits":/$950K/.toString(),"Total Projected Costs":/$1.1MM/.toString(),"Total Actual Costs":/$950K/.toString(),"Number of Matches":/0/.toString())
        //Verify Submission in the Submission Table on Business Impact tab
        new actions.PipelineDashBoard.VerifySubmissionintheSubmissionTableonBusinessImpacttab().run("Idea":/quick add1/.toString(),"Category":/Quick Add/.toString(),"Stage":/Collection/.toString(),"Total Projected Benefits":/$1.1MM/.toString(),"Total Actual Benefits":/$959.3K/.toString(),"Total Projected Costs":/$1.1MM/.toString(),"Total Actual Costs":/$950K/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
