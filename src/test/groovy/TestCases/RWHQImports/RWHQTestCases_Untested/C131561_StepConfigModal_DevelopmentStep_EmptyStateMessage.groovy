...
//C131561 - Step Config Modal - Development Step - Empty State Message
class C131561_StepConfigModal_DevelopmentStep_EmptyStateMessage
{
    ...
    public void testcase(){
        ...
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/DIV[@class='f-quest-data']\/P[starts-with(.,'There are no development fields available.')]/.toString(),"Should Element Exist":true,"Number of Matches":/1/.toString())
    }
    //Basestate
