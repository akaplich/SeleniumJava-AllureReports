...
//C10774 - Add Comment through Single Scale
class C10774_AddCommentthroughSingleScale
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Completed Tab Value":/1/.toString(),"Title":/Single scale idea/.toString(),"Number of Matches":/1/.toString())
        //Add Comment through Single Scale
        new actions.ActionItems.AddCommentthroughSingleScale().run([:])
        ...
        new actions.NGAViewIdea.VerifyCommentInNGAViewIdeaPage().run("Comment Section":/Comments/.toString(),"User":/End User/.toString(),"Comment":/Test Comment/.toString(),"Comment Type":/Private/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
