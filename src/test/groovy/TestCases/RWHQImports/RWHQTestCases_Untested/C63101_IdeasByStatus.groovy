...
//C63101 - Ideas By Status
class C63101_IdeasByStatus
{
    ...
    public void testcase(){
        ...
        //Verify Idea by Status in Overall Tab in Pipeline Dashboard
        new actions.PipelineDashBoard.VerifyIdeabyStatusinOverallTabinPipelineDashboard().run("Status":/Submitted/.toString(),"Number of Ideas":/2/.toString())
        //Verify Idea by Status in Overall Tab in Pipeline Dashboard
        new actions.PipelineDashBoard.VerifyIdeabyStatusinOverallTabinPipelineDashboard().run("Status":/Under Review/.toString(),"Number of Ideas":/1/.toString())
        //Verify Idea by Status in Overall Tab in Pipeline Dashboard
        new actions.PipelineDashBoard.VerifyIdeabyStatusinOverallTabinPipelineDashboard().run("Status":/On Hold/.toString(),"Number of Ideas":/1/.toString())
    }
    //Basestate
