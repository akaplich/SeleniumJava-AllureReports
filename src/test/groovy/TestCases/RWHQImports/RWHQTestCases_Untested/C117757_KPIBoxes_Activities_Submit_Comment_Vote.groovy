...
//C117757 - KPI Boxes - Activities - Submit, Comment, Vote
class C117757_KPIBoxes_Activities_Submit_Comment_Vote
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea - system admin/.toString(),"Description":/about/.toString(),"Category":/New Product/.toString(),"Action":/Submit Idea/.toString())
        //Navigate
        ...
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea2 - end user/.toString(),"Description":/about/.toString(),"Category":/New Product/.toString(),"Action":/Submit Idea/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Verify User Metrics on User Homepage
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea - system admin/.toString())
        ...
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App - Submit/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Select Idea in Pipeline Steps page
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/test idea2 - end user/.toString())
        ...
        new actions.ViewIdeaComment.DeleteRemoveCommentinViewIdeapage().run("Comment to Delete or Remove":/test comment/.toString(),"Replace or Permanent":/Permanent/.toString(),"Action":/Continue/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/bi.enduser1@brightidea.com/.toString(),"Password":/brightidea1/.toString())
        ...
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Verify User Metrics on User Homepage
        new actions.Enterprise.UserHomepage.VerifyUserMetricsonUserHomepage().run("Activities - Expected Value":/0/.toString())
    }
    //Basestate
