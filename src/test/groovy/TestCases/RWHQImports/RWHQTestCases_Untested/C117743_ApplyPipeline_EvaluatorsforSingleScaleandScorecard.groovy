...
//C117743 - Apply Pipeline - Evaluators for Single Scale and Scorecard
class C117743_ApplyPipeline_EvaluatorsforSingleScaleandScorecard
{
    ...
    public void testcase(){
        ...
        new actions.WebstormCreation.CreateSolveWebstorm().run("App Name":/Apply/.toString(),"Sponsor Name":/Sri/.toString(),"Sponsor Add or Remove":/Add/.toString(),"Webstorm Title":/Apply Challenge Title/.toString(),"Challenge Brief":/Apply Challenge Description/.toString(),"Action on General Information Tab":/Continue/.toString(),"Action on Design Tab":/Continue/.toString(),"General Access":/Moderator/.toString(),"General Access Add or Remove":/Add/.toString(),"Action on Participants Tab":/Continue/.toString(),"Action on Site Schedule Tab":/Continue/.toString(),"Single Scale Field":/RATE IDEAS/.toString(),"Single Scale Field Assignee":/End User,End User 2,Evaluator,End User 2/.toString(),"Single Scale Assignee Add or Remove":/Add,Add,Add,Remove/.toString(),"Scorecard Field":/EVALUATE IDEAS/.toString(),"Scorecard Field Assignee":/End User 2,Community Admin,Chris Williams,Community Admin/.toString(),"Scorecard Field Assignee Add or Remove":/Add,Add,Add,Remove/.toString(),"Action":/Create/.toString())
        //Verify Initiative Home
        new actions.Webstorm.VerifyWebstormHome().run("Initiative Title":/Apply Challenge Title/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Apply Challenge Title/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
