...
//C131441 - WB - Shapes - Lock Only Top From Multiple Layers of Objects
class C131441_WB_Shapes_LockOnlyTopFromMultipleLayersofObjects
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131441/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.ClickOnWhiteboardTool().run("Tool Type":/Shapes/.toString())
        //Set Marker or Move Tool in Whiteboard
        new actions.Whiteboards.SetMarkerToolToWhiteboard().run("X coordinate1":/-235/.toString(),"Y coordinate1":/-150/.toString(),"X coordinate2":/300/.toString(),"Y coordinate2":/200/.toString(),"X coordinate3":/0/.toString(),"Y coordinate3":/0/.toString())
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/-250/.toString(),"Y coordinate":/-150/.toString(),"Single Double or Right Click":/Right Click/.toString())
        //Whiteboard - Set Right Click on Object
        new actions.Whiteboards.SetRightClickonStickyNote().run("Lock":true)
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/0/.toString(),"Y coordinate":/-80/.toString(),"Single Double or Right Click":/Single Click/.toString())
