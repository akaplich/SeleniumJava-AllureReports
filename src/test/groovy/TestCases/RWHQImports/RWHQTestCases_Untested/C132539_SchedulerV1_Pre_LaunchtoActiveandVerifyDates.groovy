...
//C132539 - Scheduler V1 - Pre-Launch to Active and Verify Dates
class C132539_SchedulerV1_Pre_LaunchtoActiveandVerifyDates
{
    ...
    public void testcase(){
        ...
        variables."startDate" = new actions.Utils.ReturnDateinRequestedFormat().run("Days":/7/.toString(),"Format":/MM\/dd\/yyyy/.toString())
        //Return Date in Requested Format
        ...
        new actions.WebstormCreation.CreateSolveWebstorm().run("Action on Design Tab":/<Empty>/.toString(),"Launch Date":/${variables."startDate"}/.toString(),"Launch Time":/6:00 AM/.toString(),"End Date":/${variables."endDate"}/.toString(),"End Time":/7:00 AM/.toString(),"Action on Site Schedule Tab":/Continue/.toString())
        ...
        //Return Date in Requested Format
        variables."startDateInNewFormat" = new actions.Utils.ReturnDateinRequestedFormat().run("Days":/7/.toString(),"Format":/MMM d/.toString())
        //Return Date in Requested Format
        ...
        new actions.SetupScheduler.VerifySetupSchedulerV1().run("Status":/Pre-Launch/.toString(),"Pre-Launch End Date":/Ends ${variables."startDateInNewFormat"}/.toString(),"Pre-Launch Tooltip Start":/Start: Jan 1, 12 AM/.toString(),"Pre-Launch Tooltip End":/End: ${variables."startDateInNewFormat"}, 06 AM/.toString())
        ...
        new actions.SetupScheduler.SetupSchedulerV1.SetDateandTimeinSchedulerinSiteSetupV1().run("Start Date":/${variables."todaysDate"}/.toString(),"Start Date Time":/${variables."currentTime"}/.toString(),"End Date":/${variables."endDate"}/.toString(),"End Date Time":/7:00 AM/.toString(),"Action":/Save Schedule/.toString())
        //Set Schedule in Site Setup V1
