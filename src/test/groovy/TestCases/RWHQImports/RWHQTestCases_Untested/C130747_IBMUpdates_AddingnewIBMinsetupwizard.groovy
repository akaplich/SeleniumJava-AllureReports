...
//C130747 - IBM Updates - Adding new IBM in setup wizard
class C130747_IBMUpdates_AddingnewIBMinsetupwizard
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.VerifyLicenseTypeofUserinFields().run("Field":/Pipeline Managers/.toString(),"User":/brightnewuserC130747_2@mailinator.com/.toString(),"License Type":/Ideabox Manager/.toString(),"Number of Matches":/1/.toString())
        //Verify License Type of User in Fields
        new actions.PipelineSetup.VerifyLicenseTypeofUserinFields().run("Field":/Idea Box Managers/.toString(),"User":/brightnewuserC130747_2@mailinator.com/.toString(),"License Type":/Ideabox Manager/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Get Link from Invite Participant Email
        variables."link" = new actions.Mailinator.GetLinkfromInviteParticipantEmail().run("Inbox Email Count":/2/.toString(),"Email Address":/brightnewuserC130747_2/.toString(),"Subject of New Administrator Added Email":/assigned as a Idea Box Manager for Ideabox/.toString())
        //Navigate to URL
