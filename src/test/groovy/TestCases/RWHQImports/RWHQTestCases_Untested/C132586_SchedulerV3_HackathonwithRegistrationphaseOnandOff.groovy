...
//C132586 - Scheduler V3> Hackathon with Registration phase On and Off
class C132586_SchedulerV3_HackathonwithRegistrationphaseOnandOff
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.HackathonOnboarding.VerifyJoinEventButton().run("Button Text":/Registration/.toString(),"Button Displayed":false)
        //Verify Join Event Button
        ...
        //Set Schedule in Site Setup (V2 & V3)
        new actions.SetupScheduler.SetupSchedulerV2.SetScheduleinSiteSetup().run("Navigate to Tab":false,"Resource":/Registration/.toString(),"Click from":/Grid Cell/.toString())
        //Set Date and Time in Scheduler in Site Setup (V2 & V3)
        new actions.SetupScheduler.SetupSchedulerV2.SetDateandTimeinSchedulerinSiteSetup().run("Start Date":/${variables."today"}/.toString(),"Action":/Save Schedule/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.WebstormHomepage.VerifyHomepageHeader2().run("Title":/Hack/.toString(),"Description":/Submit a project and form a team to rapidly prototype in 24 hours. Top projects will have an opportunity to receive further development./.toString(),"Submit Displayed":false,"Registration":false,"Get Started":false)
        //Verify Join Event Button
        new actions.WebstormHomepage.HackathonOnboarding.VerifyJoinEventButton().run("Button Text":/Registration/.toString(),"Button Displayed":true)
        //Set Registration or Get Started For Hackathon Onboarding
        new actions.WebstormHomepage.HackathonOnboarding.SetRegistrationorGetStartedForHackathonOnboarding().run("Area Accessing The Menu From":/Widget/.toString(),"Onboarding Menu Option":/Registration/.toString())
