...
//C65710 - Idea Boards 30 - Filter Slider Bar - My Submissions - Anonymous Idea
class C65710_IdeaBoards30_FilterSliderBar_MySubmissions_AnonymousIdea
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea3/.toString(),"Username":/Anonymous/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
