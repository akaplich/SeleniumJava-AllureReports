...
//C129560 - List View - Pinned Comment Count
class C129560_ListView_PinnedCommentCount
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.ReplytoCommentinViewandNGAViewIdea().run("Parent Comment":/test pinned comment/.toString(),"Comment Reply":/test reply to pinned comment/.toString(),"Post Reply":true)
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Set Tab/View on Idea Board
        new actions.IdeaBoard.NavigatetoIdeaBoardsView().run("View":/List/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/test idea1/.toString(),"Status":/Under Review/.toString(),"Username":/Sri/.toString(),"Description":/test idea1 desc/.toString(),"Comments":/3/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/test idea2/.toString(),"Status":/Submitted/.toString(),"Username":/Sri/.toString(),"Description":/test idea2 desc/.toString(),"Comments":/0/.toString(),"Number of Matches":/1/.toString())
        //Log Out
