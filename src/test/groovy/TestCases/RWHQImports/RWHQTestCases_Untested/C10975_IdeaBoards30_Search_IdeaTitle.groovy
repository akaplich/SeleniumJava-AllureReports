...
//C10975 - Idea Boards 30 - Search - Idea Title
class C10975_IdeaBoards30_Search_IdeaTitle
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Search Value":/test idea/.toString())
        ...
        //Search Idea in Idea Board page
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Search Value":/TEST IDE/.toString())
        //Verify Idea in Idea Board page TEMP
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page TEMP
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea2/.toString(),"Number of Matches":/1/.toString())
