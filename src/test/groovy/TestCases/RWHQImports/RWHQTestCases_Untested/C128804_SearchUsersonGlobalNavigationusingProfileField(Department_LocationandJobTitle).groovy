...
class C128804_SearchUsersonGlobalNavigationusingProfileField(Department_LocationandJobTitle)
{
    ...
    public void testcase(){
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("Job Title":/QA Lead/.toString(),"Department":/Innovation/.toString(),"Location":/United States/.toString(),"Expertise":/automation/.toString(),"Add or Remove Expertise":/Add/.toString())
        //Log Out
