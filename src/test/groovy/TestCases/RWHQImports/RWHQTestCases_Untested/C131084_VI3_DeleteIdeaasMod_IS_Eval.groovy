...
//C131084 - VI3 - Delete Idea as Mod,IS,Eval
class C131084_VI3_DeleteIdeaasMod_IS_Eval
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.SetRolesinPipelineSetupPage().run("Type of Licensing Model":/Legacy/.toString(),"Navigate to Tab":true,"Administrators":/Sri/.toString(),"Administrators Add or Remove":/Remove/.toString(),"Click Save":true)
        //Log Out
        ...
        new actions.ViewIdea30.SetCopyLinkOnViewIdea30Page().run("Menu Option Name":/Delete/.toString(),"Should the option be displayed":false)
