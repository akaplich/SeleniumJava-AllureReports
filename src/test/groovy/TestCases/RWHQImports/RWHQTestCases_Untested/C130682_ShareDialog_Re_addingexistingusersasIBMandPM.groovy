...
//C130682 - Share Dialog - Re-adding existing users as IBM and PM
class C130682_ShareDialog_Re_addingexistingusersasIBMandPM
{
    ...
    public void testcase(){
        ...
        try{
            ...
            new actions.ShareDialog.SetManagersinShareDialog().run("Type of Manager":/Idea Box Manager/.toString(),"Field Name":/Invite Manager/.toString(),"User":/Evaluator/.toString(),"Users Add or Remove from Input Field":/Add/.toString())
        }
        ...
        try{
            //Set Managers in Share Dialog
            new actions.ShareDialog.SetManagersinShareDialog().run("Type of Manager":/Pipeline Manager/.toString(),"Field Name":/Invite Manager/.toString(),"User":/Pipeline Admin/.toString(),"Users Add or Remove from Input Field":/Add/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/No Results/.toString(),"Should Exist":true)
