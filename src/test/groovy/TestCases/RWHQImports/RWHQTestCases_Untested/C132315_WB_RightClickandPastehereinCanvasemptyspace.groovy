...
//C132315 - WB - Right Click and Paste here in Canvas empty space
class C132315_WB_RightClickandPastehereinCanvasemptyspace
{
    ...
    public void testcase(){
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Expected Image File":/C132315_Expected3282025.png/.toString(),"Actual Image Name":/C132315_actual.png/.toString(),"Crop Screenshot Start at X":/550/.toString(),"Crop Screenshot Start at Y":/400/.toString(),"Crop Screenshot Width":/1500/.toString(),"Crop Screenshot Height":/700/.toString(),"Allowed Number of Different Pixels":/100/.toString(),"Do Not Scroll":true)
    }
    //Basestate
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C132315_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
