...
//C65855 - Manage Find Owner
class C65855_ManageFindOwner
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Idea Name":/Quick Add Idea for Find Owner1/.toString(),"Action":/Submit/.toString())
        //Quick Add an Idea in Pipeline Steps page
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Idea Name":/Quick Add Idea for Find Owner2/.toString(),"Action":/Submit/.toString())
        ...
        //Access Action Item in Actions Items React Global Navigation
        new actions.ActionItems.AccessActionIteminActionsItemsReactGlobalNavigation().run("Action Item":/Quick Add Idea for Find Owner2/.toString())
        //Set Find Owner for an Idea in Action Items page
        ...
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Step Name to Manage (optional)":/Find Owner/.toString(),"Count to verify":/2\/2/.toString(),"Evaluator":/System Admin/.toString(),"Number of assigned items":/2/.toString(),"Number of remaining items":/0/.toString(),"Number of Matches":/1/.toString())
        //Verify Currently in Step table for Manage Judging
        new actions.PipelineManageSteps.VerifyCurrentlyinSteptableforManageJudging().run("Idea Name":/Quick Add Idea for Find Owner1/.toString(),"Number of Matches":/1/.toString())
        //Verify Currently in Step table for Manage Judging
        new actions.PipelineManageSteps.VerifyCurrentlyinSteptableforManageJudging().run("Idea Name":/Quick Add Idea for Find Owner2/.toString(),"Number of Matches":/0/.toString())
        //Verify Step History for Manage Step
        new actions.PipelineManageSteps.VerifyStepHistoryinManageStep().run("Idea Name":/Quick Add Idea for Find Owner2/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
