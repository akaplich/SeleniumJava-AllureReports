...
//C132503 - WB Ecommerce - Buy additional license as nonlicensed user 
class C132503_WBEcommerce_Buyadditionallicenseasnonlicenseduser
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.CreateWhiteboardFromUserhome().run("Create New or Choose Template":/Brainwriting/.toString())
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/UL[@class='f-canvas-element-list']\/LI\/DIV\/SPAN[starts-with(text(),'Contributor Name')]\/..\/..\/..\/..\/..\/../.toString(),"Should Element Exist":true,"Number of Matches":/1/.toString())
        //Go Back From Whiteboard
        new actions.Whiteboards.GoBackFromWhiteboard().run([:])
        //Log Out
        new actions.general.LogOut().run([:])
        ...
        new actions.Whiteboards.WhiteboardCardActionDeleteRename().run("Whiteboard to Select":/Whiteboard1/.toString(),"Option":/Save a Copy/.toString())
        //Set Buy Additional Licenses
        new actions.People.SetBuyAdditionalLicenses().run("Type of Subscription":/Annual/.toString(),"Checkout":true)
        //Set FastSpring Modal
        new actions.common.SetFastSpringModal().run("Card Number":/4242 4242 4242 4242/.toString(),"Submit":true)
        //Refresh
        new actions.selenium.Refresh().run([:])
        ...
        new actions.Whiteboards.VerifyToastMessageforLinkingandUnlinkingPipeline().run("Message":/Whiteboard copy saved successfully: Copy of Whiteboard1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.People.VerifyLicensesMetricsinPeoplePillar().run("License Type":/Whiteboard License Type/.toString(),"Metric Text":/Purchased/.toString(),"Metric Value":/5/.toString(),"Number of Matches":/1/.toString())
        //Verify Licenses Metrics in People Pillar
        ...
        //Verify Whiteboard Licenses in Use
        new actions.People.VerifyWhiteboardLicensesinUse().run("Expand License Breakdown":false,"Licenses in Use":/Evaluator/.toString(),"Number of Whiteboards":/3/.toString()," Last Login":/Todays date/.toString(),"Remove Tooltip":/Cannot remove, this license was purchased by the user./.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
