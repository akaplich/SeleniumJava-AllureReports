...
//C117752 - Highlights - User I Follow Votes on Submission
class C117752_Highlights_UserIFollowVotesonSubmission
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/End User has promoted "test idea1" by Sri/.toString(),"Highlights Item Content":/Custom App/.toString(),"Number of Matches":/1/.toString(),"Total Number of Items":/3/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/End User has promoted "test idea1" by Sri/.toString(),"Highlights Item Content":/Custom App/.toString(),"Number of Matches":/0/.toString(),"Total Number of Items":/0/.toString())
    }
    //Basestate
