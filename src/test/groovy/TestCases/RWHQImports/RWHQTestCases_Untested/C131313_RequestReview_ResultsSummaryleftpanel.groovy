...
//C131313 - Request Review - Results Summary left panel
class C131313_RequestReview_ResultsSummaryleftpanel
{
    ...
    public void testcase(){
        ...
        //Set and Verify left panel in Results Summary Review Result modal
        new actions.Memo.SetandVerifyleftpanelinReviewResultmodal().run("Question to be clicked":/Overall, should this Memo be considered for our next planning session?/.toString(),"Reviewer":/Evaluator/.toString(),"Reviewer Checkbox Check":/TRUE/.toString(),"Score":/6.3/.toString())
        //Verify Right Panel in Results Summary Review Result modal
        new actions.Memo.VerifyrightpanelinResultsSummaryReviewResultmodal().run("Question":/How strong is the core idea for this Memo?/.toString(),"Slider Value":/4/.toString(),"Score":/4/.toString(),"Reviewer":/Evaluator/.toString(),"Reviewer Score":/4/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Right Panel in Results Summary Review Result modal
        new actions.Memo.VerifyrightpanelinResultsSummaryReviewResultmodal().run("Question":/How complete is the Memo?/.toString(),"Slider Value":/5/.toString(),"Score":/5/.toString(),"Reviewer":/Evaluator/.toString(),"Reviewer Score":/5/.toString(),"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Right Panel in Results Summary Review Result modal
        new actions.Memo.VerifyrightpanelinResultsSummaryReviewResultmodal().run("Question":/How well is the Memo presented?/.toString(),"Slider Value":/10/.toString(),"Score":/10/.toString(),"Reviewer":/Evaluator/.toString(),"Reviewer Score":/10/.toString(),"Placement Number":/3/.toString(),"Number of Matches":/1/.toString())
        //Verify Right Panel in Results Summary Review Result modal
        new actions.Memo.VerifyrightpanelinResultsSummaryReviewResultmodal().run("Question":/Overall, should this Memo be considered for our next planning session?/.toString(),"Slider Value":/6/.toString(),"Score":/6/.toString(),"Reviewer":/Evaluator/.toString(),"Reviewer Score":/6/.toString(),"Placement Number":/4/.toString(),"Number of Matches":/1/.toString())
        //Verify Right Panel in Results Summary Review Result modal
        new actions.Memo.VerifyrightpanelinResultsSummaryReviewResultmodal().run("Question":/Overall, should this Memo be considered for our next planning session?/.toString(),"Reviewer":/Pipeline Admin/.toString(),"Reviewer Score":/-/.toString(),"Number of Matches":/0/.toString())
        //Verify Right Panel in Results Summary Review Result modal
