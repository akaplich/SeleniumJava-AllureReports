...
//C129772 - Move Ideas - Match Status - Select Multiple Ideas with Different Statuses
class C129772_MoveIdeas_MatchStatus_SelectMultipleIdeaswithDifferentStatuses
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SelectMultipleIdeasinPipelineSteps().run("Idea Names":["test idea1"])
        ...
        try{
            ...
            new actions.PipelineStepsView.NewMoveIdeasinPipelineStepspage().run("Move To Pipeline":/Pipeline A/.toString(),"Category":/Operations/.toString(),"Action":/Move Idea/.toString())
        }
