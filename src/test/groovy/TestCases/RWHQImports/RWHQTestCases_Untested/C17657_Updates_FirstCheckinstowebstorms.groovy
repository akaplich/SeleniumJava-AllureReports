...
//C17657 - Updates - First Checkins to webstorms
class C17657_Updates_FirstCheckinstowebstorms
{
    ...
    public void testcase(){
        ...
        new actions.Widgets.VerifyWidgetUpdates().run("Update Text Contains":/Pipeline Admin checked into Custom App for the first time/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/pipelineadmin@test.com/.toString(),"Password":/brightidea1/.toString())
