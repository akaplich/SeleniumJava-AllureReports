...
//C131007 - WB - Timer - Add One Minute
class C131007_WB_Timer_AddOneMinute
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SetTimerWhiteboardPage().run("Action":/Add Minute/.toString())
        //Verify Timer in Whiteboards
        new actions.Whiteboards.VerifyTimerWhiteboards().run("Timer Should be Present":true,"Minutes Value":/04/.toString())
    }
    //Basestate
