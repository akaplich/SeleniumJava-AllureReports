...
//C130692 - Move Ideas with moving Missing Dev Fields as Pipeline Admin
class C130692_MoveIdeaswithmovingMissingDevFieldsasPipelineAdmin
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.NewMoveIdeasinPipelineStepspage().run("Move To Pipeline":/Destination Pipeline/.toString(),"Category":/Operations/.toString(),"Status":/Submitted/.toString(),"Action":/Move Idea/.toString())
        ...
        //Verify View Idea Description Tab Field Value
        new actions.ViewIdeaFields.VerifyViewIdeaDescriptionTabFieldValue().run("Field Name":/Different Development Question/.toString(),"Field Value":/Answer1/.toString())
    }
    //Basestate
