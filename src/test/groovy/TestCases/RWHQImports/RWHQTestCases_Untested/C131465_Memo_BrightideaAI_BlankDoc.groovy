...
//C131465 - Memo - Brightidea AI - Blank Doc
class C131465_Memo_BrightideaAI_BlankDoc
{
    ...
    public void testcase(){
        ...
        new actions.Memo.CollabEditorSetToolBarOptions().run("Brightidea AI":/Main Button/.toString())
        //Collab Editor - Verify Text
        new actions.Memo.CollabEditorVerifyText().run("Expected Text":/Writing can be daunting! Use our Brightidea AI to answer questions, continue writing, or reword your current content. All you need to do is provide it with some context, and it will take it from there!/.toString(),"Font Color":/rgb(155,89,182)/.toString(),"Should Text Exist":true)
    }
    //Basestate
