...
//C118995 - Highlights - All Activity - Delete User who voted on Submission
class C118995_Highlights_AllActivity_DeleteUserwhovotedonSubmission
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/End User has demoted "test idea2" by Sri/.toString(),"Number of Matches":/0/.toString())
        //Verify Highlights Item on User Homepage
