...
class C129764_AddIdeaviaEmail_HoldSubmissionUntilUsersRegisterRedwoodHQTestCaseSendRegistrationEmail
{
    ...
    public void testcase(){
        ...
        new actions.SetupBeta.SetEnterpriseSetupforBetatab().run("Allow Unregistered Users Submit Via Email":true,"Hold Submission Until Users Register or Post Submissions Immediately":/Hold Submission Until Users Register/.toString(),"Send Registration Email Following Submission":true)
        ...
        new actions.PipelineCommunications.SetPipelineCommunicationsTab().run("Select Tab":/Emails/.toString(),"Email":/New Idea Submitted/.toString(),"Email Recipient":/Idea Submitter/.toString(),"Email Subject":/C129764 Submission Confirmation/.toString(),"Action":/Save/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Email.VerifyEmailNotMailinator().run("Sender Host":/imap.mail.yahoo.com/.toString(),"Sender's Email":/annabrightidea1@yahoo.com/.toString(),"Password":/coothhthkgxqqztx/.toString(),"Email Subject to Look For":/C129764 Submission Confirmation/.toString(),"Email Should Exist":false,"Folder":/INBOX/.toString())
        ...
        //Verify Email Not Mailinator
        new actions.Email.VerifyEmailNotMailinator().run("Sender Host":/imap.mail.yahoo.com/.toString(),"Sender's Email":/annabrightidea1@yahoo.com/.toString(),"Password":/coothhthkgxqqztx/.toString(),"Email Subject to Look For":/C129764 Submission Confirmation/.toString(),"Email Should Exist":true,"Folder":/INBOX/.toString())
    }
    //Basestate
