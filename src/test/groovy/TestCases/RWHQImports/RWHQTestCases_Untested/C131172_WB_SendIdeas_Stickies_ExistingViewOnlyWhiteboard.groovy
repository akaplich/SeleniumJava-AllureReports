...
//C131172 - WB - Send Ideas - Stickies - Existing View Only Whiteboard
class C131172_WB_SendIdeas_Stickies_ExistingViewOnlyWhiteboard
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SendIdeaToWhiteboardFromPipelineSteps().run("Existing Whiteboard or New Whiteboard":/Existing Whiteboard/.toString(),"Whiteboard Title":/Whiteboard1/.toString(),"Action":/Send/.toString())
        //Verify Toast Message in Pipeline Steps/List
        new actions.PipelineStepsView.VerifyToastMessageInPipelineStepsList().run("Message":/Sorry, you do not have sufficient access to the whiteboard./.toString())
    }
    //Basestate
