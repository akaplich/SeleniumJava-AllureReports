...
//C132080 - PR Image > Upload Image from Left Top Bar
class C132080_PRImage_UploadImagefromLeftTopBar
{
    ...
    public void testcase(){
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/${variables."elementLocation"}/.toString(),"Expected Image File":/C132080_TopBar_ExpectedImage.png/.toString(),"Actual Image Name":/C132080_TopBar_ActualImage.png/.toString())
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/${variables."elementLocation"}/.toString(),"Expected Image File":/C132080_Preview_ExpectedImage.png/.toString(),"Actual Image Name":/C132080_Preview_ActualImage.png/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Name":/C132080_TopBar_ActualImage.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Name":/C132080_Preview_ActualImage.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
