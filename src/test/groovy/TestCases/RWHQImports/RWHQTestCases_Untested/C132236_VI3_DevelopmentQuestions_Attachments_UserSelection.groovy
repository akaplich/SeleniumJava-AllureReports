...
//C132236 - VI3 - Development Questions - Attachments, User Selection
class C132236_VI3_DevelopmentQuestions_Attachments_UserSelection
{
    ...
    public void testcase(){
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("Display Picture":/Image5.jpg/.toString(),"Display Picture Change or Remove":/Change/.toString(),"Screen Name":/Screen Name/.toString(),"First Name":/First/.toString(),"Last Name":/Last Name/.toString())
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development User Selection/.toString(),"Additional Question Type":/User Selection/.toString(),"Additional Question Allow Multiple User Selection":true,"Development Field":true)
        //Set Webstorm Setup Ideas for Submission Form Tab
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development Attachment Question/.toString(),"Additional Question Type":/Attachment/.toString(),"Development Field":true,"Save Form":true)
        //Navigate WebStorm or MTS
        ...
        new actions.PipelineStepsConfigure.ConfigureDevelopmentinNewModalinPipelineStepspage().run("Assignment Method":/Individual Assignment/.toString(),"Development Lead":/Idea Submitter/.toString(),"Development Field":/Development Attachment Question,Development User Selection/.toString(),"Development Field Included or Required":/Included,Included/.toString(),"Action":/Activate/.toString())
        ...
        new actions.ViewIdea3Fields.VerifyViewIdea3DescriptionTabFieldValue().run("Field Name":/Development Attachment Question/.toString(),"Field Value":/No attachment/.toString(),"Should Exist":/TRUE/.toString())
        //Verify Description Tab Text Field on View Idea 30
        new actions.ViewIdea3Fields.VerifyViewIdea3DescriptionTabFieldValue().run("Field Name":/Development User Selection/.toString(),"Field Value":/No user/.toString(),"Should Exist":/TRUE/.toString())
        //Set Development for Idea in Action Items page
        new actions.ActionItems.SetDevelopmentforIdeainActionItemspage().run("Development Attachment Question":/Image5.jpg/.toString(),"Development User Select Question":/End User,Screen Name/.toString(),"Development User Select Question Add or Remove":/Add,Add/.toString(),"Development Child Checkbox Question":[],"Action":/Mark Complete/.toString(),"Action on Mark Development Form Complete":/Mark Complete/.toString())
        //Navigate WebStorm or MTS
        ...
        //Verify Description Tab Text Field on View Idea 30
        new actions.ViewIdea3Fields.VerifyViewIdea3DescriptionTabFieldValue().run("Field Name":/Development Attachment Question/.toString(),"Field Value":/Image5.jpg/.toString(),"Should Exist":/TRUE/.toString())
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/DIV[@class='f-question-wrapper qindex-0']/.toString(),"Expected Image File":/C132236_expected.png/.toString(),"Actual Image Name":/C132236_actual.png/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C132236_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
