...
//C206 - Long Answer Question - Video Insert, Link
class C206_LongAnswerQuestion_VideoInsert_Link
{
    ...
    public void testcase(){
        ...
        new actions.SetIdeaFields.SetPostIdeaInsertVideoforTextField().run("Field Name":/Long Answer Question/.toString(),"Video Link":/${variables."TCData.Video Link Set"}/.toString(),"Action":/Insert/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Test Idea Video Link/.toString(),"Description":/Description/.toString(),"Category":/New Product/.toString(),"Required Short Question":/Required Short/.toString(),"Action":/Submit Idea/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Test Idea Video Link/.toString())
