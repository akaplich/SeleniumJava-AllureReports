...
//C128604 - Search Admin Comment by submitter name in an Idea on Initiative Global Navigation
class C128604_SearchAdminCommentbysubmitternameinanIdeaonInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/Comment automation purpose/.toString(),"Comment Type":/Update from Admin/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Comments/.toString(),"Title":/Comment automation purpose/.toString(),"Number of Matches":/1/.toString(),"Click on the result":true)
        //Verify Comment in View Idea page
        new actions.ViewIdeaComment.VerifyCommentinViewIdeapage().run("Comment Section":/Comments/.toString(),"Type of Comment":/Administrator/.toString(),"Comment":/Comment automation purpose/.toString(),"User":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Log Out
