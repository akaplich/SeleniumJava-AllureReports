...
//C129705 - History Tab - Copy Ideas & Link (default)
class C129705_HistoryTab_CopyIdeasRedwoodHQTestCaseLink(default)
{
    ...
    public void testcase(){
        ...
        //Verify History Tab on View Idea
        new actions.ViewIdea.VerifyHistoryTabonViewIdea().run("Event Record to Verify":/Idea copied from test idea3 by System Admin/.toString(),"Number of Matches":/1/.toString(),"Total Number of Records":/2/.toString())
        //Verify Linked Submission on View Idea
        new actions.ViewIdea.VerifyLinkedSubmissiononViewIdea().run("Linked Submissions":/test idea3/.toString(),"Should Exist":/TRUE/.toString(),"Name of the Linked Submission to Navigate to":/test idea3/.toString())
        //Verify History Tab on View Idea
        new actions.ViewIdea.VerifyHistoryTabonViewIdea().run("Event Record to Verify":/Idea linked to test idea3 by System Admin/.toString(),"Number of Matches":/1/.toString(),"Total Number of Records":/2/.toString())
    }
    //Basestate
