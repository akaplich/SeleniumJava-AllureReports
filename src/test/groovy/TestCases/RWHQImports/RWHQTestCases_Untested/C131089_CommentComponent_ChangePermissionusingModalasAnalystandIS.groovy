...
//C131089 - Comment Component - Change Permission using Modal as Analyst and IS
class C131089_CommentComponent_ChangePermissionusingModalasAnalystandIS
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.SetRolesinPipelineSetupPage().run("Type of Licensing Model":/Legacy/.toString(),"Navigate to Tab":true,"Admin Field Name":/Pipeline Administrators/.toString(),"Administrators":/Sri/.toString(),"Administrators Add or Remove":/Remove/.toString(),"Click Save":true)
        //Log Out
