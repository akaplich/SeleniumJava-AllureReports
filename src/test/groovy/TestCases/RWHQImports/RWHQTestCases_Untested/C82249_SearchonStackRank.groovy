...
//C82249 - Search on Stack Rank
class C82249_SearchonStackRank
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.SetStackRankforIdeainActionItemspage().run("Idea":/stackrank idea2/.toString(),"New Order":/1/.toString(),"Action":/Save/.toString(),"Search Idea":/stackrank idea2/.toString())
        ...
        //Verify Stack Rank for Idea in Action Items Page
        new actions.ActionItems.VerifyStackRankforIdeainActionItemsPage().run("Idea":/stackrank idea1/.toString(),"Rank":/2/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
