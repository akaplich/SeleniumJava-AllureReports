...
//C131434 - WB - Top Ideas - Send To Smart Matrix - Stickies - New Whiteboard
class C131434_WB_TopIdeas_SendToSmartMatrix_Stickies_NewWhiteboard
{
    ...
    public void testcase(){
        ...
        new actions.PipelineTopIdeas.QuickAddIdeaInTopIdeas().run("Click Quick Add to Trigger Dialog":true,"Quick Add Button Should Be Active After Click":true,"Title":/test idea1/.toString(),"Category":/Theme 2/.toString(),"Action":/Submit/.toString(),"Quick Add Button Should Be Inactive At The End":true)
        ...
        new actions.Whiteboards.SendIdeaToWhiteboardFromPipelineSteps().run("Send to Whiteboard or Smart Matrix":/Send to Smart Matrix/.toString(),"Existing Whiteboard or New Whiteboard":/New Whiteboard/.toString(),"Whiteboard Title":/C131434 - smart matrix/.toString(),"Format":/Stickies/.toString(),"Smart Matrix Name":/Matrix for C131434/.toString(),"Action":/Send/.toString())
        //Verify Toast Message for Linking and Unlinking Pipeline
        new actions.Whiteboards.VerifyToastMessageforLinkingandUnlinkingPipeline().run("Message":/The selected ideas were sent successfully to the whiteboard: C131434 - smart matrix/.toString(),"Click on Idea Code":true)
        ...
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/0/.toString(),"Y coordinate":/-370/.toString(),"Single Double or Right Click":/Single Click/.toString())
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/-100/.toString(),"Y coordinate":/-65/.toString(),"Single Double or Right Click":/Single Click/.toString())
        //Wait
        ...
        new actions.Whiteboards.SetRightClickonSmartMatrix().run("X Coordinate":/-100/.toString(),"Y Coordinate":/-100/.toString(),"Menu Option":/Go to Top Ideas/.toString())
        //Switch to Browser Window
        ...
        new actions.PipelineTopIdeas.SetSortInTopIdeas().run("Sort By":/Smart Matrix (Matrix for C131434)/.toString())
        //Verify Smart Matrix in Top Ideas
        new actions.PipelineTopIdeas.VerifySmartMatrixinTopIdeas().run("Idea":/test idea1/.toString(),"Score":/28.4/.toString(),"X Axis":/Impact/.toString(),"X coordinate":/8.1/.toString(),"Y Axis":/Feasibility/.toString(),"Y coordinate":/3.5/.toString(),"Click on Smart Matrix":true)
        //Verify Smart Matrix & Other Elements Exists On Whiteboard
        new actions.Whiteboards.VerifySmartMatrixExists().run("Verify This Actual Text":/test idea1/.toString(),"Should Exist":true)
    }
    //Basestate
