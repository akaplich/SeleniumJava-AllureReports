...
class C65707_IdeaBoards30_FilterSliderBar_MySubmissions_UpdateSubmissionName
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabTextField().run("Field Name":/Title/.toString(),"Field Value":/test idea3 update/.toString(),"Action":/Save/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea3 update/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
