...
//C132475 - Action Item Completed Rule - submission form question condition - dropdown question
class C132475_ActionItemCompletedRule_submissionformquestioncondition_dropdownquestion
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Dropdown Question/.toString(),"Additional Question Type":/Dropdown/.toString(),"Additional Question Answers":/Answer 1,Answer 2,Answer 3,Drop 1,Drop 2,Drop 3/.toString(),"Additional Question Answers Actions":/Remove,Remove,Remove,Add,Add,Add/.toString(),"Save Form":true)
        ...
        new actions.PipelineStepsView.EditStepinPipelineStepspage().run("Step to Edit":/Scorecarding/.toString(),"Step Name":/Scorecard/.toString(),"Tool Type":/Scorecard/.toString(),"Action":/Save/.toString())
        ...
        new actions.Rules.SetNewRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Condition":/Dropdown Question/.toString(),"Operator value":/Is/.toString(),"Condition value":/Drop 1/.toString())
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/rule for dropdown question/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/rule for dropdown question/.toString())
        //Change Rule Status
        ...
        new actions.ActionItems.AccessActionIteminActionsItemsGlobalNavigation().run("Action Item":/rules idea/.toString())
        ...
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/rules idea/.toString(),"Step Name idea belongs to":/Selection/.toString(),"Number of Matches":/1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Test App/.toString(),"Area to Navigate to":/Rules/.toString())
        //Verify Rule in Rules Engine table
        new actions.Rules.VerifyRuleinRulesEnginetable().run("Order":/0/.toString(),"Rule Name":/rule for dropdown question/.toString(),"Event":/Action Item Completed/.toString(),"Status":/Active/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
