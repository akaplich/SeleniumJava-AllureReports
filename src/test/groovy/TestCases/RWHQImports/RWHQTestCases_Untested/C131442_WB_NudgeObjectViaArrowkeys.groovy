...
class C131442_WB_NudgeObjectViaArrowkeys
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("X":/-955/.toString())
        ...
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/Left/.toString())
        //Verify Right Side Controls in Whiteboard 
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("X":/-963/.toString(),"Y":/-285/.toString())
        //Send Key(s) To Whiteboard
        ...
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/Up/.toString())
        //Verify Right Side Controls in Whiteboard 
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("X":/-963/.toString(),"Y":/-293/.toString())
    }
    //Basestate
