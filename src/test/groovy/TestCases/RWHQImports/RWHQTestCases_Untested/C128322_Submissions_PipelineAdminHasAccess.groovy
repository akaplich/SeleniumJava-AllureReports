...
//C128322 -  Submissions - Pipeline Admin Has Access 
class C128322_Submissions_PipelineAdminHasAccess
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Ideas-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Code","Category","Submitted","Submitter","Submission Team","Title","Description","Status","Stage","Actual Benefit ($)"],"Number of Matches":/1/.toString(),"Total Number of Rows":/8/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Ideas/.toString(),"Instance":/1/.toString())
        //Verify File Data
        ...
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Ideas/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Ideas-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Pipeline Admin","pipelineadmin@test.com","Test Idea 3","Description","Submitted","Collection","Review"],"Number of Matches":/1/.toString(),"Total Number of Rows":/5/.toString())
        //Remove Report from Setup Exports
        new actions.SetupExports.RemoveReportfromSetupExports().run("Section":/Submissions/.toString(),"Report Name Starts with":/Ideas/.toString(),"Instance":/1/.toString(),"Action":/Delete Report/.toString())
    }
    //Basestate
