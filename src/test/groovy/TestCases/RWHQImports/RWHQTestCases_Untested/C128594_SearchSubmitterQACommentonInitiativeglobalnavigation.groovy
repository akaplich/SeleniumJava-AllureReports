...
//C128594 - Search Submitter QA Comment on Initiative global navigation
class C128594_SearchSubmitterQACommentonInitiativeglobalnavigation
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/Submitter QA comment automation purpose/.toString(),"Comment Type":/Submitter Q&A/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/Submitter QA comment automation purpose/.toString())
        //Verify On Global Search Result
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Comments/.toString(),"Title":/Submitter QA comment automation purpose/.toString(),"Number of Matches":/1/.toString(),"Click on the result":true)
        //Verify Comment in View Idea page
        new actions.ViewIdeaComment.VerifyCommentinViewIdeapage().run("Comment Section":/Comments/.toString(),"Type of Comment":/Submitter Q&A/.toString(),"Comment":/Submitter QA comment automation purpose/.toString(),"User":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/Submitter QA comment automation purpose/.toString())
        //Verify On Global Search Result
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Comments/.toString(),"Title":/Submitter QA comment automation purpose/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
