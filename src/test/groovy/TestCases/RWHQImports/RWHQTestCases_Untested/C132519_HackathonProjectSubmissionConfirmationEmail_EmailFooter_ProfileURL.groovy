...
//C132519 - Hackathon Project Submission Confirmation Email - Email Footer - Profile URL
class C132519_HackathonProjectSubmissionConfirmationEmail_EmailFooter_ProfileURL
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC132519/.toString(),"Finally Login as What User":/brightC132519@mailinator.com/.toString())
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/hack project/.toString(),"Description":/test/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/120/.toString())
        //Verify Email by Iterating through Inbox Mailinator
        new actions.Email.VerifyEmailbyIteratingthroughInboxMailinator().run("Email Address":/brightC132519/.toString(),"Subject":/Hack: Project Submission Confirmation/.toString(),"Email Should Be Received":true)
        //Get Profile Link from Email Footer
        variables."C132519ProfileURL" = new actions.Mailinator.GetProfileLinkfromEmailFooter().run("Email Address":/brightC132519/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."C132519ProfileURL"}/.toString())
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("Send me daily digests of all email":/Click/.toString(),"Send me daily digests of all email Time":/5 PM/.toString(),"Receive event updates via e-mail":true,"Save":true)
    }
    //Basestate
