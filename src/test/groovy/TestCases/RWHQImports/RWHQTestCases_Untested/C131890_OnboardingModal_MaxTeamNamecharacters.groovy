...
//C131890 - Onboarding Modal - Max Team Name characters
class C131890_OnboardingModal_MaxTeamNamecharacters
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Flow Option Title":/I have a team and a project, just need to get started./.toString(),"Expertise":/myexpertise1/.toString(),"Add or Remove Expertise":/Add/.toString(),"I am available to join teams":true,"Register and add expertise Action":/Next/.toString())
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/*[contains(@class,'f-teamname-remaining') and .="30 characters remaining"]/.toString(),"Should Element Exist":true,"Number of Matches":/1/.toString())
        try{
            //Set Flow B and C on Hackathon Onboarding
            new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Project Name":/30charactercountissuetotest1234/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/*[contains(@class,'f-teamname-remaining') and .="0 characters remaining"]/.toString(),"Should Element Exist":true,"Number of Matches":/1/.toString())
        try{
            //Set Flow B and C on Hackathon Onboarding
            new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Name your team Screen Action":/Next/.toString(),"Choose a team image Action":/Next/.toString(),"Build your winning team Screen Action":/Next/.toString(),"Get Started Screen Menu":/Ready to share your teams idea?/.toString(),"Wait for loading to disappear":true)
        }
       catch(all){}catch(Error err){}
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"View Type":/Gallery/.toString(),"Idea Name":/Check this idea/.toString(),"Username":/30charactercountissuetotest123/.toString(),"Description":/desc/.toString(),"Number of Matches":/1/.toString(),"Placement Number":/1/.toString())
    }
    //Basestate
