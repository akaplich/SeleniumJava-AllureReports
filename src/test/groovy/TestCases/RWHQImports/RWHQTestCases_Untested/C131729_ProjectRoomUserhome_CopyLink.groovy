...
//C131729 - Project Room Userhome > Copy Link
class C131729_ProjectRoomUserhome_CopyLink
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.SetActionMenuonProjectRoomCard().run("Project Room Title":/Testing project room/.toString(),"Option":/Copy Link/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Link copied to clipboard./.toString(),"Should Exist":true)
