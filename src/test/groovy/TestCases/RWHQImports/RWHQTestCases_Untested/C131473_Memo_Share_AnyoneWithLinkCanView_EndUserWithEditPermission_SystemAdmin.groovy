...
//C131473 - Memo - Share - Anyone With Link Can View - End User With Edit Permission, System Admin
class C131473_Memo_Share_AnyoneWithLinkCanView_EndUserWithEditPermission_SystemAdmin
{
    ...
    public void testcase(){
        ...
        new actions.Memo.ColabEditorSetMemoTitle().run("New Title":/C131473/.toString(),"Action":/Submit/.toString())
        ...
        //Collab Editor - Set Text
        new actions.Memo.ColabEditorSetText().run("Text":/added by System Admin/.toString(),"Key(s)":/Enter/.toString())
        //Collab Editor - Click Go Back Button
        new actions.Memo.ColabEditorClickGoBackButton().run([:])
        //Log Out
        new actions.general.LogOut().run([:])
        ...
        new actions.Memo.SelectExistingMemosfromUserhome().run("Memo Title":/C131473/.toString())
        //Collab Editor - Set Text
        ...
        new actions.Memo.CollabEditorVerifyText().run("Contains Text (only verifies text & color!)":/added by End User/.toString(),"Should Text Exist":true)
        //Collab Editor - Verify Text
        new actions.Memo.CollabEditorVerifyText().run("Contains Text (only verifies text & color!)":/added by System Admin/.toString(),"Should Text Exist":true)
