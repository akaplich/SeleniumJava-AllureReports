...
//C129580 - List View - Favorite toggle disabled
class C129580_ListView_Favoritetoggledisabled
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforIdeastab().run("My Favorites":false)
        //Navigate WebStorm or MTS
        ...
        new actions.IdeaBoard.VerifyVotingCommentsIconIdeaCardIdeaBoards30().run("Favorites":false)
    }
    //Basestate
