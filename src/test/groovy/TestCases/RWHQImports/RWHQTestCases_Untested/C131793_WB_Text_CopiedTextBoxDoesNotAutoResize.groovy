...
//C131793 - WB - Text - Copied Text Box Does Not Auto Resize
class C131793_WB_Text_CopiedTextBoxDoesNotAutoResize
{
    ...
    public void testcase(){
        ...
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/C130793/.toString())
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/ to copy/.toString())
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/Escape/.toString())
