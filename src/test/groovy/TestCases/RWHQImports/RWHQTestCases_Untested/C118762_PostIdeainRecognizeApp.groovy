...
//C118762 - Post Idea in Recognize App
class C118762_PostIdeainRecognizeApp
{
    ...
    public void testcase(){
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Recognize title/.toString(),"Area to Navigate to":/Setup/.toString())
