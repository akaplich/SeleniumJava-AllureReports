...
//C119035 - Highlights - All Activity - Post a Comment in Prelaunched Status
class C119035_Highlights_AllActivity_PostaCommentinPrelaunchedStatus
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("Comment":/This is comment1_testing/.toString(),"Post Comment":true)
