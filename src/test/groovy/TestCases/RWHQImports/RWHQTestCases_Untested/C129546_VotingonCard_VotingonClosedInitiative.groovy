...
//C129546 - Voting on Card - Voting on Closed Initiative
class C129546_VotingonCard_VotingonClosedInitiative
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/Gallery/.toString(),"Idea Name":/test idea1 in solve challenge/.toString(),"Username":/System Admin/.toString(),"Description":/Idea Description/.toString(),"Votes":/2/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
