...
//C132427 - Step Config - Time Setting, Not Null and Default Time Settings
class C132427_StepConfig_TimeSetting_NotNullandDefaultTimeSettings
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureSingleScaleStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Screen Companies/.toString(),"Individual Assignment User":"","Confirm Timezone":/(UTC-05:00) Eastern Time (US and Canada)/.toString(),"Confirm Set Time":/17:00/.toString(),"Action":/Cancel/.toString())
        //Configure Single Scale Step in Pipeline Steps page
        new actions.PipelineStepsConfigure.ConfigureSingleScaleStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Screen Companies/.toString(),"Individual Assignment User":"","Due at Time":/18:00/.toString(),"Confirm Timezone":/(UTC-05:00) Eastern Time (US and Canada)/.toString(),"Action":/Activate/.toString())
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Configure Single Scale Step in Pipeline Steps page
        new actions.PipelineStepsConfigure.ConfigureSingleScaleStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Screen Companies/.toString(),"Confirm Timezone":/(UTC-05:00) Eastern Time (US and Canada)/.toString(),"Confirm Set Time":/18:00/.toString())
    }
    //Basestate
