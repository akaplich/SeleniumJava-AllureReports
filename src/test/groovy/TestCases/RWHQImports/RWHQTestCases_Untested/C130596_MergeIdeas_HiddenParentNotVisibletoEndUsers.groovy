...
//C130596 - Merge Ideas - Hidden Parent Not Visible to End Users
class C130596_MergeIdeas_HiddenParentNotVisibletoEndUsers
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Title":/zparent3/.toString(),"Action":/Submit/.toString())
        //Select Idea in Pipeline Steps page
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/zparent3/.toString())
        ...
        new actions.PipelineStepsView.SelectMultipleIdeasinPipelineSteps().run("Idea Names":["zparent3","test idea2"])
        //Set Merge Ideas in Pipeline Steps & List
        new actions.PipelineStepsView.SetMergeIdeasInPipelineStepsList().run("Verify Order of Ideas:":["test idea2","zparent3"],"Select Parent":/zparent3/.toString(),"Action":/Merge Ideas/.toString())
        //Log Out
        ...
        //Click on Element
        new actions.selenium.Click().run("ID":/\/\/*[@class='model-message']\/A[contains(.,'zparent3')]/.toString())
        //Verify Message
