...
//C130932 - WB - Shapes - Add Square - Double Click
class C130932_WB_Shapes_AddSquare_DoubleClick
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.VerifySmartMatrixExists().run("Element (skip if verifying actual text)":/Rectangle 1/.toString(),"Should Exist":true)
    }
    //Basestate
