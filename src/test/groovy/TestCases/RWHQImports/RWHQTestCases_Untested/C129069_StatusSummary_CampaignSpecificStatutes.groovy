...
//C129069 - Status Summary - Campaign Specific Statutes
class C129069_StatusSummary_CampaignSpecificStatutes
{
    ...
    public void testcase(){
        ...
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Status_Summary/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Status_Summary-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Custompending"],"Number of Matches":/0/.toString(),"Total Number of Rows":/4/.toString())
    }
    //Basestate
