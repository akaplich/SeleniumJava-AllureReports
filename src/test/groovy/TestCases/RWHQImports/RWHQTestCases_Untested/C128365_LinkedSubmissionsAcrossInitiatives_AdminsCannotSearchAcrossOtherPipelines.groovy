...
//C128365 - Linked Submissions Across Initiatives - Admins Cannot Search Across Other Pipelines
class C128365_LinkedSubmissionsAcrossInitiatives_AdminsCannotSearchAcrossOtherPipelines
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/user idea1/.toString(),"Description":/desc/.toString(),"Category":/New Product/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        try{
            ...
            new actions.NGAViewIdea.SetLinkedSubmissionsNGAViewIdeaPage().run("Submission Title":/user idea/.toString(),"Add or Remove":/Add/.toString())
        }
