...
//C119176 - Owner Updates - Edit Owner Analyst
class C119176_OwnerUpdates_EditOwnerAnalyst
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureFindOwnerinNewModalinPipelineStepspage().run("Assignment Method":/Category Assignment/.toString(),"Category":/New Product,Operations,Marketing & Branding,Strategy,Quick Add\/New Categories/.toString(),"Owner":/System Admin,System Admin,System Admin,System Admin,System Admin/.toString(),"Owner Add or Remove":/Add,Add,Add,Add,Add/.toString(),"Action":/Activate/.toString())
        //Log Out
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Idea for Edit Owner Custom2/.toString(),"Description":/desc/.toString(),"Category":/New Product/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/Idea for Edit Owner Custom2/.toString())
        ...
        new actions.ActionItems.AccessActionIteminMyActionItemsActionItemsManagertable().run("Access in Which List":/My Action Items/.toString(),"Title":/Idea for Edit Owner Custom2/.toString(),"Pipeline":/Custom App/.toString(),"Step":/Find Owner Custom/.toString())
        ...
        new actions.PipelineSetup.SetRolesinPipelineSetupPage().run("Navigate to Tab":true,"Analysts":/End User/.toString(),"Analysts Add or Remove":/Add/.toString(),"Click Save":true)
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Idea for Edit Owner Custom2/.toString())
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/Idea for Edit Owner Custom2/.toString(),"Owner":/System Admin/.toString(),"Linked Submissions":[])
        try{
        ...
        new actions.ViewIdea.SetOwnerinViewIdeaPage().run("User":/Pipeline Admin/.toString(),"User Add or Remove":/Add/.toString(),"Action":/Update/.toString())
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/Idea for Edit Owner Custom2/.toString(),"Owner":/Pipeline Admin/.toString(),"Linked Submissions":[])
    }
    //Basestate
