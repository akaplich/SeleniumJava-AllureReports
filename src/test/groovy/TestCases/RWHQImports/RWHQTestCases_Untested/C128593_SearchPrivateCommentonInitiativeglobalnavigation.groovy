...
//C128593 - Search Private Comment on Initiative global navigation
class C128593_SearchPrivateCommentonInitiativeglobalnavigation
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/Private comment automation purpose/.toString(),"Comment Type":/Private/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/Private comment automation purpose/.toString())
        //Verify On Global Search Result
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Comments/.toString(),"Title":/Private comment automation purpose/.toString(),"Number of Matches":/1/.toString(),"Click on the result":true)
        //Verify Comment in View Idea page
        new actions.ViewIdeaComment.VerifyCommentinViewIdeapage().run("Comment Section":/Comments/.toString(),"Type of Comment":/Private/.toString(),"Comment":/Private comment automation purpose/.toString(),"User":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/Private comment automation purpose/.toString())
        //Verify On Global Search Result
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Comments/.toString(),"Title":/Private comment automation purpose/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
