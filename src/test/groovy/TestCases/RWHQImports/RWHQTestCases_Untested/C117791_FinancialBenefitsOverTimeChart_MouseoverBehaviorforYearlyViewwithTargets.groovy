...
class C117791_FinancialBenefitsOverTimeChart_MouseoverBehaviorforYearlyViewwithTargets
{
    ...
    public void testcase(){
        ...
        new actions.PipelineDashBoard.SetfinancialtargetsintheBusinessImpacttab().run("Year":/2018,2019/.toString(),"Targets":/10000,30000/.toString(),"Action":/Save Targets/.toString())
        //Verify the MouseHover on Chart View in Business Impact Tab
        new actions.PipelineDashBoard.VerifyMouseHoveronBusinessImpactTabinPipelineDashBoard().run("Chart View":/Yearly/.toString(),"Year":/2018,2019/.toString(),"Projected":/$30,000;$50,000/.toString(),"Actual":/$50,000;$70,000/.toString(),"Target":/$10,000;$30,000/.toString())
    }
    //Basestate
