...
//C117082 - End User should not see hidden ideas
class C117082_EndUsershouldnotseehiddenideas
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Hidden idea/.toString(),"Description":/Desc/.toString(),"Category":/New Product/.toString(),"Required Short Question":/Short/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Select Idea in Pipeline Steps page
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/Hidden idea/.toString(),"Step Name idea belongs to":/Review/.toString())
        ...
        //Verify Idea in Pipeline Steps View for End Users
        new actions.IdeaBoard.VerifyIdeainPipelineStepsViewforEndUsers().run("Idea Name":/Hidden idea/.toString(),"Step idea belongs to":/Review/.toString(),"Stage idea belongs to":/Collection/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
