...
//C131760 - Evaluation Reordering - Judging Open AI by drag and drop
class C131760_EvaluationReordering_JudgingOpenAIbydraganddrop
{
    ...
    public void testcase(){
        ...
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Step Name to Manage (optional)":/Judging/.toString(),"Evaluator":/Evaluator/.toString(),"Number of assigned items":/5/.toString(),"Number of remaining items":/5/.toString(),"Number of Matches":/1/.toString())
