...
//C117680 - Highlights - Post Comment - On My Submission
class C117680_Highlights_PostComment_OnMySubmission
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/End User commented on "test idea3"/.toString(),"Highlights Item Content":/test comment from End User/.toString(),"Number of Matches":/1/.toString(),"Total Number of Items":/1/.toString())
    }
    //Basestate
