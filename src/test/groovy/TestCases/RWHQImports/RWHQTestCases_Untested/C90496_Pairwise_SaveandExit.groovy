...
//C90496 - Pairwise - Save and Exit
class C90496_Pairwise_SaveandExit
{
    ...
    public void testcase(){
        ...
        //Set Pairwise for Idea in Action Items page
        new actions.ActionItems.SetPairwiseforIdeainActionItemspage().run("Action":/Save and Exit/.toString())
        //Navigate
        ...
        //Set Pairwise for Idea in Action Items page
        new actions.ActionItems.SetPairwiseforIdeainActionItemspage().run("Select Idea Name or Neither":/pairwise idea3/.toString())
        try{
            //Set Pairwise for Idea in Action Items page
