...
//C5854 - My Action Items Page - All Tab
class C5854_MyActionItemsPage_AllTab
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.VerifyAlltableforActionItemspage().run("All Tab Value":/4/.toString(),"Title":/test idea2/.toString(),"Number of Matches":/1/.toString())
        //Verify All table for Action Items page
        new actions.ActionItems.VerifyAlltableforActionItemspage().run("Title":/test idea1/.toString(),"Number of Matches":/1/.toString())
        //Verify All table for Action Items page
        new actions.ActionItems.VerifyAlltableforActionItemspage().run("Title":/quick add1/.toString(),"Number of Matches":/1/.toString())
        //Verify All table for Action Items page
        new actions.ActionItems.VerifyAlltableforActionItemspage().run("Title":/review idea/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
