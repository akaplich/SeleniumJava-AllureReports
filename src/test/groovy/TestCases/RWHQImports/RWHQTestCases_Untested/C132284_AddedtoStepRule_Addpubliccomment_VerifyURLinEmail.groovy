...
//C132284 - Added to Step Rule - Add public comment - Verify URL in Email
class C132284_AddedtoStepRule_Addpubliccomment_VerifyURLinEmail
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC132284_User/.toString(),"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        ...
        //Login
        new actions.general.Login().run("Email":/brightC132284_User@mailinator.com/.toString(),"Password":/brightidea1/.toString(),"Verify if Logged In On Enterprise homepage":false)
        //Navigate WebStorm or MTS
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC132284_User@mailinator.com/.toString(),"Subject":/Custom App: Idea Submission Confirmation/.toString())
        //Get Link From Comment Made on Idea Email
        variables."C132284CommentLink" = new actions.Mailinator.GetLinkFromCommentMadeonIdeaEmail().run("Email Address":/brightC132284_User/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."C132284CommentLink"}/.toString())
