...
//C65753 - Idea Boards 30 - Public Webstorm - Sort - Recent
class C65753_IdeaBoards30_PublicWebstorm_Sort_Recent
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"Idea Name":/test idea2/.toString(),"Number of Matches":/1/.toString(),"Placement Number":/1/.toString())
    }
    //Basestate
