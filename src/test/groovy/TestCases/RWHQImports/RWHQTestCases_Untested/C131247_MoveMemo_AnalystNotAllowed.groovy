...
//C131247 - Move Memo - Analyst Not Allowed
class C131247_MoveMemo_AnalystNotAllowed
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/My Memo To Move/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
