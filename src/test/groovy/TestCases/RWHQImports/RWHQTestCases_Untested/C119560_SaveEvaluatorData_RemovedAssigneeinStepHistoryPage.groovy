...
//C119560 - Save Evaluator Data - Removed Assignee in Step History Page
class C119560_SaveEvaluatorData_RemovedAssigneeinStepHistoryPage
{
    ...
    public void testcase(){
        ...
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Step Name to Manage (optional)":/Scorecarding/.toString(),"Row Number":/2/.toString(),"Evaluator":/System Admin/.toString(),"Number of assigned items":/2/.toString(),"Number of Matches":/1/.toString())
        ...
        new actions.PipelineManageSteps.AdvanceIdeatoNextStepinManageStep().run("Idea Name":/Quick add Idea2/.toString(),"Action":/Advance Ideas/.toString())
        //Verify Step History for Manage Step
        new actions.PipelineManageSteps.VerifyStepHistoryinManageStep().run("Step Name (optional)":"","Row Number":/1/.toString(),"Idea Name":/Quick add Idea2/.toString(),"Number of Matches":/1/.toString())
