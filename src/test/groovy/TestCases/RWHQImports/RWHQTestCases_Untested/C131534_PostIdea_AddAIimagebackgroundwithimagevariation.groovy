...
//C131534 - Post Idea - Add AI image background with image variation
class C131534_PostIdea_AddAIimagebackgroundwithimagevariation
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Check idea image/.toString(),"Description":/desc/.toString(),"Category":/Marketing & Branding/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
