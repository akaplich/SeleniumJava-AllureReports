...
//C119481 - Idea Edited - Change Step
class C119481_IdeaEdited_ChangeStep
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/quick add1 edited/.toString(),"Step Name idea belongs to":/Scorecarding/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
