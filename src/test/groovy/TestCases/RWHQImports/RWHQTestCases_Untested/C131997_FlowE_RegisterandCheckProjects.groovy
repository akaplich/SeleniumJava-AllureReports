...
//C131997 - Flow E - Register and Check Projects
class C131997_FlowE_RegisterandCheckProjects
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"Idea Name":/Project One Title/.toString(),"Image":false,"Number of Matches":/1/.toString(),"Placement Number":/2/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"Idea Name":/Project Two Title/.toString(),"Image":true,"Number of Matches":/1/.toString(),"Placement Number":/1/.toString())
        //Log Out
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetRegistrationorGetStartedForHackathonOnboarding().run("Area Accessing The Menu From":/HTS Left Rail/.toString(),"Onboarding Menu Option":/Registration/.toString())
        //Set Flow D and E on Hackathon Onboarding
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowDandEonHackathonOnboarding().run("Flow Option Title":/I need to find a team or project to work on./.toString(),"Action on Get Started Screen":/Next/.toString(),"Expertise":/Expertise1,Expertise2/.toString(),"Add or Remove Expertise":/Add,Add/.toString(),"Register and add expertise Action":/Next/.toString(),"Choose the best option for you":/I want to see the submitted projects/.toString())
        //Verify Idea in Idea Board page
