...
//C131804 - Project Room > Tasks - User Can Only Edit Their Own Note
class C131804_ProjectRoom_Tasks_UserCanOnlyEditTheirOwnNote
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.ProjectRoomVerifyTaskNote().run("Note":/system admin note/.toString(),"Author":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Project Room - Add Task Note
        new actions.ProjectRoom.ProjectRoomAddTaskNote().run("Note":/end user note/.toString(),"Action":/Post Note/.toString())
        //Project Room - Verify Task Note
        new actions.ProjectRoom.ProjectRoomVerifyTaskNote().run("Note":/end user note/.toString(),"Author":/End User/.toString(),"Number of Matches":/1/.toString())
        try{
            //Project Room - Edit Task Note
            new actions.ProjectRoom.ProjectRoomEditTaskNote().run("Note":/system admin note/.toString(),"Action":/Edit/.toString(),"New Note":/udpated/.toString(),"Action on Edit":/Save/.toString())
        }
        ...
        new actions.ProjectRoom.ProjectRoomVerifyTaskNote().run("Note":/system admin note/.toString(),"Author":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Project Room - Verify Task Note
        new actions.ProjectRoom.ProjectRoomVerifyTaskNote().run("Note":/updated/.toString(),"Number of Matches":/0/.toString())
        //Project Room - Set Task Note Section
        new actions.ProjectRoom.ProjectRoomSetTaskNoteSection().run("Close":true)
        //Log Out
        new actions.general.LogOut().run([:])
        ...
        try{
            //Project Room - Edit Task Note
            new actions.ProjectRoom.ProjectRoomEditTaskNote().run("Note":/end user note/.toString(),"Action":/Edit/.toString(),"New Note":/udpated/.toString(),"Action on Edit":/Save/.toString())
        }
       catch(all){}catch(Error err){}
        //Project Room - Verify Task Note
        new actions.ProjectRoom.ProjectRoomVerifyTaskNote().run("Note":/end user note/.toString(),"Author":/End User/.toString(),"Number of Matches":/1/.toString())
