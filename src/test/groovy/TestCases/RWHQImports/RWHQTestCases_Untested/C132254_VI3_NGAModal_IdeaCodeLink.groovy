...
//C132254 - VI3 - NGA Modal - Idea Code Link
class C132254_VI3_NGAModal_IdeaCodeLink
{
    ...
    public void testcase(){
        ...
        //Click on Element
        new actions.selenium.Click().run("ID":/\/\/A[@class='idea-modal-trigger' and contains(.,'D107')]/.toString())
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Idea Name":/test idea2/.toString())
