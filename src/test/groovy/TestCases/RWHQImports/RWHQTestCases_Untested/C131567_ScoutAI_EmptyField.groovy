...
//C131567 - Scout AI - Empty Field
class C131567_ScoutAI_EmptyField
{
    ...
    public void testcase(){
        ...
        try{
            ...
            new actions.PipelineStepsView.SetScoutAppAIModal().run("Search Type":/Using Button/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Enter a prompt above and provide details on the industry that your team is looking to capture competitors within./.toString(),"Should Exist":true)
        try{
            //Set Scout App AI Modal
            new actions.PipelineStepsView.SetScoutAppAIModal().run("Type":/ /.toString(),"Search Type":/Using Enter/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Utilize Brightidea AI to find companies to send to your pipeline/.toString(),"Should Exist":true)
    }
    //Basestate
