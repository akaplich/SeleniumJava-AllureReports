...
//C128559 - Comment Component - Replying to a comment > inject user tag
class C128559_CommentComponent_Replyingtoacomment_injectusertag
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC128559_7/.toString(),"Finally Login as What User":/brightC128559_7@mailinator.com/.toString())
        ...
        new actions.ViewIdeaComment.VerifyTaggedUsersInCommentsinViewandNGAViewIdea().run("Comment":/tagging user in the comment/.toString(),"Tagged User":/Autofirst Autolast/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Reply/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/test comment/.toString(),"Reply Comment":/Autofirst Autolast tagging user in the comment/.toString(),"User":/End User 2/.toString(),"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC128559_7/.toString(),"Subject":/You have been tagged in an idea comment for/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/brightC128559_7@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        //Access Notification from Global Navigation
        new actions.Notifications.AccessNotificationfromGlobalNavigation().run("Notification Message":/End User 2 tagged you in a comment/.toString())
        //Verify Tagged Users In Comments in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyTaggedUsersInCommentsinViewandNGAViewIdea().run("Comment":/tagging user in the comment/.toString(),"Tagged User":/Autofirst Autolast/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
