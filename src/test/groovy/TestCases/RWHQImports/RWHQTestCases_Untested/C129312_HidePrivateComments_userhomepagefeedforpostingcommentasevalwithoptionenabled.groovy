...
//C129312 - Hide Private Comments - userhomepage feed for posting comment as eval with option enabled
class C129312_HidePrivateComments_userhomepagefeedforpostingcommentasevalwithoptionenabled
{
    ...
    public void testcase(){
        ...
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin commented on "test idea1"/.toString(),"Highlights Item Content":/test private comment/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
