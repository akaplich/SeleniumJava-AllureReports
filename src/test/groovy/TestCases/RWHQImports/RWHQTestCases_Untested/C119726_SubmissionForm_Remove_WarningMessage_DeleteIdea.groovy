...
//C119726 - Submission Form - Remove - Warning Message - Delete Idea
class C119726_SubmissionForm_Remove_WarningMessage_DeleteIdea
{
    ...
    public void testcase(){
        ...
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Warning Test/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        ...
        new actions.SetupIdeas.EditAdditionalQuestionsinSubmissionFormtab().run("Question":/Long Answer Question/.toString(),"Edit or Hide or Remove":/Remove/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Removing fields cannot be undone/.toString(),"Should Exist":true)
    }
    //Basestate
