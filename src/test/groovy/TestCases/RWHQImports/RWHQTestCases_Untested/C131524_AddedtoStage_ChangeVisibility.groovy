...
//C131524 - Added to Stage - Change Visibility
class C131524_AddedtoStage_ChangeVisibility
{
    ...
    public void testcase(){
        ...
        new actions.Rules.SetNewRuleEventthattriggersthisrule().run("Event":/Added to Stage/.toString(),"Event Value":/Collection/.toString())
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Added to Stage - Change Visibility/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Added to Stage - Change Visibility/.toString())
        //Change Rule Status
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/Quick Idea for Rules Engine/.toString(),"Linked Submissions":[])
        //Log Out
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/Quick Idea for Rules Engine/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
