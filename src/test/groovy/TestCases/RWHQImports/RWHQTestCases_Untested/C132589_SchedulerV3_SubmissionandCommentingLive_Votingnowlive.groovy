...
//C132589 - Scheduler V3> Submission and Commenting Live, Voting now live 
class C132589_SchedulerV3_SubmissionandCommentingLive_Votingnowlive
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.VerifyHomepageHeader2().run("Title":/Hack/.toString(),"Description":/Submit a project and form a team to rapidly prototype in 24 hours. Top projects will have an opportunity to receive further development./.toString(),"Submit Displayed":true,"Registration":false,"Get Started":true)
        //Verify Navigation Options in Dynamic Nav Bar
        new actions.WebstormHomepage.VerifyNavigationOptionsinDynamicNavBar().run("Nav Parent Title":/SUBMIT/.toString(),"Nav Displayed?":true)
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowAforHackathonOnboarding().run("Wait for Post Idea Page to Load":true)
        ...
        new actions.IdeaBoard.VerifyVotingUIonIdeaCard().run("Idea Name":/Project One Title/.toString(),"Voting UI View":/Disabled/.toString(),"Number of Matches":/1/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Project One Title/.toString())
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/comment1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
