...
//C128595 - Search Admin Comment in an Idea on Initiative Global Navigation
class C128595_SearchAdminCommentinanIdeaonInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/Admin comment automation purpose/.toString(),"Comment Type":/Update from Admin/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/Admin comment automation purpose/.toString())
        //Verify On Global Search Result
        new actions.Search.VerifyOnGlobalSearchResult().run("Type":/Comments/.toString(),"Title":/Admin comment automation purpose/.toString(),"Number of Matches":/1/.toString(),"Click on the result":true)
        //Verify Comment in View Idea page
        new actions.ViewIdeaComment.VerifyCommentinViewIdeapage().run("Comment Section":/Comments/.toString(),"Type of Comment":/Administrator/.toString(),"Comment":/Admin comment automation purpose/.toString(),"User":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Log Out
