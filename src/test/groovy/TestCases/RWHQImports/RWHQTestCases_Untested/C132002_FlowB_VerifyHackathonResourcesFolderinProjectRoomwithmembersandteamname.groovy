...
//C132002 - Flow B - Verify Hackathon Resources Folder in Project Room with members and team name
class C132002_FlowB_VerifyHackathonResourcesFolderinProjectRoomwithmembersandteamname
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowBandCforHackathonOnboarding().run("Flow Option Title":/I have a team, but we are not sure what to work on./.toString(),"Team Name":/Hello what is this PR name/.toString(),"Name your team Screen Action":/Next/.toString(),"Choose a team image Action":/Next/.toString(),"Find Teammates":/End User/.toString(),"Teammates Add or Remove":/Add/.toString(),"Build your winning team Screen Action":/Next/.toString(),"Wait for loading to disappear":true)
        //Wait
        ...
        new actions.ProjectRoom.NavigateRoomItems().run("Room Item":/Hackathon Event Home/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Switch to Browser Window
        new actions.selenium.SwitchWindow().run("Tab (start from 0)":/1/.toString())
        //Verify Homepage Header 2
        new actions.WebstormHomepage.VerifyHomepageHeader2().run("Title":/Hack/.toString())
        //Log Out
        ...
        new actions.ProjectRoom.VerifyProjectRoomCard().run("Title":/Hello what is this PR name - Project Room/.toString(),"Updated By":/System Admin/.toString(),"Member count":/2/.toString(),"Total Objects":/9/.toString(),"Total Tasks":/5/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString(),"Access Project Room":true)
        //Navigate to Top Link or Page in Project Room
        new actions.ProjectRoom.NavigateRoomItems().run("Room Item":/Submission Page/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Switch to Browser Window
        new actions.selenium.SwitchWindow().run("Tab (start from 0)":/2/.toString())
        //Verify Page Title
        new actions.selenium.VerifyPageTitle().run("Title":/Hack: Post Project/.toString())
