...
//C117424 - Idea Boards 30 - Additional Submission Questions filter for hidden Ideas as public user
class C117424_IdeaBoards30_AdditionalSubmissionQuestionsfilterforhiddenIdeasaspublicuser
{
    ...
    public void testcase(){
        ...
        //Set Submission Form Question Filter on Idea Boards
        new actions.IdeaBoard.SetSubmissionFormQuestionFilteronIdeaBoards().run("Question":/Checkbox Question/.toString(),"Answers":/Answer 3/.toString(),"Answers Check":/TRUE/.toString())
        //Set Submission Form Question Filter on Idea Boards
