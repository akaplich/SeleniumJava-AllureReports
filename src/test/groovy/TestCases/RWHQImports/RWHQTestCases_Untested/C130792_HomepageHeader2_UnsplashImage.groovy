...
//C130792 - Homepage Header 2 - Unsplash Image
class C130792_HomepageHeader2_UnsplashImage
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.SetPresetBackgroundImageintheHeader().run("Unsplash Image Text":/Nature/.toString(),"Unpslash Image Number":/14/.toString(),"Action":/Cancel/.toString())
        //Set Homepage Header
        ...
        new actions.WebstormHomepage.SetChangeBackgroundmodal().run("Tab":/Search Photos/.toString())
        //Set Preset or Unsplash Background Image in the Header
        new actions.WebstormHomepage.SetPresetBackgroundImageintheHeader().run("Unsplash Image Text":/Innovation/.toString(),"Unpslash Image Number":/18/.toString(),"Action":/Add Image/.toString())
        //Set Homepage Header
        new actions.WebstormHomepage.SetHomepageHeaderMenu().run("Action":/Save/.toString())
        //Verify Homepage Header 2
        new actions.WebstormHomepage.VerifyHomepageHeader2().run("Title":/Test App/.toString(),"Description":/Submit a note and engage in a discussion about this key theme with your peers. Be sure to subscribe to this forum so you can stay up to date./.toString(),"Splash or Own Image Displayed":true,"Submit Displayed":false,"Browse Displayed":true)
    }
    //Basestate
