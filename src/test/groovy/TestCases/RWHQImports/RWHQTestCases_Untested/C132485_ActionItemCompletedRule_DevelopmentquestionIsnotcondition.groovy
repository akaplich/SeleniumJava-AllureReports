...
//C132485 - Action Item Completed Rule - Development question Is not condition
class C132485_ActionItemCompletedRule_DevelopmentquestionIsnotcondition
{
    ...
    public void testcase(){
        ...
        //Set Rule Meet the Following Conditions
        new actions.Rules.SetNewRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/2/.toString(),"Add, Delete or Modify":/Add/.toString(),"Condition":/Development Question/.toString(),"Operator value":/Is Not/.toString(),"Condition value":/Tier 1/.toString())
        ...
        //Set Rule Perform the Following Actions
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/2/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Change Status/.toString(),"Action Value":/On Hold/.toString())
        //Set Rule window
        ...
        new actions.ActionItems.SetDevelopmentActionItemPageFields().run("Multiple Choice - Title":/Development Question/.toString(),"Multiple Choice - Answer":/P&O/.toString(),"Action":/Mark Complete/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Test App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/new idea/.toString(),"Step Name idea belongs to":/Implementation/.toString(),"Number of Matches":/1/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/new idea/.toString(),"Status":/On Hold/.toString(),"Linked Submissions":[])
    }
    //Basestate
