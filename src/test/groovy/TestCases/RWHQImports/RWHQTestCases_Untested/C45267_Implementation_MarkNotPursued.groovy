...
//C45267 - Implementation - Mark Not Pursued
class C45267_Implementation_MarkNotPursued
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Verify in Which List (optional)":/My Action Items/.toString(),"Title":/Find Owner Idea1/.toString(),"Answer":/Not Pursued/.toString(),"Number of Matches":/1/.toString())
