...
//C130809 - Homepage Header 2 - Edit Title and Description
class C130809_HomepageHeader2_EditTitleandDescription
{
    ...
    public void testcase(){
        ...
        //Set Homepage Header
        new actions.WebstormHomepage.SetHomepageHeaderMenu().run("Title":/This is to testing edited Custom App/.toString(),"Description":/Your description should explain the purpose of this Initiative edited version/.toString(),"Action":/Save/.toString())
        //Verify Homepage Header 2
        new actions.WebstormHomepage.VerifyHomepageHeader2().run("Title":/This is to testing edited Custom App/.toString(),"Description":/Your description should explain the purpose of this Initiative edited version/.toString(),"Preset Image":/\/CORE\/IMAGES\/apps_v3\/custom_header.jpeg/.toString(),"Color of Submit Button":/rgb(149, 165, 166)/.toString(),"Submit Displayed":true,"Browse Displayed":true)
    }
    //Basestate
