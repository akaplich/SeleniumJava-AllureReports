...
//C131781 - Stage and Gate Beta > Complete stage and gate AI
class C131781_StageandGateBeta_CompletestageandgateAI
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureStageProcessStepinPipelineStepsPage().run("Assignment Method":/Individual Assignment/.toString(),"Stage Lead":/Select a user/.toString(),"Stage Team":/End User,analyst/.toString(),"Stage Team Add or Remove":/Add,Add/.toString(),"Selected user":/Evaluator/.toString(),"Selected Users Add or Remove":/Add/.toString(),"Folder mapping":/Stage 1: Scope/.toString(),"Action":/Activate/.toString())
        ...
        new actions.ProjectRoom.VerifyStageProcessActionItem().run("Stage or Gate Name":/Stage 1: Scope/.toString(),"Stage Heading":/Stage is due in/.toString(),"Stage or Gate Review Assigned To":/Evaluator,End User,analyst/.toString(),"Items Within Stage":/Tasks,Executive Summary,Business Requirement,Idea1/.toString())
        ...
        //Verify Stage Process or Gate Approval Action Item
        new actions.ProjectRoom.VerifyStageProcessActionItem().run("Stage or Gate Name":/Stage 1: Scope/.toString(),"Stage Heading":/Stage action item has been completed./.toString(),"Stage or Gate Review Assigned To":/Evaluator,End User,analyst/.toString(),"Items Within Stage":/Tasks,Executive Summary,Business Requirement,Idea1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.PipelineStepsConfigure.ConfigureGateApprovalStepinPipelineStepsPage().run("Assignment Method":/Individual Assignment/.toString(),"Gate Lead":/Select a user/.toString(),"Gate Team":/analyst,Moderator/.toString(),"Gate Team Add or Remove":/Add,Add/.toString(),"Selected user":/Evaluator/.toString(),"Selected Users Add or Remove":/Add/.toString(),"Gate Mapping":/Gate 1/.toString(),"Action":/Activate/.toString())
        //Select Idea in Pipeline Steps page
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/Idea1/.toString())
        //Change Idea Step in Pipeline Steps page
        ...
        //Verify Stage Process or Gate Approval Action Item
        new actions.ProjectRoom.VerifyStageProcessActionItem().run("Stage or Gate Name":/Gate 1/.toString(),"Stage Heading":/Gate review has been completed./.toString(),"Stage or Gate Review Assigned To":/Evaluator,analyst,Moderator/.toString(),"Scorecard":/Completed!/.toString())
