...
//C117106 - Scorecard - Submitter can see Evaluations Tab when visibility is set to Administrators and select roles
class C117106_Scorecard_SubmittercanseeEvaluationsTabwhenvisibilityissettoAdministratorsandselectroles
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Category":/Operations/.toString(),"Title":/test idea3/.toString(),"Description":/test idea3 description/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
