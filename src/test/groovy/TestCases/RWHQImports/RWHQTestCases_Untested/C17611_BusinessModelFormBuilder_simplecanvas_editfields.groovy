...
//C17611 - Business Model Form Builder (simple canvas) edit fields
class C17611_BusinessModelFormBuilder_simplecanvas_editfields
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupBusinessModelforIdeasTab().run("Navigate to Business Model Tab":true,"Launch Business Model Form Builder":true,"Navigate to New Tab":true,"Field to Edit":/Market\/Demand/.toString(),"Question Title":/Updated Market and Demand/.toString(),"Question Default Text":/This a default text for Market\/Demand/.toString(),"Action":/Done/.toString(),"Form Action":/Save Form/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Updated Market and Demand/.toString(),"Should Exist":true)
    }
    //Basestate
