...
//C131966 - Pipeline Creation - Community Admin Create Hackathon
class C131966_PipelineCreation_CommunityAdminCreateHackathon
{
    ...
    public void testcase(){
        ...
        //Create App Webstorm
        new actions.WebstormCreation.CreateAppWebstorm().run("App Name":/Hackathon/.toString(),"Sponsor Name":/NonBI System Admin/.toString(),"Sponsor Add or Remove":/Add/.toString(),"Webstorm Title":/Hackathon by community admin/.toString(),"Description":/Hackathon description/.toString(),"Action":/Create/.toString())
        //Verify Initiative Home
        new actions.Webstorm.VerifyWebstormHome().run("Initiative Title":/Hackathon by community admin/.toString())
    }
    //Basestate
