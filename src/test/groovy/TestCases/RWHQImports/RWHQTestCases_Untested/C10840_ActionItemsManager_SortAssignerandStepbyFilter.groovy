...
//C10840 - Action Items Manager - Sort Assigner and Step by Filter
class C10840_ActionItemsManager_SortAssignerandStepbyFilter
{
    ...
    public void testcase(){
        ...
        new actions.ActionItemsManager.SortorFilterActionItemsManagertable().run("Sort Or Filter":/Sort/.toString(),"Column":/Assigner/.toString(),"Sort Ascending or Descending":/Descending/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/Action Items Manager/.toString(),"Title":/moderator idea1/.toString(),"Row Number":/5/.toString(),"Number of Matches":/1/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/Action Items Manager/.toString(),"Title":/systemadmin idea1/.toString(),"Row Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Sort or Filter Action Items Manager table
        new actions.ActionItemsManager.SortorFilterActionItemsManagertable().run("Sort Or Filter":/Sort/.toString(),"Column":/Step/.toString(),"Sort Ascending or Descending":/Ascending/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/Action Items Manager/.toString(),"Title":/moderator idea1/.toString(),"Row Number":/5/.toString(),"Number of Matches":/1/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/Action Items Manager/.toString(),"Title":/systemadmin idea1/.toString(),"Row Number":/1/.toString(),"Number of Matches":/1/.toString())
