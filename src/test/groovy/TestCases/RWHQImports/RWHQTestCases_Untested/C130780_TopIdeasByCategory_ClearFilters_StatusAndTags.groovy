...
class C130780_TopIdeasByCategory_ClearFilters_StatusAndTags
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/test idea2/.toString(),"Description":/desc/.toString(),"Tag Name":/c130780,c13078z/.toString(),"Tag Add or Remove":/Add,Add/.toString(),"Category":/Marketing & Branding/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Idea Box BIW/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/test idea3/.toString(),"Description":/desc/.toString(),"Tag Name":/c130780,tokyo/.toString(),"Tag Add or Remove":/Add,Add/.toString(),"Category":/Strategy/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Idea Box BIW/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        ...
        new actions.PipelineStepsView.AddIdeaTaginPipelineStepspage().run("Tag Name":/c13078z/.toString(),"Tag Add or Remove":/Add/.toString(),"Action":/Add Tags/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.IdeaBoard.SetGlobalIdeaFilterBIW().run("Invoke Filter":true,"Object Type":[],"Status":["Implemented","Not Selected"],"Stage":[],"Step":[],"Category":[],"Owner":[],"Tags":["c130780","c13078z"],"Clear Individual Filters":[],"Action":/Save/.toString())
        //Refresh
        ...
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/test idea1/.toString(),"Stack Name Memo belongs to":/Marketing & Branding/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/test idea5/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/test idea3/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
