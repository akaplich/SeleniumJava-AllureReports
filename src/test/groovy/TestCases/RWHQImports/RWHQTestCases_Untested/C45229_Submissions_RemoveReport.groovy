...
//C45229 - Submissions - Remove Report
class C45229_Submissions_RemoveReport
{
    ...
    public void testcase(){
        ...
        new actions.SetupExports.VerifyGeneratedReportinSetupExports().run("Report Name Starts with":/Ideas/.toString(),"Number of Matches":/1/.toString())
        ...
        //Verify Generated Report in any Setup Exports
        new actions.SetupExports.VerifyGeneratedReportinSetupExports().run("Report Name Starts with":/Ideas/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
