...
class C129396_HidePrivateComments_EmailNotificationtoIdeaSubscriberEvalForGeneral_PinnedandSubmitterComments(newcommenting)
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC129396_11/.toString(),"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        ...
        try{
            //Verify Email
            new actions.Mailinator.VerifyEmail().run("Email Address":/brightC129396_11/.toString(),"Subject":/New Development Step1: You have 1 new Action Items/.toString())
        }
       catch(all){}catch(Error err){}
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/brightC129396_11@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        //Navigate WebStorm or MTS
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC129396_11/.toString(),"Subject":/Custom App: System Admin commented on the Idea you are subscribed to/.toString(),"Email Should Be Received":true)
        //Add Comment in View and NGA View Idea
