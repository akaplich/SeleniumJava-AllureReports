...
//C132060 - Task Sort and Filter - Empty Result + Clear filter in modal
class C132060_TaskSortandFilter_EmptyResult_Clearfilterinmodal
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.SetTasksInProjectRoom().run("Add or Edit":/Add/.toString(),"New Task Name":/Task1/.toString(),"Row Number":/1/.toString(),"Assignee":/System Admin/.toString(),"Status":/In Progress/.toString(),"Due Date":/11-24-2023/.toString())
        //Set Add or Edit Tasks In Project Room
        ...
        new actions.ProjectRoom.SetFilterforProjectRoomTasks().run("Invoke Filter":true,"Assignee":[],"Status":["Paused"],"Due Date":["No Due Date"],"Click on Close Button":true)
        //Verify Message
        ...
        new actions.ProjectRoom.VerifyFilterCountinProjectRoomTasksPage().run("Message":/Showing 0 of 3 tasks/.toString(),"Message Displayed":true)
        //Set Filter for Project Room Tasks
        new actions.ProjectRoom.SetFilterforProjectRoomTasks().run("Invoke Filter":true,"Assignee":[],"Status":[],"Due Date":[],"Clear Filter":true,"Click on Close Button":true)
        //Verify Tasks in Project Room
        new actions.ProjectRoom.VerifyTasksinProjectRoom().run("Task":/Task1/.toString(),"Assignee":/System Admin/.toString(),"Status":/In Progress/.toString(),"Due Date":/11\/24\/2023/.toString(),"Marked Completed":false,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Tasks in Project Room
