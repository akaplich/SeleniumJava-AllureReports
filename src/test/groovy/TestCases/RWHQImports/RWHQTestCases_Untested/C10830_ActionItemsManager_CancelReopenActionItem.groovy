...
//C10830 - Action Items Manager - Cancel Reopen Action Item
class C10830_ActionItemsManager_CancelReopenActionItem
{
    ...
    public void testcase(){
        ...
        new actions.ActionItemsManager.SetActionsDropdownintheActionItemsManager().run("Select Ideas":/review idea/.toString(),"Check":/TRUE/.toString(),"Action":/Reopen/.toString(),"Sub Action":/Cancel/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/Action Items Manager/.toString(),"Title":/review idea/.toString(),"Number of Matches":/0/.toString())
        //Verify Completed table for Action Items page
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Verify in Which List (optional)":/Action Items Manager/.toString(),"Title":/review idea/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
