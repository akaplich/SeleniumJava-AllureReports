...
//C129909 - Comment Component - Admin cannot Pin Child Comments
class C129909_CommentComponent_AdmincannotPinChildComments
{
    ...
    public void testcase(){
        ...
        try{
            ...
            new actions.ViewIdeaComment.SetCommentEditMenu().run("Comment to Edit":/test reply to general comment/.toString(),"Menu Option":/Pin Thread/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Comment Count in the Header
        new actions.ViewIdeaComment.VerifyCommentCountintheHeader().run("Comment Count":/3/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/test general comment/.toString(),"Edited Indicator":false,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Reply/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/test general comment/.toString(),"Reply Comment":/test reply to general comment/.toString(),"User":/System Admin/.toString(),"Edited Indicator":false,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
