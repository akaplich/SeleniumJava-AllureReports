...
//C118974 - Highlights - All Activity - Post a Submission in Prelaunched Status
class C118974_Highlights_AllActivity_PostaSubmissioninPrelaunchedStatus
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin submitted "Prelaunched Idea1"/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin submitted "Prelaunched Idea1"/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
