...
//C130693 - Move Ideas without Moving Missing Dev Fields as Pipeline Admin
class C130693_MoveIdeaswithoutMovingMissingDevFieldsasPipelineAdmin
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SetMissingDevelopmentFieldsModal().run("Missing Development Fields Count":/1/.toString(),"Select Radiobutton Selection":/Move ideas without Development field data (this cannot be reversed)/.toString(),"Action":/Continue/.toString())
        //Navigate WebStorm or MTS
