...
//C17562 - Search History - Include User Profile Data
class C17562_SearchHistory_IncludeUserProfileData
{
    ...
    public void testcase(){
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("Screen Name":/System Admin/.toString(),"First Name":/Admin_FN/.toString(),"Last Name":/System_LN/.toString(),"Job Title":/IPM/.toString(),"Department":/Innovation/.toString(),"Location":/United States/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Enterprise Setup/.toString())
        //Set Enterprise Setup Exports for Search History tab
        new actions.SetupEnterpriseExports.SetEnterpriseExportsforSearchHistoryTab().run("Report Options":/Search History/.toString(),"Include user profile data":true,"Format":/csv/.toString())
        ...
        new actions.SetupEnterpriseExports.DownloadGeneratedReportEnterpriseExports().run("Section":/Search History/.toString(),"Report Name Starts with":/Search_history/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Search_history-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["System Admin","Admin_FN","System_LN","IPM","Innovation","United States"],"Number of Matches":/1/.toString(),"Total Number of Rows":/2/.toString())
    }
    //Basestate
