...
//C130162 - Standard Licensing - Adding new System Admin with only Ideabox licenses
class C130162_StandardLicensing_AddingnewSystemAdminwithonlyIdeaboxlicenses
{
    ...
    public void testcase(){
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Assign this user to the System Administrator role/.toString(),"Should Exist":false)
        //Verify Info Message for Standard Licensing
        new actions.SetupUsers.VerifyInfoMessageonPeoplePillarandAdministratorTab().run("Area":/People Pillar/.toString(),"Info Message":/There are no Brightidea Administrator Licenses available. Assigning a user to the System Administrator role requires granting the user a Brightidea Administrator License.Get more licenses/.toString(),"Info Message Exists":false)
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/People/.toString())
        //Add User in People page
        new actions.People.AddUserinPeoplepage().run("Email Address":/brightC130162@mailinator.com/.toString(),"First Name":/Autouserfirst/.toString(),"Last Name":/Autouserlast/.toString(),"Screen Name":/Autouserscreen/.toString(),"Action":/Add User/.toString())
        //Verify User in Users tab for People page
        new actions.People.VerifyUserinUserstabforPeoplepage().run("Email Address":/brightC130162@mailinator.com/.toString(),"Name":/Autouserfirst Autouserlast/.toString(),"Screen Name":/Autouserscreen/.toString(),"Status":/Active/.toString(),"Administrative Roles":/<EMPTY>/.toString(),"Registration":/Not Registered/.toString(),"Job Title":/<EMPTY>/.toString(),"Department":/Innovation/.toString(),"Location":/United States/.toString(),"Group":/<EMPTY>/.toString(),"Expertise":/<EMPTY>/.toString(),"Certification":/<EMPTY>/.toString(),"Number of Matches":/1/.toString())
        //Verify Licenses User in People Pillar Licenses tab
        new actions.People.VerifyLicensesUserinPeoplePillarLicensesTab().run("License Type":/Idea Box Manager License Type/.toString(),"User":/Autouserfirst Autouserlast/.toString(),"Roles":/System Administrator/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Get Registration Link from Email
        variables."link" = new actions.Mailinator.GetRegistrationLinkfromEmail().run("Email Address":/brightC130162/.toString())
        //Navigate to URL
