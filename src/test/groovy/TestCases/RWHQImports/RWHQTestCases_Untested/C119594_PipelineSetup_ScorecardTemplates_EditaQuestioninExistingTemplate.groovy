...
//C119594 - Pipeline Setup - Scorecard Templates - Edit a Question in Existing Template
class C119594_PipelineSetup_ScorecardTemplates_EditaQuestioninExistingTemplate
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.SetQuestionScorecardTemplate().run("Added Question Order Number":/1/.toString(),"Question Type":/Multiple Choice (one answer)/.toString(),"Question":/Test Question/.toString(),"Answers":/One,Two,Three/.toString(),"Points":/1,2,3/.toString(),"Action":/Save/.toString())
        //Add/Edit Question or Save Form on Scorecard Template
        ...
        new actions.PipelineSetup.SetTemplatesScorecardTemplates().run("Template Title to Select":/General Evaluation Scorecard/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Test Question/.toString(),"Should Exist":true)
    }
    //Basestate
