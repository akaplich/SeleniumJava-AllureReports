...
//C17672 - Enterprise Login Widget - Non System Admin
class C17672_EnterpriseLoginWidget_NonSystemAdmin
{
    ...
    public void testcase(){
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Affiliate Name/.toString(),"Should Exist":false)
        //Verify and Access Enterprise Login Widget
