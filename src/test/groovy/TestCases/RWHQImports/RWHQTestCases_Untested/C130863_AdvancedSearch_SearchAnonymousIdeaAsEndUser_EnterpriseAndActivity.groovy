...
class C130863_AdvancedSearch_SearchAnonymousIdeaAsEndUser_EnterpriseAndActivity
{
    ...
    public void testcase(){
        ...
        new actions.Search.QuickOrAdvanceSearchInGlobalNav().run("Tab (optional)":/Advanced Search/.toString(),"Search Input":/Anonymous Title/.toString())
        //Verify Quick or Advanced Search Result
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/Anonymous Title/.toString(),"Type":/Submissions/.toString(),"Number of Total (for Advanced Search)":/1 of 1/.toString(),"Description (for Advanced Search)":/auto description/.toString(),"Number of Matches":/1/.toString(),"Click on result":true)
        ...
        //Verify Quick or Advanced Search Result
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/End User/.toString(),"Type":/Users/.toString(),"Number of Matches":/1/.toString())
        //Verify Quick or Advanced Search Result
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/Anonymous Title/.toString(),"Type":/Submissions/.toString(),"Description (for Advanced Search)":/auto description/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
