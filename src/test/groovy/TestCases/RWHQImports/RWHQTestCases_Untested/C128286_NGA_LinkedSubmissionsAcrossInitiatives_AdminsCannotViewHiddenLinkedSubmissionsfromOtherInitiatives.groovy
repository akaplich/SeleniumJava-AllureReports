...
//C128286 -  NGA - Linked Submissions Across Initiatives - Admins Cannot View Hidden Linked Submissions from Other Initiatives 
class C128286_NGA_LinkedSubmissionsAcrossInitiatives_AdminsCannotViewHiddenLinkedSubmissionsfromOtherInitiatives
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/hidden linked idea1/.toString(),"Description":/desc/.toString(),"Category":/New Product/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/hidden linked idea1/.toString())
        ...
        new actions.NGAViewIdea.SetLinkedSubmissionsNGAViewIdeaPage().run("Submission Title":/hidden linked idea1/.toString(),"Add or Remove":/Add/.toString(),"Action":/Link Submissions/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Close All Browsers
        ...
        new actions.NGAViewIdea.VerifyLinkedSubmissionNGAViewIdea().run("Linked Submissions":/hidden linked idea1/.toString(),"Should Exist":/TRUE/.toString(),"Name of the Linked Submission to Navigate to":/hidden linked idea1/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/You are unauthorized to view this idea because it is hidden/.toString(),"Should Exist":true)
    }
    //Basestate
