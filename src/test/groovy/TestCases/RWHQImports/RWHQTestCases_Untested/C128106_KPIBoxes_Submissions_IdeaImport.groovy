...
//C128106 - KPI Boxes - Submissions - Idea Import
class C128106_KPIBoxes_Submissions_IdeaImport
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.ImportIdeasinPipelineStepspage().run("Idea Import File":/C128106_1.xls/.toString(),"Action":/Import Ideas/.toString())
        //Navigate
        ...
        new actions.Enterprise.UserHomepage.VerifyUserMetricsonUserHomepage().run("Submissions - Exp Value More Than (for import auto bug)":/1/.toString())
        //Log Out
