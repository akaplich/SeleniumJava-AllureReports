...
//C39837  - Add Image to Image Library
class C39837_AddImagetoImageLibrary
{
    ...
    public void testcase(){
        ...
        new actions.SetupImageLibrary.AddorDeleteImagefilesfromImageLibraryinEnterpriseSetup().run("Add or Delete":/Add/.toString(),"File":/SamplePNG.png/.toString(),"Description":/Sample Image/.toString())
