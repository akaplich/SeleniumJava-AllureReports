...
//C117080 - Click on Ideacard in End User Steps view
class C117080_ClickonIdeacardinEndUserStepsview
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.AccessIdeafromPipelineStepsViewforEndUsers().run("Idea Name":/test idea1/.toString())
