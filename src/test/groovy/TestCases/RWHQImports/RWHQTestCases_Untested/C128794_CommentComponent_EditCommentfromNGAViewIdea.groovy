...
//C128794 - Comment Component - Edit Comment from NGA View Idea
class C128794_CommentComponent_EditCommentfromNGAViewIdea
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.SetCommentEditMenu().run("View or NGA":/NGA/.toString(),"Comment to Edit":/test comment/.toString(),"Menu Option":/Edit/.toString())
        try{
            //Edit Comment in View and NGA View Idea page
            new actions.ViewIdeaComment.EditCommentinViewandNGAViewIdeapage().run("View Idea or NGA":/NGA/.toString(),"Comment to Edit":/test comment/.toString(),"New Comment":/test comment edited version/.toString(),"Action":/Update Comment/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/test comment edited version/.toString(),"User":/End User/.toString(),"User Image":true,"Edited Indicator":true,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
