...
//C17689 - Comment on Blog
class C17689_CommentonBlog
{
    ...
    public void testcase(){
        ...
        new actions.EnterpriseBlogs.VerifyEnterpriseBlogList().run("Title":/First Blog Post/.toString(),"Topic":/Custom App/.toString(),"Posted By":/System Admin/.toString(),"Tags":/firstblog/.toString(),"Content":/First Blog posted in custom app/.toString(),"Comment Count":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
