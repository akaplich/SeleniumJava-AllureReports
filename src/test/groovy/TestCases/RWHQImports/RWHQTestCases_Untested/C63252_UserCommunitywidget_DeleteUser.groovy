...
//C63252 - User Community widget - Delete User
class C63252_UserCommunitywidget_DeleteUser
{
    ...
    public void testcase(){
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Home/.toString())
        //Verify Users in User Community Widget
        new actions.Widgets.VerifyUsersinUserCommunityWidget().run("Users":/End User,Sri/.toString(),"User Should Exist":/FALSE,TRUE/.toString())
    }
    //Basestate
