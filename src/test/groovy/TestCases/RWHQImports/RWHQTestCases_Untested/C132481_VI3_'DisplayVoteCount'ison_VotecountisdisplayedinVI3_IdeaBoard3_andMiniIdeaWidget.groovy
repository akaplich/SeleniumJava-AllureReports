...
class C132481_VI3_'DisplayVoteCount'ison_VotecountisdisplayedinVI3_IdeaBoard3_andMiniIdeaWidget
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Vote Count":/1/.toString(),"Stats Votes":/1/.toString())
        ...
        new actions.general.VerifyElement().run("ID":/\/\/*[@id="mini_idea_list_head_votes"]/.toString(),"Number of Matches":/1/.toString(),"Should Element Exist":true)
    }
    //Basestate
