...
//C131389 - WB - Stacks - Text Wrapped Within Three Lines
class C131389_WB_Stacks_TextWrappedWithinThreeLines
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131389/.toString(),"Action":/Submit/.toString())
        ...
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/93/.toString(),"Y coordinate":/-94/.toString(),"Single Double or Right Click":/Single Click/.toString())
        //Send Key(s) To Whiteboard
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Expected Image File":/C131389_expected.png/.toString(),"Actual Image Name":/C131389_actual.png/.toString(),"Crop Screenshot Start at X":/700/.toString(),"Crop Screenshot Start at Y":/400/.toString(),"Crop Screenshot Width":/1000/.toString(),"Crop Screenshot Height":/350/.toString(),"Allowed Number of Different Pixels":/100/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131389_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
