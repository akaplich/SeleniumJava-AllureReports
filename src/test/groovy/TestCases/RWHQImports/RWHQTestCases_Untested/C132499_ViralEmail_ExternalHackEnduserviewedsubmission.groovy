...
//C132499 - Viral Email - External Hack Enduser viewed submission
class C132499_ViralEmail_ExternalHackEnduserviewedsubmission
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/External Hack project1/.toString(),"Description":/test/.toString(),"Category":/Hackathon Category A/.toString(),"Action":/Submit Idea/.toString())
        //Navigate
        ...
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/External Hack/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/External Hack project1/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/120/.toString())
        //Verify Email by Iterating through Inbox Mailinator
        new actions.Email.VerifyEmailbyIteratingthroughInboxMailinator().run("Email Address":/brightC132499_submitter@mailinator.com/.toString(),"Subject":/Your submission has been viewed!/.toString(),"Email Should Be Received":true)
    }
    //Basestate
