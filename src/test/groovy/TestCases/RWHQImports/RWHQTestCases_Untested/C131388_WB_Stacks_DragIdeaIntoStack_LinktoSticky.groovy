...
//C131388 - WB - Stacks - Drag Idea Into Stack, Link to Sticky
class C131388_WB_Stacks_DragIdeaIntoStack_LinktoSticky
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131388/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.OpenExistingWhiteboardOnWhiteboardsPage().run("Name of Whiteboard":/C131388/.toString())
        //Click on Whiteboard Canvas
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Expected Image File":/C131388_Expected3282025.png/.toString(),"Actual Image Name":/C131388_actual.png/.toString(),"Crop Screenshot Start at X":/550/.toString(),"Crop Screenshot Start at Y":/400/.toString(),"Crop Screenshot Width":/950/.toString(),"Crop Screenshot Height":/500/.toString(),"Allowed Number of Different Pixels":/100/.toString(),"Do Not Scroll":true)
    }
    //Basestate
    ...
    public void afterState(){
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131388_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
