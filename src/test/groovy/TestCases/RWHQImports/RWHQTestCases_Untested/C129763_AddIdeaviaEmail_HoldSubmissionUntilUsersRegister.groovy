...
//C129763 - Add Idea via Email - Hold Submission Until Users Register
class C129763_AddIdeaviaEmail_HoldSubmissionUntilUsersRegister
{
    ...
    public void testcase(){
        ...
        new actions.SetupBeta.SetEnterpriseSetupforBetatab().run("Allow Unregistered Users Submit Via Email":true,"Hold Submission Until Users Register or Post Submissions Immediately":/Hold Submission Until Users Register/.toString(),"Send Registration Email Following Submission":false)
        ...
        new actions.PipelineCommunications.SetPipelineCommunicationsTab().run("Select Tab":/Emails/.toString(),"Email":/New Idea Submitted/.toString(),"Email Recipient":/Idea Submitter/.toString(),"Email Subject":/C129763 Submission Confirmation/.toString(),"Action":/Save/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.Email.VerifyEmailNotMailinator().run("Sender Host":/imap.mail.yahoo.com/.toString(),"Sender's Email":/annabrightidea1@yahoo.com/.toString(),"Password":/coothhthkgxqqztx/.toString(),"Email Subject to Look For":/You've been invited to join ${variables."affName"}!/.toString(),"Email Should Exist":false,"Folder":/INBOX/.toString())
        //Verify Email Not Mailinator
        new actions.Email.VerifyEmailNotMailinator().run("Sender Host":/imap.mail.yahoo.com/.toString(),"Sender's Email":/annabrightidea1@yahoo.com/.toString(),"Password":/coothhthkgxqqztx/.toString(),"Email Subject to Look For":/C129763 Submission Confirmation/.toString(),"Email Should Exist":false,"Folder":/INBOX/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/People/.toString())
        //Add User in People page
        new actions.People.AddUserinPeoplepage().run("Email Address":/annabrightidea1@yahoo.com/.toString(),"First Name":/C129763/.toString(),"Last Name":/Test User/.toString(),"Screen Name":/Email Test User/.toString(),"Action":/Add User/.toString())
        //Wait
        ...
        //Verify Email Not Mailinator
        new actions.Email.VerifyEmailNotMailinator().run("Sender Host":/imap.mail.yahoo.com/.toString(),"Sender's Email":/annabrightidea1@yahoo.com/.toString(),"Password":/coothhthkgxqqztx/.toString(),"Email Subject to Look For":/C129763 Submission Confirmation/.toString(),"Email Should Exist":true,"Folder":/INBOX/.toString())
    }
    //Basestate
