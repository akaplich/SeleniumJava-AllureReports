...
//C119173 - Owner Updates - Delete Owner
class C119173_OwnerUpdates_DeleteOwner
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureFindOwnerinNewModalinPipelineStepspage().run("Assignment Method":/Category Assignment/.toString(),"Category":/New Product,Operations,Marketing & Branding,Strategy,Quick Add\/New Categories/.toString(),"Owner":/System Admin,System Admin,System Admin,System Admin,System Admin,System Admin/.toString(),"Owner Add or Remove":/Add,Add,Add,Add,Add/.toString(),"Action":/Activate/.toString())
        ...
        new actions.ActionItems.AccessActionIteminActionsItemsReactGlobalNavigation().run("Action Item":/Quick Add for Find Owner Custom/.toString())
        ...
        try{
            ...
            new actions.ViewIdea.SetOwnerinViewIdeaPage().run("User":/System Admin/.toString(),"User Add or Remove":/Remove/.toString(),"Action":/Update/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/Quick Add for Find Owner Custom/.toString(),"Owner":/Not assigned/.toString(),"Linked Submissions":[])
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        ...
        new actions.PipelineManageSteps.AccessIdeainPipelineManageCurrentlyinStepPage().run("Idea name":/Quick Add for Find Owner Custom/.toString())
        //Verify Idea in NGA View Idea page
        new actions.NGAViewIdea.VerifyIdeainNGAViewIdeapage().run("Idea Name":/Quick Add for Find Owner Custom/.toString(),"Creator username":/System Admin/.toString(),"Status":/Submitted/.toString(),"Owner":/Not Assigned/.toString())
    }
    //Basestate
