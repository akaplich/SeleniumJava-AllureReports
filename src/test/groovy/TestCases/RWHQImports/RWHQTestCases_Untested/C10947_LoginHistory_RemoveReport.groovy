...
//C10947  - Login History - Remove Report
class C10947_LoginHistory_RemoveReport
{
    ...
    public void testcase(){
        ...
        //Verify Generated Report in any Setup Exports
        new actions.SetupExports.VerifyGeneratedReportinSetupExports().run("Report Name Starts with":/Login_history/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
