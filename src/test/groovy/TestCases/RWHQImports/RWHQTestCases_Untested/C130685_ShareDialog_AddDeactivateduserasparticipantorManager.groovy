...
//C130685 - Share Dialog - Add Deactivated user as participant or Manager 
class C130685_ShareDialog_AddDeactivateduserasparticipantorManager
{
    ...
    public void testcase(){
        ...
        try{
            ...
            new actions.ShareDialog.SetParticipantsinShareDialog().run("Participants":/Moderator/.toString(),"Participants Add or Remove from Input Field":/Add/.toString(),"Send Invite":false)
        }
        ...
        new actions.ShareDialog.VerifyParticipantorGroupinParticipantsTab().run("User or Group":/User/.toString(),"User or GroupName":/Moderator/.toString(),"Number of Matches":/0/.toString())
        //Set Share Dialog
        new actions.ShareDialog.SetShareDialog().run("Tab":/Managers/.toString())
        try{
            //Set Managers in Share Dialog
            new actions.ShareDialog.SetManagersinShareDialog().run("Type of Manager":/Idea Box Manager/.toString(),"Field Name":/Invite Manager/.toString(),"User":/Moderator/.toString(),"Users Add or Remove from Input Field":/Add/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/No Results/.toString(),"Should Exist":true)
        ...
        try{
            //Set Managers in Share Dialog
            new actions.ShareDialog.SetManagersinShareDialog().run("Type of Manager":/Pipeline Manager/.toString(),"Field Name":/Invite Manager/.toString(),"User":/Moderator/.toString(),"Users Add or Remove from Input Field":/Add/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/No Results/.toString(),"Should Exist":true)
        ...
        //Verify Participant or Group or Managers in the Share Dialog
        new actions.ShareDialog.VerifyParticipantorGroupinParticipantsTab().run("User or Group":/Participant/.toString(),"User or GroupName":/Moderator/.toString(),"Participant Image":false,"Number of Matches":/0/.toString(),"Type of User":/Pipeline Manager/.toString())
        //Verify Participant or Group or Managers in the Share Dialog
        new actions.ShareDialog.VerifyParticipantorGroupinParticipantsTab().run("User or Group":/Participant/.toString(),"User or GroupName":/Moderator/.toString(),"Participant Image":false,"Number of Matches":/0/.toString(),"Type of User":/Idea Box Manager/.toString())
        //Set Share Dialog
