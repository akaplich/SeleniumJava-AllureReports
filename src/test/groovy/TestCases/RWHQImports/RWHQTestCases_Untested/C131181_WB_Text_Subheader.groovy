...
//C131181 - WB - Text - Subheader
class C131181_WB_Text_Subheader
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SetTextToolWhiteboard().run("Select Option":/Subheader/.toString())
        ...
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/C131181/.toString())
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/Escape/.toString())
        //Verify Right Side Controls in Whiteboard 
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("L or W":/680/.toString(),"H":/40/.toString(),"Text Font":/Lato/.toString(),"Font Size":/32/.toString(),"Font Color":/444647/.toString())
    }
    //Basestate
