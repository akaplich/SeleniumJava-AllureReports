...
//C131039 - WB - Add Template - Fishbone
class C131039_WB_AddTemplate_Fishbone
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/Page still working/.toString(),"Action":/Submit/.toString())
    }
    //Basestate
