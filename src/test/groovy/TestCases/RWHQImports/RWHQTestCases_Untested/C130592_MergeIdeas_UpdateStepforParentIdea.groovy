...
//C130592 - Merge Ideas - Update Step for Parent Idea
class C130592_MergeIdeas_UpdateStepforParentIdea
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SetMergeIdeasInPipelineStepsList().run("Verify Order of Ideas:":["test idea1","test idea2"],"Select Parent":/test idea1/.toString(),"Action":/Merge Ideas/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.PipelineManageSteps.VerifyCurrentlyinStepTableforManageScorecard().run("Step Name to Manage (optional)":/Scorecarding/.toString(),"Idea Name":/test idea1/.toString(),"Number of Matches":/1/.toString())
        //Verify Currently in Step Table for Manage Scorecard
        new actions.PipelineManageSteps.VerifyCurrentlyinStepTableforManageScorecard().run("Idea Name":/test idea2/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
