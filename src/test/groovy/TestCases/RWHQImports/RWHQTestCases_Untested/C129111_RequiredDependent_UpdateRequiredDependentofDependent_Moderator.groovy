...
//C129111 - Required Dependent - Update Required Dependent of Dependent - Moderator
class C129111_RequiredDependent_UpdateRequiredDependentofDependent_Moderator
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabRadiobutton().run("Field Name":/Child2/.toString(),"Field Value":/Child2-3/.toString(),"Action":/Save/.toString())
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Verify View Idea Description Tab Field Multi Value
        new actions.ViewIdeaFields.VerifyViewIdeaDescriptionTabFieldMultiValue().run("Field Name":/Child2/.toString(),"Field Value":/Child2-3/.toString())
        //Set View Idea Description Tab Checkbox
        new actions.ViewIdeaFields.SetViewIdeaDescriptionCheckbox().run("Field Name":/Child1/.toString(),"Checkbox Name":/Child1-2,Child1-1/.toString(),"Checkbox Check":/FALSE,TRUE/.toString(),"Action":/Save/.toString())
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Child2/.toString(),"Should Exist":false)
        //Verify View Idea Description Tab Field Multi Value
        new actions.ViewIdeaFields.VerifyViewIdeaDescriptionTabFieldMultiValue().run("Field Name":/Child1/.toString(),"Field Value":/Child1-1/.toString())
    }
    //Basestate
