...
//C131075 - WB - Search whiteboard by title
class C131075_WB_Searchwhiteboardbytitle
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SetSearchWhiteboardOnUserhomepage().run("Search Field":/ran/.toString())
        //Verify Whiteboard Card in Userhomepage
        new actions.Whiteboards.VerifyWhiteboard().run("Whiteboard Name":/whiteboard1/.toString(),"Number of Matches":/0/.toString())
        //Verify Whiteboard Card in Userhomepage
