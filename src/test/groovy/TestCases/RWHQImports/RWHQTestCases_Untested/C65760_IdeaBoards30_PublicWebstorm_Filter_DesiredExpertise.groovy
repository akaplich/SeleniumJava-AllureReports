...
//C65760 -  Idea Boards 30 - Public Webstorm - Filter - Desired Expertise
class C65760_IdeaBoards30_PublicWebstorm_Filter_DesiredExpertise
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea3/.toString(),"Description":/desc/.toString(),"Expertise":/Innovations/.toString(),"Expertise Add or Remove":/Add/.toString(),"Category":/New Product/.toString(),"Required Short Question":/required/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Status":[],"Stage":[],"Categories":[],"Tags":[],"Desired Expertise":["Innovations"],"Action":/Apply Filters/.toString())
