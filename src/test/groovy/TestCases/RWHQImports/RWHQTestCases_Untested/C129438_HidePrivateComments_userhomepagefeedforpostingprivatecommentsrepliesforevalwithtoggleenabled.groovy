...
//C129438 - Hide Private Comments - userhomepage feed for posting private comments replies for eval with toggle enabled
class C129438_HidePrivateComments_userhomepagefeedforpostingprivatecommentsrepliesforevalwithtoggleenabled
{
    ...
    public void testcase(){
        ...
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin commented on "test idea1"/.toString(),"Highlights Item Content":/test reply to private comment/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
