...
//C128826 - Search question for Hidden Idea on Initiative Global Navigation
class C128826_SearchquestionforHiddenIdeaonInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/Automation/.toString())
        //Verify On Global Search Result
        new actions.Search.VerifyOnGlobalSearchResult().run("Title":/quick add1/.toString(),"Number of Matches":/1/.toString(),"Click on the result":true)
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/quick add1/.toString(),"Linked Submissions":[])
        //Log Out
        new actions.general.LogOut().run([:])
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/Automation/.toString())
        //Verify On Global Search Result
        new actions.Search.VerifyOnGlobalSearchResult().run("Title":/quick add1/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
