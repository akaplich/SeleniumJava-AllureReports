...
//C128337 - Login History - Analyst Has Access 
class C128337_LoginHistory_AnalystHasAccess
{
    ...
    public void testcase(){
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Public Webstorm Home/.toString())
        //Login
        new actions.general.Login().run("Webstorm Login":true,"Email":/analyst@test.com/.toString(),"Password":/brightidea1/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Login History/.toString(),"Report Name Starts with":/Login_history/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Login_history-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["analyst","analyst@test.com"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
