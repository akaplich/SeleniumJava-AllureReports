...
//C131229 - Community Dashboard - Overall - Innovations Submitted over Time - Chart
class C131229_CommunityDashboard_Overall_InnovationsSubmittedoverTime_Chart
{
    ...
    public void testcase(){
        ...
        new actions.PipelineDashBoard.VerifyMouseHoverChartViewInnovationTab().run("What Chart?":/Innovations Submitted over Time/.toString(),"Chart View":/Month to Date/.toString(),"What column to hover over?":/today/.toString(),"Tooltip Text":/today 2 Innovations/.toString())
        //Refresh
        ...
        //Verify MouseHover on Chart in Innovation Dashboard Tab
        new actions.PipelineDashBoard.VerifyMouseHoverChartViewInnovationTab().run("What Chart?":/Innovations Submitted over Time/.toString(),"Chart View":/Month to Date/.toString(),"What column to hover over?":/today/.toString(),"Tooltip Text":/today 1 Innovations/.toString())
    }
    //Basestate
