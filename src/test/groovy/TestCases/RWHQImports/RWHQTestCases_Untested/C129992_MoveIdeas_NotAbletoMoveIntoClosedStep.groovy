...
//C129992 - Move Ideas - Not Able to Move Into Closed Step
class C129992_MoveIdeas_NotAbletoMoveIntoClosedStep
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/test idea2/.toString(),"Step Name idea belongs to":/Initial Screen/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
