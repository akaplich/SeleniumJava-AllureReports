...
//C129564 - List View - Voting toggle Off with votes present
class C129564_ListView_VotingtoggleOffwithvotespresent
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyVotingUIonIdeaCard().run("Idea Name":/test idea1/.toString(),"Voting UI View":/Disabled/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/test idea1/.toString(),"Username":/Sri/.toString(),"Vote Count on Voting UI":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/test idea2/.toString(),"Username":/Sri/.toString(),"Vote Count on Voting UI":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/quick add1/.toString(),"Username":/Sri/.toString(),"Vote Count on Voting UI":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
