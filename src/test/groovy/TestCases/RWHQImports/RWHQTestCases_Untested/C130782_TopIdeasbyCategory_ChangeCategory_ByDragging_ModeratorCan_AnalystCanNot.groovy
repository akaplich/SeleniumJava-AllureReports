...
//C130782 - Top Ideas by Category - Change Category - By Dragging - Moderator Can, Analyst Can Not
class C130782_TopIdeasbyCategory_ChangeCategory_ByDragging_ModeratorCan_AnalystCanNot
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/test idea3 New Product/.toString(),"Description":/desc/.toString(),"Category":/New Product/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        ...
        new actions.PipelineTopIdeas.DragAndDropIdeasInTopIdeas().run("Idea Title":/test idea1 New Product/.toString(),"Category":/New Product/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/test idea1 New Product/.toString(),"Stack Name Memo belongs to":/Quick Add/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/test idea1 New Product/.toString(),"Stack Name Memo belongs to":/New Product/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
