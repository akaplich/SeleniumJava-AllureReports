...
//C119016 - Highlights - All Activity - Delete Idea and Delete Initiative
class C119016_Highlights_AllActivity_DeleteIdeaandDeleteInitiative
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/This is comment11/.toString(),"Comment Type":/General Access/.toString())
        //Log Out
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin commented on "test idea2"/.toString(),"Highlights Item Content":/This is comment11/.toString(),"Number of Matches":/0/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
