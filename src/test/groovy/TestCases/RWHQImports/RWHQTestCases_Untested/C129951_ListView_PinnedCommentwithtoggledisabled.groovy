...
//C129951 - List View - Pinned Comment with toggle disabled
class C129951_ListView_PinnedCommentwithtoggledisabled
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyPinnedCommentinIdeaBoardsListView().run("Idea":/test idea2/.toString(),"Comment":/test pinned comment/.toString(),"Comment Submitter":/System Admin/.toString(),"Comment Submitter Image":false,"Comment Date Displayed":true,"Edited Indicator":false,"Number of Matches":/0/.toString())
    }
    //Basestate
