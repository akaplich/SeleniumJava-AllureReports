...
//C10916 - Non-Financial Section - Add and Edit Benefits, Cancel
class C10916_Non_FinancialSection_AddandEditBenefits_Cancel
{
    ...
    public void testcase(){
        ...
        //Set Non Financial Benefit in Business Impact tab
        new actions.ViewIdea.BusinessImpact.SetNonFinancialBenefitinBusinessImpacttab().run("Add or Edit":/Edit/.toString(),"Benefit Title":/Product Launch Canceled/.toString(),"Benefit Type":/Brand Awareness/.toString(),"Description":/Product Launch is being canceled./.toString(),"Row Number":/1/.toString())
        //Set Non Financial Benefit in Business Impact tab
        new actions.ViewIdea.BusinessImpact.SetNonFinancialBenefitinBusinessImpacttab().run("Add or Edit":/Add/.toString(),"Benefit Title":/New Non Financial Benefit/.toString(),"Benefit Type":/Brand Awareness/.toString(),"Description":/test message/.toString(),"Row Number":/2/.toString())
        //Set Business Impact Tab
        new actions.ViewIdea.BusinessImpact.SetBusinessImpactForViewIdeaPage().run("Action":/Cancel/.toString())
        //Verify Non Financial Benefits in Business Impact tab for View Idea page
        new actions.ViewIdea.BusinessImpact.VerifyNonFinancialBenefitsinBusinessImpacttabforViewIdeapage().run("Benefit Title":/Product Launch/.toString(),"Benefit Type":/Brand Awareness/.toString(),"Description":/A Product Launch is a marketing strategy consisting of a carefully planned and scheduled sequence of events./.toString(),"Row Number":/1/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/New Non Financial Benefit/.toString(),"Should Exist":false)
    }
    //Basestate
