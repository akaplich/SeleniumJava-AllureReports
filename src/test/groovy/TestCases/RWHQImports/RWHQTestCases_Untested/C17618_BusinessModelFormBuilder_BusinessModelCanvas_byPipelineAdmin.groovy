...
//C17618 - Business Model Form Builder (Business Model Canvas) by Pipeline Admin
class C17618_BusinessModelFormBuilder_BusinessModelCanvas_byPipelineAdmin
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.TeamWorkspace.VerifyBusinessModelCanvasinTeamWorkspace().run("Verify in Which Tab (optional)":/Business Model/.toString(),"Custom Question Title":/Changed Title for Value Proposition/.toString(),"Custom Question Default Text":/This a default text for Value Proposition/.toString())
    }
    //Basestate
