...
//C128258 - Search Hidden Idea on Initiative Global Navigation
class C128258_SearchHiddenIdeaonInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.Search.SearchEnterpriseWebstorm().run("Search Value":/quick add1/.toString())
