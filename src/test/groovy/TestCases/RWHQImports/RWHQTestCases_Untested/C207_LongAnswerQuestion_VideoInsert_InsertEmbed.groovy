...
//C207 - Long Answer Question - Video Insert, Insert Embed
class C207_LongAnswerQuestion_VideoInsert_InsertEmbed
{
    ...
    public void testcase(){
        ...
        new actions.SetIdeaFields.SetPostIdeaInsertVideoforTextField().run("Field Name":/Long Answer Question/.toString(),"Video Link":/${variables."TCData.Video Embed for Pop Up"}/.toString(),"Action":/Insert/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Test Idea Video Embed/.toString(),"Description":/Description/.toString(),"Category":/New Product/.toString(),"Required Short Question":/Required Short/.toString(),"Action":/Submit Idea/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Test Idea Video Embed/.toString())
        //Verify Custom App Description tab fields in View Idea page
        Action5812921cfa4ee77809f46b4f("Long AnswerQuestion":/Video/.toString())
    }
    //Basestate
