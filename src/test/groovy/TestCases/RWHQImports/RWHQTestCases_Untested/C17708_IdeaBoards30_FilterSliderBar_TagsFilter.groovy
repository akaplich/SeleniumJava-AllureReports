...
//C17708 - Idea Boards 30 - Filter Slider Bar - Tags Filter
class C17708_IdeaBoards30_FilterSliderBar_TagsFilter
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Expand Tags Filter":true,"Status":[],"Stage":[],"Categories":[],"Tags":["tag1"],"Admin Tags":[],"Desired Expertise":[])
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/tag1/.toString(),"Should Exist":false)
    }
    //Basestate
