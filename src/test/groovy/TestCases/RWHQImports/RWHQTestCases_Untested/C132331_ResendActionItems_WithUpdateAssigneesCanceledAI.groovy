...
//C132331 - Resend Action Items - With Update Assignees Canceled AI
class C132331_ResendActionItems_WithUpdateAssigneesCanceledAI
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.VerifyAssigneeInUpdateAssigneeModal().run("Open Modal":true,"Assignee under Completed or Incomplete Action Items":/Assignees with incomplete action items/.toString(),"Assignee":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Set Update Assignee Modal
        new actions.PipelineStepsView.SetUpdateAssigneeModal().run("Open Modal":false,"Additional Assignee":/analyst,Evaluator,Moderator/.toString(),"Additional Assignee Add or Remove":/Add,Add,Add/.toString(),"Action":/Update Assignments/.toString())
        //Verify Assignee In Update Assignee Modal
        ...
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/Quick add for single scale resend/.toString())
        //Verify Assignee In Update Assignee Modal
        new actions.PipelineStepsView.VerifyAssigneeInUpdateAssigneeModal().run("Open Modal":true,"Assignee under Completed or Incomplete Action Items":/Assignees with incomplete action items/.toString(),"Assignee":/analyst/.toString(),"Number of Matches":/1/.toString())
        //Verify Assignee In Update Assignee Modal
        new actions.PipelineStepsView.VerifyAssigneeInUpdateAssigneeModal().run("Open Modal":false,"Assignee under Completed or Incomplete Action Items":/Assignees with complete action items/.toString(),"Assignee":/Moderator/.toString(),"Number of Matches":/1/.toString())
        //Verify Assignee In Update Assignee Modal
        ...
        new actions.PipelineStepsView.VerifyAssigneeInUpdateAssigneeModal().run("Open Modal":false,"Assignee under Completed or Incomplete Action Items":/Assignees with incomplete action items/.toString(),"Assignee":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Set Update Assignee Modal
        new actions.PipelineStepsView.SetUpdateAssigneeModal().run("Open Modal":false,"Additional Assignee":/analyst/.toString(),"Additional Assignee Add or Remove":/Remove/.toString(),"Action":/Update Assignments/.toString())
        //Set Update Assignee Modal
        new actions.PipelineStepsView.SetUpdateAssigneeModal().run("Open Modal":true,"Additional Assignee":/Moderator,End User/.toString(),"Additional Assignee Add or Remove":/Remove,Add/.toString(),"Action":/Update Assignments/.toString())
        //Verify Assignee In Update Assignee Modal
        ...
        //Verify Assignee In Update Assignee Modal
        new actions.PipelineStepsView.VerifyAssigneeInUpdateAssigneeModal().run("Open Modal":false,"Assignee under Completed or Incomplete Action Items":/Assignees with complete action items/.toString(),"Assignee":/Moderator/.toString(),"Number of Matches":/0/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Access Action Item in Actions Items React Global Navigation
        new actions.ActionItems.AccessActionIteminActionsItemsReactGlobalNavigation().run("Action Item":/Quick add for single scale resend/.toString())
        ...
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Step Name to Manage (optional)":/Single Scale/.toString(),"Count to verify":/2\/5/.toString(),"Evaluator":/System Admin/.toString(),"Number of assigned items":/1/.toString(),"Number of remaining items":/0/.toString(),"Percent Complete Bar - Completed":/100%/.toString(),"Number of Matches":/1/.toString())
        //Verify Action Items in Progress in Manage Step Page
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Count to verify":/2\/5/.toString(),"Evaluator":/Evaluator/.toString(),"Number of assigned items":/1/.toString(),"Number of remaining items":/0/.toString(),"Percent Complete Bar - Completed":/100%/.toString(),"Number of Matches":/1/.toString())
        //Verify Action Items in Progress in Manage Step Page
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Count to verify":/2\/5/.toString(),"Evaluator":/End User/.toString(),"Number of assigned items":/1/.toString(),"Number of remaining items":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Action Items in Progress in Manage Step Page
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Count to verify":/2\/5/.toString(),"Evaluator":/analyst/.toString(),"Number of assigned items":/1/.toString(),"Number of remaining items":/0/.toString(),"Percent Complete Bar - Cancelled":/100%/.toString(),"Number of Matches":/1/.toString())
        //Verify Action Items in Progress in Manage Step Page
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Count to verify":/2\/5/.toString(),"Evaluator":/Moderator/.toString(),"Number of assigned items":/1/.toString(),"Number of remaining items":/0/.toString(),"Percent Complete Bar - Cancelled":/100%/.toString(),"Number of Matches":/1/.toString())
        //Verify Currently in Step table for Manage Judging
        new actions.PipelineManageSteps.VerifyCurrentlyinSteptableforManageJudging().run("Overall Score":/3.67/.toString(),"Idea Name":/Quick add for single scale resend/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
