...
//C129753 - New Copy Ideas - Hidden Comments
class C129753_NewCopyIdeas_HiddenComments
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("Comment":/Visible Comment/.toString(),"Comment Type":/General Access/.toString(),"Attachment File":/Sample PDF.pdf/.toString(),"Attachment Add or Remove":/Add/.toString(),"Post Comment":true)
        //Add Comment in View and NGA View Idea
        new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("Comment":/Hidden Comment/.toString(),"Comment Type":/General Access/.toString(),"Attachment File":/Sample PDF.pdf/.toString(),"Attachment Add or Remove":/Add/.toString(),"Post Comment":true)
        //Set Comment Edit Menu
        new actions.ViewIdeaComment.SetCommentEditMenu().run("Comment to Edit":/Hidden Comment/.toString(),"Menu Option":/Hide/.toString())
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/Hidden Comment/.toString(),"User":/System Admin/.toString(),"Number of Matches":/0/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/Visible Comment/.toString(),"User":/System Admin/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
