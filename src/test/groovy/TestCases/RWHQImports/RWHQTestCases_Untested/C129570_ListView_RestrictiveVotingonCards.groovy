...
//C129570 - List View - Restrictive Voting on Cards
class C129570_ListView_RestrictiveVotingonCards
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/test idea2/.toString(),"Username":/Sri/.toString(),"Vote Count on Voting UI":/0/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/test idea1/.toString(),"Username":/Sri/.toString(),"Vote Count on Voting UI":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
