...
//C128674 - Analyst cannot post idea with admin question
class C128674_Analystcannotpostideawithadminquestion
{
    ...
    public void testcase(){
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Admin Only Dropdown Question/.toString(),"Should Exist":false)
    }
    //Basestate
