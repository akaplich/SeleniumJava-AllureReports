...
//C128362 - NGA Linked Submissions Across Initiatives - Evaluator Cannot View Hidden Linked Submissions 
class C128362_NGALinkedSubmissionsAcrossInitiatives_EvaluatorCannotViewHiddenLinkedSubmissions
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/linked idea2/.toString())
        ...
        new actions.ViewIdea.SetLinkedSubmissionsonViewIdeaPage().run("Submission Title":/linked idea1/.toString(),"Add or Remove":/Add/.toString(),"Action":/Save Changes/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.NGAViewIdea.VerifyLinkedSubmissionNGAViewIdea().run("Linked Submissions":/linked idea2/.toString(),"Should Exist":/TRUE/.toString(),"Name of the Linked Submission to Navigate to":/linked idea2/.toString())
        //Verify Message
