...
//C65758 - Idea Boards 30 - Public Webstorm - Filter - Status
class C65758_IdeaBoards30_PublicWebstorm_Filter_Status
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Status":["Under Review"],"Stage":[],"Categories":[],"Tags":[],"Desired Expertise":[],"Action":/Apply Filters/.toString())
