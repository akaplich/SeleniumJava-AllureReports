...
//C131802 - PR Files > Multiple File Pages
class C131802_PRFiles_MultipleFilePages
{
    ...
    public void testcase(){
        ...
        new actions.selenium.Refresh().run([:])
        //Set Files in Team Workspace
        new actions.ViewIdea.TeamWorkspace.SetFilesinTeamWorkspace().run("Attachment File":/ImageOver2MB.jpg/.toString())
        //Refresh
        new actions.selenium.Refresh().run([:])
        ...
        //Verify Files in Team Workspace
        new actions.ViewIdea.TeamWorkspace.VerifyFilesinTeamWorkspace().run("Attachment Name":/ImageOver2MB.jpg/.toString(),"Number of Matches":/1/.toString())
        //Verify Files in Team Workspace
