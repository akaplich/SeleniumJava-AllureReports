...
//C10741 - Idea Boards 20 - Engaging with other Innovators
class C10741_IdeaBoards20_EngagingwithotherInnovators
{
    ...
    public void testcase(){
        ...
        //Set User Flyover in Idea Board 20 page
        new actions.IdeaBoard.SetUserFlyoverinIdeaBoardpage().run("Idea Name":/New Idea/.toString(),"Username":/End User/.toString(),"Action":/Follow or Unfollow/.toString())
        //Navigate
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Set User Flyover in Idea Board 20 page
        new actions.IdeaBoard.SetUserFlyoverinIdeaBoardpage().run("Idea Name":/New Idea/.toString(),"Username":/End User/.toString(),"Action":/Profile/.toString())
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Set User Flyover in Idea Board 20 page
        new actions.IdeaBoard.SetUserFlyoverinIdeaBoardpage().run("Idea Name":/New Idea/.toString(),"Username":/End User/.toString(),"Action":/Message/.toString())
        //Set Message in Message Pop up
        new actions.general.SetMessageinMessagePopup().run("Subject":/Test Email/.toString(),"Message Body":/This is a test email to check the functionality/.toString(),"Action":/Send/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/bi.enduser1@brightidea.com/.toString(),"Password":/brightidea1/.toString())
