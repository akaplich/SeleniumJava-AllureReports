...
//C117939 - Pitch Event - Early access participants
class C117939_PitchEvent_Earlyaccessparticipants
{
    ...
    public void testcase(){
        ...
        //Create App Webstorm
        new actions.WebstormCreation.CreateAppWebstorm().run("App Name":/Pitch/.toString(),"Sponsor Name":/NonBI System Admin/.toString(),"Sponsor Add or Remove":/Add/.toString(),"Webstorm Title":/Pitch Event title/.toString(),"Description":/Pitch Event description/.toString(),"Early Access":/End User,End User 2,New Group,End User 2/.toString(),"Early Access Add or Remove":/Add,Add,Add,Remove/.toString(),"General Access":/End User 2,ALL/.toString(),"General Access Add or Remove":/Add,Remove/.toString(),"Action":/Create/.toString())
