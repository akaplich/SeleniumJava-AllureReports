...
//C117594 - My Idea List
class C117594_MyIdeaList
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyIdeainMyIdeasList().run("Thumbnail":/Default/.toString(),"Title":/Brightidea must be next big thing/.toString(),"Row Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
