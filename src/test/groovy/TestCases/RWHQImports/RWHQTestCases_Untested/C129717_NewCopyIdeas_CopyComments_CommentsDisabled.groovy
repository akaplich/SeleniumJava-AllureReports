...
//C129717 - New Copy Ideas - Copy Comments - Comments Disabled
class C129717_NewCopyIdeas_CopyComments_CommentsDisabled
{
    ...
    public void testcase(){
        ...
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea3/.toString(),"Status":/Submitted/.toString(),"Username":/System Admin/.toString(),"Description":/description of test idea3/.toString(),"Comments":/5/.toString())
