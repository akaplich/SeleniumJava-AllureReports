...
//C131051 - Advanced Search - Search Comment From Deleted Idea
class C131051_AdvancedSearch_SearchCommentFromDeletedIdea
{
    ...
    public void testcase(){
        ...
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/test comment/.toString(),"Type":/Comments/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
