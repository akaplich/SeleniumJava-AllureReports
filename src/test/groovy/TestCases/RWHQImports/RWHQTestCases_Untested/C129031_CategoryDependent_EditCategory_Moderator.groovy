...
//C129031 - Category Dependent - Edit Category - Moderator
class C129031_CategoryDependent_EditCategory_Moderator
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureScorecardStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Submitted/.toString(),"Individual Assignment User":/Evaluator/.toString(),"Individual Assignment User Add or Remove":/Add/.toString(),"Action":/Activate/.toString())
        //Log Out
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Multiple Choice Question/.toString(),"Should Exist":false)
        //Set NGA View Idea Description Tab Text Field
        new actions.NGAViewIdea.SetNGAViewIdeaDescriptionTabTextField().run("Field Name":/Long Answer Question/.toString(),"Field Value":/test Long Answer Question/.toString(),"Action":/Save/.toString())
    }
    //Basestate
