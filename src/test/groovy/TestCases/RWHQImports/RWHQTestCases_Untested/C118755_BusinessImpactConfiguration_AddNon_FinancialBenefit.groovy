...
//C118755 - Business Impact Configuration - Add Non-Financial Benefit
class C118755_BusinessImpactConfiguration_AddNon_FinancialBenefit
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetConfigureBusinessImpactFields().run("Action":/Add/.toString(),"Type":/non-financial-benefits/.toString(),"Benefit Title":/Test/.toString())
