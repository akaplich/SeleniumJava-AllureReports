...
//C130837 - Pipeline Summary - Review
class C130837_PipelineSummary_Review
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.CreateStepinPipelineStepspage().run("Step Name":/Review/.toString(),"Select Tool Type":/Review/.toString(),"Action":/Create/.toString())
        //Configure Review Step in Pipeline Steps page
        new actions.PipelineStepsConfigure.ConfigureReviewStepinNewModalinPipelineStepspage().run("Individual Assignment User":/Evaluator,Pipeline Admin/.toString(),"Individual Assignment User Add or Remove":/Add,Add/.toString(),"Action":/Activate/.toString())
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Pipeline_Summary-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Pipeline Admin Completed","Evaluator Completed"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Pipeline_Summary/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Pipeline_Summary-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Collection","Review","0","N/A","Open"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Pipeline_Summary/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Pipeline_Summary-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Collection","Review","0","Completed","Canceled"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
