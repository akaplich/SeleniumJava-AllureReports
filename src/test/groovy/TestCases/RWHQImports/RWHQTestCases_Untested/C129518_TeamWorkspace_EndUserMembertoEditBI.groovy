...
//C129518 - Team Workspace - End User Member to Edit BI
class C129518_TeamWorkspace_EndUserMembertoEditBI
{
    ...
    public void testcase(){
        ...
        //Set Costs in Business Impact tab
        new actions.ViewIdea.BusinessImpact.SetCostsinBusinessImpacttab().run("Add or Edit Costs":/Edit,Edit/.toString(),"Year":/2018,2019/.toString(),"Current Year":/2018/.toString(),"Cost Title":/Future Assets,Future Assets/.toString(),"Projected Cost":/6300,14000/.toString(),"Actual Cost":/1000,7800/.toString(),"Row Number":/1,1/.toString())
        //Set Business Impact Tab
        new actions.ViewIdea.BusinessImpact.SetBusinessImpactForViewIdeaPage().run("Action":/Save Version/.toString())
        //Verify Projected and Actual Costs in Business Impact tab for View Idea page
        new actions.ViewIdea.BusinessImpact.VerifyProjectedandActualCostsinBusinessImpacttabforViewIdeapage().run("Year":/2018;2019/.toString(),"Current Year":/2018/.toString(),"Costs Title":/Future Assets;Future Assets/.toString(),"Row Number":/1;1/.toString(),"Projected Cost":/6,300;14,000/.toString(),"Actual Cost":/1,000;7,800/.toString())
