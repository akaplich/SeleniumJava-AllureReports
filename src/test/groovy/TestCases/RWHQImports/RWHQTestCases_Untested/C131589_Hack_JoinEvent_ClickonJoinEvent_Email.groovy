...
//C131589 - Hack > Join Event - Click on Join Event, Email
class C131589_Hack_JoinEvent_ClickonJoinEvent_Email
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC131589_1/.toString(),"Finally Login as What User":/brightC131589_1@mailinator.com/.toString())
        ...
        new actions.WebstormHomepage.HackathonOnboarding.SetFlowAforHackathonOnboarding().run("Action on Get Started Screen":/Next/.toString(),"Expertise":/QA,Automation/.toString(),"Add or Remove Expertise":/Add,Add/.toString(),"Register and add expertise Action":/Continue to submission/.toString(),"Action on Time to submit your project":/Cancel/.toString(),"Wait for Post Idea Page to Load":false)
        //Verify Body of Email
        new actions.Mailinator.VerifyBodyofEmail().run("Email Address":/brightC131589_1@mailinator.com/.toString(),"Expected Text":"","Contains Text":/Hello Auto,   You’ve joined the event! What’s next?  - If you have a Project, Submit it! - Browse other Projects. If you find a Project you like, request to join the team. - No Project? Team up with other participants that are not on teams. - If you should be part of a Project but have not been added yet, tell your team leader./.toString())
    }
    //Basestate
