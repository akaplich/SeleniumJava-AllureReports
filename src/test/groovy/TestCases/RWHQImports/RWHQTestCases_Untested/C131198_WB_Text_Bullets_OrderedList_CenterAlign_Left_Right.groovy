...
class C131198_WB_Text_Bullets_OrderedList_CenterAlign_Left_Right
{
    ...
    public void testcase(){
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Expected Image File":/C131198_1_Expected3282025.png/.toString(),"Actual Image Name":/C131198_1_actual.png/.toString(),"Crop Screenshot Start at X":/200/.toString(),"Crop Screenshot Start at Y":/200/.toString(),"Crop Screenshot Width":/750/.toString(),"Crop Screenshot Height":/250/.toString(),"Do Not Scroll":true)
        //Set Right Side Controls in Whiteboard
        new actions.Whiteboards.SetRightSideControlsWhiteboard().run("Horizontal Alignment":/Align left/.toString())
        //Compare Images
        new actions.selenium.CompareImages().run("Expected Image File":/C131198_2_Expected3282025.png/.toString(),"Actual Image Name":/C131198_2_actual.png/.toString(),"Crop Screenshot Start at X":/200/.toString(),"Crop Screenshot Start at Y":/200/.toString(),"Crop Screenshot Width":/750/.toString(),"Crop Screenshot Height":/250/.toString(),"Do Not Scroll":true)
        //Set Right Side Controls in Whiteboard
        new actions.Whiteboards.SetRightSideControlsWhiteboard().run("Horizontal Alignment":/Align right/.toString())
        //Compare Images
        new actions.selenium.CompareImages().run("Expected Image File":/C131198_3_Expected3282025.png/.toString(),"Actual Image Name":/C131198_3_actual.png/.toString(),"Crop Screenshot Start at X":/200/.toString(),"Crop Screenshot Start at Y":/200/.toString(),"Crop Screenshot Width":/750/.toString(),"Crop Screenshot Height":/250/.toString(),"Do Not Scroll":true)
    }
    //Basestate
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131198_1_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131198_2_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131198_3_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
