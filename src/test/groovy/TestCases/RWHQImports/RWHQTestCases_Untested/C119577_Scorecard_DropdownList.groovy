...
//C119577 - Scorecard - Dropdown List
class C119577_Scorecard_DropdownList
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.AddQuestionSaveFormScorecardTemlates().run("Add Question":true)
        //Set Question in Scorecard Template
        new actions.PipelineSetup.SetQuestionScorecardTemplate().run("Added Question Order Number":/2/.toString(),"Question Type":/Select Answer (drop down list)/.toString(),"Question":/2 - Dropdown/.toString(),"Short Name":/Short Name Test/.toString(),"Tooltip":/Test Tooltip One Answer/.toString(),"Answers":/Four,Five,Six/.toString(),"Points":/1,2,3/.toString(),"Action":/Save/.toString())
        //Add/Edit Question or Save Form on Scorecard Template
        ...
        //Set Evaluation Scorecard for Idea in Action Items page
        new actions.ActionItems.SetEvaluationScorecardIdeaActionItemspage().run("Dropdown - Question":/2 - Dropdown/.toString(),"Dropdown - Answer(s)":/Four/.toString(),"Submit Scorecard":true)
        //Access Action Item in Actions Items React Global Navigation
        ...
        new actions.ActionItems.VerifyScorecardAnswers().run("Dropdown - Question":/1 - Dropdown/.toString(),"Dropdown - Answer(s)":/Two/.toString())
        //Verify Scorecard Answers
        new actions.ActionItems.VerifyScorecardAnswers().run("Dropdown - Question":/2 - Dropdown/.toString(),"Dropdown - Answer(s)":/Four/.toString())
    }
    //Basestate
