...
//C132176 - VI3 - Open Team Workspace as Analyst
class C132176_VI3_OpenTeamWorkspaceasAnalyst
{
    ...
    public void testcase(){
        ...
        //Set Team Workspace on VI3 
        new actions.ViewIdea30.TeamWorkspaceOnVI3().run("Click Button":/Create/.toString())
        //Log Out
        ...
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Set Team Workspace on VI3 
        new actions.ViewIdea30.TeamWorkspaceOnVI3().run("Click Button":/Open/.toString())
    }
    //Basestate
