...
//C82240 - Find owner - Cancel on Forward to Colleague
class C82240_Findowner_CancelonForwardtoColleague
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.AccessActionIteminActionsItemsGlobalNavigation().run("Action Item":/View All/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/My Action Items/.toString(),"Title":/Find Owner Idea1/.toString(),"Pipeline":/Suggest Pipeline/.toString(),"Step":/Find Owner/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
