...
//C129541 - Voting on Card - Public Instance with Unified login on
class C129541_VotingonCard_PublicInstancewithUnifiedloginon
{
    ...
    public void testcase(){
        ...
        new actions.SetupBeta.SetWebstormSetupforBetaBetatab().run("Unified Login Page":true)
        //Log Out
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString(),"Status":/Under Review/.toString(),"Description":/test idea1 desc/.toString(),"Votes":/1/.toString(),"Vote Count on Voting UI":/1/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Public Webstorm Idea Board/.toString())
