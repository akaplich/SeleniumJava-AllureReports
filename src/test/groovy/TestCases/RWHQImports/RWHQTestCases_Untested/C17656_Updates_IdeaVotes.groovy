...
//C17656 - Updates - Idea Votes
class C17656_Updates_IdeaVotes
{
    ...
    public void testcase(){
        ...
        new actions.general.Navigate().run("Area to Navigate to":/Home/.toString())
        //Verify Widget Updates
        new actions.Widgets.VerifyWidgetUpdates().run("Update Text Contains":/End User 2 has demoted Sri/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
