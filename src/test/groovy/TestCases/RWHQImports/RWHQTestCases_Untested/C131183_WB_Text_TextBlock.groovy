...
//C131183 - WB - Text - Text Block
class C131183_WB_Text_TextBlock
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/C131183/.toString())
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/Escape/.toString())
        //Verify Right Side Controls in Whiteboard 
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("L or W":/680/.toString(),"H":/80/.toString(),"Text Font":/Lato/.toString(),"Font Size":/14/.toString())
    }
    //Basestate
