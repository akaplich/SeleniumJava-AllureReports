...
//C131179 - Community Dashboard - Business Impact Export
class C131179_CommunityDashboard_BusinessImpactExport
{
    ...
    public void testcase(){
        ...
        new actions.People.AddUserinPeoplepage().run("Email Address":/brightc131179@mailinator.com/.toString(),"First Name":/ABCommunity/.toString(),"Last Name":/Admin/.toString(),"Screen Name":/ABCommunity Admin/.toString(),"Action":/Add User/.toString())
        //Get Registration Link from Email
        variables."link" = new actions.Mailinator.GetRegistrationLinkfromEmail().run("Email Address":/brightc131179/.toString())
        //Navigate to URL
        ...
        new actions.SetupEnterpriseCommunities.AddRemoveCommunityAdministrator().run("User":/ABCommunity Admin/.toString(),"Add or Remove":/Add/.toString())
        ...
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/brightc131179@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        ...
        variables."downloadURL" = new actions.Mailinator.GetDownloadLinkfromEmail().run("Email Address":/brightc131179/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."downloadURL"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/3/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Test1 Community-Business-Impact-Initiatives*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Initiative Name","Initiative Status","Link to Initiative","App Type","Total Submissions with Business Impact","Total Submissions","First Impact Recorded"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."downloadURL"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/3/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Test1 Community-Business-Impact-Initiatives*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Last Impact Recorded","Total Projected Benefit ($)","Total Projected Cost ($)"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."downloadURL"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/3/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Test1 Community-Business-Impact-Initiatives*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Solve App","Closed","1.0","2","2021","2022","24000","22000"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."downloadURL"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/3/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Test1 Community-Business-Impact-Initiatives*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Custom App","custom","Active","1.0","3","2021","2022","23000","22000"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
