...
class C130971_WB_Shapes_LockAndUnlock
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SetShapesToolWhiteboard().run("Add via Single Click or Drag and Drop":/Single Click/.toString(),"X coordinate":/740/.toString(),"Y coordinate":/657/.toString())
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Fill/.toString(),"Should Exist":false)
        //Click on Whiteboard Canvas
