...
//C130004 - Idea Boards 30 - Filter Options Cleared When Navigating Directly
class C130004_IdeaBoards30_FilterOptionsClearedWhenNavigatingDirectly
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea3/.toString(),"Description":/desc/.toString(),"Category":/Strategy/.toString(),"Required Short Question":/required/.toString(),"Action":/Submit Idea/.toString())
        //Filter Idea in Idea Board page
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Status":[],"Stage":[],"Categories":["Strategy"],"Tags":[],"Desired Expertise":[],"My Submissions":true)
