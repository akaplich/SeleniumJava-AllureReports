...
//C128711 - NGA Linked Submissions - Pre-load Search Results - Team Submitter
class C128711_NGALinkedSubmissions_Pre_loadSearchResults_TeamSubmitter
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea - team/.toString(),"Submitter":/Team/.toString(),"Submitter Team User":/Evaluator/.toString(),"Submitter Team User Add or Remove":/Add/.toString(),"Description":/desc/.toString(),"Category":/New Product/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App Test/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/do not show/.toString(),"Description":/desc/.toString(),"Category":/New Product/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea4/.toString(),"Submitter":/Team/.toString(),"Submitter Team User":/Evaluator/.toString(),"Submitter Team User Add or Remove":/Add/.toString(),"Description":/desc/.toString(),"Category":/Operations/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ActionItems.AccessActionIteminActionsItemsGlobalNavigation().run("Action Item":/test idea4/.toString())
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/test idea - team/.toString(),"Should Exist":true)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/do not show/.toString(),"Should Exist":false)
        //Set Linked Submissions on NGA View Idea Page
        new actions.NGAViewIdea.SetLinkedSubmissionsNGAViewIdeaPage().run("Submission Title":/test idea - team/.toString(),"Add or Remove":/Add/.toString(),"Action":/Link Submissions/.toString())
        //Set Linked Submissions on NGA View Idea Page
        new actions.NGAViewIdea.SetLinkedSubmissionsNGAViewIdeaPage().run("Submission Title":/test idea - team/.toString(),"Add or Remove":/Remove/.toString(),"Action":/Link Submissions/.toString())
        //Access Action Item in Actions Items React Global Navigation
        new actions.ActionItems.AccessActionIteminActionsItemsReactGlobalNavigation().run("Action Item":/test idea4/.toString())
        //Set Linked Submissions on NGA View Idea Page
        new actions.NGAViewIdea.SetLinkedSubmissionsNGAViewIdeaPage().run("Submission Title":/just open/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/test idea - team/.toString(),"Should Exist":true)
