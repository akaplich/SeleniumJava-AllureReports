...
//C131312 - Request Review - Round Information
class C131312_RequestReview_RoundInformation
{
    ...
    public void testcase(){
        ...
        new actions.Memo.VerifyRoundInformationInReviewResultsmodal().run("Progress Bar":/50%/.toString(),"Completed":/1\/2/.toString(),"Due in":true,"Reviewers":/Evaluator,Pipeline Admin/.toString(),"Score":/6.3,-/.toString(),"Assigned by":/System Admin/.toString(),"Round name":/Round1/.toString(),"Template":/General Memo Review/.toString())
    }
    //Basestate
