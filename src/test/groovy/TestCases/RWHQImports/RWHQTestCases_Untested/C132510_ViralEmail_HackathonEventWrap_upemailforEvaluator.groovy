...
//C132510 - Viral Email - Hackathon Event Wrap-up email for Evaluator
class C132510_ViralEmail_HackathonEventWrap_upemailforEvaluator
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC132510_eval/.toString(),"Finally Login as What User":/brightC132510_eval@mailinator.com/.toString())
        //Navigate
        ...
        new actions.PipelineStepsView.EditStepinPipelineStepspage().run("Step to Edit":/Initial Submission/.toString(),"Tool Type":/Review/.toString(),"Action":/Save/.toString())
        //Configure Review Step in Pipeline Steps page
        new actions.PipelineStepsConfigure.ConfigureReviewStepinNewModalinPipelineStepspage().run("Individual Assignment User":/Autofirst Autolast/.toString(),"Individual Assignment User Add or Remove":/Add/.toString(),"Action":/Activate/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/brightC132510_eval@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        //Access Action Item in Actions Items Global Navigation
        new actions.ActionItems.AccessActionIteminActionsItemsGlobalNavigation().run("Action Item":/hack project1/.toString())
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC132510_eval@mailinator.com/.toString(),"Subject":/Initial Submission: You have 1 new Action Items/.toString(),"From":/The Innovation Team/.toString(),"Email Should Be Received":true)
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC132510_eval@mailinator.com/.toString(),"Subject":/Thank You for Your Expertise in Hack!/.toString(),"From":/noreply@brightidea.com/.toString(),"Email Should Be Received":true)
    }
    //Basestate
