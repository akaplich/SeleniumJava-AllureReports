...
//C130308 - People Pillar Updates - Delete User with Data (Project,AI)
class C130308_PeoplePillarUpdates_DeleteUserwithData_Project_AI
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforTeamWorkspaceTab().run("Team Workspace":true,"Milestones Tab":true,"Tasks Tab":true)
        //Navigate WebStorm or MTS
        ...
        //Set Workspace Team
        new actions.ViewIdea.TeamWorkspace.SetWorkspaceTeam().run("User":/Pipeline Admin/.toString(),"Add or Remove or Set Leader":/Add/.toString(),"Action":/Update/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.People.VerifyMessageonPeoplePillarUserMenuModal().run("Message":/You are about to delete Pipeline Admin. This will permanently delete this user's account and all associated data, including:1 project2 action itemsIf you do not want to permanently delete this user and data, you can choose to deactivate them instead. I understand that deleting Pipeline Admin will also delete all related submissions, votes, comments, and action items./.toString())
        //Set User Menu in People Pillar
