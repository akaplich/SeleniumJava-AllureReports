...
//C10999 - Tag Followers - Unfollow Tag
class C10999_TagFollowers_UnfollowTag
{
    ...
    public void testcase(){
        ...
        //Set Tag for View Idea page
        new actions.ViewIdea.SetTagforViewIdeapage().run("Tag Name":/tag5/.toString(),"Subscribe or Unsubscribe":/Unsubscribe/.toString())
        //Navigate
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Tag_followers-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["tag5","System Admin","bi.adminuser1@brightidea.com"],"Number of Matches":/0/.toString(),"Total Number of Rows":/1/.toString())
    }
    //Basestate
