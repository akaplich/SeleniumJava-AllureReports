...
//C131384 - WB - Stacks - Remove All
class C131384_WB_Stacks_RemoveAll
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131834/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.VerifySmartMatrixExists().run("Element (skip if verifying actual text)":/KanbanCard 1/.toString(),"Should Exist":false)
        //Verify Smart Matrix & Other Elements Exists On Whiteboard
        new actions.Whiteboards.VerifySmartMatrixExists().run("Element (skip if verifying actual text)":/Group 1/.toString(),"Should Exist":false)
    }
    //Basestate
