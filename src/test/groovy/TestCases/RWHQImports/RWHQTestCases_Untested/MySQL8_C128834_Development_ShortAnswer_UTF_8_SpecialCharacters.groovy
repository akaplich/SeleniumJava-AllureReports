...
class MySQL8_C128834_Development_ShortAnswer_UTF_8_SpecialCharacters
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development Short Text - A/.toString(),"Additional Question Type":/Short Answer/.toString(),"Development Field":true,"Save Form":true)
        //Navigate Webstorm via Admin Dropdown Only
        ...
        new actions.PipelineStepsConfigure.ConfigureDevelopmentinNewModalinPipelineStepspage().run("Assignment Method":/Individual Assignment/.toString(),"Development Lead":/Idea Submitter/.toString(),"Development Team":/Evaluator/.toString(),"Development Team Add or Remove":/Add/.toString(),"Development Field":/Development Short Text - A/.toString(),"Development Field Included or Required":/Included/.toString(),"Action":/Activate/.toString())
        ...
        new actions.ActionItems.SetDevelopmentActionItemPageFields().run("Short Answer - Title":/Development Short Text - A/.toString(),"Short Answer - Answer":/Greek: Μπορώ να φάω σπασμένα γυαλιά χωρίς να πάθω τίποτα. Íslenska \/ Icelandic: Ég get etið gler án þess að meiða mig.Polish: Mogę jeść szkło, i mi nie szkodzi. 4.Romanian: Pot să mănânc sticlă și ea nu mă rănește. Ukrainian: Я можу їсти шкло, й воно мені не пошкодить. Armenian: Կրնամ ապակի ուտել և ինծի անհանգիստ չըներ։Georgian: მინას ვჭამ და არა მტკივა.Hebrew(2):ני יכול לאכול זכוכית וזה לא מזיק לי.Yiddish(2):ך קען עסן גלאָז און עס טוט מיר נישט װ.Arabic(2):أنا قادر على أكل الزجاج و هذا لا يؤلمني.Russian: Буря мглою небо кроет, Вихри снежные крутя;Special Chars and Symbols: √ ∑ π ∞ ∆ ™ © æ £ ¢ @, <, \, ‘, “, $, %, &/.toString(),"Action":/Save/.toString())
