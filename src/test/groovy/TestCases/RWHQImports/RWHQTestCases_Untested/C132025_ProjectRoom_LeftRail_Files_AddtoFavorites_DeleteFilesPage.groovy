...
class C132025_ProjectRoom_LeftRail_Files_AddtoFavorites_DeleteFilesPage
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.SetProjectRoomTitle().run("Title":/C132025/.toString(),"Action":/Submit/.toString())
        ...
        new actions.ProjectRoom.VerifyRoomPageInFavoritesTabInProjectRoom().run("Placement Number of Page":/2/.toString(),"Room Page":/Files/.toString(),"Number of Matches":/0/.toString())
        //Verify Folder Or Room Page In Project Room in Root Folder
        new actions.ProjectRoom.VerifyFolderOrRoomPageInProjectRoom().run("Placement Number of Child Page or Folder":/2/.toString(),"Parent Folder Name":/Files/.toString(),"Child Page or Folder":"","Number of Matches":/0/.toString())
    }
    //Basestate
