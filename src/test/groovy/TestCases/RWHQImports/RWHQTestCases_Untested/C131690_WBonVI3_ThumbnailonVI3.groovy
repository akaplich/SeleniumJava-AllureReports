...
//C131690 - WB on VI3 > Thumbnail on VI3
class C131690_WBonVI3_ThumbnailonVI3
{
    ...
    public void testcase(){
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/*[@class='f-whiteboard-container']\/\/IMG/.toString(),"Expected Image File":/C131690_expected.png/.toString(),"Actual Image Name":/C131690_actual.png/.toString(),"Do Not Scroll":true)
    }
    //Basestate
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131690_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
