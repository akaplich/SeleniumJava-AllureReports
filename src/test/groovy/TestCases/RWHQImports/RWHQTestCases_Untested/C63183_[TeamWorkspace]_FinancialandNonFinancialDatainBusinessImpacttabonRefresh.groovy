...
class C63183_[TeamWorkspace]_FinancialandNonFinancialDatainBusinessImpacttabonRefresh
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforTeamWorkspaceTab().run("Team Workspace":true,"Risks Tab":true,"Business Impact Tab":true)
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdea.TeamWorkspace.SetRisksinRiskiestAssumptionsinTeamWorkspace().run("Set Tab (optional)":/Riskiest Assumptions/.toString())
        //Set Business Impact Tab
