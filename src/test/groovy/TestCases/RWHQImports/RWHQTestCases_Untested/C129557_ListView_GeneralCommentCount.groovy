...
//C129557 - List View - General Comment Count
class C129557_ListView_GeneralCommentCount
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/test idea1/.toString(),"Status":/Under Review/.toString(),"Username":/Sri/.toString(),"Description":/test idea1 desc/.toString(),"Comments":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
