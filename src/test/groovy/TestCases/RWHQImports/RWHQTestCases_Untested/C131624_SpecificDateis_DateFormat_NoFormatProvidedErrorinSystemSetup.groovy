...
//C131624 - Specific Date is - Date Format, No Format Provided Error in System Setup
class C131624_SpecificDateis_DateFormat_NoFormatProvidedErrorinSystemSetup
{
    ...
    public void testcase(){
        ...
        new actions.SetupSite.SetEnterpriseSetupSiteComponentsPage().run("Enable Date Formatting":true)
        //Wait
        new actions.general.Wait().run("Seconds":/3/.toString())
        //Set Enterprise Setup Site General Settings Page
        new actions.SetupSite.SetEnterpriseSetupSiteComponentsPage().run("Date Format":/dd-mm-yy/.toString())
        ...
        new actions.Rules.SetNewRuleEventthattriggersthisrule().run("Event":/Specific Date is/.toString(),"Event Value":/${variables."date"}/.toString(),"Input Event Value":true)
        ...
        //Return Todays or Other Date in the Requested Format
        variables."date1" = new actions.Utils.ReturnTodaysDateintheRequestedFormat().run("Format":/dd-MM-yy/.toString())
