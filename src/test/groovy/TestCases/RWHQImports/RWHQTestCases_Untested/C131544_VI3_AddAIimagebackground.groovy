...
//C131544 - VI3 - Add AI image background
class C131544_VI3_AddAIimagebackground
{
    ...
    public void testcase(){
        ...
        new actions.WebstormHomepage.SetGenerateAIImage().run("Text to Search":/yosemite/.toString(),"Action to Generate Images":/Click on Generate button/.toString(),"AI Image Number to Click":/2/.toString(),"Action":/Add Image/.toString())
        //Verify Message
        ...
        new actions.ViewIdea30.VerifyAttachmentinViewIdea3Page().run("Attachment Header Count":/1/.toString(),"Attachment File":/yosemite/.toString(),"Should it have cover image icon":false,"Number of Matches":/1/.toString())
    }
    //Basestate
