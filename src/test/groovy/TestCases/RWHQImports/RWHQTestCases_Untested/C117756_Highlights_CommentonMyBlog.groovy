...
//C117756 - Highlights - Comment on My Blog
class C117756_Highlights_CommentonMyBlog
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/End User commented on the blog entry "First Blog Post"/.toString(),"Highlights Item Content":/First Comment on First Blog/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
