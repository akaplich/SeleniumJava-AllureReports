...
class C117083_EnableStepsRedwoodHQTestCaseStagesviewandMoveideatoanotherstep
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifyIdeainPipelineStepsViewforEndUsers().run("Idea Name":/test idea1/.toString(),"Step idea belongs to":/Single Scale/.toString(),"Stage idea belongs to":/Evaluation/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Pipeline Steps View for End Users
