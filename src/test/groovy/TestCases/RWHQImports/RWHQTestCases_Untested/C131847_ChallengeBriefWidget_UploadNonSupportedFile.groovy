...
//C131847 - Challenge Brief Widget > Upload Non Supported File
class C131847_ChallengeBriefWidget_UploadNonSupportedFile
{
    ...
    public void testcase(){
        ...
        //Set Redactor Toolbar Options
        new actions.common.SetRedactorToolbarOptions().run("Field":/Challenge Brief Widget/.toString(),"Toolbar Option":/File/.toString(),"Image or File to Upload":/example1.exe/.toString(),"Wait for file or image to load":false)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/File type not allowed./.toString(),"Should Exist":true)
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/example1.exe/.toString(),"Should Exist":false)
    }
    //Basestate
