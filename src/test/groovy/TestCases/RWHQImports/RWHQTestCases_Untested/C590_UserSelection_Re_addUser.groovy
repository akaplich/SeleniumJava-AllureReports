...
//C590 - User Selection - Re-add User
class C590_UserSelection_Re_addUser
{
    ...
    public void testcase(){
        ...
        new actions.People.AddUserinPeoplepage().run("Email Address":/bob@test.com/.toString(),"First Name":/Bob/.toString(),"Last Name":/Smith/.toString(),"Screen Name":/Bob Smith/.toString(),"Action":/Add User/.toString())
        //Navigate
        ...
        //Set View Idea Description Tab User Selection
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabUserSelection().run("Field Name":/User Selection Question/.toString(),"User Name":/Bob/.toString(),"Add or Remove":/Add/.toString(),"Action":/Save/.toString())
        //Set View Idea Description Tab User Selection
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabUserSelection().run("Field Name":/User Selection Question/.toString(),"User Name":/Bob Smith/.toString(),"Add or Remove":/Remove/.toString(),"Action":/Save/.toString())
        //Set View Idea Description Tab User Selection
        new actions.ViewIdeaFields.SetViewIdeaDescriptionTabUserSelection().run("Field Name":/User Selection Question/.toString(),"User Name":/Bob/.toString(),"Add or Remove":/Add/.toString(),"Action":/Save/.toString())
        //Verify Custom App Description tab fields in View Idea page
        Action5812921cfa4ee77809f46b4f("User Selection Question":/Bob Smith/.toString())
    }
    //Basestate
