...
//C118734 - Post Idea in Optimize App
class C118734_PostIdeainOptimizeApp
{
    ...
    public void testcase(){
        ...
        new actions.Webstorm.VerifyWebstormHome().run("Initiative Title":/Optimize Challenge title/.toString())
        ...
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Optimize Challenge title/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Optimize App Post Idea
        new actions.PostIdea.SetOptimizeAppPostIdea().run("Title":/Idea Title/.toString(),"Image":/Image5.jpg/.toString(),"Image Crop or Cancel":/Crop/.toString(),"Submitter":/Yourself/.toString(),"Description":/Idea Description/.toString(),"Attachments":/SamplePDF.pdf/.toString(),"Attachments Add or Remove":/Add/.toString(),"Tags":/testtag1/.toString(),"Tags Add or Remove":/Add/.toString(),"Category":/Improvement/.toString(),"Please describe the expected benefit of this improvement.":/Great Benefit/.toString(),"Action":/Submit Idea/.toString())
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/Idea Title/.toString(),"Idea Image":true,"Creator username":/System Admin/.toString(),"Category":/Improvement/.toString(),"Tag":/testtag1/.toString(),"Tag Should Exist":/TRUE/.toString(),"Description":/Idea Description/.toString(),"Linked Submissions":[])
        //Verify View Idea Description Tab Field Value
        new actions.ViewIdeaFields.VerifyViewIdeaDescriptionTabFieldValue().run("Field Name":/Please describe the expected benefit of this improvement./.toString(),"Field Value":/Great Benefit/.toString())
        //Verify Attachment in Attachments tab for View Idea page
        new actions.ViewIdea.VerifyAttachmentinAttachmentstabforViewIdeapage().run("Attachment File":/SamplePDF.pdf/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
