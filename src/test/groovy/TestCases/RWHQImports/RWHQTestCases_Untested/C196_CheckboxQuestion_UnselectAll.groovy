...
//C196 - Checkbox Question - Unselect All
class C196_CheckboxQuestion_UnselectAll
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Test Idea/.toString(),"Description":/Description/.toString(),"Category":/New Product/.toString(),"Checkbox Question Name":/Answer 1,Answer 2,Answer 3/.toString(),"Checkbox Check":/TRUE,TRUE,TRUE/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Checkbox Question Name":/Answer 1,Answer 2,Answer 3/.toString(),"Checkbox Check":/FALSE,FALSE,FALSE/.toString(),"Required Short Question":/Required Short/.toString(),"Action":/Submit Idea/.toString())
        ...
        Action5812921cfa4ee77809f46b4f("Checkbox Question":/<EMPTY>/.toString())
    }
    //Basestate
