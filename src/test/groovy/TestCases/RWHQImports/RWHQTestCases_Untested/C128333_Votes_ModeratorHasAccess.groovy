...
//C128333 -  Votes - Moderator Has Access
class C128333_Votes_ModeratorHasAccess
{
    ...
    public void testcase(){
        ...
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Votes/.toString(),"Report Name Starts with":/Votes/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Votes-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["End User","bi.enduser1@brightidea.com","Idea Vote1","D113","Promote"],"Number of Matches":/1/.toString(),"Total Number of Rows":/5/.toString())
    }
    //Basestate
