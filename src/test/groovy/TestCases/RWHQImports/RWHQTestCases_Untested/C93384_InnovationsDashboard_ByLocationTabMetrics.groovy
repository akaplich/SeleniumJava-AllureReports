...
//C93384 - Innovations Dashboard - By Location Tab Metrics
class C93384_InnovationsDashboard_ByLocationTabMetrics
{
    ...
    public void testcase(){
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("Location":/United States/.toString())
