...
//C132231 - VI3 - Development Questions - Viewing Permissions - Admins Only
class C132231_VI3_DevelopmentQuestions_ViewingPermissions_AdminsOnly
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea3Fields.VerifyViewIdea3DescriptionTabFieldValue().run("Field Name":/Development Parent Dropdown Question/.toString(),"Field Value":/No answer/.toString(),"Should Exist":/${variables."TCData.Visibility"}/.toString())
    }
    //Basestate
