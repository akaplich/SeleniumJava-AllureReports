...
//C130642 - Share Dialog as IBM - Add existing and new user as PM
class C130642_ShareDialogasIBM_AddexistingandnewuserasPM
{
    ...
    public void testcase(){
        //Basestate
        Action58123c20fa4ee77809f468f6("Licensing Model":/Standard Licensing Model/.toString(),"Unlimited Idea Box Manager License Type":/10/.toString())
        //Navigate
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC130642existinguser2/.toString(),"Finally Login as What User":/communityadmin@test.com/.toString())
        //Navigate to URL
        ...
        try{
            ...
            new actions.ShareDialog.SetManagersinShareDialog().run("Type of Manager":/Pipeline Manager/.toString(),"Field Name":/Invite Manager/.toString(),"User":/brightC130642existinguser2@mailinator.com,brightC130642newuser2@mailinator.com/.toString(),"Users Add or Remove from Input Field":/Add,Add/.toString())
        }
        ...
        //Verify Participant or Group or Managers in the Share Dialog
        new actions.ShareDialog.VerifyParticipantorGroupinParticipantsTab().run("User or Group":/Participant/.toString(),"User or GroupName":/System Admin/.toString(),"Participant Image":false,"Placement Number":/6/.toString(),"Type of User":/Pipeline Manager/.toString())
        //Verify Participant or Group or Managers in the Share Dialog
        ...
        //Verify Participant or Group or Managers in the Share Dialog
        new actions.ShareDialog.VerifyParticipantorGroupinParticipantsTab().run("User or Group":/User/.toString(),"User or GroupName":/brightC130642newuser2@mailinator.com/.toString(),"Participant Image":false,"Placement Number":/3/.toString(),"Number of Matches":/1/.toString(),"Type of User":/Pipeline Manager/.toString())
        //Verify Participant or Group or Managers in the Share Dialog
        new actions.ShareDialog.VerifyParticipantorGroupinParticipantsTab().run("User or Group":/User/.toString(),"User or GroupName":/Autofirst Autolast/.toString(),"Participant Image":false,"Placement Number":/2/.toString(),"Number of Matches":/1/.toString(),"Type of User":/Pipeline Manager/.toString())
        //Set Share Dialog
        ...
        new actions.PipelineSetup.VerifyLicenseTypeofUserinFields().run("Field":/Pipeline Managers/.toString(),"User":/Autofirst Autolast/.toString(),"License Type":/Ideabox Manager/.toString(),"Number of Matches":/0/.toString())
        //Verify License Type of User in Fields
        new actions.PipelineSetup.VerifyLicenseTypeofUserinFields().run("Field":/Pipeline Managers/.toString(),"User":/brightC130642newuser2@mailinator.com/.toString(),"License Type":/Ideabox Manager/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/brightC130642existinguser2@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        //Get Link from Invite Participant Email
        variables."link" = new actions.Mailinator.GetLinkfromInviteParticipantEmail().run("Inbox Email Count":/1/.toString(),"Email Address":/brightC130642existinguser2/.toString(),"Subject of New Administrator Added Email":/assigned as a Pipeline Manager for Ideabox/.toString())
        //Navigate to URL
        ...
        new actions.general.LogOut().run([:])
        //Get Link from Invite Participant Email
        variables."link" = new actions.Mailinator.GetLinkfromInviteParticipantEmail().run("Inbox Email Count":/2/.toString(),"Email Address":/brightC130642newuser2/.toString(),"Subject of New Administrator Added Email":/assigned as a Pipeline Manager for Ideabox/.toString())
        //Navigate to URL
