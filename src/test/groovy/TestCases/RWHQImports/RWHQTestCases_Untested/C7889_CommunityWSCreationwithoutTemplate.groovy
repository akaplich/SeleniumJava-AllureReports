...
//C7889 - Community WS Creation without Template
class C7889_CommunityWSCreationwithoutTemplate
{
    ...
    public void testcase(){
        ...
        new actions.SetupEnterpriseWebStorms.CreateWebStormfromEnterpriseSetuppage().run("WebStorm Name":/Test Webstorm1/.toString(),"Sponsor":/System Admin/.toString(),"Topic":/This is the topic for Test Webstorm1/.toString(),"Access Group":/ALL/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Enterprise Setup/.toString())
        //Go to Community
        new actions.SetupEnterpriseCommunities.GotoCommunity().run("Community Name to go to":/Newly Added Community/.toString())
