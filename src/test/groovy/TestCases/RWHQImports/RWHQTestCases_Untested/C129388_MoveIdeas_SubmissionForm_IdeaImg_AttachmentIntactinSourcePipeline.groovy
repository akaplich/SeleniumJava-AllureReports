...
class C129388_MoveIdeas_SubmissionForm_IdeaImg_AttachmentIntactinSourcePipeline
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.NewMoveIdeasinPipelineStepspage().run("Move To Pipeline":/Destination/.toString(),"Category":/Marketing & Branding/.toString(),"Status":/Under Review/.toString(),"Action":/Move Idea/.toString())
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"Idea Name":/test idea4/.toString(),"Image":true,"Status":/Submitted/.toString(),"Username":/End User/.toString(),"Description":/description4/.toString(),"Number of Matches":/1/.toString(),"Placement Number":/1/.toString())
