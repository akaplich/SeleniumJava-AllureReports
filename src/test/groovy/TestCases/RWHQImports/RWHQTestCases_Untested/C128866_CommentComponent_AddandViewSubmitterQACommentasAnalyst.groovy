...
//C128866 - Comment Component - Add and View Submitter QA Comment as Analyst
class C128866_CommentComponent_AddandViewSubmitterQACommentasAnalyst
{
    ...
    public void testcase(){
        ...
        try{
            //Add Comment in View and NGA View Idea
            new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("Comment":/test analyst submitter QA comment/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Post Comment":true)
        }
