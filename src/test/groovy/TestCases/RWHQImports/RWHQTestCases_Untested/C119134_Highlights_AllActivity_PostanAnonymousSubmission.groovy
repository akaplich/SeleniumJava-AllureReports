...
//C119134 - Highlights - All Activity - Post an Anonymous Submission
class C119134_Highlights_AllActivity_PostanAnonymousSubmission
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Anonymous Idea1/.toString(),"Submitter":/Anonymous/.toString(),"Description":/desc/.toString(),"Category":/New Product/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Navigate
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/Anonymous submitted "Anonymous Idea1"/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
