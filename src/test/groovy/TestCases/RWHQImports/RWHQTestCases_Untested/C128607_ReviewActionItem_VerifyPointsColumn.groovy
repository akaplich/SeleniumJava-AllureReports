...
//C128607 - Review Action Item - Verify Points Column
class C128607_ReviewActionItem_VerifyPointsColumn
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.SetColumnsFromActionItemViewTable().run("Column Title":/Points/.toString(),"Check":true)
        //Verify All table for Action Items page
        new actions.ActionItems.VerifyAlltableforActionItemspage().run("Title":/test idea1/.toString(),"Score":/2/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
