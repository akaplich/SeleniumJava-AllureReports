...
class C130776_TopIdeasbyCategory_ChangeCategory_ByClick_AdminCan_AnalystCanNot
{
    ...
    public void testcase(){
        ...
        //Quick Add an Idea in Pipeline Steps page
        new actions.PipelineStepsView.SetQuickAddMemoorIdea().run("Idea Name":/test idea1 New Product/.toString(),"Action":/Submit/.toString())
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/test idea3 New Product/.toString(),"Description":/desc/.toString(),"Category":/Marketing & Branding/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        ...
        new actions.PipelineTopIdeas.SelectIdeasInTopIdeas().run("Idea Title(s)":["test idea1 New Product","test idea2"])
        //Right Click on Idea in Top Ideas
        new actions.PipelineTopIdeas.RightClickOnIdeaInTopIdeas().run("Idea Title":/test idea1 New Product/.toString())
        //Verify Message
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Idea Box BIW/.toString(),"Area to Navigate to":/Top Ideas/.toString())
        //Select Idea(s) In Top Ideas
        new actions.PipelineTopIdeas.SelectIdeasInTopIdeas().run("Idea Title(s)":["test idea1 New Product","test idea3 New Product"])
        //Right Click on Idea in Top Ideas
        new actions.PipelineTopIdeas.RightClickOnIdeaInTopIdeas().run("Idea Title":/test idea1 New Product/.toString())
        ...
        try{
            ...
            new actions.PipelineTopIdeas.TopIdeaChangeCategoryViaRightClickMenu().run("Action":/Save/.toString())
        }
       catch(all){}catch(Error err){}
        //Change Category via Right Click Menu in Top Ideas
        new actions.PipelineTopIdeas.TopIdeaChangeCategoryViaRightClickMenu().run("Action":/Cancel/.toString())
        //Right Click on Idea in Top Ideas
        new actions.PipelineTopIdeas.RightClickOnIdeaInTopIdeas().run("Idea Title":/test idea1 New Product/.toString())
        //Set Right Click Menu in Top Ideas
        new actions.PipelineTopIdeas.SetRightClickMenuInTopIdeas().run("Select Option":/Change category.../.toString())
        ...
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/test idea3 New Product/.toString(),"Stack Name Memo belongs to":/New Product/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/test idea1 New Product/.toString(),"Stack Name Memo belongs to":/New Product/.toString(),"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/test idea2/.toString(),"Stack Name Memo belongs to":/Quick Add/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
