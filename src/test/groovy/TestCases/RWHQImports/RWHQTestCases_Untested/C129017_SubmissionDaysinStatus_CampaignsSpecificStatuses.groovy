...
//C129017 - Submission Days in Status - Campaigns Specific Statuses
class C129017_SubmissionDaysinStatus_CampaignsSpecificStatuses
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Submission_Days_in_Status-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["test idea2","Pending"],"Number of Matches":/2/.toString(),"Total Number of Rows":/8/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Submission_Days_in_Status/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Submission_Days_in_Status-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Customsubmitted","quick add1"],"Number of Matches":/1/.toString(),"Total Number of Rows":/8/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Submission_Days_in_Status/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Submission_Days_in_Status-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["test idea3","NewStatus"],"Number of Matches":/1/.toString(),"Total Number of Rows":/8/.toString())
    }
    //Basestate
