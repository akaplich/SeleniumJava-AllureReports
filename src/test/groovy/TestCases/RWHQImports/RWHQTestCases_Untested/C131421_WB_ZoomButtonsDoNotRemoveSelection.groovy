...
//C131421 - WB - Zoom Buttons Do Not Remove Selection
class C131421_WB_ZoomButtonsDoNotRemoveSelection
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SetRightSideControlsWhiteboard().run("Fill Color":/BBE161/.toString())
        //Set Right Side Controls in Whiteboard
        new actions.Whiteboards.SetRightSideControlsWhiteboard().run("R":/0/.toString())
        //Verify Right Side Controls in Whiteboard 
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("Fill Color":/BBE161/.toString())
    }
    //Basestate
