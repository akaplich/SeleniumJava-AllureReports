...
//C128856 - Comment Component - Add Empty Comment
class C128856_CommentComponent_AddEmptyComment
{
    ...
    public void testcase(){
        ...
        try{
            ...
            new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("Comment":/<EMPTY>/.toString(),"Post Comment":true)
        }
