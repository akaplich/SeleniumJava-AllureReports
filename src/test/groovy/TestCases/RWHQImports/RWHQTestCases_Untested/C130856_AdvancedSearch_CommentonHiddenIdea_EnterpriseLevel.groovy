...
//C130856 - Advanced Search - Comment on Hidden Idea (Enterprise Level)
class C130856_AdvancedSearch_CommentonHiddenIdea_EnterpriseLevel
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/Hidden comment automation purpose/.toString(),"Comment Type":/General Access/.toString())
        //Navigate
        ...
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/Hidden comment automation purpose/.toString(),"Type":/Comments/.toString(),"Number of Total (for Advanced Search)":/2 of 2/.toString(),"Number of Matches":/1/.toString(),"Click on result":true)
        //Verify Comment in View Idea page
        new actions.ViewIdeaComment.VerifyCommentinViewIdeapage().run("Comment Section":/Comments/.toString(),"Type of Comment":/General Access/.toString(),"Comment":/Hidden comment automation purpose/.toString(),"User":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        ...
        try{
            //Verify Quick or Advanced Search Result
            new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/Hidden comment automation purpose/.toString(),"Type":/Comments/.toString(),"Number of Total (for Advanced Search)":/2 of 2/.toString(),"Number of Matches":/1/.toString())
        }
