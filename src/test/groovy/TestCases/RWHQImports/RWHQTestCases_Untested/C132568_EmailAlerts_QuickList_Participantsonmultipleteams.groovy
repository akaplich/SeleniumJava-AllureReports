...
//C132568 - Email Alerts - Quick List - Participants on multiple teams
class C132568_EmailAlerts_QuickList_Participantsonmultipleteams
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC132568_TwoTeams/.toString(),"First Name":/brightC132568/.toString(),"Last Name":/TwoTeams/.toString(),"Screen Name":/brightC132568_TwoTeams/.toString(),"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        //Navigate
        ...
        try{
            ...
            new actions.PostIdea.SetCustomAppPostIdea().run("Title":/hack project1/.toString(),"Submitter":/Team/.toString(),"Submitter Team User":/brightC132568 TwoTeams/.toString(),"Submitter Team User Add or Remove":/Add/.toString(),"Team Submission Name":/Team2/.toString(),"Description":/Desc/.toString(),"Category":/Theme 2/.toString(),"Action":/Submit Idea/.toString())
        }
        ...
        try{
            //Set Custom and Other App Post Idea
            new actions.PostIdea.SetCustomAppPostIdea().run("Title":/hack project2/.toString(),"Submitter":/Team/.toString(),"Submitter Team User":/brightC132568 TwoTeams/.toString(),"Submitter Team User Add or Remove":/Add,Add/.toString(),"Team Submission Name":/Team1/.toString(),"Description":/Desc/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        }
       catch(all){}catch(Error err){}
        //Navigate
        ...
        new actions.PipelineSetup.CreateNewsletterinPipelineSetup().run("Create Email Alert":true,"Enter Subject":/To Many Teams/.toString(),"Add Quick List":/Participant on multiple teams/.toString(),"Email Body":/Please pick a single team./.toString(),"Action":/Send Now/.toString())
        //Verify Email by Iterating through Inbox Mailinator
        new actions.Email.VerifyEmailbyIteratingthroughInboxMailinator().run("Email Address":/brightC132568_TwoTeams/.toString(),"Subject":/To Many Teams/.toString())
    }
    //Basestate
