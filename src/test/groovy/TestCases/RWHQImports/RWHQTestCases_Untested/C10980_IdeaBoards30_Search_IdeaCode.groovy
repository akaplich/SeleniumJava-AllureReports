...
//C10980 - Idea Boards 30 - Search - Idea Code
class C10980_IdeaBoards30_Search_IdeaCode
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Search Value":/d107/.toString())
        ...
        //Search Idea in Idea Board page
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Search Value":/D107/.toString(),"Clear Search":false)
        //Verify Idea in Idea Board page TEMP
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea2/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page TEMP
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString(),"Number of Matches":/0/.toString())
        ...
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Clear Search":true)
        //Search Idea in Idea Board page
        new actions.IdeaBoard.SearchIdeainIdeaBoards30().run("Search Value":/105/.toString(),"Clear Search":false)
        //Verify Idea in Idea Board page TEMP
