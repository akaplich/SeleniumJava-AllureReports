...
//C132129 - WB - Copy as PNG from Right Click Menu
class C132129_WB_CopyasPNGfromRightClickMenu
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/WBC132129/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.SetRightClickonStickyNote().run("Right Click on Sticky Note":true,"Copy as PNG":true)
        //Click on Whiteboard Canvas
        ...
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("Crop":true)
    }
    //Basestate
