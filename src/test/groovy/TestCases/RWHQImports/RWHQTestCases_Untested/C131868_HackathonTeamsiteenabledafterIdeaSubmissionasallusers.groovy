...
//C131868 - Hackathon Team site enabled after Idea Submission as all users
class C131868_HackathonTeamsiteenabledafterIdeaSubmissionasallusers
{
    ...
    public void testcase(){
        ...
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."affiliateURL"}\/Hack\/submit/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/SA Idea1/.toString(),"Description":/desc/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/SA Idea1/.toString(),"Step Name idea belongs to":/Initial Submission/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        ...
        new actions.selenium.NavigateToURL().run("URL":/${variables."affiliateURL"}\/Hack\/submit/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/PA Idea1/.toString(),"Description":/desc/.toString(),"Category":/Theme 2/.toString(),"Action":/Submit Idea/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/PA Idea1/.toString(),"Step Name idea belongs to":/Initial Submission/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/SA Idea1/.toString(),"Step Name idea belongs to":/Initial Submission/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        ...
        new actions.selenium.NavigateToURL().run("URL":/${variables."affiliateURL"}\/Hack\/submit/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/Mod Idea1/.toString(),"Description":/desc/.toString(),"Category":/Theme 2/.toString(),"Action":/Submit Idea/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/PA Idea1/.toString(),"Step Name idea belongs to":/Initial Submission/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/SA Idea1/.toString(),"Step Name idea belongs to":/Initial Submission/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/Mod Idea1/.toString(),"Step Name idea belongs to":/Initial Submission/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.selenium.NavigateToURL().run("URL":/${variables."affiliateURL"}\/hack\/submit/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/analyst Idea1/.toString(),"Description":/desc/.toString(),"Category":/Theme 3/.toString(),"Action":/Submit Idea/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/PA Idea1/.toString(),"Step Name idea belongs to":/Initial Submission/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/SA Idea1/.toString(),"Step Name idea belongs to":/Initial Submission/.toString(),"Number of Matches":/1/.toString())
        ...
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/Mod Idea1/.toString(),"Step Name idea belongs to":/Initial Submission/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/analyst Idea1/.toString(),"Step Name idea belongs to":/Initial Submission/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.selenium.NavigateToURL().run("URL":/${variables."affiliateURL"}\/hack\/submit/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Wait for Page to Load":true,"Title":/eu Idea1/.toString(),"Description":/desc/.toString(),"Category":/Theme 3/.toString(),"Action":/Submit Idea/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/eu Idea1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/SA Idea1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/PA Idea1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/analyst Idea1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/Mod Idea1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
