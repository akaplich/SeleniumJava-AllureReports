...
//C130630 - Merge Ideas - Action Items Cancelled When Child Changes Step To Parent
class C130630_MergeIdeas_ActionItemsCancelledWhenChildChangesStepToParent
{
    ...
    public void testcase(){
        ...
        new actions.ActionItemsManager.VerifyCanceledtableforActionItemsManager().run("Canceled Tab Value":/1/.toString(),"Title":/test idea2/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
