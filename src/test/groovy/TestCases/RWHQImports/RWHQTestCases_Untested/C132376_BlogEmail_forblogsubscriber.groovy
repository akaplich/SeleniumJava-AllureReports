...
//C132376 - Blog Email - for blog subscriber
class C132376_BlogEmail_forblogsubscriber
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC132376_1/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        ...
        //Login
        new actions.general.Login().run("Email":/brightC132376_1@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Blog/.toString())
        //Verify Enterprise Blog List
        new actions.EnterpriseBlogs.VerifyEnterpriseBlogList().run("Subscribe or Unsubscribe":true)
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        variables."link" = new actions.Mailinator.GetLinkforIdeasforSubscribedIdeaEmail().run("Email Address":/brightC132376_1/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Verify Enterprise and Initiative View Blog
        new actions.EnterpriseBlogs.VerifyEnterpriseViewBlog().run("Title":/First Blog Post Edited/.toString(),"Content":/First Blog posted in custom app/.toString())
    }
    //Basestate
