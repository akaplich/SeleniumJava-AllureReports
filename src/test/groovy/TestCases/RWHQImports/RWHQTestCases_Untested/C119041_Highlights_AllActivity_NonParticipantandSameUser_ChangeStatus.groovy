...
//C119041 - Highlights - All Activity -Non Participant and Same User - Change Status
class C119041_Highlights_AllActivity_NonParticipantandSameUser_ChangeStatus
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/The Status of "test idea1" by Sri has been changed to Completed./.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
