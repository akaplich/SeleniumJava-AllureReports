...
//C119480 - Idea Edited - Send Email
class C119480_IdeaEdited_SendEmail
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC119480_2/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        ...
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Send Email/.toString(),"Send Email Recipent Group":/To System Administrator(s)/.toString(),"Send Email Enter Subject":/Test Email/.toString(),"Send Email Text":/Email sent for Idea Edited/.toString())
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/Idea Edited - Send Email/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Idea Edited - Send Email/.toString())
        //Change Rule Status
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC119480_2@mailinator.com/.toString(),"Subject":/Test Email/.toString())
    }
    //Basestate
