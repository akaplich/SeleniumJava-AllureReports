...
//C118103 - View My Idea - Update Description Field
class C118103_ViewMyIdea_UpdateDescriptionField
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.SetViewMyIdeaTextField().run("Field Name":/Description/.toString(),"Field Value":/This is for testing purpose/.toString())
        //Verify View My Idea in User Homepage
        new actions.Enterprise.UserHomepage.VerifyViewMyIdeainUserHomepage().run("Idea Title":/Brightidea must be next big thing/.toString(),"Idea Description":/This is for testing purpose/.toString())
        //Wait
