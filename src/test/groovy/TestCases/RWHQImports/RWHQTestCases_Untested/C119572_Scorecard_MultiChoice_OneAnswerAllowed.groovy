...
//C119572 - Scorecard - Multi Choice - One Answer Allowed
class C119572_Scorecard_MultiChoice_OneAnswerAllowed
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.SetQuestionScorecardTemplate().run("Added Question Order Number":/1/.toString(),"Question Type":/Multiple Choice (one answer)/.toString(),"Question":/One Answer - 1/.toString(),"Short Name":/Short Name Test/.toString(),"Tooltip":/Test Tooltip One Answer/.toString(),"Answers":/One,Two,Three/.toString(),"Points":/1,2,3/.toString(),"Action":/Save/.toString())
        //Add/Edit Question or Save Form on Scorecard Template
        new actions.PipelineSetup.AddQuestionSaveFormScorecardTemlates().run("Add Question":true)
        //Set Question in Scorecard Template
        new actions.PipelineSetup.SetQuestionScorecardTemplate().run("Added Question Order Number":/2/.toString(),"Question Type":/Multiple Choice (one answer)/.toString(),"Question":/One Answer - 2/.toString(),"Short Name":/Short Name Test/.toString(),"Tooltip":/Test Tooltip One Answer/.toString(),"Answers":/Four,Five,Six/.toString(),"Points":/1,2,3/.toString(),"Action":/Save/.toString())
        //Add/Edit Question or Save Form on Scorecard Template
        new actions.PipelineSetup.AddQuestionSaveFormScorecardTemlates().run("Add Question":true)
        //Set Question in Scorecard Template
        new actions.PipelineSetup.SetQuestionScorecardTemplate().run("Added Question Order Number":/3/.toString(),"Question Type":/Multiple Choice (one answer)/.toString(),"Question":/One Answer - 3/.toString(),"Short Name":/Short Name Test/.toString(),"Tooltip":/Test Tooltip One Answer/.toString(),"Answers":/Seven,Eight,Nine/.toString(),"Points":/1,2,3/.toString(),"Action":/Save/.toString())
        //Add/Edit Question or Save Form on Scorecard Template
        ...
        new actions.ActionItems.SetEvaluationScorecardIdeaActionItemspage().run("Multi Choice One Answer - Question":/One Answer - 1/.toString(),"Multi Choice One - Answer(s)":/One/.toString(),"Submit Scorecard":false)
        //Set Evaluation Scorecard for Idea in Action Items page
        new actions.ActionItems.SetEvaluationScorecardIdeaActionItemspage().run("Multi Choice One Answer - Question":/One Answer - 2/.toString(),"Multi Choice One - Answer(s)":/Four,Five,Six/.toString(),"Submit Scorecard":false)
        //Set Evaluation Scorecard for Idea in Action Items page
        new actions.ActionItems.SetEvaluationScorecardIdeaActionItemspage().run("Multi Choice One Answer - Question":/One Answer - 3/.toString(),"Multi Choice One - Answer(s)":/Seven,Seven,Seven/.toString(),"Submit Scorecard":true)
        //Access Action Item in Actions Items React Global Navigation
        ...
        new actions.ActionItems.VerifyScorecardAnswers().run("Multi Choice One Answer - Question":/One Answer - 1/.toString(),"Multi Choice One - Answer(s)":/One/.toString())
        //Verify Scorecard Answers
        new actions.ActionItems.VerifyScorecardAnswers().run("Multi Choice One Answer - Question":/One Answer - 2/.toString(),"Multi Choice One - Answer(s)":/Six/.toString())
        //Verify Scorecard Answers
        new actions.ActionItems.VerifyScorecardAnswers().run("Multi Choice One Answer - Question":/One Answer - 3/.toString(),"Multi Choice One - Answer(s)":/Seven/.toString())
        //Wait
