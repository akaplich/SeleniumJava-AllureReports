...
class C117096_Publicwebstorm_HiddenideashouldnotbedisplayedonEndUserStepsView
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Hidden Idea/.toString(),"Description":/Hidden Idea Description/.toString(),"Category":/New Product/.toString(),"Required Short Question":/required short/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
