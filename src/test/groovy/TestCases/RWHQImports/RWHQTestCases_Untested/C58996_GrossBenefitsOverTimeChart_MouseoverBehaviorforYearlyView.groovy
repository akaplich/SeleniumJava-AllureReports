...
//C58996 - Gross Benefits Over Time Chart - Mouseover Behavior for Yearly View
class C58996_GrossBenefitsOverTimeChart_MouseoverBehaviorforYearlyView
{
    ...
    public void testcase(){
        ...
        new actions.PipelineDashBoard.VerifyMouseHoveronBusinessImpactTabinPipelineDashBoard().run("Chart View":/Yearly/.toString(),"Year":/2017,2018/.toString(),"Projected":/$25,000;$48,000/.toString(),"Actual":/$29,000;$30,000/.toString())
    }
    //Basestate
