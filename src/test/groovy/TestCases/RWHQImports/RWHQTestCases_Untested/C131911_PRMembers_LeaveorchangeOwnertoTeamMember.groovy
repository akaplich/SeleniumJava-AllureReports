...
//C131911 - PR Members > Leave or change Owner to Team Member
class C131911_PRMembers_LeaveorchangeOwnertoTeamMember
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.EditorRemoveTeamMemberinProjectRoom().run("Member(s)":/System Admin/.toString(),"Option(s)":/leave/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/The project room needs to have at least one owner associated within the room. Please assign another owner, prior to removing yourself./.toString(),"Should Exist":true)
        //Edit or Remove Team Member in Project Room
        ...
        new actions.ProjectRoom.VerifyProjectRoomMemberinMembersTab().run("Member Name":/System Admin/.toString(),"Member Display Picture":false,"Type of Member":/owner/.toString(),"Number of Matches":/1/.toString())
        //Edit or Remove Team Member in Project Room
        new actions.ProjectRoom.EditorRemoveTeamMemberinProjectRoom().run("Member(s)":/System Admin/.toString(),"Option(s)":/team member/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/The project room needs to have at least one owner associated within the room. Please assign another owner, prior to removing yourself./.toString(),"Should Exist":true)
        //Edit or Remove Team Member in Project Room
        new actions.ProjectRoom.EditorRemoveTeamMemberinProjectRoom().run("Remove Action":/Remove user/.toString())
