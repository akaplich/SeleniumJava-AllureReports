...
//C39817 - Pipeline Creation - Recognize App
class C39817_PipelineCreation_RecognizeApp
{
    ...
    public void testcase(){
        ...
        new actions.Webstorm.VerifyWebstormHome().run("Webstorm Title":/Recognize title/.toString())
    }
    //Basestate
