...
//C128235 - Comment Component - View Hidden reply Comment
class C128235_CommentComponent_ViewHiddenreplyComment
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("View Idea or NGA":/View Idea/.toString(),"Comment":/test general comment/.toString(),"Comment Type":/General Access/.toString(),"Post Comment":true)
        //Reply to Comment in View and NGA View Idea
        new actions.ViewIdeaComment.ReplytoCommentinViewandNGAViewIdea().run("Parent Comment":/test general comment/.toString(),"Comment Reply":/test reply to hidden comment/.toString(),"Post Reply":true)
        //Set Comment Edit Menu
        new actions.ViewIdeaComment.SetCommentEditMenu().run("Comment to Edit":/test reply to hidden comment/.toString(),"Menu Option":/Hide/.toString())
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("View Idea or NGA":/View Idea/.toString(),"Comment section":/Parent Comment/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/test general comment/.toString(),"User":/System Admin/.toString(),"User Image":false,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("View Idea or NGA":/View Idea/.toString(),"Comment section":/Reply/.toString(),"Comment Type":/Hidden/.toString(),"Parent Comment":/test general comment/.toString(),"Reply Comment":/test reply to hidden comment/.toString(),"User":/System Admin/.toString(),"User Image":false,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Log Out
