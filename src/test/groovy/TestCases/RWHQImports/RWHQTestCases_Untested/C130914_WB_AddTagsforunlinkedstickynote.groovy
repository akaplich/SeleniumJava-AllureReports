...
//C130914 - WB - Add Tags for unlinked sticky note
class C130914_WB_AddTagsforunlinkedstickynote
{
    ...
    public void testcase(){
        ...
        //Whiteboard - Set Right Click on Object
        new actions.Whiteboards.SetRightClickonStickyNote().run("Right Click on Sticky Note":true)
        //Verify Right Click Option For Sticky Note Is Enabled
        new actions.Whiteboards.VerifyRightClickOptionForStickyNoteIsEnabled().run("Menu Option":/Add tags.../.toString(),"Is Enabled":false)
    }
    //Basestate
