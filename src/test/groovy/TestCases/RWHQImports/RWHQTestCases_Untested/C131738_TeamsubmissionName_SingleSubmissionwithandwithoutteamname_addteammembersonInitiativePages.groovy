...
//C131738 - Team submission Name - Single Submission with and without team name,add team members on Initiative Pages
class C131738_TeamsubmissionName_SingleSubmissionwithandwithoutteamname_addteammembersonInitiativePages
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/WITH TEAM NAME/.toString(),"Description":/Idea Description/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack Event title/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/WITHOUT TEAM NAME/.toString(),"Submitter":/Yourself/.toString(),"Description":/Idea Description/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        ...
        new actions.ViewIdea30.SetSubmitterinViewIdea3().run("Submission Team Name":/team name1/.toString(),"User":/End User/.toString(),"User Name on the List":/End User/.toString(),"Add or Remove or Set Owner":/Add/.toString(),"Action":/Update/.toString())
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"View Type":/Gallery/.toString(),"Idea Name":/WITH TEAM NAME/.toString(),"Username":/team name1/.toString(),"Description":/Idea Description/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"View Type":/Gallery/.toString(),"Idea Name":/WITHOUT TEAM NAME/.toString(),"Username":/Team - System Admin/.toString(),"Description":/Idea Description/.toString(),"Number of Matches":/1/.toString())
        //Set Tab/View on Idea Board
        new actions.IdeaBoard.NavigatetoIdeaBoardsView().run("View":/List/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"View Type":/List/.toString(),"Idea Name":/WITH TEAM NAME/.toString(),"Username":/team name1/.toString(),"Description":/Idea Description/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Tab":/Recent/.toString(),"View Type":/List/.toString(),"Idea Name":/WITHOUT TEAM NAME/.toString(),"Username":/Team - System Admin/.toString(),"Description":/Idea Description/.toString(),"Number of Matches":/1/.toString())
        //Set Tab/View on Idea Board
