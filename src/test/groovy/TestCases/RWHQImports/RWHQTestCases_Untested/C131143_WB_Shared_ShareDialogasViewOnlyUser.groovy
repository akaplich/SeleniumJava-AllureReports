...
//C131143 - WB - Shared - Share Dialog as View Only User
class C131143_WB_Shared_ShareDialogasViewOnlyUser
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SetShareWhiteboard().run("Click Share Button":true,"User(s)":/End User,Moderator/.toString(),"User Add or Remove":/Add,Add/.toString(),"Send Invite":true,"Anyone with link...":/can view/.toString(),"Action":/Close/.toString())
        ...
        try{
            //Whiteboard - Set Share
            new actions.Whiteboards.SetShareWhiteboard().run("User(s)":/Evaluator/.toString(),"User Add or Remove":/Add/.toString(),"Action":/Close/.toString())
        }
        ...
        try{
            //Whiteboard - Set Share
            new actions.Whiteboards.SetShareWhiteboard().run("Click Share Button":true,"User to Remove":/Moderator/.toString(),"Action":/Close/.toString())
        }
       catch(all){}catch(Error err){}
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/Escape/.toString())
        ...
        new actions.Whiteboards.SetSearchWhiteboardOnUserhomepage().run("Search Field":/TestLink/.toString())
        //Verify Whiteboard Card in Userhomepage
        new actions.Whiteboards.VerifyWhiteboard().run("Whiteboard Name":/TestLink/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Close All Browsers
        new actions.selenium.CloseBrowser().run([:])
        ...
        new actions.Whiteboards.SetSearchWhiteboardOnUserhomepage().run("Search Field":/TestLink/.toString())
        //Verify Whiteboard Card in Userhomepage
        new actions.Whiteboards.VerifyWhiteboard().run("Whiteboard Name":/TestLink/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
