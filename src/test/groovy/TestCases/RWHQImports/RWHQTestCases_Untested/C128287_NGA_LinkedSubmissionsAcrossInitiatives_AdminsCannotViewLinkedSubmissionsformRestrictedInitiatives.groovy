...
//C128287 -  NGA - Linked Submissions Across Initiatives - Admins Cannot View Linked Submissions form Restricted Initiatives
class C128287_NGA_LinkedSubmissionsAcrossInitiatives_AdminsCannotViewLinkedSubmissionsformRestrictedInitiatives
{
    ...
    public void testcase(){
        ...
        new actions.WebstormCreation.CreateCustomWebstorm().run("Webstorm Title":/Custom App Test/.toString(),"Description":/About/.toString(),"General Access":/ALL,End User/.toString(),"General Access Add or Remove":/Remove,Add/.toString(),"Action":/Create/.toString())
        //Log Out
