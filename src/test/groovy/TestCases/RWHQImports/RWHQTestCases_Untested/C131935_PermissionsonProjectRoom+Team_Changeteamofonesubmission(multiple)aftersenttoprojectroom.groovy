...
class C131935_PermissionsonProjectRoom+Team_Changeteamofonesubmission(multiple)aftersenttoprojectroom
{
    ...
    public void testcase(){
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/eu test idea2/.toString())
        //Set Action Menu in View Idea 3.0 Page
        new actions.ViewIdea30.SetCopyLinkOnViewIdea30Page().run("Menu Option Name":/Send to Project Room/.toString(),"Click the Option":true)
        //Send to Project Room
        new actions.PipelineStepsView.SendToProjectRoom().run("From the Actions Menu":false,"Existing or New":/Existing Project Room/.toString(),"Title":/Existing PR1/.toString(),"Action":/Submit/.toString(),"Wait":true)
        ...
        new actions.ViewIdea30.SetSubmitterinViewIdea3().run("User":/End User,analyst/.toString(),"User Name on the List":/End User,analyst/.toString(),"Add or Remove or Set Owner":/Add,Add/.toString(),"Action":/Update/.toString())
        //Access or Close Idea from View Idea 3 Modal
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Close Idea Modal":true)
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/eu test idea2/.toString())
        //Set Submitter in View Idea 3 Using Submitter Modal
        new actions.ViewIdea30.SetSubmitterinViewIdea3().run("User":/Pipeline Admin,analyst/.toString(),"User Name on the List":/Pipeline Admin,analyst/.toString(),"Add or Remove or Set Owner":/Add,Add/.toString(),"Action":/Update/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Navigate Tab User Homepage or MTS
        new actions.Enterprise.UserHomepage.NavigateTabUserHomepage().run("Tab":/Project Room/.toString())
