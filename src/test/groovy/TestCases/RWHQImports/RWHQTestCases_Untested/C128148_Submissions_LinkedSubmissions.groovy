...
//C128148 - Submissions - Linked Submissions
class C128148_Submissions_LinkedSubmissions
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Submissions-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Initiative","Linked Submissions"],"Number of Matches":/1/.toString(),"Total Number of Rows":/9/.toString())
        //Download Generated Report From Enterprise and Community Exports
        new actions.SetupEnterpriseExports.DownloadGeneratedReportEnterpriseExports().run("Section":/Submissions/.toString(),"Report Name Starts with":/Submissions/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Submissions-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["D113","test idea3","Yes","test idea4 (D114)"],"Number of Matches":/1/.toString(),"Total Number of Rows":/9/.toString())
        //Download Generated Report From Enterprise and Community Exports
        new actions.SetupEnterpriseExports.DownloadGeneratedReportEnterpriseExports().run("Section":/Submissions/.toString(),"Report Name Starts with":/Submissions/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Submissions-*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["D114","test idea4","Yes","test idea3 (D113)"],"Number of Matches":/1/.toString(),"Total Number of Rows":/9/.toString())
    }
    //Basestate
