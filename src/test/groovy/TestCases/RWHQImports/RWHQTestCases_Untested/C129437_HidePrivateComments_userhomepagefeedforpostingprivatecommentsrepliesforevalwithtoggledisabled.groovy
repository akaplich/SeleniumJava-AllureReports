...
//C129437 - Hide Private Comments - userhomepage feed for posting private comments replies for eval with toggle disabled
class C129437_HidePrivateComments_userhomepagefeedforpostingprivatecommentsrepliesforevalwithtoggledisabled
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString())
        //Add Comment in View and NGA View Idea
        new actions.ViewIdeaComment.AddCommentinViewandNGAViewIdea().run("Comment":/test eval private comment/.toString(),"Comment Type":/Private/.toString(),"Post Comment":true)
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString())
        //Reply to Comment in View and NGA View Idea
        new actions.ViewIdeaComment.ReplytoCommentinViewandNGAViewIdea().run("Parent Comment":/test eval private comment/.toString(),"Comment Reply":/test reply to eval private comment/.toString(),"Post Reply":true)
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/evaluator@test.com/.toString(),"Password":/brightidea1/.toString())
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin commented on "test idea1"/.toString(),"Highlights Item Content":/test reply to eval private comment/.toString(),"Number of Matches":/1/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin commented on "test idea1"/.toString(),"Highlights Item Content":/test reply to private comment/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
