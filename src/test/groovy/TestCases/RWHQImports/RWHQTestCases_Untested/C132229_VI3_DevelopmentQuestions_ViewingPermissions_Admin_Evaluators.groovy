...
//C132229 - VI3 - Development Questions - Viewing Permissions - Admin, Evaluators
class C132229_VI3_DevelopmentQuestions_ViewingPermissions_Admin_Evaluators
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforSubmissionFormTab().run("Additional Question Name":/Development Parent Dropdown Question/.toString(),"Additional Question Type":/Dropdown/.toString(),"Development Field":true,"Viewing Permissions":/admin_evals/.toString(),"Save Form":true)
        ...
        new actions.PipelineStepsConfigure.ConfigureDevelopmentinNewModalinPipelineStepspage().run("Assignment Method":/Individual Assignment/.toString(),"Development Lead":/Me/.toString(),"Development Team":/Evaluator/.toString(),"Development Team Add or Remove":/Add/.toString(),"Development Field":/Development Parent Dropdown Question/.toString(),"Development Field Included or Required":/Included/.toString(),"Action":/Activate/.toString())
        //Navigate
        ...
        new actions.ViewIdea3Fields.VerifyViewIdea3DescriptionTabFieldValue().run("Field Name":/Development Parent Dropdown Question/.toString(),"Field Value":/No answer/.toString(),"Should Exist":/${variables."TCData.UserNotVisible"}/.toString())
    }
    //Basestate
