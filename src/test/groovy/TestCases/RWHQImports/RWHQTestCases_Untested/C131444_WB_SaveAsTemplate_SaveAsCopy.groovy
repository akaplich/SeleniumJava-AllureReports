...
//C131444 - WB - Save As Template - Save As Copy
class C131444_WB_SaveAsTemplate_SaveAsCopy
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.WhiteboardSetSaveAsTemplate().run("Template Name":/test template C131444/.toString(),"Action":/Save Template/.toString())
        //Wait
