...
//C128160 - Pipeline List View - Export - Submission Team
class C128160_PipelineListView_Export_SubmissionTeam
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Custom_App-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Submitter","Submission Team"],"Number of Matches":/1/.toString(),"Total Number of Rows":/8/.toString())
        //Export Ideas from Pipeline List View
        new actions.PipelineList.ExportIdeasfromPipelineListView().run([:])
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Custom_App-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["System Admin","End User 2"],"Number of Matches":/1/.toString(),"Total Number of Rows":/8/.toString())
    }
    //Basestate
