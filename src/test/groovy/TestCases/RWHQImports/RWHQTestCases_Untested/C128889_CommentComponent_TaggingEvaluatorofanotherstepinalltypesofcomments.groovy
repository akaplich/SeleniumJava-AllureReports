...
//C128889 - Comment Component - Tagging Evaluator of another step in all types of comments
class C128889_CommentComponent_TaggingEvaluatorofanotherstepinalltypesofcomments
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureSingleScaleStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Single Scale/.toString(),"Individual Assignment User":/Automation/.toString(),"Individual Assignment User Add or Remove":/Add/.toString(),"Action":/Update/.toString())
        //Navigate WebStorm or MTS
