...
//C131414 - MTS homepage > Memo Tab > Advanced create External and Internal FAQs Onedrive document
class C131414_MTShomepage_MemoTab_AdvancedcreateExternalandInternalFAQsOnedrivedocument
{
    ...
    public void testcase(){
        ...
        new actions.MTS.SetAdvancedCreateMemo().run("Select an editor to draft your Memo within":/OneDrive/.toString(),"Action on Select an editor to draft your Memo within slide":/Next/.toString(),"Select visibility for your memo":/Private Memo/.toString(),"Action on Select visibility for your memo slide":/Done/.toString())
        ...
        try{
            //Compare Images
            new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/DIV[contains(@class,'f-memo-thumbnail-body')]/.toString(),"Expected Image File":/C131414_expected.png/.toString(),"Actual Image Name":/C131414_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        //Verify Memo Card in Userhomepage
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/Memo - Untitled/.toString(),"Memo Icon Type":/Onedrive/.toString(),"User Name":/System Admin/.toString(),"Status":/Private/.toString(),"Thumbnail Image Displayed":true,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/https:\/\/brightidea-my.sharepoint.com\/personal\/bi_adminuser1_brightidea_com\/_layouts\/15\/onedrive.aspx?view=0/.toString())
        try{
            //Set Delete the 3rd Party documents
            new actions.Utils.DeleteTheGoogleDocument().run("OneDrive document title":/Memo - Untitled.docx/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131414_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
