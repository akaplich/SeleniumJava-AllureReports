...
//C70 - Submission Form User Selection Question
class C70_SubmissionFormUserSelectionQuestion
{
    ...
    public void testcase(){
        ...
        new actions.People.AddUserinPeoplepage().run("Email Address":/test@test.com/.toString(),"First Name":/Jane/.toString(),"Last Name":/Smith/.toString(),"Screen Name":/Jennifer/.toString(),"Action":/Add User/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Home/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Idea Title/.toString(),"Description":/Idea Description/.toString(),"Category":/New Product/.toString(),"User Selection Question Name":/Jane/.toString(),"User Selection Question Add or Remove":/Add/.toString(),"Required Short Question":/required short/.toString(),"Action":/Submit Idea/.toString())
        ...
        Action5812921cfa4ee77809f46b4f("User Selection Question":/Jane Smith/.toString())
    }
    //Basestate
