...
//C130631 - Merge Ideas - Merge Into Existing Parent From List view
class C130631_MergeIdeas_MergeIntoExistingParentFromListview
{
    ...
    public void testcase(){
        ...
        //Select Ideas in Pipeline List View
        new actions.PipelineList.SelectIdeasPipelineListView().run("Idea Title(s)":/parent test idea3,test idea2/.toString())
        //Set Merge Ideas in Pipeline Steps & List
