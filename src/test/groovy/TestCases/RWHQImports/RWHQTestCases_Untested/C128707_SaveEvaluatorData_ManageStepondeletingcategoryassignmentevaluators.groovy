...
//C128707 - Save Evaluator Data - Manage Step on deleting category assignment evaluators
class C128707_SaveEvaluatorData_ManageStepondeletingcategoryassignmentevaluators
{
    ...
    public void testcase(){
        ...
        //Verify Action Items in Progress in Manage Step Page
        new actions.PipelineManageSteps.VerifyActionItemsinProgressinManageStep().run("Row Number":/1/.toString(),"Evaluator":/Evaluator/.toString(),"Number of assigned items":/2/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
