...
//C117101 - Scorecard - End Users can see Evaluations Tab when visibility is set to All Roles
class C117101_Scorecard_EndUserscanseeEvaluationsTabwhenvisibilityissettoAllRoles
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.VerifyEvaluationstabRibboninVewIdeapage().run("Overall Score":/69.6/.toString(),"Total Evaluation":/1/.toString(),"Completed Evaluation":/1/.toString())
    }
    //Basestate
