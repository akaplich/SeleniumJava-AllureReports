...
//C128761 - Comment Component - Deleting the Parent Comment
class C128761_CommentComponent_DeletingtheParentComment
{
    ...
    public void testcase(){
        ...
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Reply/.toString(),"Parent Comment":/This message was deleted./.toString(),"Reply Comment":/test idea2 general comment1 reply1/.toString(),"User":/System Admin/.toString(),"Placement Number":/1/.toString())
    }
    //Basestate
