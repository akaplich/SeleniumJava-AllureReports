...
//C132573 - Scheduler V3 > Winners Widget showing Ideas
class C132573_SchedulerV3_WinnersWidgetshowingIdeas
{
    ...
    public void testcase(){
        ...
        //Set Date and Time in Scheduler in Site Setup (V2 & V3)
        new actions.SetupScheduler.SetupSchedulerV2.SetDateandTimeinSchedulerinSiteSetup().run("Start Date":/${variables."newStart"}/.toString(),"Action":/Save Schedule/.toString())
        //Navigate WebStorm or MTS
        ...
        //Set Widget
        new actions.Widgets.SetWidget().run("Name of Widget to Modify":/Winners/.toString(),"New Title name":/Finalist for Hack/.toString())
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/No winners selected/.toString(),"Should Exist":false)
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Winners Widget Name":/Finalist for Hack/.toString(),"Idea Name":/Finalist Idea1/.toString(),"Status":/Finalist/.toString(),"Username":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Winners Widget Name":/Finalist for Hack/.toString(),"Idea Name":/Finalist Idea2/.toString(),"Status":/Finalist/.toString(),"Username":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Winners Widget Name":/Finalist for Hack/.toString(),"Idea Name":/Selected as Winner Idea1/.toString(),"Status":/Selected as Winner/.toString(),"Username":/System Admin/.toString(),"Number of Matches":/0/.toString())
        //Set Widget Controller
        new actions.Widgets.SetWidgetController().run("Add Widget from Selection":/Winner's widget/.toString())
        //Set Widget
        new actions.Widgets.SetWidget().run("Name of Widget to Modify":/Winners/.toString(),"Edit the Widget":true)
        //Set Winners Widget
        ...
        new actions.Widgets.SetWidget().run("Name of Widget to Modify":/Winners/.toString(),"Save":true)
        //Set Widget
        new actions.Widgets.SetWidget().run("Name of Widget to Modify":/Winners/.toString(),"New Title name":/Selected as Winner for Hack/.toString())
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/No winners selected/.toString(),"Should Exist":false)
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Winners Widget Name":/Finalist for Hack/.toString(),"Idea Name":/Selected as Winner Idea1/.toString(),"Status":/Selected as Winner/.toString(),"Username":/System Admin/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Winners Widget Name":/Selected as Winner for Hack/.toString(),"Idea Name":/Finalist Idea1/.toString(),"Status":/Finalist/.toString(),"Username":/System Admin/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Winners Widget Name":/Selected as Winner for Hack/.toString(),"Idea Name":/Finalist Idea2/.toString(),"Status":/Finalist/.toString(),"Username":/System Admin/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Winners Widget Name":/Selected as Winner for Hack/.toString(),"Idea Name":/Selected as Winner Idea1/.toString(),"Status":/Selected as Winner/.toString(),"Username":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Winners Widget Name":/Selected as Winner for Hack/.toString(),"Idea Name":/Hackathon Approved Idea1/.toString(),"Status":/Hackathon Approved/.toString(),"Username":/System Admin/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
