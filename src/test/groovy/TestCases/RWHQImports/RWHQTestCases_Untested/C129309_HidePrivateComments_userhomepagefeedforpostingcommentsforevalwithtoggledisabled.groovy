...
//C129309 - Hide Private Comments - userhomepage feed for posting comments for eval with toggle disabled
class C129309_HidePrivateComments_userhomepagefeedforpostingcommentsforevalwithtoggledisabled
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin commented on "test idea1"/.toString(),"Highlights Item Content":/test general comment/.toString(),"Number of Matches":/1/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin commented on "test idea1"/.toString(),"Highlights Item Content":/test submitter comment/.toString(),"Number of Matches":/1/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin commented on "test idea1"/.toString(),"Highlights Item Content":/test pinned comment/.toString(),"Number of Matches":/1/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/System Admin commented on "test idea1"/.toString(),"Highlights Item Content":/test private comment/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
