...
//C131471 - Memo - Share - Anyone With Link Can Edit
class C131471_Memo_Share_AnyoneWithLinkCanEdit
{
    ...
    public void testcase(){
        ...
        new actions.Memo.ColabEditorSetMemoTitle().run("New Title":/C131471/.toString(),"Action":/Submit/.toString())
