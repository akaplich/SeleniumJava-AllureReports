...
//C10963 - Tag Followers - Remove Report
class C10963_TagFollowers_RemoveReport
{
    ...
    public void testcase(){
        ...
        //Verify Generated Report in any Setup Exports
        new actions.SetupExports.VerifyGeneratedReportinSetupExports().run("Report Name Starts with":/Tag_followers/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
