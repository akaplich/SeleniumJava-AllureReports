...
//C131012 - Word Limit - Add Word Limit for Submission Form Fields
class C131012_WordLimit_AddWordLimitforSubmissionFormFields
{
    ...
    public void testcase(){
        ...
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/SPAN[@id='word-limiter-region']\/DIV[contains(.,'0\/5 Words')]/.toString(),"Should Element Exist":true,"Number of Matches":/1/.toString())
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/DIV[@id='word-limiter-region']\/DIV[contains(.,'0\/11 Words')]/.toString(),"Should Element Exist":true,"Number of Matches":/1/.toString())
    }
    //Basestate
