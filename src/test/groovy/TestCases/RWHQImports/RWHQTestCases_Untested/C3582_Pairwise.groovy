...
class C3582_Pairwise
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.SetPairwiseforIdeainActionItemspage().run("Select Idea Name or Neither":/pairwise idea1/.toString(),"Action":/Complete/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/Action Items/.toString())
        //Verify Completed table for Action Items page
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Completed Tab Value":/1/.toString(),"Title":/Pairwise/.toString(),"Number of Matches":/1/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Open Tab Value":/3/.toString(),"Title":/Pairwise/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
