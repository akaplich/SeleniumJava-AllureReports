...
//C117092 - Submission Hover
class C117092_SubmissionHover
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifythesubmissionhoveronPipelineStepsViewforEndUsers().run("Idea Title":/test idea1/.toString(),"Idea Submitter":/Sri/.toString(),"Submitter Image":true,"Idea Status":/Under Review/.toString(),"Idea Category":/New Product/.toString(),"Idea Description":/test idea1 desc/.toString(),"Votes":/1/.toString(),"Comments":/1/.toString(),"Favorite":false,"Number of Matches":/1/.toString())
    }
    //Basestate
