...
//C117678 - Highlights - Post Comment - User I Stopped Following
class C117678_Highlights_PostComment_UserIStoppedFollowing
{
    ...
    public void testcase(){
        ...
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Verify Highlights Item on User Homepage
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/End User commented on "test idea1"/.toString(),"Highlights Item Content":/End User test comment/.toString(),"Number of Matches":/0/.toString(),"Total Number of Items":/0/.toString())
    }
    //Basestate
