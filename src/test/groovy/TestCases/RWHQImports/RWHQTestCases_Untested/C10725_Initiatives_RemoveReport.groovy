...
//C10725 - Initiatives - Remove Report
class C10725_Initiatives_RemoveReport
{
    ...
    public void testcase(){
        ...
        new actions.SetupExports.VerifyGeneratedReportinSetupExports().run("Report Name Starts with":/All_initiatives/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
