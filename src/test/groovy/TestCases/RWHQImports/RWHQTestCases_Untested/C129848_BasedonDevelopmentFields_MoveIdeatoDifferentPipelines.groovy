...
//C129848 - Based on Development Fields - Move Idea to Different Pipelines
class C129848_BasedonDevelopmentFields_MoveIdeatoDifferentPipelines
{
    ...
    public void testcase(){
        ...
        new actions.Rules.ConfigureNewRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Pipeline A/.toString(),"Category":/Marketing & Branding/.toString(),"Status":/Completed/.toString(),"Append extra submission questions to description":true,"Action":/Save/.toString())
        //Set Rule window
        ...
        new actions.Rules.SetNewRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Move Idea to Pipeline/.toString(),"Configure Action (Move or Copy to Pipeline Only)":true)
        //Configure Rule Action Move Idea to Pipeline
        new actions.Rules.ConfigureNewRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Pipeline B/.toString(),"Category":/Marketing & Branding/.toString(),"Status":/Completed/.toString(),"Append extra submission questions to description":true,"Action":/Save/.toString())
        //Set Rule window
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea A/.toString(),"Description":/descA/.toString(),"Attachments File":/Image5.jpg/.toString(),"Attachment Add or Remove":/Add/.toString(),"Category":/Strategy/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea A/.toString(),"Status":/Completed/.toString())
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/test idea A/.toString(),"Creator username":/System Admin/.toString(),"Category":/Marketing & Branding/.toString(),"Status":/Completed/.toString(),"Description":/descA Extra Questions Required Short Question short/.toString(),"Linked Submissions":[])
        ...
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea B/.toString(),"Status":/Completed/.toString())
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/test idea B/.toString(),"Creator username":/System Admin/.toString(),"Category":/Marketing & Branding/.toString(),"Status":/Completed/.toString(),"Description":/descB Extra Questions Required Short Question short/.toString(),"Linked Submissions":[])
        //Verify Attachment in Attachments tab for View Idea page
        new actions.ViewIdea.VerifyAttachmentinAttachmentstabforViewIdeapage().run("Attachment File":/Image5.jpg/.toString(),"Private Attachment":false,"Number of Matches":/1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea A/.toString(),"Number of Matches":/0/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/test idea B/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
