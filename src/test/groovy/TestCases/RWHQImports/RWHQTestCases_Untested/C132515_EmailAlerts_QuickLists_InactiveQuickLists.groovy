...
//C132515 - Email Alerts - Quick Lists - Inactive Quick Lists
class C132515_EmailAlerts_QuickLists_InactiveQuickLists
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.CreateNewsletterinPipelineSetup().run("Select Tab":/Email Alerts/.toString(),"Create Email Alert":true,"Add Quick List":/All users with access/.toString())
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/*[@id='fractal-membertypeahead-input']/.toString(),"Expected Image File":/C132515_1_expected.png/.toString(),"Actual Image Name":/C132515_1_actual.png/.toString(),"Allowed Number of Different Pixels":/200/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C132515_1_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C132515_2_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
    }
}