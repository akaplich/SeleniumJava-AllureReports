...
//C131657 - Apply - Apply Button Becomes Applicants for Submitters
class C131657_Apply_ApplyButtonBecomesApplicantsforSubmitters
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test/.toString(),"Description":/test/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/team hack project/.toString(),"Submitter":/Team/.toString(),"Submitter Team User":/End User 2/.toString(),"Submitter Team User Add or Remove":/Add/.toString(),"Description":/test/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/team hack project/.toString())
        //Verify Element
        ...
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/BUTTON[contains(@class,'f-gig-applicants-view')]/.toString(),"Should Element Exist":true,"Number of Matches":/1/.toString())
        //Access or Close Idea from View Idea 3 Modal
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Access Idea":/team hack project/.toString())
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/*[@id='f-gig-app-btn-trigger-modal']/.toString(),"Should Element Exist":false,"Number of Matches":/0/.toString())
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/BUTTON[contains(@class,'f-gig-applicants-view')]/.toString(),"Should Element Exist":true,"Number of Matches":/1/.toString())
