...
//C137 - Long Answer Question - Max Image Size
class C137_LongAnswerQuestion_MaxImageSize
{
    ...
    public void testcase(){
        ...
        new actions.SetupBI.SetSiteSetupforBIBetatab().run("Attachment Max Upload Filesize":/5/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Post Idea Insert Image for Text Field
        new actions.SetIdeaFields.SetPostIdeaInsertImageforTextField().run("Field Name":/Long Answer Question/.toString(),"Image File":/image8.jpg/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/Long Answer Max Image/.toString(),"Description":/Description/.toString(),"Category":/New Product/.toString(),"Required Short Question":/Required Short/.toString(),"Action":/Submit Idea/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/Long Answer Max Image/.toString())
