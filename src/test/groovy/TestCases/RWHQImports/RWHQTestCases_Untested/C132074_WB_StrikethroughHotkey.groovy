...
//C132074 - WB - Strikethrough Hotkey
class C132074_WB_StrikethroughHotkey
{
    ...
    public void testcase(){
        ...
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/Control + Shift + X/.toString())
        //Verify Right Side Controls in Whiteboard 
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("Strikethrough":true)
    }
    //Basestate
