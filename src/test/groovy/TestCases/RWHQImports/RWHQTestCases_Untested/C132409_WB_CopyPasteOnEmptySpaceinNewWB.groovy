...
//C132409 - WB - Copy Paste On Empty Space in New WB
class C132409_WB_CopyPasteOnEmptySpaceinNewWB
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C132409/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/C132409/.toString())
        ...
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/C132382/.toString())
        //Click on Whiteboard Tool
        ...
        new actions.Whiteboards.CreateWhiteboardFromUserhome().run("Create New or Choose Template":/New Blank Whiteboard/.toString())
        //Set Whiteboard Title
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C13240_paste/.toString(),"Action":/Submit/.toString())
        //Click on Whiteboard Canvas
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/100/.toString(),"Y coordinate":/100/.toString(),"Single Double or Right Click":/Single Click/.toString())
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/Control + V/.toString())
        //Compare Images
        new actions.selenium.CompareImages().run("Expected Image File":/C132409_expected.png/.toString(),"Actual Image Name":/C132409_actual.png/.toString(),"Crop Screenshot Start at X":/0/.toString(),"Crop Screenshot Start at Y":/0/.toString(),"Crop Screenshot Width":/1600/.toString(),"Crop Screenshot Height":/1200/.toString())
    }
    //Basestate
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C132409_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
    }
}