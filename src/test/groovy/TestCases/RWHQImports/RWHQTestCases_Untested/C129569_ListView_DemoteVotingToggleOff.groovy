...
//C129569 - List View - Demote Voting Toggle Off
class C129569_ListView_DemoteVotingToggleOff
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupIdeasforNewVotingtab().run("Demote Voting Checkbox":false)
        //Navigate WebStorm or MTS
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("View Type":/List/.toString(),"Idea Name":/test idea1/.toString(),"Status":/Under Review/.toString(),"Username":/Sri/.toString(),"Vote Count on Voting UI":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
