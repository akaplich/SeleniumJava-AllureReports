...
//C119513 - Activities - User Added to Early Access Group Later
class C119513_Activities_UserAddedtoEarlyAccessGroupLater
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.SetParticipantsinPipelineSetupPage().run("Early Access":/End User/.toString(),"Early Access Add or Remove":/Add/.toString())
        //Navigate
        ...
        new actions.Enterprise.UserHomepage.VerifyActivityinUserHomepage().run("Active or Closed":/Active/.toString(),"Total Number of Activities on the page":/2/.toString(),"Activity Name":/My Activity - Test/.toString(),"Description":/Solve challenge description/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
