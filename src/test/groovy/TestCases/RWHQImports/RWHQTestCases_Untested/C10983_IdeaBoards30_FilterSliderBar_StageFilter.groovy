...
//C10983  - Idea Boards 30 - Filter Slider Bar - Stage Filter
class C10983_IdeaBoards30_FilterSliderBar_StageFilter
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Status":[],"Stage":["Evaluation"],"Categories":[],"Tags":[],"Desired Expertise":[])
        ...
        //Filter Idea in Idea Board page
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Status":[],"Stage":["Collection"],"Categories":[],"Tags":[],"Desired Expertise":[])
        //Verify Idea in Idea Board page TEMP
