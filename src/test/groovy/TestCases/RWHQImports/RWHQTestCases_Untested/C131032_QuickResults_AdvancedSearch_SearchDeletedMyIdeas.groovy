...
//C131032 - Quick Results, Advanced Search - Search Deleted My Ideas
class C131032_QuickResults_AdvancedSearch_SearchDeletedMyIdeas
{
    ...
    public void testcase(){
        ...
        //Delete My Idea
        new actions.Enterprise.UserHomepage.DeleteMyIdea().run("Title":/first my idea/.toString())
        ...
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/first my idea/.toString(),"Number of Matches":/0/.toString())
        //Verify Quick or Advanced Search Result
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/eval idea 1/.toString(),"Type":/Submissions/.toString(),"Number of Total (for Advanced Search)":/1 of 1/.toString(),"Description (for Advanced Search)":/test/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
