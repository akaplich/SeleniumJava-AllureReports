...
//C90495 - Pairwise - Neither
class C90495_Pairwise_Neither
{
    ...
    public void testcase(){
        ...
        new actions.ActionItems.VerifySelectedIdeaforthePairwise().run("Pairing":/Pairing 1/.toString(),"Selected Idea":/Neither/.toString())
    }
    //Basestate
