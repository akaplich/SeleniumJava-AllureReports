...
//C130903 - WB - Remove Smart Matrix, CSP is ON
class C130903_WB_RemoveSmartMatrix_CSPisON
{
    ...
    public void testcase(){
        ...
        new actions.SetupSite.SetEnterpriseSetupSiteUserHomepage().run("User Homepage options":/User Homepage/.toString(),"Featured Activity":true)
        //Navigate
        ...
        new actions.Whiteboards.SetRightClickonSmartMatrix().run("X Coordinate":/740/.toString(),"Y Coordinate":/500/.toString(),"Menu Option":/Remove Smart Matrix/.toString())
        //Verify Smart Matrix & Other Elements Exists On Whiteboard
        new actions.Whiteboards.VerifySmartMatrixExists().run("Element (skip if verifying text)":/Matrix/.toString(),"Should Exist":false)
    }
    //Basestate
