...
//C131424 - MTS homepage > Memo Tab > Submit to Batch as Owner and Editor
class C131424_MTShomepage_MemoTab_SubmittoBatchasOwnerandEditor
{
    ...
    public void testcase(){
        ...
        new actions.Memo.SetEllipseDropdownForMemo().run("Memo Title (Required)":/testing1 gdocument/.toString(),"Click Ellipse Menu":true,"Menu Item":/Submit to Batch…/.toString())
        //Collab Editor/Userhome/MTS - Set Submit to Batch
        new actions.Memo.CollabEditorSetSubmitToBatch().run("Via Button or Dropdown?":/From Userhome\/MTS/.toString(),"Select batch":/Memo Program testing/.toString(),"Action":/Submit/.toString())
        //Verify Memo Card in Userhomepage
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/testing1 gdocument/.toString(),"Memo Icon Type":/Google/.toString(),"User Name":/System Admin/.toString(),"Status":/Incubate 🐣/.toString(),"Thumbnail Image Displayed":true,"Number of Matches":/1/.toString())
        //Set Hover Menu on Memo Template Tiles
        ...
        //Verify Memo Card in Userhomepage
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/Ztesting memo/.toString(),"Memo Icon Type":/Brightidea/.toString(),"User Name":/System Admin/.toString(),"Status":/Private/.toString(),"Thumbnail Image Displayed":true,"Number of Matches":/1/.toString())
        //Memo in Userhome/VI3 - Set Memo Ellipse Dropdown or Open Document
        new actions.Memo.SetEllipseDropdownForMemo().run("Memo Title (Required)":/Ztesting memo/.toString(),"Click Ellipse Menu":true,"Menu Item":/Submit to Batch…/.toString())
        //Collab Editor/Userhome/MTS - Set Submit to Batch
        new actions.Memo.CollabEditorSetSubmitToBatch().run("Via Button or Dropdown?":/From Userhome\/MTS/.toString(),"Select batch":/Memo Program testing/.toString(),"Action":/Submit/.toString())
        //Verify Memo Card in Userhomepage
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/Ztesting memo/.toString(),"Memo Icon Type":/Brightidea/.toString(),"User Name":/System Admin/.toString(),"Status":/Incubate 🐣/.toString(),"Thumbnail Image Displayed":true,"Number of Matches":/1/.toString())
    }
    //Basestate
