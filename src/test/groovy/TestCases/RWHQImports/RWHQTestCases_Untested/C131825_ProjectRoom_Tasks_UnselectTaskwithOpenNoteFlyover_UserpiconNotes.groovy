...
//C131825 - Project Room > Tasks - Unselect Task with Open Note Flyover, Userpic on Notes
class C131825_ProjectRoom_Tasks_UnselectTaskwithOpenNoteFlyover_UserpiconNotes
{
    ...
    public void testcase(){
        ...
        //Compare Images
        new actions.selenium.CompareImages().run("Element ID (optional)":/\/\/DIV[@class='f-notes-flyover ']\/\/IMG[contains(@class,'member-img')]/.toString(),"Expected Image File":/C131825_expected.png/.toString(),"Actual Image Name":/C131825_actual.png/.toString())
        //Select All or Multiple Tasks in Project Room
        new actions.ProjectRoom.SelectAllorMultipleTasksinProjectRoom().run("Tasks to Select":/task1/.toString(),"Select the Checbox":/FALSE/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/1/.toString())
        //Project Room - Set Task Note Section
        ...
        //Select All or Multiple Tasks in Project Room
        new actions.ProjectRoom.SelectAllorMultipleTasksinProjectRoom().run("Tasks to Select":/All/.toString(),"Select the Checbox":/FALSE/.toString())
        //Select All or Multiple Tasks in Project Room
        new actions.ProjectRoom.SelectAllorMultipleTasksinProjectRoom().run("Tasks to Select":/All/.toString(),"Select the Checbox":/FALSE/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/1/.toString())
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C131825_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
        try{
            //Delete File
