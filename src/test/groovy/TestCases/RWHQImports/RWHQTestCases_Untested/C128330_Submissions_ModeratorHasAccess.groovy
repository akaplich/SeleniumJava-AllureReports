...
//C128330 -  Submissions - Moderator Has Access 
class C128330_Submissions_ModeratorHasAccess
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/Ideas-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Code","Title","Actual Benefit ($)"],"Number of Matches":/1/.toString(),"Total Number of Rows":/8/.toString())
        //Download Generated Report
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Submissions/.toString(),"Report Name Starts with":/Ideas/.toString(),"Instance":/1/.toString())
        //Verify File Data
