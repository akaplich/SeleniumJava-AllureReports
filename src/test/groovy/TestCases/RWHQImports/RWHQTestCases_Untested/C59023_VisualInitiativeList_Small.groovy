...
//C59023 - Visual Initiative List (Small)
class C59023_VisualInitiativeList_Small
{
    ...
    public void testcase(){
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Solve App/.toString(),"Should Exist":false)
        //Verify Message
