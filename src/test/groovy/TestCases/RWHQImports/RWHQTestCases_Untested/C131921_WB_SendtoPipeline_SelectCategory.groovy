...
//C131921 - WB - Send to Pipeline, Select Category
class C131921_WB_SendtoPipeline_SelectCategory
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetWebstormSetupCategoryIdeasTab().run("Original Category Name":/Operations/.toString())
        //Navigate
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131921/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.SetRightClickonStickyNote().run("Right Click on Sticky Note":true,"Click on Add to pipeline":true,"Add to pipeline":/Custom App/.toString(),"Select Pipeline Category":/New Product/.toString(),"Add to pipeline Action":/Add/.toString())
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/Idea1(D113)/.toString(),"Idea Image":true,"Category":/New Product/.toString(),"Submitter Name":/End User/.toString(),"Submitter Image":true)
        ...
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Category":/New Product/.toString(),"Linked Submissions":[])
    }
    //Basestate
