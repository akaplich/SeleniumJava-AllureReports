...
//C117731 - Gig Enhancements - Decline User
class C117731_GigEnhancements_DeclineUser
{
    ...
    public void testcase(){
        ...
        //Edit Your Profile
        new actions.UserProfile.EditYourProfile().run("Expertise":/Expertise150/.toString(),"Add or Remove Expertise":/Add/.toString())
        //Navigate WebStorm or MTS
        ...
        new actions.ViewIdea.GigEnhancementsApplyApplicants.AcceptApplicantinViewIdea().run("Applicant's Username":/Pipeline Sponsor/.toString(),"Accept or Decline":/Decline/.toString(),"Message (optional)":/test message/.toString(),"Action":/Accept/.toString())
        //Verify Applicants Tab in View Idea
        new actions.ViewIdea.GigEnhancementsApplyApplicants.VerifyApplicantsTabinViewIdea().run("Applicant's Username":/Pipeline Sponsor/.toString(),"Status":/Declined/.toString())
    }
    //Basestate
