...
class C119517_UserhomeActivitiesTab_OpenTab_NavigatetoHome_IdeaBoards_PostIdea
{
    ...
    public void testcase(){
        ...
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Navigate From Activity Card
        new actions.Enterprise.UserHomepage.NavigateFromActivityCard().run("Active or Closed":/Active/.toString(),"Activity Name":/Custom App/.toString(),"Navigate to":/Topic/.toString())
        //Subscribe to Challenge
        new actions.Webstorm.SubscribetoChallenge().run("Subscribe or Unsubscribe":/Subscribe/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Navigate From Activity Card
        new actions.Enterprise.UserHomepage.NavigateFromActivityCard().run("Active or Closed":/Active/.toString(),"Activity Name":/Custom App/.toString(),"Navigate to":/Submit/.toString())
