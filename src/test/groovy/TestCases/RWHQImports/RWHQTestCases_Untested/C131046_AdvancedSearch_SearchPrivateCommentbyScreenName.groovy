...
//C131046 - Advanced Search - Search Private Comment by ScreenName
class C131046_AdvancedSearch_SearchPrivateCommentbyScreenName
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.AddCommentinViewIdeapage().run("Comment":/test comment1/.toString(),"Comment Type":/Private/.toString())
        //Navigate
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewIdeapage().run("Comment Section":/Comments/.toString(),"Type of Comment":/Private/.toString(),"Comment":/test comment1/.toString(),"User":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Log Out
