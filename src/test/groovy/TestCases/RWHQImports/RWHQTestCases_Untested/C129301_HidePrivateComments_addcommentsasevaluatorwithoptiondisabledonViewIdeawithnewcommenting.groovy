...
//C129301 - Hide Private Comments - add comments as evaluator with option disabled on View Idea with new commenting
class C129301_HidePrivateComments_addcommentsasevaluatorwithoptiondisabledonViewIdeawithnewcommenting
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.CreateStepinPipelineStepspage().run("Step Name":/Development1/.toString(),"Select Tool Type":/Development/.toString(),"Action":/Create/.toString())
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/Private/.toString(),"Parent Comment":/test private comment/.toString(),"User":/Evaluator/.toString(),"Placement Number":/1/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Reply/.toString(),"Comment Type":/Private/.toString(),"Parent Comment":/test private comment/.toString(),"Reply Comment":/test reply to test private comment/.toString(),"User":/Evaluator/.toString(),"Placement Number":/1/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Parent Comment/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Parent Comment":/test submitter comment/.toString(),"User":/Evaluator/.toString(),"Placement Number":/3/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Reply/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Parent Comment":/test submitter comment/.toString(),"Reply Comment":/test reply to test submitter comment/.toString(),"User":/Evaluator/.toString(),"Placement Number":/1/.toString())
        //Verify Comment in View and NGA View Idea
        ...
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Reply/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/test comment/.toString(),"Reply Comment":/test reply to test comment/.toString(),"User":/Evaluator/.toString(),"Placement Number":/1/.toString())
    }
    //Basestate
