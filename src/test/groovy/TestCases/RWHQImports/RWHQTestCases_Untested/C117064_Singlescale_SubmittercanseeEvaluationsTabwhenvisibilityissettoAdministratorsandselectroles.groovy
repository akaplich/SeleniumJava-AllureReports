...
//C117064 - Singlescale - Submitter can see Evaluations Tab when visibility is set to Administrators and select roles
class C117064_Singlescale_SubmittercanseeEvaluationsTabwhenvisibilityissettoAdministratorsandselectroles
{
    ...
    public void testcase(){
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea3/.toString(),"Description":/test idea3 description/.toString(),"Category":/Operations/.toString(),"Required Short Question":/short/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        ...
        new actions.PipelineStepsConfigure.ConfigureSingleScaleStepinNewModalinPipelineStepspage().run("Step Name to Configure (optional)":/Single Scale/.toString(),"Individual Assignment User":/Evaluator/.toString(),"Individual Assignment User Add or Remove":/Add/.toString(),"Evaluation Results":true,"Display on Submission's Evaluation tab when:":/First Action Item for the Submission is complete/.toString(),"Results are visible to":/Administrators and select roles/.toString(),"Submitters":true,"Action":/Update/.toString())
        ...
        try{
            ...
            new actions.ViewIdea.VerifyEvaluationstabRibboninVewIdeapage().run("Overall Score":/7 Overall Score/.toString(),"Total Evaluation":/50 Percentile of 1 Submission/.toString(),"Completed Evaluation":/1 \/ 1 Evaluations Completed/.toString())
        }
        ...
        //Verify Evaluations Tab Ribbon in Vew Idea page
        new actions.ViewIdea.VerifyEvaluationstabRibboninVewIdeapage().run("Overall Score":/7 Overall Score/.toString(),"Total Evaluation":/50 Percentile of 2 Submission/.toString(),"Completed Evaluation":/1 \/ 1 Evaluations Completed/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
