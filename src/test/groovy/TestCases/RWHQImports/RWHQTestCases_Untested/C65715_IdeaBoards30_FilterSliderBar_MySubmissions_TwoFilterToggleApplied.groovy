...
//C65715 - Idea Boards 30 - Filter Slider Bar - My Submissions - Two Filter Toggle Applied
class C65715_IdeaBoards30_FilterSliderBar_MySubmissions_TwoFilterToggleApplied
{
    ...
    public void testcase(){
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea4/.toString(),"Description":/desc/.toString(),"Category":/New Product/.toString(),"Required Short Question":/required/.toString(),"Action":/Submit Idea/.toString())
        ...
        //Set Idea in Idea Board Page
        new actions.IdeaBoard.SetIdeainIdeaBoardPage30().run("Idea Name":/test idea4/.toString(),"Favorite":true)
        //Set Idea in Idea Board Page
        new actions.IdeaBoard.SetIdeainIdeaBoardPage30().run("Idea Name":/test idea1/.toString(),"Favorite":true)
        //Filter Idea in Idea Board page
        new actions.IdeaBoard.FilterIdeainIdeaBoardpage30().run("Status":[],"Stage":[],"Categories":[],"Tags":[],"Desired Expertise":[],"My Favorites":true)
