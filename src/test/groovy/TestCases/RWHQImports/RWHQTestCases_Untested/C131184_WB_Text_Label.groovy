...
//C131184 - WB - Text - Label
class C131184_WB_Text_Label
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/C131184/.toString())
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/Escape/.toString())
        //Verify Right Side Controls in Whiteboard 
        new actions.Whiteboards.VerifyRightSideControlsWhiteboard().run("L or W":/340/.toString(),"H":/20/.toString(),"Text Font":/Lato/.toString(),"Font Size":/14/.toString(),"Font Color":/444647/.toString())
    }
    //Basestate
