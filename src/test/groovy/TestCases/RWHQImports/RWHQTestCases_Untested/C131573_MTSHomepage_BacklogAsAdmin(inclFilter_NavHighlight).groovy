...
//C131573 - MTS Homepage > Backlog As Admin (incl Filter, Nav Highlight)
class C131573_MTSHomepage_BacklogAsAdmin(inclFilter_NavHighlight)
{
    ...
    public void testcase(){
        ...
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Idea Paused, Hidden/.toString(),"Stack Name Memo belongs to":/Process Improvement/.toString(),"Status":/Paused ⏸/.toString(),"Stage":/Backlog/.toString(),"Step":/Backlog/.toString(),"Idea Code":/D117/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Idea Paused/.toString(),"Stack Name Memo belongs to":/Process Improvement/.toString(),"Status":/Paused ⏸/.toString(),"Stage":/Backlog/.toString(),"Step":/Backlog/.toString(),"Idea Code":/D116/.toString(),"Placement Number":/2/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        ...
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Memo In Flight/.toString(),"Stack Name Memo belongs to":/Process Improvement/.toString(),"Status":/In-flight 🔥/.toString(),"Stage":/Backlog/.toString(),"Step":/Backlog/.toString(),"Idea Code":/D113/.toString(),"Placement Number":/5/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Memo Development/.toString(),"Stack Name Memo belongs to":/Process Improvement/.toString(),"Status":/Active Development 📄/.toString(),"Stage":/Backlog/.toString(),"Step":/Backlog/.toString(),"Idea Code":/D114/.toString(),"Placement Number":/4/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Top Ideas
        new actions.Memo.VerifyMemoinTopIdeas().run("Title":/Memo Green Light/.toString(),"Stack Name Memo belongs to":/Process Improvement/.toString(),"Status":/Green Light ✅/.toString(),"Stage":/Backlog/.toString(),"Step":/Backlog/.toString(),"Idea Code":/D115/.toString(),"Placement Number":/3/.toString(),"Number of Matches":/1/.toString())
