...
//C131766 - WB - Edit Link on Text Box via Right Panel
class C131766_WB_EditLinkonTextBoxviaRightPanel
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/C131766/.toString(),"Action":/Submit/.toString())
        ...
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/C131766/.toString())
        //Send Key(s) To Whiteboard
