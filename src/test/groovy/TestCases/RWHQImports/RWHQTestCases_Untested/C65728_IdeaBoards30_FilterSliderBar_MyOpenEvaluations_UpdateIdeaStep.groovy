...
//C65728 - Idea Boards 30 - Filter Slider Bar - My Open Evaluations, Update Idea Step
class C65728_IdeaBoards30_FilterSliderBar_MyOpenEvaluations_UpdateIdeaStep
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureScorecardStepinNewModalinPipelineStepspage().run("Individual Assignment User":/System Admin/.toString(),"Individual Assignment User Add or Remove":/Add/.toString(),"Action":/Update/.toString())
