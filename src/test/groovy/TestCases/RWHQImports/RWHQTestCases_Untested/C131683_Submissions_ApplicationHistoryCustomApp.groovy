...
//C131683 - Submissions - Application History Custom App
class C131683_Submissions_ApplicationHistoryCustomApp
{
    ...
    public void testcase(){
        ...
        new actions.SetupIdeas.SetSiteSetupIdeasTeamConfiguration().run("Section":/Team Configuration/.toString(),"Users can apply to join teams":true)
        //Navigate WebStorm or MTS
        ...
        new actions.PostIdea.SetCustomAppPostIdea().run("Title":/test idea1/.toString(),"Description":/test/.toString(),"Category":/Theme 1/.toString(),"Action":/Submit Idea/.toString())
        //Log Out
        ...
        new actions.ViewIdea30.ApplyOnViewIdea30().run("Message":/test message one/.toString(),"Action":/Apply/.toString())
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString())
        //Apply on View Idea 30
        new actions.ViewIdea30.ApplyOnViewIdea30().run("Message":/test message two/.toString(),"Action":/Apply/.toString())
        //Access or Close Idea from View Idea 3 Modal
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Close Idea Modal":true)
        //Log Out
        new actions.general.LogOut().run([:])
        ...
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString())
        //Apply on View Idea 30
        new actions.ViewIdea30.ApplyOnViewIdea30().run("Message":/test message three/.toString(),"Action":/Apply/.toString())
        //Access or Close Idea from View Idea 3 Modal
        new actions.ViewIdea30.AccessIdeafromViewIdea3Modal().run("Close Idea Modal":true)
        //Log Out
        new actions.general.LogOut().run([:])
        ...
        new actions.ViewIdea30.AcceptDeclineApplicantSendMessageonViewIdea3().run("Applicant's Username":/End User/.toString(),"Accept or Reject or Send Message":/Accept/.toString(),"Message (optional)":/accept one/.toString(),"Action":/Accept/.toString())
        //Verify Applicants On View Idea 3
        new actions.ViewIdea30.VerifyApplicantsOnViewIdea3().run("Applicant's Username":/End User/.toString(),"Applicant's Message":/test message one/.toString(),"Make Decision, Accepted or Rejected":/Accepted/.toString(),"Number of Matches":/1/.toString())
        //Accept/Decline Applicant, Send Message on View Idea 3
        new actions.ViewIdea30.AcceptDeclineApplicantSendMessageonViewIdea3().run("Applicant's Username":/End User 2/.toString(),"Accept or Reject or Send Message":/Accept/.toString(),"Message (optional)":/accept two/.toString(),"Action":/Accept/.toString())
        //Verify Applicants On View Idea 3
        new actions.ViewIdea30.VerifyApplicantsOnViewIdea3().run("Applicant's Username":/End User 2/.toString(),"Applicant's Message":/test message two/.toString(),"Make Decision, Accepted or Rejected":/Accepted/.toString(),"Number of Matches":/1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Hack/.toString(),"Area to Navigate to":/Setup/.toString())
