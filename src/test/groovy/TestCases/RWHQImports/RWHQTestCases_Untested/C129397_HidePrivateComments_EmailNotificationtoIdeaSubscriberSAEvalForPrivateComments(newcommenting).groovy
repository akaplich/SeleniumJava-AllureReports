...
//C129397 - Hide Private Comments - Email Notification to Idea Subscriber SA Eval For Private Comments(new commenting)
class C129397_HidePrivateComments_EmailNotificationtoIdeaSubscriberSAEvalForPrivateComments(newcommenting)
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC129397_1_SA/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        ...
        try{
            //Verify Email
            new actions.Mailinator.VerifyEmail().run("Email Address":/brightC129397_1_SA/.toString(),"Subject":/New Development Step1: You have 1 new Action Items/.toString())
        }
       catch(all){}catch(Error err){}
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/brightC129397_1_SA@mailinator.com/.toString(),"Password":/brightidea1/.toString())
        //Navigate WebStorm or MTS
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC129397_1_SA/.toString(),"Subject":/Custom App: System Admin commented on the Idea you are subscribed to/.toString())
    }
    //Basestate
