...
//C131036 - Advanced Search - Search Projects When Project Not Created
class C131036_AdvancedSearch_SearchProjectsWhenProjectNotCreated
{
    ...
    public void testcase(){
        ...
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/test idea1/.toString(),"Type":/Projects/.toString(),"Description (for Advanced Search)":/test idea1 desc/.toString(),"Number of Matches":/0/.toString())
        //Log Out
