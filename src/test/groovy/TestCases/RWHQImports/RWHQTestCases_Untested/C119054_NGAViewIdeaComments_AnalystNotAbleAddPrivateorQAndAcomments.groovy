...
class C119054_NGAViewIdeaComments_AnalystNotAbleAddPrivateorQAndAcomments
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.VerifyCommentInNGAViewIdeaPage().run("Comment Section":/Comments/.toString(),"User":/analyst/.toString(),"Comment":/Private Comment/.toString(),"Comment Type":/Private/.toString(),"Number of Matches":/0/.toString())
        //Verify Comment In NGA View Idea Page
        new actions.NGAViewIdea.VerifyCommentInNGAViewIdeaPage().run("Comment Section":/Comments/.toString(),"User":/analyst/.toString(),"Comment":/Submitter Comment/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
