...
//C128724 - Pipeline List View - Actions Dropdown - Change Step
class C128724_PipelineListView_ActionsDropdown_ChangeStep
{
    ...
    public void testcase(){
        ...
        new actions.PipelineList.VerifyIdeainPipelineListpage().run("Title":/test idea1/.toString(),"Step":/Scorecarding/.toString(),"Number of Matches":/1/.toString())
        //Verify Idea in Pipeline List page
        new actions.PipelineList.VerifyIdeainPipelineListpage().run("Title":/test idea2/.toString(),"Step":/Scorecarding/.toString(),"Number of Matches":/1/.toString())
