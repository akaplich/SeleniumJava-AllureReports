...
//C131395 - MTS homepage > Memo Tab > Link Existing Google document
class C131395_MTShomepage_MemoTab_LinkExistingGoogledocument
{
    ...
    public void testcase(){
        ...
        new actions.Memo.VerifyMemoCardinUserhomepage().run("Memo Title":/testing1 gdocument/.toString(),"Memo Icon Type":/Google/.toString(),"User Name":/End User/.toString(),"Status":/Private/.toString(),"Thumbnail Image Displayed":true,"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
