...
//C131822 - Send to Project Room > Filtering for 20+ Project Room
class C131822_SendtoProjectRoom_Filteringfor20_ProjectRoom
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SendToProjectRoom().run("From the Actions Menu":false,"Existing or New":/Existing/.toString(),"Title":/Project room12/.toString(),"Action":/Submit/.toString(),"Wait":false)
        //Verify Toast Message in Tasks In Project Room
        new actions.ProjectRoom.VerifyToastMessageinTasksInProjectRoom().run("Message":/Your Idea has been added to your project room. Project room12/.toString(),"Click on the link":true)
        ...
        //Login
        new actions.general.Login().run("Email":/pipelineadmin@test.com/.toString(),"Password":/brightidea1/.toString(),"Verify if Logged In On Enterprise homepage":true)
        //Navigate WebStorm or MTS
        ...
        //Send to Project Room
        new actions.PipelineStepsView.SendToProjectRoom().run("From the Actions Menu":true,"Existing or New":/Existing/.toString(),"Title":/Project room19/.toString(),"Action":/Submit/.toString(),"Wait":false)
        //Verify Toast Message in Tasks In Project Room
        new actions.ProjectRoom.VerifyToastMessageinTasksInProjectRoom().run("Click on the link":true)
        //Switch to Browser Window
        new actions.selenium.SwitchWindow().run("Tab (start from 0)":/1/.toString())
        //Navigate to Top Link or Page in Project Room
        new actions.ProjectRoom.NavigateRoomItems().run("Room Item":/quick add1/.toString())
        //Verify Idea on View Idea 30
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("Template":/Medium Header/.toString(),"View As":/Admin/.toString(),"Idea Name":/quick add1/.toString())
    }
    //Basestate
