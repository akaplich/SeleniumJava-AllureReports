...
//C118866 - Idea Import - Visible Ideas
class C118866_IdeaImport_VisibleIdeas
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.ImportIdeasinPipelineStepspage().run("Idea Import File":/Import_Ideas_C118866.xls/.toString(),"Action":/Import Ideas/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom Initiative for Idea Import Title/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/visible idea1/.toString(),"Step Name idea belongs to":/Submitted/.toString())
        //Verify Idea in Pipeline Steps page
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/visible idea2/.toString(),"Step Name idea belongs to":/Submitted/.toString())
        //Log Out
        ...
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/visible idea1/.toString(),"Description":/desc1/.toString())
        //Verify Idea in Idea Board page
        new actions.IdeaBoard.VerifyIdeainIdeaBoardpage30().run("Idea Name":/visible idea2/.toString(),"Description":/desc2/.toString())
    }
    //Basestate
