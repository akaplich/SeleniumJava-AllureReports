...
//C119510 - Activities - User Not in Access Groups
class C119510_Activities_UserNotinAccessGroups
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyActivityinUserHomepage().run("Active or Closed":/Active/.toString(),"Total Number of Activities on the page":/1/.toString(),"Activity Name":/My Activity - Test/.toString(),"Description":/My Activity Description/.toString(),"Number of Matches":/0/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
