...
//C118101 - View My Idea - Update Title Field
class C118101_ViewMyIdea_UpdateTitleField
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.SetViewMyIdeaTextField().run("Field Name":/Title/.toString(),"Field Value":/This is for testing purpose/.toString())
        //Verify View My Idea in User Homepage
        new actions.Enterprise.UserHomepage.VerifyViewMyIdeainUserHomepage().run("Idea Title":/This is for testing purpose/.toString(),"Idea Description":/Brightidea must be next big thing/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Access My Idea on View My Idea
        new actions.Enterprise.UserHomepage.AccessMyIdeaonViewMyIdea().run("Access View My Idea modal":/This is for testing purpose/.toString())
        //Verify View My Idea in User Homepage
        new actions.Enterprise.UserHomepage.VerifyViewMyIdeainUserHomepage().run("Idea Title":/This is for testing purpose/.toString(),"Idea Description":/Brightidea must be next big thing/.toString())
    }
    //Basestate
