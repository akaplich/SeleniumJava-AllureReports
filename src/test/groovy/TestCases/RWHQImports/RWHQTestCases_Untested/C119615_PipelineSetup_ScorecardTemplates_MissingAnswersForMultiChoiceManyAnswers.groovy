...
class C119615_PipelineSetup_ScorecardTemplates_MissingAnswersForMultiChoiceManyAnswers
{
    ...
    public void testcase(){
        ...
        new actions.PipelineSetup.SetQuestionScorecardTemplate().run("Added Question Order Number":/1/.toString(),"Question Type":/Multiple Choice (more than one answer)/.toString(),"Required to Answer":true,"Question":/Test Question One Answer/.toString(),"Short Name":/Short Name Test/.toString(),"Tooltip":/Test Tooltip One Answer/.toString(),"Action":/Save/.toString())
        //Verify Message
