...
class C131295_Userhome_MST_Whiteboards_SystemAdminDoesNotSeeOtherUsersWB
{
    ...
    public void testcase(){
        ...
        //Create App Webstorm
        new actions.WebstormCreation.CreateAppWebstorm().run("App Name":/Instance Ideabox/.toString(),"Sponsor Name":/pipelinesponsor@mailinator.com/.toString(),"Sponsor Add or Remove":/Add/.toString(),"Webstorm Title":/Ideabox Teamsite/.toString(),"Description":/test/.toString(),"Type of Licensing Model":/Standard Licensing Model/.toString(),"Action":/Create/.toString())
        ...
        new actions.SetupBI.SetEnterpriseSetupforBIOnlyBetatab().run("Idea Box Team Site Routing":true)
        //Log Out
        ...
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Ideabox Teamsite/.toString(),"Area to Navigate to":/Home/.toString())
        //Navigate Tab User Homepage or MTS
        new actions.Enterprise.UserHomepage.NavigateTabUserHomepage().run("Tab":/Whiteboards/.toString())
        //Create Whiteboard or Edit Template
        new actions.Whiteboards.CreateWhiteboardFromUserhome().run("Create New or Choose Template":/New Blank Whiteboard/.toString())
        //Set Whiteboard Title
        new actions.Whiteboards.EditTitleOfWhiteboard().run("Title":/Another End User Whiteboard/.toString(),"Action":/Submit/.toString())
        //Go Back From Whiteboard
        new actions.Whiteboards.GoBackFromWhiteboard().run([:])
        //Log Out
        new actions.general.LogOut().run([:])
        ...
        new actions.Whiteboards.VerifyWhiteboard().run("Whiteboard Name":/Another End User Whiteboard/.toString(),"Number of Matches":/0/.toString())
        //Verify Whiteboard Card in Userhomepage
        new actions.Whiteboards.VerifyWhiteboard().run("Whiteboard Name":/End User Whiteboard/.toString(),"Number of Matches":/0/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Ideabox Teamsite/.toString(),"Area to Navigate to":/Home/.toString())
        //Navigate Tab User Homepage or MTS
        new actions.Enterprise.UserHomepage.NavigateTabUserHomepage().run("Tab":/Whiteboards/.toString())
