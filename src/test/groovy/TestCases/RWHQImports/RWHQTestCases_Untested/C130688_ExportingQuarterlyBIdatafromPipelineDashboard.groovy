...
//C130688 - Exporting Quarterly BI data from Pipeline Dashboard
class C130688_ExportingQuarterlyBIdatafromPipelineDashboard
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightc130688_1/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/brightc130688_1@mailinator.com/.toString())
        //Navigate WebStorm or MTS
        ...
        variables."link" = new actions.Mailinator.GetDownloadLinkfromEmail().run("Email Address":/brightc130688_1/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/3/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/auto*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["2021 Q3 Projected Benefit ($)","2021 Q3 Projected Cost ($)","2021 Q3 Actual Benefit ($)","2021 Q3 Actual Cost ($)","2021 Q4 Projected Benefit ($)","2021 Q4 Projected Cost ($)","2021 Q4 Actual Benefit ($)","2021 Q4 Actual Cost ($)","2022 Q1 Projected Benefit ($)","2022 Q1 Projected Cost ($)","2022 Q1 Actual Benefit ($)","2022 Q1 Actual Cost ($)"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/2/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/auto*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Benefit","Cost Savings","15000","0","14000"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/2/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/auto*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Cost","New Cost","0","-30000"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        //Navigate to URL
        new actions.selenium.NavigateToURL().run("URL":/${variables."link"}/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/2/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/auto*.xlsx/.toString(),"File Location":/Downloads/.toString(),"Row Values":["-10000","0","-5000"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
    }
    //Basestate
