...
class C130931_WB_Image_Undo_Ctrl_Plus_Z_UploadAndUnsplash
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.VerifySmartMatrixExists().run("Element (skip if verifying text)":/Image/.toString(),"Should Exist":false)
        //Click on Whiteboard Tool
        new actions.Whiteboards.ClickOnWhiteboardTool().run("Click on ToolKit":true,"Tool Type":/Place Image - I/.toString())
        //Set Change Background or Other Modal Tab
        ...
        new actions.WebstormHomepage.SetPresetBackgroundImageintheHeader().run("Unsplash Image Text":/test/.toString(),"Unpslash Image Number":/1/.toString(),"Action":/Update/.toString())
        //Wait
        new actions.general.Wait().run("Seconds":/5/.toString())
        //Send Key(s) To Whiteboard
        new actions.Whiteboards.SendKeysToWhiteboard().run("Key(s) to send":/Control + Z/.toString())
