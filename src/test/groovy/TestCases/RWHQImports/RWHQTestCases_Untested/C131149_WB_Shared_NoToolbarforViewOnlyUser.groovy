...
//C131149 - WB - Shared - No Toolbar for View Only User
class C131149_WB_Shared_NoToolbarforViewOnlyUser
{
    ...
    public void testcase(){
        ...
        //Verify Element
        new actions.general.VerifyElement().run("ID":/\/\/*[contains(@class,'f-canvas-controls-container')]/.toString(),"Should Element Exist":false,"Number of Matches":/0/.toString())
        try{
            //Click on Whiteboard Tool
