...
//C5986 - Step Result - Scorecard - Complete Action Item
class C5986_StepResult_Scorecard_CompleteActionItem
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.VerifyStepResultsinStepsViewpage().run("Step Name":/Scorecarding/.toString(),"Idea Code":/D102/.toString(),"Score":/69.6/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
