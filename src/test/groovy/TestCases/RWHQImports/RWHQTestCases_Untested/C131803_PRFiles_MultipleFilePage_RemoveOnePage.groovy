...
//C131803 - PR Files > Multiple File Page > Remove One Page
class C131803_PRFiles_MultipleFilePage_RemoveOnePage
{
    ...
    public void testcase(){
        ...
        new actions.ProjectRoom.SetRenamePageinProjectRoom().run("New Page Name":/Files1/.toString(),"Action":/Rename Files/.toString())
        ...
        new actions.ProjectRoom.SetRoomPageintheProjectRoom().run("Type of Room Page":/Files/.toString())
        //Set Edit Menu for Room Pages in Project Room
        new actions.ProjectRoom.SetEditMenuforRoomPagesinProjectRoom().run("Room Page":/Files/.toString(),"Menu Options":/Rename/.toString(),"Placement Number Of Folder or Page":/3/.toString())
        //Set Rename Page in Project Room
        new actions.ProjectRoom.SetRenamePageinProjectRoom().run("New Page Name":/Files2/.toString(),"Action":/Rename Files/.toString())
        //Navigate to Top Link or Page in Project Room
        new actions.ProjectRoom.NavigateRoomItems().run("Room Item":/Files2/.toString())
        //Set Files in Team Workspace
        ...
        new actions.selenium.Refresh().run([:])
        //Set Files in Team Workspace
        new actions.ViewIdea.TeamWorkspace.SetFilesinTeamWorkspace().run("Attachment File":/Image5.jpg/.toString())
        //Refresh
        new actions.selenium.Refresh().run([:])
        //Log Out
        ...
        //Navigate to Top Link or Page in Project Room
        new actions.ProjectRoom.NavigateRoomItems().run("Room Item":/Files1/.toString())
        //Remove Files in Team Workspace
        new actions.ViewIdea.TeamWorkspace.RemoveFilesTeamWorkspace().run("Attachment Name":/NonVideoFileOver1MBAndLessThan2MB.SLDASM/.toString(),"Instance":/1/.toString(),"Action":/Delete/.toString())
        ...
        //Verify Files in Team Workspace
        new actions.ViewIdea.TeamWorkspace.VerifyFilesinTeamWorkspace().run("Attachment Name":/Image5.jpg/.toString(),"Number of Matches":/0/.toString())
        //Verify Files in Team Workspace
        ...
        //Set Edit Menu for Room Pages in Project Room
        new actions.ProjectRoom.SetEditMenuforRoomPagesinProjectRoom().run("Room Page":/Files2/.toString(),"Menu Options":/Delete/.toString(),"Placement Number Of Folder or Page":/3/.toString())
