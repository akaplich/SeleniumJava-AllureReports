...
//C129956 - List View - Pinned Comment reply
class C129956_ListView_PinnedCommentreply
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.ReplytoCommentinViewandNGAViewIdea().run("Parent Comment":/test pinned comment/.toString(),"Comment Reply":/test reply to test comment for testing/.toString(),"Post Reply":true)
        //Reply to Comment in View and NGA View Idea
        new actions.ViewIdeaComment.ReplytoCommentinViewandNGAViewIdea().run("Parent Comment":/test pinned comment/.toString(),"Comment Reply":/test reply2 to test comment for testing/.toString(),"Post Reply":true)
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        ...
        new actions.IdeaBoard.VerifyPinnedCommentinIdeaBoardsListView().run("Idea":/test idea2/.toString(),"Comment":/test pinned comment/.toString(),"Comment Submitter":/System Admin/.toString(),"Comment Submitter Image":false,"Comment Date Displayed":true,"Edited Indicator":false,"Number of Matches":/1/.toString())
    }
    //Basestate
