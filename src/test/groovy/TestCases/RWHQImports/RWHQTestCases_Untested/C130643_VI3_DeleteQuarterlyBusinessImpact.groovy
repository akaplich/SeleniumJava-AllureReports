...
//C130643 - VI3 - Delete Quarterly Business Impact
class C130643_VI3_DeleteQuarterlyBusinessImpact
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.AccessIdeainPipelineStepsView().run("Idea Name":/quarterly idea1/.toString())
        ...
        new actions.ViewIdea.BusinessImpact.VerifyProjectedandActualCostsinBusinessImpacttabforViewIdeapage().run("Year":/Q3 2021;Q4 2021/.toString(),"Current Year":/Q3 2021/.toString(),"Costs Title":/New Cost;New Cost/.toString(),"Row Number":/1;1/.toString(),"Projected Cost":/30,000;5,000/.toString(),"Actual Cost":/10,000;6,000/.toString())
        //Verify Projected and Actual Benefits in Business Impact tab for View Idea page
        new actions.ViewIdea.BusinessImpact.VerifyProjectedandActualBenefitsinBusinessImpacttabforViewIdeapage().run("Year":/Q3 2021;Q4 2021/.toString(),"Current Year":/Q3 2021/.toString(),"Benefit Type":/Cost Savings;Cost Savings/.toString(),"Row Number of the Benefit":/1;1/.toString(),"Projected Benefit":/15,000;9,000/.toString(),"Actual Benefit":/14,000;10,000/.toString())
        //Verify Total Cost and Benefits in Business Impact tab
        new actions.ViewIdea.BusinessImpact.VerifyTotalCostandBenefitsinBusinessImpacttab().run("Year":/Q3 2021;Q4 2021/.toString(),"Current Year":/Q3 2021/.toString(),"Total Projected Benefit":/15,000;9,000/.toString(),"Total Actual Benefit":/14,000;10,000/.toString(),"Total Projected Cost":/30,000;5,000/.toString(),"Total Actual Cost":/10,000;6,000/.toString(),"Projected Net Benefit":/-15,000;4,000/.toString(),"Actual Net Benefit":/4,000;4,000/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Q1 2022/.toString(),"Should Exist":false)
    }
    //Basestate
