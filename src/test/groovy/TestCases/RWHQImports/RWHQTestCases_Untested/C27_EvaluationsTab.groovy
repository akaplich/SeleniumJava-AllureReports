...
class C27_EvaluationsTab
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdea.VerifyEvaluationstabRibboninVewIdeapage().run("Overall Score":/76.7/.toString(),"Total Evaluation":/1/.toString(),"Completed Evaluation":/1/.toString())
    }
    //Basestate
