...
//C119160 - Owner Updates - Edit Owner Admin
class C119160_OwnerUpdates_EditOwnerAdmin
{
    ...
    public void testcase(){
        ...
        new actions.NGAViewIdea.VerifyIdeainNGAViewIdeapage().run("Idea Name":/Quick Add for Find Owner Custom/.toString(),"Owner":/Not Assigned/.toString())
        ...
        //Verify Idea in View Idea page
        new actions.ViewIdea.VerifyIdeainViewIdeapage().run("Idea Name":/Quick Add for Find Owner Custom/.toString(),"Owner":/NonBI System Admin/.toString(),"Linked Submissions":[])
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Pipeline Steps/.toString())
        ...
        //Verify Idea in NGA View Idea page
        new actions.NGAViewIdea.VerifyIdeainNGAViewIdeapage().run("Idea Name":/Quick Add for Find Owner Custom/.toString(),"Creator username":/System Admin/.toString(),"Status":/Submitted/.toString(),"Owner":/NonBI System Admin/.toString())
    }
    //Basestate
