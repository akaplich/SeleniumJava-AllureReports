...
//C132102 - Update Assignee - Evaluator appear for open AI on reassign AI
class C132102_UpdateAssignee_EvaluatorappearforopenAIonreassignAI
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.VerifyAssigneeInUpdateAssigneeModal().run("Open Modal":true,"Assignee under Completed or Incomplete Action Items":/Assignees with complete action items/.toString(),"Assignee":/End User 2/.toString(),"Display Image":/E/.toString(),"Number of Matches":/1/.toString())
        //Verify Assignee In Update Assignee Modal
        ...
        new actions.PipelineStepsView.DragandDropIdeasinPipelineSteps().run("Idea Title":/test idea1/.toString(),"Step":/Single Scale/.toString())
        ...
        new actions.PipelineStepsView.SelectIdeainPipelineStepsViewpage().run("Idea Name":/test idea1/.toString())
        //Verify Assignee In Update Assignee Modal
        new actions.PipelineStepsView.VerifyAssigneeInUpdateAssigneeModal().run("Open Modal":true,"Assignee under Completed or Incomplete Action Items":/Assignees with incomplete action items/.toString(),"Assignee":/End User 2/.toString(),"Display Image":/E/.toString(),"Number of Matches":/1/.toString())
        //Verify Assignee In Update Assignee Modal
        new actions.PipelineStepsView.VerifyAssigneeInUpdateAssigneeModal().run("Open Modal":false,"Assignee under Completed or Incomplete Action Items":/Assignees with incomplete action items/.toString(),"Assignee":/Evaluator/.toString(),"Display Image":/E/.toString(),"Number of Matches":/1/.toString())
        //Verify Assignee In Update Assignee Modal
        new actions.PipelineStepsView.VerifyAssigneeInUpdateAssigneeModal().run("Open Modal":false,"Assignee under Completed or Incomplete Action Items":/Assignees with complete action items/.toString(),"Assignee":/End User 2/.toString(),"Display Image":/E/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
