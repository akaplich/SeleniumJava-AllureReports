...
//C45268 - Implementation - Mark as Return Project
class C45268_Implementation_MarkasReturnProject
{
    ...
    public void testcase(){
        ...
        //Access Action Item in My Action Items/Action Items Manager table
        new actions.ActionItems.AccessActionIteminMyActionItemsActionItemsManagertable().run("Access in Which List":/My Action Items/.toString(),"Title":/Find Owner Idea1/.toString(),"Pipeline":/Suggest Pipeline/.toString(),"Step":/Implementation/.toString())
        ...
        new actions.ActionItems.VerifyCompletedtableforActionItemspage().run("Verify in Which List (optional)":/My Action Items/.toString(),"Title":/Find Owner Idea1/.toString(),"Answer":/Returned/.toString(),"Number of Matches":/1/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/My Action Items/.toString(),"Title":/Find Owner Idea1/.toString(),"Pipeline":/Suggest Pipeline/.toString(),"Step":/Implementation/.toString(),"Number of Matches":/0/.toString())
        //Access Action Item in Actions Items React Global Navigation
        new actions.ActionItems.AccessActionIteminActionsItemsReactGlobalNavigation().run("Action Item":/View All/.toString())
        //Verify Open table for Action Items page
        new actions.ActionItems.VerifyOpentableforActionItemspage().run("Verify in Which List (optional)":/My Action Items/.toString(),"Title":/Find Owner Idea1/.toString(),"Pipeline":/Suggest Pipeline/.toString(),"Step":/Find Owner/.toString(),"Number of Matches":/1/.toString())
        //Verify Completed table for Action Items page
