...
//C17576 - Affiliate Summary - Remove Report
class C17576_AffiliateSummary_RemoveReport
{
    ...
    public void testcase(){
        ...
        new actions.SetupExports.VerifyGeneratedReportinSetupExports().run("Report Name Starts with":/Affiliate/.toString(),"Number of Matches":/1/.toString())
        ...
        //Verify Generated Report in any Setup Exports
        new actions.SetupExports.VerifyGeneratedReportinSetupExports().run("Report Name Starts with":/Affiliate/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
