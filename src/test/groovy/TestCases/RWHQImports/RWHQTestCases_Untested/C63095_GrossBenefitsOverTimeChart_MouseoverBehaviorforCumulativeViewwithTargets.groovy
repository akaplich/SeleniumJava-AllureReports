...
//C63095 - Gross Benefits Over Time Chart - Mouseover Behavior for Cumulative View with Targets
class C63095_GrossBenefitsOverTimeChart_MouseoverBehaviorforCumulativeViewwithTargets
{
    ...
    public void testcase(){
        ...
        new actions.PipelineDashBoard.VerifyMouseHoveronBusinessImpactTabinPipelineDashBoard().run("Chart View":/Cumulative/.toString(),"Year":/2017,2018/.toString(),"Projected":/$25,000;$73,000/.toString(),"Actual":/$29,000;$59,000/.toString())
        ...
        new actions.PipelineDashBoard.NavigateToPipelineDashBoardTab().run("Tab":/Business Impact Tab/.toString())
        //Verify the MouseHover on Chart View in Business Impact Tab
        new actions.PipelineDashBoard.VerifyMouseHoveronBusinessImpactTabinPipelineDashBoard().run("Chart View":/Cumulative/.toString(),"Year":/2017,2018/.toString(),"Projected":/$25,000;$73,000/.toString(),"Actual":/$29,000;$59,000/.toString(),"Target":/$5,000;$15,000/.toString())
    }
    //Basestate
