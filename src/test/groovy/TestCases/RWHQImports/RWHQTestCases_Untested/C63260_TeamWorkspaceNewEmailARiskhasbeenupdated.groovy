...
//C63260 - Team Workspace New Email A Risk has been updated
class C63260_TeamWorkspaceNewEmailARiskhasbeenupdated
{
    ...
    public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/brightC63260test19/.toString(),"Enterprise System Administrator":false,"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC63260test19/.toString(),"Subject":/You have been invited to collaborate on test idea1!/.toString(),"Email Should Be Received":true)
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/brightC63260test19/.toString(),"Subject":/System Admin added a new Risk to test idea1/.toString(),"Email Should Be Received":true)
    }
    //Basestate
