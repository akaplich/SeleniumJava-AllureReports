...
//C128893 - Comment Component - Tagging analyst in all types of comments replies
class C128893_CommentComponent_Tagginganalystinalltypesofcommentsreplies
{
    ...
    public void testcase(){
        ...
        new actions.ViewIdeaComment.VerifyTaggedUsersInCommentsinViewandNGAViewIdea().run("Comment":/test general comment reply/.toString(),"Tagged User":/analyst/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Reply/.toString(),"Comment Type":/General/.toString(),"Parent Comment":/test general comment/.toString(),"Reply Comment":/analyst test general comment reply/.toString(),"User":/System Admin/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Reply to Comment in View and NGA View Idea
        new actions.ViewIdeaComment.ReplytoCommentinViewandNGAViewIdea().run("Parent Comment":/test private comment/.toString())
        try{
            //Set Tag or Untag user in Comment in View and NGA View Idea
            new actions.ViewIdeaComment.TagorUntagUserInCommentInViewAndNGAViewIdea().run("Comment Section":/Reply/.toString(),"SearchText":/test/.toString(),"Username":/analyst/.toString(),"Email":/analyst@test.com/.toString(),"Add or Remove":/Add/.toString())
        }
        ...
        //Verify Tagged Users In Comments in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyTaggedUsersInCommentsinViewandNGAViewIdea().run("Comment":/test private comment reply/.toString(),"Tagged User":/analyst/.toString(),"Number of Matches":/0/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Reply/.toString(),"Comment Type":/Private/.toString(),"Parent Comment":/test private comment/.toString(),"Reply Comment":/@testtest private comment reply/.toString(),"User":/System Admin/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Reply to Comment in View and NGA View Idea
        ...
        //Verify Tagged Users In Comments in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyTaggedUsersInCommentsinViewandNGAViewIdea().run("Comment":/test submitter QA comment reply/.toString(),"Tagged User":/analyst/.toString(),"Number of Matches":/0/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("View Idea or NGA":/View Idea/.toString(),"Comment section":/Reply/.toString(),"Comment Type":/Submitter Q&A/.toString(),"Parent Comment":/test submitter QA comment/.toString(),"Reply Comment":/@analysttest submitter QA comment reply/.toString(),"User":/System Admin/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Reply to Comment in View and NGA View Idea
        ...
        //Verify Tagged Users In Comments in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyTaggedUsersInCommentsinViewandNGAViewIdea().run("Comment":/test pinned comment reply/.toString(),"Tagged User":/analyst/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment in View and NGA View Idea
        new actions.ViewIdeaComment.VerifyCommentinViewandNGAViewIdea().run("Comment section":/Reply/.toString(),"Comment Type":/Pinned/.toString(),"Parent Comment":/test pinned comment/.toString(),"Reply Comment":/analyst test pinned comment reply/.toString(),"User":/System Admin/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
