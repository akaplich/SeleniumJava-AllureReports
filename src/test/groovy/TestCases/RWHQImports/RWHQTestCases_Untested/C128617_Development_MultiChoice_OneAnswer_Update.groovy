...
//C128617 - Development - Multi Choice - One Answer - Update
class C128617_Development_MultiChoice_OneAnswer_Update
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsConfigure.ConfigureDevelopmentinNewModalinPipelineStepspage().run("Assignment Method":/Individual Assignment/.toString(),"Development Lead":/Idea Submitter/.toString(),"Development Team":/Evaluator/.toString(),"Development Team Add or Remove":/Add/.toString(),"Development Field":/Development Multi Choice - A/.toString(),"Development Field Included or Required":/Included/.toString(),"Action":/Activate/.toString())
        ...
        new actions.ActionItems.SetDevelopmentActionItemPageFields().run("Multiple Choice - Title":/Development Multi Choice - A/.toString(),"Multiple Choice - Answer":/Answer 1/.toString(),"Action":/Save/.toString())
        ...
        new actions.ActionItems.VerifyDevelopmentCardAnswers().run("Multiple Choice - Title":/Development Multi Choice - A/.toString(),"Multiple Choice - Answer":/Answer 1/.toString())
        //Set Development Action Item Page Fields
        new actions.ActionItems.SetDevelopmentActionItemPageFields().run("Multiple Choice - Title":/Development Multi Choice - A/.toString(),"Multiple Choice - Answer":/Answer 3/.toString(),"Action":/Save/.toString())
        //Access Action Item in Actions Items React Global Navigation
        new actions.ActionItems.AccessActionIteminActionsItemsReactGlobalNavigation().run("Action Item":/new idea/.toString())
        //Verify Development Card Answers
        new actions.ActionItems.VerifyDevelopmentCardAnswers().run("Multiple Choice - Title":/Development Multi Choice - A/.toString(),"Multiple Choice - Answer":/Answer 3/.toString())
    }
    //Basestate
