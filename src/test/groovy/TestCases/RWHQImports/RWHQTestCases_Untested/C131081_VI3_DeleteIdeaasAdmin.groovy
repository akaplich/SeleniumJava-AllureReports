...
//C131081 - VI3 - Delete Idea as Admin
class C131081_VI3_DeleteIdeaasAdmin
{
    ...
    public void testcase(){
        ...
        new actions.PipelineStepsView.SetDeleteIdea().run("I understand":true,"Action":/Delete Idea/.toString())
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Idea deleted successfully!/.toString(),"Should Exist":true)
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/note deleted successfully!/.toString(),"Should Exist":true)
        //Verify Idea in Idea Board page
        ...
        new actions.PipelineStepsView.AccessIdeainPipelineStepsView().run("Idea Name":/quick add1/.toString())
        //Set Action Menu in View Idea 3.0 Page
        new actions.ViewIdea30.SetCopyLinkOnViewIdea30Page().run("Menu Option Name":/Delete/.toString(),"Click the Option":true)
        //Set Delete Idea or Pipeline in all places
        new actions.PipelineStepsView.SetDeleteIdea().run("I understand":true,"Action":/Delete note/.toString())
