...
//C128379 -  User Activity - Moderator, Analyst Have Access
class C128379_UserActivity_Moderator_AnalystHaveAccess
{
    ...
    public void testcase(){
        ...
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/User_activity-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["Moderator","moderator@test.com"],"Number of Matches":/1/.toString(),"Total Number of Rows":/3/.toString())
        ...
        new actions.SetupExports.DownloadGeneratedReport().run("Section":/Users/.toString(),"Report Name Starts with":/User_activity/.toString(),"Instance":/1/.toString())
        //Verify File Data
        new actions.general.VerifyFileData().run("File Name":/User_activity-*.csv/.toString(),"File Location":/Downloads/.toString(),"Row Values":["analyst","analyst@test.com"],"Number of Matches":/1/.toString(),"Total Number of Rows":/4/.toString())
    }
    //Basestate
