...
//C128584 - Search blog draft on Initiative Global Navigation
class C128584_SearchblogdraftonInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        //Set Blog Post
        new actions.EnterpriseBlogs.SetBlogPost().run("Add or Edit":/Add/.toString(),"Title":/First Blog Post/.toString(),"Tags":/firstblog/.toString(),"Add or Delete Tags":/Add/.toString(),"Content":/First Blog posted in custom app/.toString(),"Action":/Save Draft/.toString())
        //Navigate WebStorm or MTS
