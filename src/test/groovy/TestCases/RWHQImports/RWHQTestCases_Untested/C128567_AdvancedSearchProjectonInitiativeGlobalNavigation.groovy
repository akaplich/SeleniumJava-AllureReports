...
//C128567 - Advanced Search Project on Initiative Global Navigation
class C128567_AdvancedSearchProjectonInitiativeGlobalNavigation
{
    ...
    public void testcase(){
        ...
        new actions.Search.QuickOrAdvanceSearchInGlobalNav().run("Search Input":/test idea/.toString())
        //Verify Quick or Advanced Search Result
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Quick Results/.toString(),"Name of the searched item":/test idea2/.toString(),"Placement Number (for Quick Results)":/2/.toString(),"Type":/Idea/.toString(),"Number of Matches":/1/.toString())
        //Verify Quick or Advanced Search Result
        ...
        //Verify Quick or Advanced Search Result
        new actions.Search.VerifyQuickOrAdvancedSearchResult().run("Tab":/Advanced Search/.toString(),"Name of the searched item":/test idea1/.toString(),"Type":/Projects/.toString(),"Number of Total (for Advanced Search)":/1 of 1/.toString(),"Description (for Advanced Search)":/test idea1 desc/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
