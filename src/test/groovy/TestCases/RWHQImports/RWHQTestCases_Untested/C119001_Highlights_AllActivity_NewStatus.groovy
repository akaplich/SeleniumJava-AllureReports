...
//C119001 - Highlights - All Activity - New Status
class C119001_Highlights_AllActivity_NewStatus
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyHighlightsItemonUserHomepage().run("Highlights Item Header":/The Status of "test idea1" by Sri has been changed to Completed./.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
