...
//C130977 - WB - Text - Lock & Unlock
class C130977_WB_Text_LockRedwoodHQTestCaseUnlock
{
    ...
    public void testcase(){
        ...
        new actions.Whiteboards.ClickOnWhiteboardCanvas().run("X coordinate":/50/.toString(),"Y coordinate":/30/.toString(),"Single Double or Right Click":/Right Click/.toString())
