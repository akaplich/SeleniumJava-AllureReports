...
//C128544 - Users accessing Confidential Image
class C128544_UsersaccessingConfidentialImage
{
    ...
    public void testcase(){
        ...
        new actions.SetupImageLibrary.AddorDeleteImagefilesfromImageLibraryinEnterpriseSetup().run("Add or Delete":/Add/.toString(),"File":/SamplePNG.png/.toString(),"Description":/Sample Image/.toString(),"Confidential File":true)
        ...
        //Verify Image loads
        new actions.SetupImageLibrary.VerifyImageLoads().run("Image Displayed":false)
        //Navigate to URL
