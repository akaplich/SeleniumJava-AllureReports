...
//C131212 - VI3 - Link Ideas - SA, PA, CA, Moderator Link Ideas
class C131212_VI3_LinkIdeas_SA_PA_CA_ModeratorLinkIdeas
{
    ...
    public void testcase(){
        ...
        new actions.general.LogOut().run([:])
        //Login
        new actions.general.Login().run("Email":/${variables."TCData.useremail"}/.toString(),"Password":/brightidea1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Access Idea in Idea Board page
        new actions.IdeaBoard.AccessIdeainIdeaBoardpage30().run("Idea Name":/test idea1/.toString())
        //Set Linked Ideas on VI3
        new actions.ViewIdea30.SetLinkedIdeasVI3().run("Idea Title":/linked idea1/.toString(),"Link or Unlink":/Link/.toString(),"Action":/Submit/.toString())
        //Set Linked Ideas on VI3
        new actions.ViewIdea30.SetLinkedIdeasVI3().run("Idea Title":/quick add1/.toString(),"Link or Unlink":/Link/.toString(),"Action":/Submit/.toString())
        //Verify Linked Submissions on VI3
        new actions.ViewIdea30.VerifyLinkedSubmissionsVI3().run("Linked Idea(s)":/(D113) linked idea1,(D105) quick add1/.toString(),"Linked Idea(s) Status":/Submitted,Pending/.toString(),"Should Exist":/TRUE,TRUE/.toString(),"Linked Idea to Click On (optional)":/(D105) quick add1/.toString())
        //Verify Linked Submissions on VI3
        new actions.ViewIdea30.VerifyLinkedSubmissionsVI3().run("Linked Idea(s)":/(D102) test idea1,(D113) linked idea1/.toString(),"Linked Idea(s) Status":/Under Review,Submitted/.toString(),"Should Exist":/TRUE,FALSE/.toString())
    }
    //Basestate
