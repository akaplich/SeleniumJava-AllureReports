...
//C132316 - Edit Cloned Rule - Able to add new condition
class C132316_EditClonedRule_Abletoaddnewcondition
{
    ...
    public void testcase(){
        ...
        //Set Rule window
        new actions.Rules.SetNewRulewindow().run("Rule Name":/test new rule with conditions/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/test new rule with conditions/.toString())
        //Clone Rule
        Action5951802937f5aeb002321993([:])
        //Verify Rule in Rules Engine table
        new actions.Rules.VerifyRuleinRulesEnginetable().run("Order":/1/.toString(),"Rule Name":/Clone of test new rule with conditions/.toString(),"Event":/Added to Step Review/.toString(),"Last Run":/Never/.toString(),"Status":/Inactive/.toString(),"Number of Matches":/1/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Rules/.toString())
        //Access Existing Rule
        new actions.Rules.AccessExistingRule().run("Rule Name":/test new rule with conditions/.toString())
        //Set Rule Perform the Following Actions
