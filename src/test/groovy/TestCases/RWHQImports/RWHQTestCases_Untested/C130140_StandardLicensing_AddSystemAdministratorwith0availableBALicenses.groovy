...
class C130140_StandardLicensing_AddSystemAdministratorwith0availableBALicenses
{
    ...
    public void testcase(){
        ...
        try{
            //Set Enterprise Setup Users Administrators page
            new actions.SetupUsers.SetEnterpriseSetupUsersAdministratorspage().run("System Administrators":/Moderator/.toString(),"System Administrators Add or Remove":/Add/.toString(),"User Available":false)
        }
       catch(all){}catch(Error err){}
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/No licenses available!/.toString(),"Should Exist":true)
        try{
            //Set Enterprise Setup Users Administrators page
            new actions.SetupUsers.SetEnterpriseSetupUsersAdministratorspage().run("System Administrators":/Pipeline Admin/.toString(),"System Administrators Add or Remove":/Add/.toString(),"User Available":false)
        }
       catch(all){}catch(Error err){}
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/No licenses available!/.toString(),"Should Exist":true)
        ...
        try{
            //Set Enterprise Setup Users Administrators page
            new actions.SetupUsers.SetEnterpriseSetupUsersAdministratorspage().run("System Administrators":/dfhfdf/.toString(),"System Administrators Add or Remove":/Add/.toString(),"User Available":false)
        }
       catch(all){}catch(Error err){}
        //Verify Message
        ...
        new actions.People.VerifyLicensesUserinPeoplePillarLicensesTab().run("License Type":/Brightidea Administrator License Type/.toString(),"Expand License Breakdown":true,"User":/Moderator/.toString(),"Roles":/System Administrator/.toString(),"Number of Matches":/0/.toString())
        //Verify Licenses User in People Pillar Licenses tab
        new actions.People.VerifyLicensesUserinPeoplePillarLicensesTab().run("License Type":/Brightidea Administrator License Type/.toString(),"Expand License Breakdown":false,"User":/NonBI System Admin/.toString(),"Roles":/System Sponsor,System Administrator/.toString(),"Placement Number":/1/.toString(),"Number of Matches":/1/.toString())
        //Verify Licenses User in People Pillar Licenses tab
