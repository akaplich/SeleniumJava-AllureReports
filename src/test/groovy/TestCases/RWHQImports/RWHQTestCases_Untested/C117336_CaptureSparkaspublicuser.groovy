...
//C117336 - Capture Spark as public user
class C117336_CaptureSparkaspublicuser
{
    ...
    public void testcase(){
        ...
        new actions.Enterprise.UserHomepage.VerifyIdeainMyIdeasList().run("Thumbnail":/Default/.toString(),"Title":/Brightidea must be next big thing/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
