...
//C130771 - Migrate Quarterly BI to Yearly in Pipeline Dashboard
class C130771_MigrateQuarterlyBItoYearlyinPipelineDashboard
{
    ...
    public void testcase(){
        ...
        //Set Financial Targets in the Business Impact tab
        new actions.PipelineDashBoard.SetfinancialtargetsintheBusinessImpacttab().run("Year":/2022/.toString(),"Targets":/500/.toString())
        //Set Financial Targets in the Business Impact tab
        new actions.PipelineDashBoard.SetfinancialtargetsintheBusinessImpacttab().run("Year":/2024/.toString(),"Targets":/1000/.toString(),"Action":/Save Targets/.toString())
        //Verify Benefits Over Time Stats
        new actions.PipelineDashBoard.VerifyBenefitsOverTimeStats().run("Total Projected Benefits":/$49,000/.toString(),"Total Actual Benefits":/$48,000/.toString(),"Total Target Benefits":/$4,500/.toString())
        //Verify the MouseHover on Chart View in Business Impact Tab
        new actions.PipelineDashBoard.VerifyMouseHoveronBusinessImpactTabinPipelineDashBoard().run("Year":/2021,2022,2023,2024/.toString(),"Projected":/$24,000;$49,000;<EMPTY>;<EMPTY>/.toString(),"Actual":/$24,000;$48,000;<EMPTY>;<EMPTY>/.toString(),"Target":/$1,500;$2,000;$3,500;$4,500/.toString())
    }
    //Basestate
