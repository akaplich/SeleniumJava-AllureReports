...
//C117193 - Chips Voting count on Submission hover - VI3
class C117193_ChipsVotingcountonSubmissionhover_VI3
{
    ...
    public void testcase(){
        ...
        new actions.IdeaBoard.VerifythesubmissionhoveronPipelineStepsViewforEndUsers().run("Idea Title":/idea1/.toString(),"Idea Submitter":/System Admin/.toString(),"Idea Category":/New Product/.toString(),"Idea Description":/desc/.toString(),"Votes":/0/.toString(),"Number of Matches":/0/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Voting Test/.toString(),"Area to Navigate to":/Setup/.toString())
        //Set Webstorm Setup Ideas for Voting tab
        new actions.SetupIdeas.SetWebstormSetupIdeasforNewVotingtab().run("Voting Checkbox":true,"Type of Voting":/Chips/.toString(),"Total number of chips per user":/50/.toString(),"Number of chips a user can give to an idea":/10/.toString())
        //Log Out
        ...
        new actions.IdeaBoard.AccessIdeafromPipelineStepsViewforEndUsers().run("Idea Name":/idea1/.toString())
        //Set Voting on VI3
        new actions.ViewIdea30.SetVotingonViewIdea3().run("Add or Edit Chips":/5/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Voting Test/.toString(),"Area to Navigate to":/Idea Board/.toString())
        //Set Tab/View on Idea Board
        new actions.IdeaBoard.NavigatetoIdeaBoardsView().run("View":/Steps/.toString())
        //Verify Submission Rollover in Pipeline Steps View for End Users
        new actions.IdeaBoard.VerifythesubmissionhoveronPipelineStepsViewforEndUsers().run("Idea Title":/idea1/.toString(),"Idea Submitter":/System Admin/.toString(),"Idea Category":/New Product/.toString(),"Idea Description":/desc/.toString(),"Votes":/5/.toString(),"Number of Matches":/1/.toString())
        //Log Out
        new actions.general.LogOut().run([:])
        //Login
