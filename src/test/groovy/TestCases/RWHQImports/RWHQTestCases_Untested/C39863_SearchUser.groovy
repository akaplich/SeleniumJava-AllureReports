...
class C39863_SearchUser
{
    ...
    public void testcase(){
        ...
        new actions.People.AddUserinPeoplepage().run("Email Address":/brightC39863_4@mailinator.com/.toString(),"First Name":/New/.toString(),"Last Name":/User/.toString(),"Screen Name":/Auto/.toString(),"Action":/Add User/.toString())
        //Get Registration Link from Email
        variables."link" = new actions.Mailinator.GetRegistrationLinkfromEmail().run("Email Address":/brightC39863_4/.toString())
        //Navigate to URL
