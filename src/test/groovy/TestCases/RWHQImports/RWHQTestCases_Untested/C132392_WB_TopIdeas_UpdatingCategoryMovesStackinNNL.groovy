...
//C132392 - WB - Top Ideas - Updating Category Moves Stack in NNL
class C132392_WB_TopIdeas_UpdatingCategoryMovesStackinNNL
{
    ...
    public void testcase(){
        ...
        new actions.PipelineTopIdeas.TopIdeaChangeCategoryViaRightClickMenu().run("Choose Category":/Theme 2/.toString(),"Action":/Save/.toString())
        //Navigate
        new actions.general.Navigate().run("Area to Navigate to":/User Homepage/.toString())
        //Select Existing Whiteboard from Userhome Whiteboards
        new actions.Whiteboards.OpenExistingWhiteboardOnWhiteboardsPage().run("Name of Whiteboard":/C132392/.toString())
        //Compare Images
        new actions.selenium.CompareImages().run("Expected Image File":/C132392_expected.png/.toString(),"Actual Image Name":/C132392_actual.png/.toString(),"Crop Screenshot Start at X":/550/.toString(),"Crop Screenshot Start at Y":/400/.toString(),"Crop Screenshot Width":/850/.toString(),"Crop Screenshot Height":/500/.toString(),"Allowed Number of Different Pixels":/100/.toString(),"Do Not Scroll":true)
    }
    //Basestate
    ...
    public void afterState(){
        ...
        try{
            //Delete File
            new actions.selenium.DeleteFile().run("File Location":/Downloads/.toString(),"File Name":/C132392_actual.png/.toString())
        }
       catch(all){}catch(Error err){}
    }
}