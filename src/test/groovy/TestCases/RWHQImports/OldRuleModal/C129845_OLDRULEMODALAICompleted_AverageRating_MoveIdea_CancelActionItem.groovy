...
// C129845 - OLD RULE MODAL AI Completed - Average Rating - Move Idea, Cancel Action Item
class C129845_OLDRULEMODALAICompleted_AverageRating_MoveIdea_CancelActionItem
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.ConfigureRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Pipeline A/.toString(),"Category":/Marketing & Branding/.toString(),"Status":/In Progress/.toString(),"Action":/Save/.toString())
