...
//C93390  - OLD RULE MODAL Idea Status Changed Rule
class C93390_OLDRULEMODALIdeaStatusChangedRule
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/oldbrightC93390_9/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        //Navigate
        ...
        new actions.Rules.SetRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Condition":/Status/.toString(),"Operator value":/Is/.toString(),"Condition value":/Non-Adopted/.toString())
        //OLD RULE Set Rule Perform the Following Actions
        new actions.Rules.SetRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Perform Following Action":/Send Email/.toString(),"Send Email Recipent Group":/To Users and Groups/.toString(),"Send Email Enter Subject":/Test Email/.toString(),"Send Email Text":/Status of your idea has been changed./.toString(),"Select Recipient":/System Admin Group/.toString())
        //OLD RULE Set Rule window
        new actions.Rules.SetRulewindow().run("Rule Name":/Status Changed/.toString(),"Action":/Create/.toString())
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/oldbrightC93390_9@mailinator.com/.toString(),"Subject":/Test Email/.toString())
    }
    //Basestate
