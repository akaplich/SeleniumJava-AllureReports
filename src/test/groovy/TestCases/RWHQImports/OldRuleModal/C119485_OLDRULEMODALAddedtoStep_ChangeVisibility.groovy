...
//C119485 - OLD RULE MODAL Added to Step - Change Visibility
class C119485_OLDRULEMODALAddedtoStep_ChangeVisibility
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.SetRulewindow().run("Rule Name":/Added to Step - Change Visibility/.toString(),"Action":/Create/.toString())
