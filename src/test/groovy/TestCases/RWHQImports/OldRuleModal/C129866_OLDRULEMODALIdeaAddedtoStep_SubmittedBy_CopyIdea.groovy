...
//C129866 - OLD RULE MODAL Idea Added to Step - Submitted By - Copy Idea
class C129866_OLDRULEMODALIdeaAddedtoStep_SubmittedBy_CopyIdea
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.SetRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Condition":/Days Since Idea Submission/.toString(),"Operator value":/Is Less Than/.toString(),"Condition value":/1/.toString())
        //OLD RULE Set Rule Perform the Following Actions
        new actions.Rules.SetRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Perform Following Action":/Change Status/.toString(),"Action Value":/Under Review/.toString())
        //OLD RULE Set Rule window
        new actions.Rules.SetRulewindow().run("Rule Name":/1 Rule Status/.toString(),"Action":/Create/.toString())
        ...
        new actions.Rules.SetRuleEventthattriggersthisrule().run("Event":/Added to Step/.toString(),"Event Value":/Single Scale/.toString())
        //OLD RULE Set Rule Meet the Following Conditions
        new actions.Rules.SetRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Condition":/Submitted by/.toString(),"Operator value":/Is/.toString(),"Condition value":/End User/.toString())
        //OLD RULE Set Rule Perform the Following Actions
