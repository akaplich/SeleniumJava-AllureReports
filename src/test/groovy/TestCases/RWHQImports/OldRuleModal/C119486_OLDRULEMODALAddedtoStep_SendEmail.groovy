...
//C119486 - OLD RULE MODAL Added to Step - Send Email 
class C119486_OLDRULEMODALAddedtoStep_SendEmail
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/oldbrightC119486_1/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        //Navigate
        ...
        new actions.Rules.SetRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Perform Following Action":/Send Email/.toString(),"Send Email Enter Subject":/Test Email/.toString(),"Send Email Text":/Email sent for Added to Step/.toString(),"Select Recipient":/System Admin Group/.toString())
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/oldbrightC119486_1/.toString(),"Subject":/Test Email/.toString())
    }
    //Basestate
