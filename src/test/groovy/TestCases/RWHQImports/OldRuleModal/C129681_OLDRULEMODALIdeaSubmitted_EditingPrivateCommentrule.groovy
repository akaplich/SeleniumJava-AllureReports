...
//C129681 - OLD RULE MODAL Idea Submitted - Editing Private Comment rule
class C129681_OLDRULEMODALIdeaSubmitted_EditingPrivateCommentrule
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.SetRulewindow().run("Rule Name":/Idea Submitted - Add Private Comment/.toString(),"Action":/Create/.toString())
        ...
        //OLD RULE Set Rule Perform the Following Actions
        new actions.Rules.SetRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Perform Following Action":/Add Private Comment/.toString(),"Comment":/testing by adding Private Comment through rules edited version/.toString())
        //Verify Message
        ...
        //OLD RULE Set Rule window
        new actions.Rules.SetRulewindow().run("Rule Name":/Idea Submitted - Add Private Comment/.toString(),"Action":/Save/.toString())
        //Navigate WebStorm or MTS
        new actions.general.NavigateWebStormAdminBar().run("WebStorm Name":/Custom App/.toString(),"Area to Navigate to":/Post Idea/.toString())
        //Set Custom and Other App Post Idea
