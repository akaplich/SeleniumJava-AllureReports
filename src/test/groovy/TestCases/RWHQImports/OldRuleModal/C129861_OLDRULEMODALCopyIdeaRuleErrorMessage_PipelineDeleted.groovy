...
//C129861 - OLD RULE MODAL Copy Idea Rule Error Message - Pipeline Deleted
class C129861_OLDRULEMODALCopyIdeaRuleErrorMessage_PipelineDeleted
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/Ideas will be copied to/.toString(),"Should Exist":true)
        //Verify Message
