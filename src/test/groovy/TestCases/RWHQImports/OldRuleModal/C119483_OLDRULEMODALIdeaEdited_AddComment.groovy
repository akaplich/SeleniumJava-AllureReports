...
//C119483 - OLD RULE MODAL Idea Edited - Add Comment
class C119483_OLDRULEMODALIdeaEdited_AddComment
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.SetRulewindow().run("Rule Name":/Idea Edited - Add Comment/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Idea Edited - Add Comment/.toString())
