...
//C5090 - OLD RULE MODAL Delete Rule
class C5090_OLDRULEMODALDeleteRule
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        //OLD RULE Delete Rule
        new actions.Rules.DeleteRule().run([:])
        //Verify Rule in Rules Engine table
        new actions.Rules.VerifyRuleinRulesEnginetable().run("Rule Name":/New Idea added to step/.toString(),"Number of Matches":/0/.toString())
    }
    //Basestate
