...
//C129872 - OLD RULE MODAL Idea Submitted - Imported Ideas - Category Is - Copy Idea
class C129872_OLDRULEMODALIdeaSubmitted_ImportedIdeas_CategoryIs_CopyIdea
extends TestBase {
    ...
    public void testcase(){
        ...
        new actions.Rules.ConfigureRuleActionCopyIdeatoPipeline().run("Pipeline":/Healthcare/.toString(),"Action":/Save/.toString())
        ...
        new actions.Rules.SetRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Perform Following Action":/Copy Idea to Pipeline/.toString(),"Configure Action (Move or Copy to Pipeline Only)":true)
        //OLD RULE Configure Rule Action Copy Idea to Pipeline
        new actions.Rules.ConfigureRuleActionCopyIdeatoPipeline().run("Pipeline":/Education/.toString(),"Action":/Save/.toString())
        //OLD RULE Set Rule window
        new actions.Rules.SetRulewindow().run("Rule Name":/Rule Copy 2/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        ...
        new actions.Rules.SetRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Perform Following Action":/Copy Idea to Pipeline/.toString(),"Configure Action (Move or Copy to Pipeline Only)":true)
        //OLD RULE Configure Rule Action Copy Idea to Pipeline
        new actions.Rules.ConfigureRuleActionCopyIdeatoPipeline().run("Pipeline":/Entertainment/.toString(),"Action":/Save/.toString())
        //OLD RULE Set Rule window
        new actions.Rules.SetRulewindow().run("Rule Name":/Rule Copy 3/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
