...
//C129840 - OLD RULE MODAL Comment Submitted - Comment Count - Move Idea 
class C129840_OLDRULEMODALCommentSubmitted_CommentCount_MoveIdea
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.ViewIdea30.VerifyIdeaonViewIdea3().run("View As":/Admin/.toString(),"Idea Name":/test idea2/.toString(),"Description":/test idea2 desc/.toString(),"Category":/Marketing & Branding/.toString(),"Status":/Submitted/.toString(),"Submitter Name":/Sri/.toString())
