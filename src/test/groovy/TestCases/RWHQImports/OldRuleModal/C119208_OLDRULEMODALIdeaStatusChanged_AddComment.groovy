...
//C119208 - OLD RULE MODAL Idea Status Changed - Add Comment
class C119208_OLDRULEMODALIdeaStatusChanged_AddComment
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.SetRulewindow().run("Rule Name":/Idea Status Changed - Add Comment/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Idea Status Changed - Add Comment/.toString())
