...
//C129865 - OLD RULE MODAL Comment Submitted - Comment Count - Copy Idea With Comments
class C129865_OLDRULEMODALCommentSubmitted_CommentCount_CopyIdeaWithComments
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.SetRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Condition":/Comment Count/.toString(),"Operator value":/Is/.toString(),"Condition value":/2/.toString())
        ...
        new actions.ViewIdeaComment.VerifyCommentinViewIdeapage().run("Comment Section":/Comments/.toString(),"Type of Comment":/General Access/.toString(),"Comment":/test comment1/.toString(),"User":/System Admin/.toString(),"Number of Matches":/1/.toString())
        //Verify Comment in View Idea page
        new actions.ViewIdeaComment.VerifyCommentinViewIdeapage().run("Comment Section":/Comments/.toString(),"Type of Comment":/General Access/.toString(),"Comment":/test comment2/.toString(),"User":/System Admin/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
