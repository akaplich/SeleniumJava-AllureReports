...
//C129853 - OLD RULE MODAL Move Idea Rule Setup - Admin Has No Access to Destination Pipeline
class C129853_OLDRULEMODALMoveIdeaRuleSetup_AdminHasNoAccesstoDestinationPipeline
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.ConfigureRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Pipeline A/.toString(),"Category":/Operations/.toString(),"Status":/Submitted/.toString(),"Action":/Save/.toString())
