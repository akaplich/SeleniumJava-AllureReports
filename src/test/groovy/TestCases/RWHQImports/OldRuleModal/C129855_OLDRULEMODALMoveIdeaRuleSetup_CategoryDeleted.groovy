...
//C129855 - OLD RULE MODAL Move Idea Rule Setup - Category Deleted
class C129855_OLDRULEMODALMoveIdeaRuleSetup_CategoryDeleted
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.ConfigureRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Pipeline A/.toString(),"Category":/Marketing & Branding/.toString(),"Status":/Submitted/.toString(),"Action":/Save/.toString())
