...
//C129854 - OLD RULE MODAL Move Idea Rule Setup - Cannot Save Rule If Not Configured
class C129854_OLDRULEMODALMoveIdeaRuleSetup_CannotSaveRuleIfNotConfigured
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.SetRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Perform Following Action":/Move Idea to Pipeline/.toString())
        try{
        ...
        //Verify Message
        new actions.general.VerifyMessage().run("Message Text":/This action requires additional configuration before it can be saved/.toString(),"Should Exist":true)
    }
    //Basestate
