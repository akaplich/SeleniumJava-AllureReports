...
//C129858 - OLD RULE MODAL Move Idea Rule Setup - System Status Deleted
class C129858_OLDRULEMODALMoveIdeaRuleSetup_SystemStatusDeleted
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.ConfigureRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Pipeline A/.toString(),"Category":/Marketing & Branding/.toString(),"Status":/Completed/.toString(),"Action":/Save/.toString())
