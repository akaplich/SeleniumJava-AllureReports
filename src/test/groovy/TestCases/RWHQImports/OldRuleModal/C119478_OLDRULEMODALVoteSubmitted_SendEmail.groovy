...
//C119478 - OLD RULE MODAL Vote Submitted - Send Email
class C119478_OLDRULEMODALVoteSubmitted_SendEmail
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Mailinator.CreateMailinatorUser().run("Email":/oldbrightC119478/.toString(),"Enterprise System Administrator":true,"Finally Login as What User":/bi.adminuser1@brightidea.com/.toString())
        //Navigate
        ...
        new actions.Rules.SetRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Perform Following Action":/Send Email/.toString(),"Send Email Enter Subject":/Test Email/.toString(),"Send Email Text":/Email sent for Vote Submitted/.toString(),"Select Recipient":/System Admin Group/.toString())
        //OLD RULE Set Rule window
        new actions.Rules.SetRulewindow().run("Rule Name":/Vote Submitted - Send Email/.toString(),"Action":/Create/.toString())
        ...
        //Verify Email
        new actions.Mailinator.VerifyEmail().run("Email Address":/oldbrightC119478@mailinator.com/.toString(),"Subject":/Test Email/.toString())
    }
    //Basestate
