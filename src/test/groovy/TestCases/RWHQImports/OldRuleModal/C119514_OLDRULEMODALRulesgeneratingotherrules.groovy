...
//C119514 - OLD RULE MODAL Rules generating other rules
class C119514_OLDRULEMODALRulesgeneratingotherrules
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.AccessAddCreateRulepopup().run([:])
        //OLD RULE Set Rule Event that triggers this rule
        new actions.Rules.SetRuleEventthattriggersthisrule().run("Event":/Added to Step/.toString(),"Event Value":/Scorecarding/.toString())
        //OLD RULE Set Rule Perform the Following Actions
        ...
        //OLD RULE Set Rule window
        new actions.Rules.SetRulewindow().run("Rule Name":/Change Visibility/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
