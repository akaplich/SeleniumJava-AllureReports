...
//C119207 - OLD RULE MODAL Idea Status Changed - Change Step
class C119207_OLDRULEMODALIdeaStatusChanged_ChangeStep
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.SetRulewindow().run("Rule Name":/Idea Status Changed - Change Step/.toString(),"Action":/Create/.toString())
        //Select Rule in Rules Engine table
        new actions.Rules.SelectRuleinRulesEnginepage().run("Rule Name":/Idea Status Changed - Change Step/.toString())
