...
//C119205 - OLD RULE MODAL Idea Status Changed - Change Status
class C119205_OLDRULEMODALIdeaStatusChanged_ChangeStatus
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.SetRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Perform Following Action":/Change Status/.toString(),"Action Value":/Pending/.toString())
        //OLD RULE Set Rule window
        new actions.Rules.SetRulewindow().run("Rule Name":/Idea Status Changed - Change Status/.toString(),"Action":/Create/.toString())
