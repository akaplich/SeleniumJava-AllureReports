...
//C119515 - OLD RULE MODAL Rules performing multiple actions and conditions
class C119515_OLDRULEMODALRulesperformingmultipleactionsandconditions
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        //OLD RULE Set Rule Meet the Following Conditions
        new actions.Rules.SetRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/2/.toString(),"Add, Delete or Modify":/Add/.toString(),"Condition":/Status/.toString(),"Operator value":/Is/.toString(),"Condition value":/Non-Adopted/.toString())
        //OLD RULE Set Rule Perform the Following Actions
        new actions.Rules.SetRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Perform Following Action":/Change Step/.toString(),"Action Value":/Scorecarding/.toString())
        //OLD RULE Set Rule Perform the Following Actions
        new actions.Rules.SetRulePerformtheFollowingActions().run("Row Number to be Added, Delete or Modify existing":/2/.toString(),"Add, Delete or Modify":/Add/.toString(),"Perform Following Action":/Change Visibility/.toString(),"Action Value":/Hidden/.toString())
        //OLD RULE Set Rule window
        new actions.Rules.SetRulewindow().run("Rule Name":/Comment Submitted - Change Step/.toString(),"Action":/Create/.toString())
