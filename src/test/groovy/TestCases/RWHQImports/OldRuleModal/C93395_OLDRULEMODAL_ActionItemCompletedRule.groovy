...
//C93395 - OLD RULE MODAL - Action Item Completed Rule
class C93395_OLDRULEMODAL_ActionItemCompletedRule
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.SetRuleMeettheFollowingConditions().run("Row Number to be Added, Delete or Modify existing":/1/.toString(),"Add, Delete or Modify":/Modify/.toString(),"Condition":/Step/.toString(),"Operator value":/Is/.toString(),"Condition value":/Review/.toString())
        ...
        new actions.Rules.SetRulewindow().run("Rule Name":/Move Idea Forward/.toString(),"Action":/Create/.toString())
        ...
        new actions.PipelineStepsView.VerifyIdeainPipelineStepsViewpage().run("Idea Name":/review idea/.toString(),"Step Name idea belongs to":/Single Scale/.toString(),"Number of Matches":/1/.toString())
    }
    //Basestate
