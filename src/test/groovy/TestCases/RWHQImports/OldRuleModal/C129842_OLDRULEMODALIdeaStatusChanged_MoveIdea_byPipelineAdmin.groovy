...
//C129842 - OLD RULE MODAL Idea Status Changed - Move Idea - by Pipeline Admin
class C129842_OLDRULEMODALIdeaStatusChanged_MoveIdea_byPipelineAdmin
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.ConfigureRuleActionMoveIdeatoPipeline().run("Move To Pipeline":/Pipeline A/.toString(),"Category":/Strategy/.toString(),"Status":/Submitted/.toString(),"Action":/Save/.toString())
