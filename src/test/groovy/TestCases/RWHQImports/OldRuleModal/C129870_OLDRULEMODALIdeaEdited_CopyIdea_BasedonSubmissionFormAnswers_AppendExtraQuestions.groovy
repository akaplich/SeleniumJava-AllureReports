...
//C129870 - OLD RULE MODAL Idea Edited - Copy Idea - Based on Submission Form Answers, Append Extra Questions
class C129870_OLDRULEMODALIdeaEdited_CopyIdea_BasedonSubmissionFormAnswers_AppendExtraQuestions
extends TestBase {
    ...
    @Test @Tag("OldRulesModalRegression")  public void testcase(){
        ...
        new actions.Rules.ConfigureRuleActionCopyIdeatoPipeline().run("Pipeline":/Pipeline A/.toString(),"Append extra submission questions to description":true,"Action":/Save/.toString())
